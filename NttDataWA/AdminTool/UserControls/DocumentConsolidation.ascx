<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocumentConsolidation.ascx.cs" Inherits="SAAdminTool.UserControls.DocumentConsolidation" %>
...
//                "L'operazione ha carattere di irreversibilità. Si desidera continuare?");
    ...
    function showConsolidationSummary() {
        ...
        return window.showModalDialog('<%=SAAdminTool.Utils.getHttpFullPath()%>/MassiveOperation/DocumentConsolidationSummary.aspx',
            null, 
