...
namespace SAAdminTool
{
    ...
    public class UserManager
    {
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getParentCorr(Page page)
        {
            return (SAAdminTool.DocsPaWR.Corrispondente)page.Session["rubricaDT.parentCorr"];
        }
        ...
        public static SAAdminTool.DocsPaWR.Canale[] getListaCanali(Page page)
        {
            if (page.Session["rubrica.listaCanali"] == null)
            {
                ...
                DocsPaWR.Canale[] canali = new SAAdminTool.DocsPaWR.Canale[arrayLength];
            ...
            return (SAAdminTool.DocsPaWR.Canale[])page.Session["rubrica.listaCanali"];
        }
        #endregion
        ...
        public static SAAdminTool.DocsPaWR.Configurazione getParametroConfigurazione(Page page)
        {
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.Amministrazione[] getListaAmministrazioni(Page page, out string returnMsg)
        {
        ...
        public static Utente login(Page page, SAAdminTool.DocsPaWR.UserLogin login,
            out SAAdminTool.DocsPaWR.LoginResult loginResult, out string ipaddress)
        {
            Utente utente = null;
            loginResult = SAAdminTool.DocsPaWR.LoginResult.OK;
            ipaddress = "";
            ...
            catch (Exception exception)
            {
                ...
                loginResult = SAAdminTool.DocsPaWR.LoginResult.APPLICATION_ERROR;
                utente = null;
            }
        ...
        public static Utente login(string SessionID, SAAdminTool.DocsPaWR.UserLogin login,
            out SAAdminTool.DocsPaWR.LoginResult loginResult, out string ipaddress)
        {
            Utente utente = null;
            loginResult = SAAdminTool.DocsPaWR.LoginResult.OK;
        ...
        public static Utente LoginBatch(string SessionID, string userName, string DST,
            out SAAdminTool.DocsPaWR.LoginResult loginResult, out SAAdminTool.DocsPaWR.UserLogin userLogin)
        {
            userLogin = null;
        ...
        /// <returns></returns>
        public static Utente ForcedLogin(Page page, SAAdminTool.DocsPaWR.UserLogin login, out SAAdminTool.DocsPaWR.LoginResult loginResult)
        {
            Utente utente = null;
            loginResult = SAAdminTool.DocsPaWR.LoginResult.OK;
            string ipaddress;
        ...
        /// <returns></returns>
        public static SAAdminTool.DocsPaWR.ValidationResult ValidateLogin(string userName, string idAmm, string sessionId)
        {
            DocsPaWR.ValidationResult result = SAAdminTool.DocsPaWR.ValidationResult.APPLICATION_ERROR;
            ...
            catch (Exception exception)
            {
                ...
                result = SAAdminTool.DocsPaWR.ValidationResult.APPLICATION_ERROR;
            }
        ...
        public static Utente getUtente()
        {
            ...
            {
                ErrorManager.redirectToLoginPage(null);
                return null;
            }
        }
        ...
        /// <param name="sessionId"></param>
        public static void logoff(SAAdminTool.DocsPaWR.InfoUtente infoUtente, string sessionId)
        {
            try
            {
        ...
        public static void logoffAdmin(DocsPaWR.InfoUtenteAmministratore adminUser)
       {
        ...
        public static SAAdminTool.DocsPaWR.Registro getRegistroBySistemId(Page page, string idRegistro)
        {
        ...
        public static string getStatoRegistro(SAAdminTool.DocsPaWR.Registro reg)
        {
            // R = Rosso -  CHIUSO
            // V = Verde -  APERTO
        ...
        public static string[] getListaIdRegistriRuolo(Page page, SAAdminTool.DocsPaWR.Ruolo ruolo)
        {
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente GetCorrispondenteInterno(Page page, string codiceRubrica, bool fineValidita)
        {
            try
            {
                Utente utente = getUtente(page);
                ...
                qco.tipoUtente = SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO;
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente GetCorrispondenteInternoOrganigramma(Page page, string codiceRubrica, bool fineValidita)
        {
            try
            {
                Utente utente = getUtente(page);
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente GetCorrispondenteInterno(Page page, string codiceRubrica, bool fineValidita, bool destProtoInt)
        {
            try
            {
                Utente utente = getUtente(page);
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente[] getAllRuoli(SAAdminTool.DocsPaWR.Corrispondente[] corrispondenti, bool cameFromRubrica)
        {
            string l_oldSystemId = "";
            System.Object[] l_objects = new System.Object[0];
            System.Object[] l_objects_ruoli = new System.Object[0];
            DocsPaWR.Ruolo[] lruolo = new SAAdminTool.DocsPaWR.Ruolo[0];
            int i = 0;
            foreach (SAAdminTool.DocsPaWR.Corrispondente t_corrispondente in corrispondenti)
            {
                ...
                else
                {
                    ...
                    if (t_corrispondente.GetType().Equals(typeof(SAAdminTool.DocsPaWR.Utente)))
                    {
                        if (!cameFromRubrica)
                        {
                            if ((l_objects[i - 1]).GetType().Equals(typeof(SAAdminTool.DocsPaWR.Utente)))
                            {
                                l_objects_ruoli = ((Utils.addToArray(((SAAdminTool.DocsPaWR.Utente)(l_objects[i - 1])).ruoli, ((SAAdminTool.DocsPaWR.Utente)t_corrispondente).ruoli[0])));
                                DocsPaWR.Ruolo[] l_ruolo = new SAAdminTool.DocsPaWR.Ruolo[l_objects_ruoli.Length];
                                ((SAAdminTool.DocsPaWR.Utente)(l_objects[i - 1])).ruoli = l_ruolo;
                                l_objects_ruoli.CopyTo(((SAAdminTool.DocsPaWR.Utente)(l_objects[i - 1])).ruoli, 0);
            ...
            DocsPaWR.Corrispondente[] l_corrSearch = new SAAdminTool.DocsPaWR.Corrispondente[l_objects.Length];
            l_objects.CopyTo(l_corrSearch, 0);

            return l_corrSearch;
        }

        public static SAAdminTool.DocsPaWR.Ruolo[] getRuoliFiltrati(SAAdminTool.DocsPaWR.Ruolo[] ruoli)
        {
            //string l_oldSystemId="";								
            System.Object[] l_objects = new System.Object[0];
            ...
            foreach (SAAdminTool.DocsPaWR.Ruolo ruolo in ruoli)
            {
            ...
            DocsPaWR.Ruolo[] ruoliFiltrati = new SAAdminTool.DocsPaWR.Ruolo[l_objects.Length];
            l_objects.CopyTo(ruoliFiltrati, 0);

            return ruoliFiltrati;
        }

        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondente(Page page, string codiceRubrica, bool fineValidita)
        {
            try
            {
                Utente utente = getUtente(page);
                ...
                qco.tipoUtente = SAAdminTool.DocsPaWR.AddressbookTipoUtente.GLOBALE;
                //qco.fineValidita = fineValidita;
                DocsPaWR.Corrispondente result;
                DocsPaWR.Corrispondente[] corrispondenti = docsPaWS.AddressbookGetListaCorrispondenti(qco);
                if (corrispondenti.Length > 0)
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteRubrica(Page page, string codiceRubrica, DocsPaWR.RubricaCallType callType)
        {
            try
            {
              ...
              //  qco.caller.filtroRegistroPerRicerca = qco.caller.IdRegistro;
                ...
                qco.tipoIE = SAAdminTool.DocsPaWR.AddressbookTipoUtente.GLOBALE;
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteReferente(Page page, string codiceRubrica, bool fineValidita)
        {
            try
            {
                Utente utente = getUtente(page);
        ...
        public static string getDecrizioneCorrispondente(Page page, Corrispondente myCorr)
        {
            ...
            if (myCorr.GetType() == typeof(Ruolo))
            {
                ...
                //				{
                //					case "I": qco.tipoUtente = SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO; break;
                //					case "E": qco.tipoUtente = SAAdminTool.DocsPaWR.AddressbookTipoUtente.ESTERNO; break;
                //					default: qco.tipoUtente = SAAdminTool.DocsPaWR.AddressbookTipoUtente.GLOBALE; break;					
                //				}

                UnitaOrganizzativa corrUO;
                string descrUO = "";
                //				DocsPaWR.Ruolo ruo=(SAAdminTool.DocsPaWR.Ruolo) UserManager.getListaCorrispondenti(page,qco)[0];
                //				if(ruo!=null)
                //				{
        ...
        public static bool VerificaAutorizzazioneRuoloSuRegistro(Page page, string idRegistro, string idRuolo)
        {
            ...
            try
            {
                if (idRegistro != null && idRegistro != "")
                {
                    ...
                    foreach (SAAdminTool.DocsPaWR.Registro reg in RegRuoloSel)
                    {
        ...
        public static SAAdminTool.DocsPaWR.FileDocumento reportCorrispondenti(Page page, string tipo, SAAdminTool.DocsPaWR.Registro registro)
        {
            try
            {
                //costruzione oggetto queryCorrispondente
        ...
        #endregion
        //public static SAAdminTool.DocsPaWR.Corrispondente addressbookInsertCorrispondente(Page page, DocsPaWR.Corrispondente newCorr, DocsPaWR.Corrispondente parentCorr, InfoUtente um)
        //{
        //    try
        //    {
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente addressbookInsertCorrispondente(Page page, DocsPaWR.Corrispondente newCorr, DocsPaWR.Corrispondente parentCorr)
        {
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.Ruolo[] getListaRuoliSup(Page page, SAAdminTool.DocsPaWR.Ruolo ruolo)
        {
        ...
        public static SAAdminTool.DocsPaWR.Ruolo[] getRuoliRiferimentoAutorizzati(Page page, SAAdminTool.DocsPaWR.AddressbookQueryCorrispondenteAutorizzato qca, SAAdminTool.DocsPaWR.UnitaOrganizzativa uo)
        {
            //DocsPaWR.Ruolo[] ruoli;
            try
            {
        ...
        public static ElementoRubrica[] filtra_trasmissioniPerListe(Page page, ParametriRicercaRubrica qco, SAAdminTool.DocsPaWR.ElementoRubrica[] ers)
        {
            try
            {
        ...
        /// <param name="page"></param>
        public static void sendSollecito(SAAdminTool.DocsPaWR.Trasmissione trasm, Page page)
        {
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteByCodRubrica(Page page, string codice)
        {
            return getCorrispondenteByCodRubrica(page, codice, false);
        }
        
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteByCodRubrica(Page page, string codice, bool storicizzato)
        {
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteByCodRubricaIE(Page page, string codice, SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE)
        {
            try
            {
        ...
        /// <returns></returns>
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteByCodRubricaIENotdisabled(Page page, string codice, SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE)
        {
            try
            {
        ...
        public static ElementoRubrica[] getElementiRubrica(Page page, ParametriRicercaRubrica qco, SAAdminTool.DocsPaWR.SmistamentoRubrica smistamentoRubrica)
        {
            try
            {
        ...
        public static ElementoRubrica getElementoRubrica(Page page, string cod, SAAdminTool.DocsPaWR.SmistamentoRubrica smistaRubrica, string condregistri)
        {
            try
            {
        ...
        public static void setQueryRubricaCaller(ref SAAdminTool.DocsPaWR.ParametriRicercaRubrica qco)
        {
            qco.caller = new SAAdminTool.DocsPaWR.RubricaCallerIdentity();
            System.Web.HttpContext ctx = System.Web.HttpContext.Current;

            if (ctx.Session["userRuolo"] != null)
            {
                qco.caller.IdRuolo = ((SAAdminTool.DocsPaWR.Ruolo)ctx.Session["userRuolo"]).systemId;
            }
        ...
        public static Ruolo[] getListaRuoliInUO(Page page, DocsPaWR.UnitaOrganizzativa uo, SAAdminTool.DocsPaWR.InfoUtente utente)
        {
            try
            {
        ...
        public static ElementoRubrica[] getElementiRubricaRange(string[] codici, SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE, Page page)
        {
            try
            {
        ...
        public static ElementoRubrica[] getGerarchiaElemento(string codice, SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE, Page page)
        {
            try
            {
        ...
        public static ElementoRubrica[] getGerarchiaElemento(string codice, SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE, Page page, SAAdminTool.DocsPaWR.SmistamentoRubrica smistamentoRubrica)
        {
            try
            {
        ...
        public static ElementoRubrica[] getRootItems(SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE, Page page)
        {
            try
            {
        ...
        public static ElementoRubrica[] getRootItems(SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE, Page page, SAAdminTool.DocsPaWR.SmistamentoRubrica smistamentoRubrica)
        {
            try
            {
        ...
        public static bool isUniqueNomeLista(Page page, string nomeLista)
        {
            try
            {
                return docsPaWS.isUniqueNomeLista(nomeLista);
            }
            catch (System.Web.Services.Protocols.SoapException es)
            {
                ErrorManager.redirect(page, es);
        ...
        public static ArrayList getModelliUtente(Page page, SAAdminTool.DocsPaWR.Utente utente, SAAdminTool.DocsPaWR.InfoUtente infoUt, DocsPaWR.FiltroRicerca[] filtriRicerca)
        {
            try
            {
                //Veronica
        ...
        public static SAAdminTool.DocsPaWR.ModelloTrasmissione getModelloByID(Page page, string idAmm, string idModello)
        {
            try
            {
        ...
        public static int getIdProfileByData(SAAdminTool.DocsPaWR.InfoUtente infoUtente, string numProto, string AnnoProto, string idRegistro, out string inArchivio)
        {
            try
            {
        ...
        public static bool DeleteModifyCorrispondenteEsterno(Page page, SAAdminTool.DocsPaWR.DatiModificaCorr datiModifica, int flagListe, string action, out string message)
        {
        ...
        public static bool DeleteModifyCorrispondenteEsterno(Page page, SAAdminTool.DocsPaWR.DatiModificaCorr datiModifica, int flagListe, string action,out string newIdCorr, out string message)
        {
            message = String.Empty;
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteByIdPeople(Page page, string idPeople, SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE)
        {
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteCompletoBySystemId(Page page, string systemId, SAAdminTool.DocsPaWR.AddressbookTipoUtente tipoIE)
        {
            try
            {
        ...
        public static ElementoRubrica[] getCorrispondenteRubricaControl(Page page, string codiceRubrica, DocsPaWR.RubricaCallType callType)
        {
            try
            {
                ...
                if (elSearch != null && elSearch.Length == 1)
                {
                    ...
                    //corrRes = getCorrispondenteByCodRubricaIE(page, elSearch[0].codice, elSearch[0].interno ? SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO : SAAdminTool.DocsPaWR.AddressbookTipoUtente.ESTERNO);
                }
                else
                {
                    //corrRes = null;
        ...
        public static SAAdminTool.DocsPaWR.Corrispondente getCorrispondenteByCodRubricaRubricaComune(Page page, string codice)
        {
            try
            {
        ...
        //public static DocsPaWR.ElementoRubrica[] getElementoRubricaControl(Page page, string cod, SAAdminTool.DocsPaWR.SmistamentoRubrica smistaRubrica)
        //{
        //    try
        //    {
        ...
        //public static SAAdminTool.DocsPaWR.Corrispondente[] getCorrispondentiForUC(Page page, string codiceRubrica, bool fineValidita)
        //{
        //    try
        //    {
        //        Utente utente = getUtente(page);
      ...
      /*  private string getCorrispondenteRuoloInferiore(DocsPaVO.trasmissione.OggettoTrasm objOggettoTrasmesso, DocsPaVO.utente.Ruolo objRuolo, bool cercaInf)
        ...
        public static bool verifyRegNoAOO(SAAdminTool.DocsPaWR.SchedaDocumento schedaCorrente, DocsPaWR.Registro[] userRegistri)
        {
            bool result = false;
        ...
        public static SAAdminTool.DocsPaWR.ElementoRubrica[] getElementiRubricaMultipli(Page page, string codiceRubrica, DocsPaWR.RubricaCallType callType, bool codiceEsatto)
        {
            try
            {
                DocsPaWR.ParametriRicercaRubrica qco = new SAAdminTool.DocsPaWR.ParametriRicercaRubrica();
        ...
        /// </summary>
        public static SAAdminTool.DocsPaWR.Amministrazione[] getListaAmministrazioniByUser(Page page, string userId, bool controllo, out string returnMsg)
        {
            returnMsg = string.Empty;
