...
namespace SAAdminTool
{
    public class ProfilazioneFascManager
    {
        ...
        private static SAAdminTool.fascicolo.AclFascicolo GetControlAclFascicolo(Page page)
        {
            return (SAAdminTool.fascicolo.AclFascicolo)page.FindControl("aclFascicolo");
        }
