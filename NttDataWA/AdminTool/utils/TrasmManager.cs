...
namespace SAAdminTool
{
	...
	public class TrasmManager
	{
		...
		public static SAAdminTool.DocsPaWR.Trasmissione getTrasmRispostadaUt(Page page,DocsPaWR.TrasmissioneUtente trasmUt)
		{
		...
		public static SAAdminTool.DocsPaWR.Trasmissione getTrasmRispostadaSing(Page page,DocsPaWR.TrasmissioneSingola trasmSing)
		{
        ...
        public static Trasmissione saveExecuteTrasm(Page page, Trasmissione trasmissione, SAAdminTool.DocsPaWR.InfoUtente infoUtente)
        {
            logger.Info("BEGIN");
        ...
        public static Trasmissione saveExecuteTrasmAM(Page page, Trasmissione trasmissione, SAAdminTool.DocsPaWR.InfoUtente infoUtente)
        {
            logger.Info("BEGIN");
            Trasmissione result = null;
            try
...
//				}
		...
		public static RagioneTrasmissione[] getListaRagioni(Page page, SAAdminTool.DocsPaWR.SchedaDocumento schedaDocumento, bool flgDaRicercaTrasm)
		{
			try
			{
		...
		public static Trasmissione removeTrasmSingola(Trasmissione trasmissione, int i, bool setDaEliminare)
		{
			...
			{				
				...
				{
                    DocsPaWR.TrasmissioneSingola[] listaTrasmSingole = new SAAdminTool.DocsPaWR.TrasmissioneSingola[trasmissione.trasmissioniSingole.Length - 1];
                    int indice = 0;
		...
		public static void updateTemplate (Page page, SAAdminTool.DocsPaWR.TemplateTrasmissione template) 
		{
			try 
			{	
		...
		public static void deleteTemplate (Page page, SAAdminTool.DocsPaWR.TemplateTrasmissione template) 
		{
			try 
			{	
		...
		protected static SAAdminTool.DocsPaWR.TemplateTrasmissione[] addInListaTemplate(SAAdminTool.DocsPaWR.TemplateTrasmissione[] listaTemplate, SAAdminTool.DocsPaWR.TemplateTrasmissione oggetto) 
		{
			...
			if (listaTemplate != null) 
			{
				...
				nuovaLista = new SAAdminTool.DocsPaWR.TemplateTrasmissione[len + 1];
				listaTemplate.CopyTo(nuovaLista,0);
				nuovaLista[len] = oggetto;
			}
			else 
			{
				nuovaLista=new SAAdminTool.DocsPaWR.TemplateTrasmissione[1];
		...
		public static SAAdminTool.DocsPaWR.TemplateTrasmissione[] rimuoviTemplate(SAAdminTool.DocsPaWR.TemplateTrasmissione[] listaTemplate, int index) 
		{
			...
			DocsPaWR.TemplateTrasmissione[] nuovaListaTemplate = new SAAdminTool.DocsPaWR.TemplateTrasmissione[nuovaArrayListaTemplate.Count];
			for (int j=0; j < nuovaArrayListaTemplate.Count; j++)
				nuovaListaTemplate[j] = (SAAdminTool.DocsPaWR.TemplateTrasmissione) nuovaArrayListaTemplate[j];
		...
		//templateSel
		public static void setTemplateSel(Page page, SAAdminTool.DocsPaWR.TemplateTrasmissione template)
		{
			page.Session["templateTrasmissione.TemplateSel"] = template;
		}

		public static SAAdminTool.DocsPaWR.TemplateTrasmissione getTemplateSel(Page page)
		{
			return (SAAdminTool.DocsPaWR.TemplateTrasmissione) page.Session["templateTrasmissione.TemplateSel"];
		}
		...
		public static Trasmissione addTrasmDaTemplate(Page page,InfoDocumento infoDocumento, SAAdminTool.DocsPaWR.TemplateTrasmissione template, InfoUtente infoUtente)
		{
			try 
			{				
		...
		public static Trasmissione addTrasmFascicoloDaTemplate(Page page,InfoFascicolo infoFascicolo, SAAdminTool.DocsPaWR.TemplateTrasmissione template, InfoUtente infoUtente)
		{
			try 
			{				
				DocsPaWR.Utente utente = UserManager.getUtente(page);
		...
		public static FileDocumento getReportTrasm(Page page, SAAdminTool.DocsPaWR.TrasmissioneOggettoTrasm oggettoTrasm)
		{
			try 
			{
                ...
                SAAdminTool.DocsPaWR.InfoUtente infoUt = null;
		...
		public static FileDocumento getReportTrasmUO(Page page, SAAdminTool.DocsPaWR.FiltroRicerca[] filtriTrasm, string UO)
		{
			try 
			{
...
//		}
		...
		public static SAAdminTool.DocsPaWR.FiltroRicerca[] getMemoriaFiltriRicTrasm(Page page) 
		{
			return (SAAdminTool.DocsPaWR.FiltroRicerca[]) GetSessionValue("MemoriaFiltriRicTrasm");
		}

		public static void setMemoriaFiltriRicTrasm(Page page, SAAdminTool.DocsPaWR.FiltroRicerca[] listaFiltri) 
		{
		...
		/// <returns></returns>
		public static SAAdminTool.DocsPaWR.ModelloTrasmissione getModelloTrasmNuovo(SAAdminTool.DocsPaWR.Trasmissione trasmissione, string idRegistro)
		{
			DocsPaWR.ModelloTrasmissione modello = new SAAdminTool.DocsPaWR.ModelloTrasmissione();
			...
			if(modello.ID_REGISTRO == null)
				modello.ID_REGISTRO = ((SAAdminTool.DocsPaWR.Registro) (UserManager.GetRegistriByRuolo(null,UserManager.getRuolo().systemId))[0]).systemId;
			...
			//MITTENTE MODELLO
			modello.MITTENTE = new SAAdminTool.DocsPaWR.MittDest[1];
			...
			DocsPaWR.RagioneDest ragioneDest_1 = new SAAdminTool.DocsPaWR.RagioneDest();
			...
			if(trasmSingole.Count != 0)
			{
				...
				DocsPaWR.TrasmissioneSingola trasmSingola_1 = (SAAdminTool.DocsPaWR.TrasmissioneSingola) trasmSingole[0];
				...
				DocsPaWR.MittDest dest_1 = new SAAdminTool.DocsPaWR.MittDest();                
				...
				{
					DocsPaWR.TrasmissioneSingola trasmSingola_2 = (SAAdminTool.DocsPaWR.TrasmissioneSingola) trasmSingole[i];
					int ragioneDestDaModificare = -1;

					for(int j=0; j<modello.RAGIONI_DESTINATARI.Length; j++)
					{
						DocsPaWR.RagioneDest ragioneDest_2 = (SAAdminTool.DocsPaWR.RagioneDest) modello.RAGIONI_DESTINATARI[j];
					...
					if(ragioneDestDaModificare != -1)
					{
						...
						DocsPaWR.MittDest dest_2 = new SAAdminTool.DocsPaWR.MittDest();
						...
						((SAAdminTool.DocsPaWR.RagioneDest) modello.RAGIONI_DESTINATARI[ragioneDestDaModificare]).DESTINATARI = Utils.addToArrayMittDest(((SAAdminTool.DocsPaWR.RagioneDest) modello.RAGIONI_DESTINATARI[ragioneDestDaModificare]).DESTINATARI,dest_2);                        
					}
					else
					{
						//Aggiungo una nuova ragioneDest
						DocsPaWR.RagioneDest ragioneDest_3 = new SAAdminTool.DocsPaWR.RagioneDest();
						
						ragioneDest_3.CHA_TIPO_RAGIONE = trasmSingola_2.ragione.tipo;
						ragioneDest_3.RAGIONE = trasmSingola_2.ragione.descrizione;
						
						DocsPaWR.MittDest dest_3 = new SAAdminTool.DocsPaWR.MittDest();
	...
	/// <summary>
        ...
        /// <returns></returns>
        public static SAAdminTool.DocsPaWR.infoToDoList[] getMyTodolist(string docOrFasc, string registri,
            SAAdminTool.DocsPaWR.FiltroRicerca [] filter,
        ...
        public static SAAdminTool.DocsPaWR.infoToDoList[] getMyNewTodolist(string registri,
           SAAdminTool.DocsPaWR.FiltroRicerca[] filter,
        ...
        // old method
        //public static SAAdminTool.DocsPaWR.infoToDoList[] getMyTodolist(string idPeople, string idGruppo, string registri, string type, SAAdminTool.DocsPaWR.FiltroRicerca [] filter)
        //{
        //    try
        //    {
        ...
        //public static SAAdminTool.DocsPaWR.infoToDoList[] rimuoviToDoListACL(string numProto, string idPeopleDest, string idRuoloDest, string registri, SAAdminTool.DocsPaWR.FiltroRicerca[] filter, string tipoObj, DocsPaWR.InfoUtente infoUtente)
        ...
        /// <returns></returns>
        public static SAAdminTool.DocsPaWR.Trasmissione [] trasmGetDettaglioTrasmissione(SAAdminTool.DocsPaWR.Utente ut, SAAdminTool.DocsPaWR.Ruolo role, SAAdminTool.DocsPaWR.infoToDoList todo)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static void effettuaTrasmissioneFascDaModello(SAAdminTool.DocsPaWR.ModelloTrasmissione modello, string idStato, Fascicolo fascicolo, Page page)
        {
            logger.Info("BEGIN");
            ...
            for (int i = 0; i < modello.RAGIONI_DESTINATARI.Length; i++)
            {
                ...
                DocsPaWR.RagioneDest ragDest = (SAAdminTool.DocsPaWR.RagioneDest)modello.RAGIONI_DESTINATARI[i];
                ArrayList destinatari = new ArrayList(ragDest.DESTINATARI);
                for (int j = 0; j < destinatari.Count; j++)
                {
                    DocsPaWR.MittDest mittDest = (SAAdminTool.DocsPaWR.MittDest)destinatari[j];
            ...
            if(idStato != null && idStato != "")
                SAAdminTool.DiagrammiManager.salvaStoricoTrasmDiagrammiFasc(trasmissione.systemId, fascicolo.systemID, idStato,page);
        ...
        /// </summary>
        /// <returns></returns>
        public static void effettuaTrasmissioneFascDaModello(SAAdminTool.DocsPaWR.ModelloTrasmissione modello, string idStato, InfoFascicolo infoFascicolo, Page page)
        {
            logger.Info("BEGIN");
            Trasmissione trasmissione = new SAAdminTool.DocsPaWR.Trasmissione();
            SAAdminTool.DocsPaWR.DocsPaWebService wws = new DocsPaWebService();
            ...
            TrasmManager.executeTrasm(page, trasmissione);
            if (idStato != null && idStato != "")
                SAAdminTool.DiagrammiManager.salvaStoricoTrasmDiagrammiFasc(trasmissione.systemId, infoFascicolo.idFascicolo, idStato,page);
        ...
        /// </summary>
        /// <returns></returns>
        public static void effettuaTrasmissioneDocDaModello(SAAdminTool.DocsPaWR.ModelloTrasmissione modello, string idStato, SchedaDocumento schedaDocumento, Page page)
        {
            logger.Info("BEGIN");
            Trasmissione trasmissione = new SAAdminTool.DocsPaWR.Trasmissione();
            SAAdminTool.DocsPaWR.DocsPaWebService wws = new DocsPaWebService();
            ...
            if (trasmissione != null && modello.CEDE_DIRITTI.Equals("1"))
            {
                ...
                {
                    DocsPaWR.CessioneDocumento cessione = new SAAdminTool.DocsPaWR.CessioneDocumento();
            ...
            TrasmManager.executeTrasm(page, trasmissione);
            if (idStato != null && idStato != "")
                SAAdminTool.DiagrammiManager.salvaStoricoTrasmDiagrammiFasc(trasmissione.systemId, schedaDocumento.docNumber, idStato,page);
        ...
        /// </summary>
        /// <returns></returns>
        public static void effettuaTrasmissioneDocDaModello(SAAdminTool.DocsPaWR.ModelloTrasmissione modello, string idStato, InfoDocumento infoDocumento, Page page)
        {
            logger.Info("BEGIN");
            Trasmissione trasmissione = new SAAdminTool.DocsPaWR.Trasmissione();
            SAAdminTool.DocsPaWR.DocsPaWebService wws = new DocsPaWebService();
            ...
            for (int i = 0; i < modello.RAGIONI_DESTINATARI.Length; i++)
            {
                ...
                for (int j = 0; j < destinatari.Count; j++)
                {
                    ...
                    {
                        SAAdminTool.DocsPaWR.SchedaDocumento schedaDoc = DocumentManager.getDettaglioDocumento(page, infoDocumento.idProfile, infoDocumento.docNumber);
            ...
            TrasmManager.executeTrasm(page, trasmissione);
            if (idStato != null && idStato != "")
                SAAdminTool.DiagrammiManager.salvaStoricoTrasmDiagrammiFasc(trasmissione.systemId, infoDocumento.docNumber, idStato,page);

            logger.Info("END");
        }

        private static SAAdminTool.DocsPaWR.Corrispondente[] queryUtenti(SAAdminTool.DocsPaWR.Corrispondente corr, Page page)
        {
        ...
        public static SAAdminTool.DocsPaWR.Trasmissione addTrasmissioneSingola(SAAdminTool.DocsPaWR.Trasmissione trasmissione, SAAdminTool.DocsPaWR.Corrispondente corr, SAAdminTool.DocsPaWR.RagioneTrasmissione ragione, string note, string tipoTrasm, int scadenza, bool nascondiVersioniPrecedenti, Page page)
        {
            ...
            {
                DocsPaWR.UnitaOrganizzativa theUo = (SAAdminTool.DocsPaWR.UnitaOrganizzativa)corr;
        ...
        public static SAAdminTool.DocsPaWR.Trasmissione addTrasmissioneSingola(SAAdminTool.DocsPaWR.Trasmissione trasmissione, SAAdminTool.DocsPaWR.Corrispondente corr, SAAdminTool.DocsPaWR.RagioneTrasmissione ragione, string note, string tipoTrasm, int scadenza, Page page)
        {
        ...
        private static SAAdminTool.DocsPaWR.Trasmissione impostaNotificheUtentiDaModello(SAAdminTool.DocsPaWR.Trasmissione objTrasm, SAAdminTool.DocsPaWR.ModelloTrasmissione modello)
        {
        ...
        private static bool daNotificareSuModello(string currentIDPeople, string currentIDCorrGlobRuolo, SAAdminTool.DocsPaWR.ModelloTrasmissione modello)
        {
            bool retValue = true;

            //DocsPaWR.ModelloTrasmissione modello = (SAAdminTool.DocsPaWR.ModelloTrasmissione)Session["Modello"];
