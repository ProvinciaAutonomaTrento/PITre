...
namespace SAAdminTool
{
	...
	public class FascicoliManager
	{
		...
		public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloDaCodice(Page page,string codiceFasc,DocsPaWR.InfoUtente infoUtente){
...
//			}
		...
		public static SAAdminTool.DocsPaWR.Fascicolo getListaFascicoliDaCodice(Page page,string codiceFasc,DocsPaWR.InfoUtente infoUtente)
		{		
			try 
			{			
				bool enableUfficioRef =(ConfigSettings.getKey(ConfigSettings.KeysENUM.ENABLE_UFFICIO_REF)!= null 
...
//			}
		...
		public static SAAdminTool.DocsPaWR.FascicolazioneClassificazione[] fascicolazioneGetTitolario(Page page) 
		{
			try  
			{
				InfoUtente infoUtente = UserManager.getInfoUtente(page);
...
//			}
		...
		public static SAAdminTool.DocsPaWR.FascicolazioneClassificazione[] fascicolazioneGetTitolario(Page page,string codClassifica,bool getFigli) 
		{
			try  
			{
				InfoUtente infoUtente = UserManager.getInfoUtente(page);
...
//			}
        ...
        public static SAAdminTool.DocsPaWR.FascicolazioneClassificazione[] fascicolazioneGetTitolario2(Page page, string codClassifica, bool getFigli, string idTitolario)
        {
            try
            {
                InfoUtente infoUtente = UserManager.getInfoUtente(page);
        ...
        public static SAAdminTool.DocsPaWR.FascicolazioneClassificazione[] fascicolazioneGetTitolario2(Page page, string codClassifica, SAAdminTool.DocsPaWR.Registro regNodo, bool getFigli, string idTitolario)
        {
            try
            {
                InfoUtente infoUtente = UserManager.getInfoUtente(page);
		...
		public static SAAdminTool.DocsPaWR.FascicolazioneClassificazione[] fascicolazioneGetTitolario(Page page,string codClassifica, SAAdminTool.DocsPaWR.Registro regNodo, bool getFigli) 
		{
			try  
			{
				InfoUtente infoUtente = UserManager.getInfoUtente(page);
...
//			}
		...
		public static Fascicolo[] getListaFascicoliPaging(Page page,FascicolazioneClassificazione classificazione, SAAdminTool.DocsPaWR.Registro registro, FiltroRicerca[] filtriRicerca,  bool childs,int requestedPage,out int numTotPage,out int nRec,int pageSize,
        ...
        public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloDaCodice2(Page page, string codFascicolo, string idTitolario)
        {
            try
            {
                InfoUtente infoUtente = UserManager.getInfoUtente(page);
		...
		public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloDaCodice(Page page,string codFascicolo)
		{
			try 
			{				
				InfoUtente infoUtente = UserManager.getInfoUtente(page);
...
//			}
		...
		public static SAAdminTool.DocsPaWR.Fascicolo[] getListaFascicoliDaCodice(Page page,string codFascicolo, SAAdminTool.DocsPaWR.Registro reg, string insRic)
		{
			try 
			{				
				InfoUtente infoUtente = UserManager.getInfoUtente(page);
      ...
      /// <returns></returns>
      public static SAAdminTool.DocsPaWR.Folder[] getListaFolderDaCodiceFascicolo(Page page,string codFascicolo,string descrFolder, SAAdminTool.DocsPaWR.Registro reg)
		   {
			   try 
			   {				
				   InfoUtente infoUtente = UserManager.getInfoUtente(page);
      ...
      /// <param name="reg"></param>
      /// <returns></returns>
      public static SAAdminTool.DocsPaWR.Folder[] getListaFolderDaIdFascicolo(Page page, string idFascicolo, SAAdminTool.DocsPaWR.Registro reg)
      {
         try
         {
            InfoUtente infoUtente = UserManager.getInfoUtente(page);
...
//			}
        ...
        public static SAAdminTool.DocsPaWR.FascicoloDiritto[] getListaVisibilita(Page page, DocsPaWR.InfoFascicolo infoFasc, bool cercaRimossi, string rootFolder)
		{
...
//			} 
		...
		public static SAAdminTool.DocsPaWR.Fascicolo[] getFascicoliInAreaLavoro(Page page)
		{
			try
			{
				Utente utente = UserManager.getUtente(page);
				Ruolo ruolo = UserManager.getRuolo(page);
				DocsPaWR.AreaLavoroTipoOggetto tipoObj = SAAdminTool.DocsPaWR.AreaLavoroTipoOggetto.FASCICOLO; 
				DocsPaWR.AreaLavoroTipoFascicolo tipoFasc = SAAdminTool.DocsPaWR.AreaLavoroTipoFascicolo.TUTTI; //.PROCEDIMENTALE;
				DocsPaWR.AreaLavoroTipoDocumento tipoDoc = new SAAdminTool.DocsPaWR.AreaLavoroTipoDocumento();

				//perchè è vuoto ?
				string idRegistro = String.Empty;
				//nuovo
				DocsPaWR.Registro registroSel = (SAAdminTool.DocsPaWR.Registro)UserManager.getRegistroSelezionato(page);
				if(registroSel!=null)
				{
				...
				DocsPaWR.Fascicolo[] retValue=new SAAdminTool.DocsPaWR.Fascicolo[areaLavoro.lista.Length];
		...
		public static SAAdminTool.DocsPaWR.FascicolazioneClassifica[] getGerarchiaDaCodice(Page page,string codClassificazione,string idAmm)
		{
			try 
			{				
        ...
        public static SAAdminTool.DocsPaWR.FascicolazioneClassifica[] getGerarchiaDaCodice2(Page page, string codClassificazione, string idAmm, string idTitolario)
        {
            try
            {
		...
		public static SAAdminTool.DocsPaWR.FascicolazioneClassifica[] getGerarchia(Page page,string idClassificazione,string idAmm)
		{
			try 
			{				
		...
		public static SAAdminTool.DocsPaWR.FileDocumento reportTitolario(Page page, SAAdminTool.DocsPaWR.Registro registro)
		{
			try 
			{	
				InfoUtente infoUtente = UserManager.getInfoUtente(page);
		...
		/// <returns></returns>
		public static SAAdminTool.DocsPaWR.RagioneTrasmissione TrasmettiFascicoloToUoReferente(Ruolo ruolo, out bool verificaRagioni) 
		{
		...
		public static SAAdminTool.DocsPaWR.FileDocumento reportFascette(Page page, string codiceFacicolo, SAAdminTool.DocsPaWR.Registro registro) 
		{
			try 
			{
		...
		public static SAAdminTool.DocsPaWR.FascicolazioneClassifica[] GetFigliClassifica(Page page,DocsPaWR.FascicolazioneClassifica classifica,string idAmm)
		{
			try 
			{				
				InfoUtente infoUtente = UserManager.getInfoUtente(page);
        ...
        public static SAAdminTool.DocsPaWR.FascicolazioneClassifica[] GetFigliClassifica2(Page page, DocsPaWR.FascicolazioneClassifica classifica, string idAmm, string idTitolario)
        {
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.ValidationResultInfo deleteDocFromFolder(Page page, DocsPaWR.Folder folder, string idProfile, string fascRapida, out string msg)
        {
        ...
        public static SAAdminTool.DocsPaWR.ValidationResultInfo deleteDocFromProject(Page page, DocsPaWR.Folder folder, string idProfile, string fascRapida, DocsPaWR.Fascicolo fasc, out string msg)
        {
            SAAdminTool.DocsPaWR.ValidationResultInfo result = null;
            msg = string.Empty;
            try
		...
		public static Fascicolo newFascicolo(Page page,FascicolazioneClassificazione classificazione,Fascicolo fascicolo, out SAAdminTool.DocsPaWR.ResultCreazioneFascicolo resultCreazione) 
		{
            logger.Info("BEGIN");
...
#region Variabile sessione "FolderSelezionato"
		...
		public static SAAdminTool.DocsPaWR.Folder getFolderSelezionato(Page page)
		{
			return (SAAdminTool.DocsPaWR.Folder)page.Session["fascDocumenti.FolderSel"];
		}

        public static SAAdminTool.DocsPaWR.Folder getFolderSelezionato()
        {
            return (SAAdminTool.DocsPaWR.Folder)GetSessionValue("fascDocumenti.FolderSel");
        }
...
#region Variabile sessione "ListaFascicoliInGriglia"
		...
		public static SAAdminTool.DocsPaWR.Fascicolo[] getListaFascicoliInGriglia(Page page)
		{
			return (SAAdminTool.DocsPaWR.Fascicolo[])page.Session["ListaFascicoliInGriglia"];
		}
...
#region Variabile sessione "Info Fascicolo Sel"
		...
		public static SAAdminTool.DocsPaWR.InfoFascicolo getInfoFascicolo(Page page)
		{
			return (SAAdminTool.DocsPaWR.InfoFascicolo)page.Session["tabRisultatiRicTrasm.InfoFasc"];
		}
...
#region Variabile sessione "FascicoloSelezionato"
		...
		public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloSelezionato(Page page)
		{
        ...
        public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloSelezionato()
        {
            HttpContext ctx = HttpContext.Current;
            return (SAAdminTool.DocsPaWR.Fascicolo)ctx.Session["FascicoloSelezionato"];
        }

        public static void setFascicoloSelezionato(SAAdminTool.DocsPaWR.Fascicolo fascicoloSelezionato)
        {
            HttpContext ctx = HttpContext.Current;
		...
		public static SAAdminTool.DocsPaWR.Fascicolo getMemoriaFascicoloSelezionato(Page page)
		{
			//return (SAAdminTool.DocsPaWR.Fascicolo)page.Session["MemoriaFascicoloSelezionato"];
            return getMemoriaFascicoloSelezionato();
		}

        public static SAAdminTool.DocsPaWR.Fascicolo getMemoriaFascicoloSelezionato()
        {
            HttpContext ctx = HttpContext.Current;
            return (SAAdminTool.DocsPaWR.Fascicolo)ctx.Session["MemoriaFascicoloSelezionato"];
        }
		...
		public static SAAdminTool.DocsPaWR.Folder getMemoriaFolderSelezionata(Page page)
		{
            return getMemoriaFolderSelezionata();
		}

        public static SAAdminTool.DocsPaWR.Folder getMemoriaFolderSelezionata()
        {
            HttpContext ctx = HttpContext.Current;
            return (SAAdminTool.DocsPaWR.Folder)ctx.Session["MemoriaFolderSelezionata"];
        }
...
#region Variabile sessione "classificazioneSelezionata"
	...
	public static void removeCodRubrica(Page page) 
		...
		public static SAAdminTool.DocsPaWR.FascicolazioneClassificazione getMemoriaClassificaRicFasc(Page page) 
		{
			return (SAAdminTool.DocsPaWR.FascicolazioneClassificazione) GetSessionValue("MemoriaClassificaRicFasc");
		}

		public static void setMemoriaClassificaRicFasc(Page page, SAAdminTool.DocsPaWR.FascicolazioneClassificazione classifica) 
		{
		...
		public static SAAdminTool.DocsPaWR.Registro getMemoriaRegistroRicFasc(Page page) 
		{
			return (SAAdminTool.DocsPaWR.Registro) GetSessionValue("MemoriaRegistroRicFasc");
		}

		public static void setMemoriaRegistroRicFasc(Page page, SAAdminTool.DocsPaWR.Registro registro) 
		{
		...
		public static SAAdminTool.DocsPaWR.FiltroRicerca[][] getMemoriaFiltriRicFasc(Page page) 
		{
			return (SAAdminTool.DocsPaWR.FiltroRicerca[][]) GetSessionValue("MemoriaFiltriRicFasc");
		}

		public static void setMemoriaFiltriRicFasc(Page page, SAAdminTool.DocsPaWR.FiltroRicerca[][] listaFiltri) 
		{
		...
		public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloSelezionatoFascRapida(Page page)
		{
			return (SAAdminTool.DocsPaWR.Fascicolo)getFascicoloSelezionatoFascRapida();
		}
        ...
        public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloSelezionatoFascRapida()
        {
            return (SAAdminTool.DocsPaWR.Fascicolo)HttpContext.Current.Session["FascicoloSelezionatoFascRapida"];
        }
      ...
      public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloSelezionatoRicerca()
      {
          return (SAAdminTool.DocsPaWR.Fascicolo)HttpContext.Current.Session["FascicoloSelezionatoRicerca"];
      }
      ...
      public static string getNumeroFascicolo(Page page,string idTitolario, string idRegistro)
        ...
        #region ACL
        public static bool editingFascACL(SAAdminTool.DocsPaWR.FascicoloDiritto fascDiritto, string personOrGroup, DocsPaWR.InfoUtente infoUtente)
        {
            bool result = false;
            try
            {
        ...
        public static bool ripristinaFascACL(SAAdminTool.DocsPaWR.FascicoloDiritto fascDiritto, string personOrGroup, DocsPaWR.InfoUtente infoUtente)
        {
            bool result = false;
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.Fascicolo getFascicoloDaArchiviare(Page page, string codFascicolo)
        {
            try
            {
                InfoUtente infoUtente = UserManager.getInfoUtente(page);
        ...
        public static Fascicolo[] getListaFascicoliDaArchiviare(Page page, FascicolazioneClassificazione classificazione, SAAdminTool.DocsPaWR.Registro registro, FiltroRicerca[] filtriRicerca, bool childs, int requestedPage, out int numTotPage, out int nRec, int pageSize)
        {
            nRec = 0;
            numTotPage = 0;
            try
        ...
        public static void trasfInDepositoALLFascicoliProc(Page page, SAAdminTool.DocsPaWR.FiltroRicerca[][] filtriRic, InfoUtente utente, string tipoOp)
        {
            bool result = false;
            try
            {
        ...
        public static bool addAllFascAreaScarto(Page page, SAAdminTool.DocsPaWR.Fascicolo fascicolo, SAAdminTool.DocsPaWR.InfoUtente infoUtente, string tipoRic)
        {
            bool result = true;
            try
            {
        ...
        public static InfoScarto[] getListaScarto(Page page, SAAdminTool.DocsPaWR.InfoUtente infoUtente, int numPage, out int numTotPage, out int nRec)
        {
            nRec = 0;
            numTotPage = 0;
        ...
        public static SAAdminTool.DocsPaWR.InfoScarto[] getListaScarto(Page page)
        {
            return (SAAdminTool.DocsPaWR.InfoScarto[])page.Session["ListaScarto"];
        }
        ...
        public static SAAdminTool.DocsPaWR.InfoScarto getIstanzaScarto(Page page)
        {
            return (SAAdminTool.DocsPaWR.InfoScarto)GetSessionValue("ItemScarto");
        }
        ...
        public static string inserisciContatore(SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom, string paramContatore)
        {
        ...
        public static SAAdminTool.DocsPaWR.Folder getFolderByIdFasc(DocsPaWR.InfoUtente infoUtente, SAAdminTool.DocsPaWR.Fascicolo Fasc)
        {
            SAAdminTool.DocsPaWR.Folder result = null;
        ...
        public static SAAdminTool.DocsPaWR.FascicoloDiritto[] getListaVisibilitaSemplificata(Page page, DocsPaWR.InfoFascicolo infoFasc, bool cercaRimossi, string rootFolder)
        {
            //docWS.getQuery(xmlQueryV,xmlSafe);
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.OrgTitolario[] getTitolariUtilizzabili(string idAmm, Page page)
        {
            SAAdminTool.DocsPaWR.OrgTitolario[] retValue = null;
            try
            {
        ...
        public static SAAdminTool.DocsPaWR.StoricoProfilati[] getStoriaProfilatiFasc(Page page, SAAdminTool.DocsPaWR.Templates template, string idProject)
        {
            try
            {
