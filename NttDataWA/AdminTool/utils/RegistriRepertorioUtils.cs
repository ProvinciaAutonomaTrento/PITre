...
namespace SAAdminTool.utils
{
    ...
    public class RegistriRepertorioUtils
    {
        ...
        public static RegistroRepertorioSettingsMinimalInfo[] GetSettingsMinimalInfo(String counterId, TipologyKind tipologyKind)
        {
            return _docsPaWS.GetSettingsMinimalInfo(new GetSettingsMinimalInfoRequest() { CounterId = counterId, TipologyKind = tipologyKind }).Settings;
        }
