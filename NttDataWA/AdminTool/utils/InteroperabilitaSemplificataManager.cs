    ...
    public class InteroperabilitaSemplificataManager
    {
        ...
        public static String InteroperabilityServiceUrl
        {
            get
            {
                ...
                String valoreChiaveInteropUrl = SAAdminTool.utils.InitConfigurationKeys.GetValue(infoUtente.idAmministrazione, "INTEROP_SERVICE_URL");
                if (string.IsNullOrEmpty(valoreChiaveInteropUrl))
                    valoreChiaveInteropUrl = SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "INTEROP_SERVICE_URL");
        ...
        public static bool IsEnabledSimpInterop
        {
            get
            {
                ...
                String valoreChiaveInterop = SAAdminTool.utils.InitConfigurationKeys.GetValue(infoUtente.idAmministrazione, "INTEROP_SERVICE_ACTIVE");
                if (string.IsNullOrEmpty(valoreChiaveInterop))
                    valoreChiaveInterop = SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "INTEROP_SERVICE_ACTIVE");
