<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClientModelProcessor.ascx.cs" Inherits="SAAdminTool.ActivexWrappers.ClientModelProcessor" %>
<% if (SAAdminTool.ActivexWrappers.Configurations.UserClientModelProcessorControl && 
...
<script id="clientModelProcessorScript" type="text/javascript">
    function ClientModelProcessor_ProcessModel(outputFilePath, documentId, modelType) 
    {
        ...
        try {
            if ("<%=SAAdminTool.ActivexWrappers.Configurations.UserClientModelProcessorControl%>" == "True") {
