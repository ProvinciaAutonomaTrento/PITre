...
namespace ProspettiRiepilogativi
{
    ...
    /// </summary>
    public class ProspettiRiepilogativi_LF : SAAdminTool.CssPage
    {
        ...
        protected SAAdminTool.UserControls.Calendar txt_dataSpedDa;
        protected SAAdminTool.UserControls.Calendar txt_dataSpedA;
        ...
        protected SAAdminTool.UserControls.Corrispondente corr_magistrato;
        protected SAAdminTool.UserControls.Corrispondente corr_revisore;
        ...
        protected SAAdminTool.UserControls.Calendar dataDa;
        protected SAAdminTool.UserControls.Calendar dataA;
        ...
        protected SAAdminTool.UserControls.Calendar cld_creazione_dal;
        protected SAAdminTool.UserControls.Calendar cld_creazione_al;
        protected SAAdminTool.UserControls.Calendar cld_chiusura_dal;
        protected SAAdminTool.UserControls.Calendar cld_chiusura_al;
        ...
        SAAdminTool.DocsPaWR.Utente _utente = new SAAdminTool.DocsPaWR.Utente();
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //foreach(SAAdminTool.DocsPaWR.Report r in reports)
                //{
                ...
                //        {
                //            if (SAAdminTool.UserManager.ruoloIsAutorized(this, "EXP_FASC_COUNT"))
                //            {
                //                rb_prospettiRiepilogativi.Items.Add(new ListItem(r.Descrizione, r.Valore));
                //            }
                //        }
                ...
                _utente = (SAAdminTool.DocsPaWR.Utente)Session["userData"];
                if (_utente != null)
                {
            ...
            if (SAAdminTool.UserManager.ruoloIsAutorized(this, "EXP_FASC_COUNT"))
            {
                string use_new_rubrica = SAAdminTool.ConfigSettings.getKey(SAAdminTool.ConfigSettings.KeysENUM.RUBRICA_V2);
        ...
        private void prospettiRiepilogativi_PreRender(object sender, EventArgs e)
        {
            if (SAAdminTool.UserManager.ruoloIsAutorized(this, "EXP_FASC_COUNT"))
            {
                ...
                SAAdminTool.DocsPaWR.Corrispondente corrSott = SAAdminTool.UserManager.getCorrispondenteSelezionatoRuoloSottoposto(this);
                if (corrSott != null)
                {
                    SAAdminTool.UserManager.removeCorrispondentiSelezionati(this);
                    if (!corrSott.codiceRubrica.Equals(""))
                    {
                        this.txt1_corr_sott.Text = corrSott.codiceRubrica;
                        this.txt2_corr_sott.Text = SAAdminTool.UserManager.getDecrizioneCorrispondenteSemplice(corrSott);
                        SAAdminTool.UserManager.setCorrispondenteSelezionatoRuoloSottoposto(this.Page, corrSott);
                    }
                }
            }
        }
        ...
        private void btnStampa_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            try
            {
                ...
                SAAdminTool.DocsPaWR.Utente ut = (SAAdminTool.DocsPaWR.Utente)Session["userData"];
                ...
                SAAdminTool.DocsPaWR.InfoUtente infoUtente = SAAdminTool.UserManager.getInfoUtente(this);
                ...
                SAAdminTool.DocsPaWR.FileDocumento fileRep = new SAAdminTool.DocsPaWR.FileDocumento();

                string searchType = "";

                //EXPORT FASCICOLI
                if (SAAdminTool.UserManager.ruoloIsAutorized(this, "EXP_FASC_COUNT") && (rb_prospettiRiepilogativi.SelectedValue.Equals("reportNumFasc") || rb_prospettiRiepilogativi.SelectedValue.Equals("reportNumDocInFasc")))
                {
                    ...
                    if (controllaCampiObbligatoriExportFasc())
                    {
                        ...
                        {
                            SAAdminTool.DocsPaWR.Corrispondente corrUo = SAAdminTool.UserManager.getCorrispondenteByCodRubrica(this, this.txt1_corr_sott.Text);
                        ...
                        else
                        {
                            if (Session["filtri"] != null)
                            {
                                ...
                                if (pnl_DettPratica.Visible == true)
                                {
                                    ...
                                    SAAdminTool.DocsPaWR.Registro reg = wws.GetRegistroBySistemId(idReg);
                                    ArrayList nodoTitolario = new ArrayList(wws.getNodiFromProtoTit(reg, ((SAAdminTool.DocsPaWR.Utente)Session["userData"]).idAmministrazione, numProtPtratica, idTitolario));
                                    ...
                                    ProspettiRiepilogativi.Frontend.Parametro _classifica = new ProspettiRiepilogativi.Frontend.Parametro();//("classifica", ((SAAdminTool.DocsPaWR.OrgNodoTitolario)nodoTitolario[0]).Codice);
                                    _classifica.Nome = "classifica";
                                    if (nodoTitolario.Count > 0)
                                    {
                                        _classifica.Valore = ((SAAdminTool.DocsPaWR.OrgNodoTitolario)nodoTitolario[0]).Codice;
                                    }
                                    else
                                    {
                                ...
                                if (pnl_regCC.Visible == true)
                                {
                                    ...
                                    SAAdminTool.DocsPaWR.Registro reg = wws.GetRegistroBySistemId(ddl_regCC.SelectedValue);
                                ...
                                switch (rb_prospettiRiepilogativi.SelectedValue)
                                {
                                    ...
                                    case "reportAnnualeDoc":
                                        ...
                                        {
                                            SAAdminTool.ErrorManager.redirectToErrorPage(this, ex);
                                        }
            ...
            try
            {
                ...
                if (_value == "stampaProtArma" || _value == "stampaDettaglioPratica" || _value == "stampaGiornaleRiscontri" || _value == "documentiSpediti" || _value == "reportNumFasc" || _value == "reportNumDocInFasc")
                {
                    ...
                    if (_value == "reportNumFasc" || _value == "reportNumDocInFasc")
                    {
                        ...
                        //Inserisci uo 
                        SAAdminTool.DocsPaWR.InfoUtente infoUtente = SAAdminTool.UserManager.getInfoUtente(this);
                        Ruolo ruoloTipologia = SAAdminTool.UserManager.getRuoloByIdGruppo(infoUtente.idGruppo, this);
        ...
        private void DO_SetControlFromDocsPA(SAAdminTool.DocsPaWR.Utente _utente)
        {
            try
            {
                ...
                SAAdminTool.DocsPaWR.PR_Amministrazione amm = Controller.Do_GetAmmByIdAmm(Convert.ToInt32(_utente.idAmministrazione));
                ddl_amm.Items.Clear();
                ddl_amm.Items.Add("");
                ...
                */
                ...
                {
                    SAAdminTool.DocsPaWR.Ruolo ruolo = (SAAdminTool.DocsPaWR.Ruolo)_utente.ruoli[i];
                    for (int j = 0; j < ruolo.registri.Length; j++)
                    {
                        SAAdminTool.DocsPaWR.Registro reg = (SAAdminTool.DocsPaWR.Registro)ruolo.registri[j];
        ...
        private void setParamReportDocSpediti(SAAdminTool.DocsPaWR.Utente ut)
        {
            filtri = (ArrayList)Session["filtri"];
        ...
        private void setStampaProtocolloArma()
        {
            if (!string.IsNullOrEmpty(wws.isEnableProtocolloTitolario()))
            {
                ...
                if ((SAAdminTool.DocsPaWR.Utente)Session["userData"] == null)
        ...
        {
            Ruolo ruolo = SAAdminTool.UserManager.getRuolo(this);
        ...
        private void setDdlReportCDC()
        {
            ...
            if (ruolo != null && ruolo.funzioni != null)
            {
                ...
                if (REPORT_CDC_GLOBALI != null || REPORT_CDC_GLOBALI_SRC != null)
                {
                    ...
                    Templates[] tipiAtto = (Templates[])SAAdminTool.ProfilazioneDocManager.getTemplates(ruolo.idAmministrazione, this).ToArray(typeof(Templates));
                    ...
                    if (tipoAtto != null)
                    {
                        ruoliTipoAtto = SAAdminTool.ProfilazioneDocManager.getRuoliTipoDoc(tipoAtto.SYSTEM_ID.ToString(), this);
                    ...
                    if (ruoliTipoAtto != null)
                    {
                            ...
                            foreach (AssDocFascRuoli assDocFascRuoli in ruoliTipoAtto)
                            {
                                    ...
                                    !assDocFascRuoli.DIRITTI_TIPOLOGIA.Equals("0"))
                                {
                                    Ruolo ruoloTipologia =
                                        SAAdminTool.UserManager.getRuoloByIdGruppo(assDocFascRuoli.ID_GRUPPO, this);
                                    if (ruoloTipologia != null && ruoloTipologia.uo != null)
                                    {
                        ...
                        else if (rb_prospettiRiepilogativi.SelectedValue.Equals("CDC_reportControlloPreventivoSRC"))
                        {
                            ...
                            //string idRegistro = SAAdminTool.UserManager.getRuolo(this).idRegistro;
                ...
                {
                    string descrizioneUo = SAAdminTool.UserManager.getRuolo(this).uo.descrizione;
                    string codiceUo = SAAdminTool.UserManager.getRuolo(this).uo.codice;

                    ddl_uffici.Items.Add(new ListItem(descrizioneUo, codiceUo));
                    ddl_uffici.Enabled = false;

                    if (!idUffici.ContainsKey(codiceUo))
                        idUffici.Add(codiceUo, SAAdminTool.UserManager.getRuolo(this).uo.systemId);
                ...
                if (REPORT_CDC_PER_UFFICIO_SRC != null && REPORT_CDC_GLOBALI_SRC == null)
                {
                    ...
                    Registro[] regs = SAAdminTool.UserManager.GetRegistriByRuolo(this,
                                                                              SAAdminTool.UserManager.getRuolo(this).
                                                                                  systemId);
                ...
                )
            {
                ...
                else
                {
                    if (!ErrInProc && Session["filtri"] != null && (pnl_FiltriCDC.Visible || ((Panel)FindControl("pnl_FiltriCDCElencoDecreti")).Visible))
                    {
                        ...
                        {
                            Corrispondente corrMagistrato = SAAdminTool.UserManager.getCorrispondenteByCodRubrica(this, corr_magistrato.CODICE_TEXT);
                        ...
                        {
                            Corrispondente corrRevisore = SAAdminTool.UserManager.getCorrispondenteByCodRubrica(this, corr_revisore.CODICE_TEXT);
                        ...
                        {
                            Templates[] tipiAtto = (Templates[])SAAdminTool.ProfilazioneDocManager.getTemplates(SAAdminTool.UserManager.getRuolo(this).idAmministrazione, this).ToArray(typeof(Templates));
                            Templates tipoAtto = null;
                            ArrayList ruoliTipoAtto = null;
        ...
        private void caricaComboRf()
        {
            ...
            SAAdminTool.DocsPaWR.PR_Amministrazione amm = Controller.Do_GetAmmByIdAmm(Convert.ToInt32(cr.idAmministrazione));
            ...
            if (listaTotale != null && listaTotale.Length > 0)
            {
                ...
                SAAdminTool.DocsPaWR.Registro rf_reg = wws.GetRegistroBySistemId(ddl_rf.SelectedItem.Value);
            }

            SAAdminTool.DocsPaWR.Registro[] registriRf = null;
            Ruolo ruoloUtente = SAAdminTool.UserManager.getRuolo();
            registriRf = SAAdminTool.UserManager.getListaRegistriWithRF(ruoloUtente.systemId, "1", "");
        ...
        private void caricaComboTitolari()
        {
            ...
            ArrayList listaTitolari = new ArrayList(wws.getTitolariUtilizzabili(SAAdminTool.UserManager.getUtente(this).idAmministrazione));
            ...
            if (listaTitolari.Count > 1)
            {
                ...
                foreach (SAAdminTool.DocsPaWR.OrgTitolario titolario in listaTitolari)
                {
                    ListItem it = null;
            ...
            if (listaTitolari.Count == 1)
            {
                SAAdminTool.DocsPaWR.OrgTitolario titolario = (SAAdminTool.DocsPaWR.OrgTitolario)listaTitolari[0];
                if (titolario.Stato != SAAdminTool.DocsPaWR.OrgStatiTitolarioEnum.InDefinizione)
                {
        ...
        protected void ddl_tipo_data_creazione_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            if (this.ddl_tipo_data_creazione.SelectedIndex == 2)
            {
                ...
                this.lbl_al_apertura.Visible = false;
                this.lbl_dal_apertura.Visible = false;
                this.GetCalendarControl("cld_creazione_dal").txt_Data.Text = SAAdminTool.DocumentManager.toDay();
            ...
            if (this.ddl_tipo_data_creazione.SelectedIndex == 3)
            {
                ...
                this.lbl_al_apertura.Visible = true;
                this.lbl_dal_apertura.Visible = true;
                this.GetCalendarControl("cld_creazione_dal").txt_Data.Text = SAAdminTool.DocumentManager.getFirstDayOfWeek();
                this.GetCalendarControl("cld_creazione_al").txt_Data.Text = SAAdminTool.DocumentManager.getLastDayOfWeek();
                this.GetCalendarControl("cld_creazione_dal").txt_Data.Enabled = false;
            ...
            if (this.ddl_tipo_data_creazione.SelectedIndex == 4)
            {
                ...
                this.lbl_al_apertura.Visible = true;
                this.lbl_dal_apertura.Visible = true;
                this.GetCalendarControl("cld_creazione_dal").txt_Data.Text = SAAdminTool.DocumentManager.getFirstDayOfMonth();
                this.GetCalendarControl("cld_creazione_al").txt_Data.Text = SAAdminTool.DocumentManager.getLastDayOfMonth();
                this.GetCalendarControl("cld_creazione_dal").txt_Data.Enabled = false;
                this.GetCalendarControl("cld_creazione_al").txt_Data.Enabled = false;
        ...
        protected void ddl_tipo_data_chiusura_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            if (this.ddl_tipo_data_chiusura.SelectedIndex == 2)
            {
                ...
                this.lbl_al_chiusura.Visible = false;
                this.lbl_dal_chiusura.Visible = false;
                this.GetCalendarControl("cld_chiusura_dal").txt_Data.Text = SAAdminTool.DocumentManager.toDay();
            ...
            if (this.ddl_tipo_data_chiusura.SelectedIndex == 3)
            {
                ...
                this.lbl_al_chiusura.Visible = true;
                this.lbl_dal_chiusura.Visible = true;
                this.GetCalendarControl("cld_chiusura_dal").txt_Data.Text = SAAdminTool.DocumentManager.getFirstDayOfWeek();
                this.GetCalendarControl("cld_chiusura_al").txt_Data.Text = SAAdminTool.DocumentManager.getLastDayOfWeek();
                this.GetCalendarControl("cld_chiusura_dal").txt_Data.Enabled = false;
            ...
            if (this.ddl_tipo_data_chiusura.SelectedIndex == 4)
            {
                ...
                this.lbl_al_chiusura.Visible = true;
                this.lbl_dal_chiusura.Visible = true;
                this.GetCalendarControl("cld_chiusura_dal").txt_Data.Text = SAAdminTool.DocumentManager.getFirstDayOfMonth();
                this.GetCalendarControl("cld_chiusura_al").txt_Data.Text = SAAdminTool.DocumentManager.getLastDayOfMonth();
                this.GetCalendarControl("cld_chiusura_dal").txt_Data.Enabled = false;
                this.GetCalendarControl("cld_chiusura_al").txt_Data.Enabled = false;
        ...
        private void setDescCorrSott(string codiceRubrica)
        {
            ...
            if (!codiceRubrica.Equals(""))
                corr = SAAdminTool.UserManager.getCorrispondente(this, codiceRubrica, false);
            ...
            else
            {
                ...
                else
                {
                    ...
                    SAAdminTool.DocsPaWR.Corrispondente cr = (SAAdminTool.DocsPaWR.Corrispondente)this.Session["userData"];
                    infoUtente.idAmministrazione = cr.idAmministrazione;
                    SAAdminTool.DocsPaWR.Ruolo role = SAAdminTool.UserManager.getRuolo(this);
                    SAAdminTool.UserManager.setCorrispondenteSelezionatoRuoloSottopostoNoRubr(this.Page, corr);
                    this.txt1_corr_sott.Text = codiceRubrica;
                    this.txt2_corr_sott.Text = SAAdminTool.UserManager.getDecrizioneCorrispondenteSemplice(corr);
        ...
        private bool controllaCampiObbligatoriExportFasc()
        {
            ...
            {
                if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("cld_creazione_dal").txt_Data.Text))
                {
            ...
            {
                if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("cld_chiusura_dal").txt_Data.Text))
                {
            ...
            {
                if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("cld_creazione_al").txt_Data.Text))
                {
                    utility.do_alert(this, "Attenzione! Formato data creazione errato");
            ...
            {
                if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("cld_chiusura_al").txt_Data.Text))
                {
                    utility.do_alert(this, "Attenzione! Formato data chiusura errato");
            ...
            if (result && !string.IsNullOrEmpty(cld_chiusura_dal.Text) && !string.IsNullOrEmpty(cld_chiusura_al.Text) && SAAdminTool.Utils.verificaIntervalloDate(this.GetCalendarControl("cld_chiusura_dal").txt_Data.Text, this.GetCalendarControl("cld_chiusura_al").txt_Data.Text))
            {
            ...
            if (result && !string.IsNullOrEmpty(cld_creazione_dal.Text) && !string.IsNullOrEmpty(cld_creazione_al.Text) && SAAdminTool.Utils.verificaIntervalloDate(this.GetCalendarControl("cld_creazione_dal").txt_Data.Text, this.GetCalendarControl("cld_creazione_al").txt_Data.Text))
            {
