...
namespace ProspettiRiepilogativi.Frontend
{
    ...
    public class Controller
    {
        ...
        private static SAAdminTool.DocsPaWR.DocsPaWebService _docsPaWS = new SAAdminTool.DocsPaWR.DocsPaWebService();
        ...
        protected SAAdminTool.DocsPaWR.DocsPaWebService WS
        {
            get
            {
                if (_docsPaWS == null)
                {
                    _docsPaWS = new SAAdminTool.DocsPaWR.DocsPaWebService();
        ...
        public static DropDownList DO_GetAmministrazioni(DropDownList list)
        {
            try
            {
                ...
                foreach (SAAdminTool.DocsPaWR.PR_Amministrazione amm in amministrazioni)
                {
        ...
        public static DropDownList DO_GetRegistriByAmministrazione(DropDownList list, string cod_amm)
        {
            try
            {
                ...
                list.Items.Clear();
                list.Items.Add("");
                foreach (SAAdminTool.DocsPaWR.PR_Registro reg in registri)
                {
        ...
        public static SAAdminTool.DocsPaWR.FileDocumento DO_StampaReport(string templateFilePath, ReportDisponibili tipoReport, ArrayList filtri, int idPeople, string timeStamp)
        {
            ...
            switch (tipoReport)
            {
                ...
                case ReportDisponibili.CDC_reportControlloPreventivo:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportControlloPreventivo(SAAdminTool.UserManager.getInfoUtente(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportSuccessivoSCCLA:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportControlloSuccessivo(SAAdminTool.UserManager.getInfoUtente(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportControlloPreventivoSRC:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportControlloPreventivoSRC(SAAdminTool.UserManager.getInfoUtente(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportPensioniCivili:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportPensioniCivili(SAAdminTool.UserManager.getInfoUtente(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportPensioniMilitari:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportPensioniMilitari(SAAdminTool.UserManager.getInfoUtente(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
        ...
        public static SAAdminTool.DocsPaWR.PR_Amministrazione Do_GetAmmByIdAmm(int idAmm)
        {
        ...
        public static void DO_GetTitolario(ref DropDownList list, string codiceAmm)
        {
            try
            {
                ...
                foreach (SAAdminTool.DocsPaWR.PR_Titolario tit in _docsPaWS.DO_GetTitolari(id_amm))
                {
        ...
        public static SAAdminTool.DocsPaWR.Report DO_AddSubReport(SAAdminTool.DocsPaWR.Report report, SAAdminTool.DocsPaWR.Report subReport)
        {
        ...
        #region DO_NewReport
        public static SAAdminTool.DocsPaWR.Report DO_NewReport(string descrizione, string valore)
        {
        ...
        public static SAAdminTool.DocsPaWR.PR_Registro DO_NewRegistro(string system_id, string codice, string descrizione)
        {
        ...
        public static SAAdminTool.DocsPaWR.PR_Amministrazione DO_NewAmministrazione(string system_id, string codice, string descrizione, string libreria)
        {
        ...
        public static SAAdminTool.DocsPaWR.FileDocumento DO_StampaExcel(ArrayList filtri, string timeStamp, SAAdminTool.DocsPaWR.InfoUtente infoUtente, string searchType)
        {
            SAAdminTool.DocsPaWR.FileDocumento fileRep = new SAAdminTool.DocsPaWR.FileDocumento();
            ...
            // SAAdminTool.DocsPaWR.Parametro[] temp = new SAAdminTool.DocsPaWR.Parametro[filtri.Count];
            /* for(int i=0; i<filtri.Count; i++){
                 ...
                 temp[i] = new SAAdminTool.DocsPaWR.Parametro()
                 {
        ...
        public static SAAdminTool.DocsPaWR.FileDocumento DO_StampaLog(ArrayList filtri, SAAdminTool.DocsPaWR.InfoUtente infoUtente)
        {
            SAAdminTool.DocsPaWR.FileDocumento fileRep = new SAAdminTool.DocsPaWR.FileDocumento();
