...
namespace SAAdminTool.smistaDoc
{
	/// <summary>
	...
	public class SmistaDocManager
	{
		...
		private SAAdminTool.DocsPaWR.DocumentoSmistamento _currentDocument=null;

		private ArrayList _datiDocumentiTrasmessi=null;

		private SAAdminTool.DocsPaWR.Ruolo _ruolo=null;
		private SAAdminTool.DocsPaWR.Utente _utente=null;
		private SAAdminTool.DocsPaWR.InfoUtente _infoUtente=null;

		private SAAdminTool.DocsPaWR.MittenteSmistamento _mittenteSmistamento=null;
		
		private SAAdminTool.DocsPaWR.UOSmistamento _uoAppartenenza=null;
		private SAAdminTool.DocsPaWR.UOSmistamento[] _uoInferiori=null;
		...
		public SAAdminTool.DocsPaWR.DocumentoSmistamento GetCurrentDocument(bool content)
		{
		...
		public SAAdminTool.DocsPaWR.UOSmistamento GetUOAppartenenza()
		{
		...
		public SAAdminTool.DocsPaWR.UOSmistamento[] GetUOInferiori()
		{
			return this._uoInferiori;
		}
        public void SetUOInferiori(SAAdminTool.DocsPaWR.UOSmistamento[] uoInf)
        {
...
//			this._idTrasmissioneUtente.RemoveAt(this._currentDocumentIndex - 1);
		...
		public bool IsTrasmissioneConWorkflow(int documentIndex)
		{
			...
			if(this._datiDocumentiTrasmessi.Count>0)
				retValue=((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento) this._datiDocumentiTrasmessi[documentIndex]).TrasmissioneConWorkflow;
		...
		public string GetIdTrasmissione(int documentIndex)
		{
			...
			if(this._datiDocumentiTrasmessi.Count>0)
				retValue=((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento) this._datiDocumentiTrasmessi[documentIndex]).IDTrasmissione;
		...
		public string GetIdTrasmissioneSingola(int documentIndex)
		{
			...
			if(this._datiDocumentiTrasmessi.Count>0)
				retValue=((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento) this._datiDocumentiTrasmessi[documentIndex]).IDTrasmissioneSingola;
		...
		public string GetIdTrasmissioneUtente(int documentIndex)
		{
			...
			if(this._datiDocumentiTrasmessi.Count>0)
				retValue=((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento) this._datiDocumentiTrasmessi[documentIndex]).IDTrasmissioneUtente;
        ...
        public string GetNoteGenerali(int documentIndex)
        {
            ...
            if (this._datiDocumentiTrasmessi.Count > 0)
                retValue = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[documentIndex]).NoteGenerali;
        ...
        public string GetNoteIndividuali(int documentIndex)
        {
            ...
            if (this._datiDocumentiTrasmessi.Count > 0)
                retValue = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[documentIndex]).NoteIndividualiTrasmSingola;
        ...
        public string GetDescRagioneTrasm(int documentIndex)
        {
            ...
            if (this._datiDocumentiTrasmessi.Count > 0)
                retValue = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[documentIndex]).DescRagioneTrasmissione;
		...
		public bool RifiutaDoc(string notaRifiuto)
		{
            ...
            string idTrasmissione = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[GetCurrentDocumentPosition() - 1]).IDTrasmissione;
        ...
        public bool ScartaDoc()
        {
            ...
            //bool trasmConWorkflow = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento) this._datiDocumentiTrasmessi[GetCurrentDocumentPosition()-1]).TrasmissioneConWorkflow;
            //string idPeople = this._infoUtente.idPeople;
            //string idTrasmissione = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[GetCurrentDocumentPosition() - 1]).IDTrasmissione;
            ...
            string idOggetto = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[GetCurrentDocumentPosition() - 1]).IDDocumento;
            string tipoOggetto = "D";
            string idTrasmissione = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[GetCurrentDocumentPosition() - 1]).IDTrasmissione;
            string idTrasmsingola = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[GetCurrentDocumentPosition() - 1]).IDTrasmissioneSingola;

            DocsPaWR.RuoloSmistamento ruolo = new SAAdminTool.DocsPaWR.RuoloSmistamento();
        ...
        {
            ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[this.GetCurrentDocumentPosition() - 1]).NoteGenerali = value;
        }
        ...
        public SAAdminTool.DocsPaWR.MittenteSmistamento getMittenteSmistamento()
        {
        ...
        {
            string mittTrasm = ((SAAdminTool.DocsPaWR.DatiTrasmissioneDocumento)this._datiDocumentiTrasmessi[index]).MittenteTrasmissione;
