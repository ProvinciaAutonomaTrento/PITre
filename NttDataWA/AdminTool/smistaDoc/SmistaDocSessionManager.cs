...
namespace SAAdminTool.smistaDoc
{
	...
	public sealed class SmistaDocSessionManager
	{
        ...
        /// </summary>
        /// <returns></returns>
        public static SAAdminTool.smistaDoc.SmistaDocManager GetSmistaDocManager()
        {
        ...
        /// <returns></returns>
		public static SAAdminTool.smistaDoc.SmistaDocManager GetSmistaDocManager(string idDocumento)
		{
			if (System.Web.HttpContext.Current.Session[SESSION_KEY]==null)
			{
				SAAdminTool.smistaDoc.SmistaDocManager retValue=new SAAdminTool.smistaDoc.SmistaDocManager(UserManager.getRuolo(), UserManager.getUtente(), UserManager.getInfoUtente(), idDocumento);
				System.Web.HttpContext.Current.Session.Add(SESSION_KEY,retValue);
			}

			return (SAAdminTool.smistaDoc.SmistaDocManager) System.Web.HttpContext.Current.Session[SESSION_KEY];            
		}
        ...
        public static void SetSmistaDocManager(SAAdminTool.smistaDoc.SmistaDocManager docManager)
        {
        ...
        public static void SetSessionUoApp(SAAdminTool.DocsPaWR.UOSmistamento uoApp)
        {
            if (System.Web.HttpContext.Current.Session["SMISTA_DOC_MANAGER"] != null)
            {
                SAAdminTool.smistaDoc.SmistaDocManager docManager = (SAAdminTool.smistaDoc.SmistaDocManager)System.Web.HttpContext.Current.Session["SMISTA_DOC_MANAGER"];
        ...
        public static void SetSessionUoInf(SAAdminTool.DocsPaWR.UOSmistamento[] uoInf)
        {
            if (System.Web.HttpContext.Current.Session["SMISTA_DOC_MANAGER"] != null)
            {
                SAAdminTool.smistaDoc.SmistaDocManager docManager = (SAAdminTool.smistaDoc.SmistaDocManager)System.Web.HttpContext.Current.Session["SMISTA_DOC_MANAGER"];
