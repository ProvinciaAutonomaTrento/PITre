...
<%@ Page Language="c#" CodeBehind="ProfiloFasc.aspx.cs" AutoEventWireup="false" Inherits="SAAdminTool.AdminTool.Gestione_ProfDinamicaFasc.ProfiloFasc"
...
<head id="HEAD1" runat="server">
    ...
    <script language="javascript">
        ...
        function apriPopupAnteprima() {
            ...
            window.showModalDialog('ModalAnteprimaProfDinamicaFasc.aspx?Chiamante=AnteprimaProfDinamicaFasc.aspx', '', 'dialogWidth:700px;dialogHeight:500px;status:no;resizable:no;scroll:no;center:yes;help:no;close:no;top:' + new_h + ';left:' + new_w);
        }
        ...
        function apriModelliTrasm() {
            ...
            window.showModalDialog('ModalAnteprimaProfDinamicaFasc.aspx?Chiamante=AssociaModelliTrasmFasc.aspx', '', 'dialogWidth:600px;dialogHeight:400px;status:no;resizable:no;scroll:no;center:yes;help:no;close:no;top:' + new_h + ';left:' + new_w);
        }
        ...
        function apriPopupVisibilita() {
            ...
            window.showModalDialog('ModalAnteprimaProfDinamicaFasc.aspx?Chiamante=VisibilitaFasc.aspx', '', 'dialogWidth:800px;dialogHeight:650px;status:no;resizable:no;scroll:no;center:yes;help:no;close:no;top:' + new_h + ';left:' + new_w);
        }
        ...
        */
        ...
        function apriPopupModelli() {
            ...
            window.showModalDialog('ModalAnteprimaProfDinamicaFasc.aspx?Chiamante=AssociaModelliFasc.aspx', '', 'dialogWidth:500px;dialogHeight:200px;status:no;resizable:no;scroll:no;center:yes;help:no;close:no;top:' + new_h + ';left:' + new_w);
            Form1.submit();
        }

        function apriPopupCampiComuni() {
            //window.open('ModalAnteprimaProfDinamicaFasc.aspx?Chiamante=Visibilita.aspx','','top = '+ new_h +' left = '+new_w+' width=500,height=400,scrollbars=YES');				
            window.showModalDialog('ModalAnteprimaProfDinamicaFasc.aspx?Chiamante=CampiComuni.aspx', '', 'dialogWidth:600px;dialogHeight:400px;status:no;resizable:no;scroll:no;center:yes;help:no;close:no;top:' + new_h + ';left:' + new_w);
            Form1.submit();
        }
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        &nbsp;<asp:Button ID="btn_CampiComuni" runat="server" CssClass="testo_btn_p" Visible="False"
                                            Text="Campi Comuni" OnClick="btn_CampiComuni_Click"></asp:Button>&nbsp;<asp:Button
                                                ID="btn_inEsercizio" runat="server" CssClass="testo_btn_p" Visible="False" Text="In Esercizio">
                                            </asp:Button>&nbsp;<asp:Button ID="btn_salvaTemplate" runat="server" CssClass="testo_btn_p"
                                                Visible="False" Text="Salva"></asp:Button>&nbsp;<asp:Button ID="btn_anteprima" runat="server"
                                                    CssClass="testo_btn_p" Visible="False" Text="Anteprima"></asp:Button>&nbsp;<asp:Button
                                                        ID="btn_modelli" runat="server" CssClass="testo_btn_p" Visible="False" Text="Tipi Fascicolo">
                                                    </asp:Button>&nbsp;<asp:Button ID="btn_nuovoModello" runat="server" CssClass="testo_btn_p"
                                                        Text="Nuovo"></asp:Button>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" valign="top">
                                                            <asp:RadioButtonList ID="rbl_tipoContatore" class="testo_grigio_scuro" RepeatDirection="Horizontal"
                                                                runat="server">
