...
namespace SAAdminTool.AdminTool.Gestione_Qualifiche
{
    public partial class GestQual : System.Web.UI.Page
    {
        ...
        private void RefreshQualFromUI(ref SAAdminTool.DocsPaWR.Qualifica qualifica, bool insertMode)
        {
        ...
        private void RefreshGridItem(SAAdminTool.DocsPaWR.Qualifica qualifica)
        {
