    ...
    public partial class SistemiEsterni : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "BE_AUTH_SYS_EXT_TRANSITION")) || SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "BE_AUTH_SYS_EXT_TRANSITION") == "0")
                {
