...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SistemiEsterni.aspx.cs"
    Inherits="SAAdminTool.AdminTool.Gestione_SistemiEsterni.SistemiEsterni" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" onunload="ClosePopUp()">
    ...
    <table height="800px" cellspacing="1" cellpadding="0" width="100%" border="0">
        ...
        <tr id="msg_Transition" runat="server">
        <td valign="top" align="center" bgcolor="#f6f4f4" height="50px" style="font-family:Verdana; color:Red;">
        <br />
        <img src="../Images/alert.gif" alt="Attenzione"/> Attenzione: Chiave di transizione attiva. <br />Non è attivo il controllo sull'obbligatorietà e validità temporale del token
        </td>
        </tr>
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanelSistemiEsterni" runat="server">
                    ...
                    <asp:UpdateProgress  ID="updProgressCasella" runat="server" >
                        ...
                        <table cellspacing="0" cellpadding="0" align="center" border="0" width="820px">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl_info_sist_esterno" runat="server" Visible="true">
                                            <tr>
                                                ...
                                                <asp:HiddenField ID="hd_codeAPP" runat="server" />
                                                <asp:HiddenField ID="hd_codeUser" runat="server" />
                            ...
                            <tr>
                                <td>
                                    <asp:Panel ID="pnl_altre_conf" runat="server">
                                        <table class="contenitore" width="100%">
                                            <tr>
                                                <td class="titolo_pnl" valign="middle" align="left" width="30%">
                                                    Configurazioni Supplementari
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="testo_grigio_scuro" valign="middle" align="right">
                                                    <asp:Button ID="btn_toTipiDoc" TabIndex="33" runat="server" CssClass="testo_btn"
                                                        Text="Tipi Documento" OnClientClick="location.href='../Gestione_ProfDinamica/ProfiloDoc.aspx?extsysconf=1'">
                                                    </asp:Button>
                                                    <asp:Button ID="btn_toTipiFasc" TabIndex="33" runat="server" CssClass="testo_btn"
                                                        Text="Tipi Fascicolo" OnClientClick="location.href='../Gestione_ProfDinamicaFasc/ProfiloFasc.aspx?extsysconf=1'">
                                                    </asp:Button>
                                                    <asp:Button ID="btn_toTitolario" TabIndex="33" runat="server" CssClass="testo_btn"
                                                        Text="Titolario" OnClientClick="location.href='../Gestione_Titolario/Titolario.aspx?extsysconf=1'">
                                                    </asp:Button>
                                                    <asp:Button ID="btn_toTrasmModel" TabIndex="37" runat="server" CssClass="testo_btn"
                                                        Text="Modelli Trasmissione" OnClientClick="location.href='../Gestione_ModelliTrasm/ModelliTrasm.aspx?extsysconf=1'" />
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                        ...
                                        <asp:Panel runat="server" ID="pnlRF">
                                            ...
                                            <div style="overflow: auto; height: 89px; width: 99%; padding: 3px;">
                                                <asp:UpdatePanel ID="updPanelRF" runat="server" UpdateMode="Always">
                                                    <ContentTemplate>
                                                        <asp:DataGrid Width="100%" ID="dg_RF" TabIndex="29" runat="server" Height="59px"
                                                            AutoGenerateColumns="False" CellPadding="1" BorderWidth="1px" BorderColor="Gray">
                                                            <SelectedItemStyle CssClass="bg_grigioS"></SelectedItemStyle>
                                                            <AlternatingItemStyle CssClass="bg_grigioA"></AlternatingItemStyle>
                                                            <ItemStyle CssClass="bg_grigioN"></ItemStyle>
                                            ...
                                            <table style="width: 99%; margin: 3px;" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="titolo_pnl" valign="middle" align="right">
                                                        <asp:Button ID="btn_mod_registri" TabIndex="30" runat="server" CssClass="testo_btn_org"
                                    ...
                                    <asp:Panel ID="pnl_metodi_pis" runat="server" Visible="true" CssClass="contenitore">
                                        <asp:Panel ID="pnl_pis">
                                            ...
                                            <div style="overflow: auto; height: 89px; width: 99%; padding: 3px;">
                                                <asp:UpdatePanel ID="uppnl_pis" runat="server" UpdateMode="Always">
                                                    <ContentTemplate>
                                                        <asp:DataGrid Width="100%" ID="dg_pis" TabIndex="31" runat="server" Height="59px"
                                                            AutoGenerateColumns="False" CellPadding="1" BorderWidth="1px" BorderColor="Gray">
                                                            <SelectedItemStyle CssClass="bg_grigioS"></SelectedItemStyle>
                                                            <AlternatingItemStyle CssClass="bg_grigioA"></AlternatingItemStyle>
                                                            <ItemStyle CssClass="bg_grigioN"></ItemStyle>
                                        ...
                                        <asp:Panel ID="pnl_btn_pis" runat="server">
                                            <table style="width: 99%; margin: 3px;" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="titolo_pnl" valign="middle" align="right">
                                                        <asp:Button ID="btn_mod_pis" TabIndex="32" runat="server" CssClass="testo_btn_org"
                                                            Text="Modifica"></asp:Button>
                                                    </td>
                                                </tr>
                                            </table>
