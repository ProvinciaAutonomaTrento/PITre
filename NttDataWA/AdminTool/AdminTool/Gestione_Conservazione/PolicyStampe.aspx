<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyStampe.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_Conservazione.PolicyStampe" %>
                                    ...
                                    <asp:DataGrid ID="grvPolicy" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                                                HeaderText="TIPO">
                                                <ItemTemplate>
                                                    <asp:Label ID="TIPOPOLICY" runat="server" Text='<%# this.GetPolicyType((SAAdminTool.DocsPaWR.Policy)Container.DataItem) %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
