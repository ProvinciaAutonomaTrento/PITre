<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DimensioniIstanze.aspx.cs"
    Inherits="SAAdminTool.AdminTool.Gestione_Conservazione.DimensioniIstanze" %>
...
<head id="Head1" runat="server">
    <title>Conservazione -> Dimensioni Istanze</title>
    ...
    <table height="100%" cellspacing="1" cellpadding="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td class="titolo" align="center" bgcolor="#e0e0e0" height="20">
                Conservazione -> Dimensioni Istanze
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        ...
                        <td width="100%" height="100%" valign="middle" align="center">
                            <div id="DivSel" style="overflow: auto; height: 551px" class="testo_grigio_scuro">
                                <br />
                                Impostazione dello dimensioni massime delle istanze di conservazione:<br />
                                <br />
                                &nbsp;<br />
                                <table width="70%">
                                    <tr style="height: 25px">
                                        <td style="width: 60%; text-align: right" class="testo">
                                            Massimo numero di documenti all'interno di un'istanza:
                                        </td>
                                        <td style="width: 40%" class="testo">
                                            <asp:TextBox ID="tb_num_docs" runat="server" />
                                        </td>
                                    </tr>
                                    <tr style="height: 25px">
                                        <td style="width: 60%; text-align: right" class="testo">
                                    ...
                                    <tr style="height: 25px">
                                        <td style="width: 60%; text-align: right" class="testo">
                                            Massima dimensione di un'istanza di conservazione:
                                        </td>
                                        <td style="width: 40%; text-align: left" class="testo">
                                            <asp:TextBox ID="tb_dim_istanza" runat="server" />
                                            MB
                                        </td>
                                    </tr>
                                    <tr style="height: 25px">
                                    ...
                                    <tr style="height: 25px">
                                        ...
                                        <td style="width: 40%; text-align: left" class="testo">
                                            <asp:TextBox ID="tb_perc" runat="server" />
                                            %
                                        </td>
                                    </tr>
                                </table>
                                &nbsp;
                                <div id="button_new">
                                    <asp:Button ID="btn_salva_dimensioni" runat="server" CssClass="cbtn" Text="Salva"
                                        OnClick="btn_salva_dimensioni_Click" />
                                </div>
                                <br />
                            </div>
                        </td>
