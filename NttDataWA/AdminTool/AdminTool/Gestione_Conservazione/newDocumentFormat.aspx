<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newDocumentFormat.aspx.cs"
    Inherits="SAAdminTool.AdminTool.Gestione_Conservazione.newDocumentFormat" %>
                    ...
                    <asp:DataGrid ID="grvFileType" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateColumn Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="SYSTEM_ID" runat="server" Text='<%# this.GetTypeID((SAAdminTool.DocsPaWR.SupportedFileType)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="8%" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="check_file" OnCheckedChanged="ChangeCheckClick"
                                        AutoPostBack="true" Checked='<%# this.GetChecked((SAAdminTool.DocsPaWR.SupportedFileType)Container.DataItem) %>' />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="20%" HeaderText="ESTENSIONE" ItemStyle-CssClass="tab_sx2"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="FILENAME" runat="server" Text='<%# this.GetTypeName((SAAdminTool.DocsPaWR.SupportedFileType)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="72%" HeaderText="DESCRIZIONE" ItemStyle-CssClass="tab_sx"
                                HeaderStyle-HorizontalAlign="left" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                    <asp:Label ID="FILEDESCRIPTION" runat="server" Text='<%# this.GetTypeDescription((SAAdminTool.DocsPaWR.SupportedFileType)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
