...
{
    public partial class PolicyDocumenti : System.Web.UI.Page
    {
        ...
        {
            Policy[] policyList = this._wsInstance.GetListaPolicy(IdAmministrazione, "D");
        ...
        protected void DeletePolicy(object sender, EventArgs e)
        {
            ...
            // svuoto la cache altrimenti non viene aggiornato il dettaglio
            try
            {
                this._wsInstance.SvuotaCachePolicy((this.IdAmministrazione).ToString(), "D");
            }
            catch (Exception ex)
            {
        ...
        protected string UrlNewPolicy
        {
            get
            {
                return "newPolicyDocumento.aspx?s=new";
            }
        }
        ...
        protected string UrlViewPolicy
        {
            get
            {
                return "newPolicyDocumento.aspx";
            }
        }
