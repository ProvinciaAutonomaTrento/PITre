    ...
    public partial class GestioneAlert : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session["leggibilitaScadenza"] = SAAdminTool.utils.InitConfigurationKeys.GetValue(this.idAmm, "BE_CONS_VER_LEG_INTERVALLO");
                Session["leggibilitaNotifiche"] = SAAdminTool.utils.InitConfigurationKeys.GetValue(this.idAmm, "BE_CONS_VER_LEG_GG_NOTIFICHE");
