<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseProject.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_Conservazione.ChooseProject" %>
                    ...
                    <asp:DataGrid ID="grvFileType" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateColumn Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="SYSTEM_ID" runat="server" Text='<%# this.GetProjectID((SAAdminTool.DocsPaWR.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="8%" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                     <input name="rbl_pref" type="radio" class="testo_grigio_scuro" value='<%# this.GetProjectID((SAAdminTool.DocsPaWR.Fascicolo)Container.DataItem) %>'>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="20%" HeaderText="CODICE" ItemStyle-CssClass="tab_sx2"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="CODEPROJECT" runat="server" Text='<%# this.GetProjectCode((SAAdminTool.DocsPaWR.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="37%" HeaderText="DESCRIZIONE" ItemStyle-CssClass="tab_sx"
                                HeaderStyle-HorizontalAlign="left" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                    <asp:Label ID="PROJECTDESCRIPTION" runat="server" Text='<%# this.GetProjectDescription((SAAdminTool.DocsPaWR.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="35%" HeaderText="TITOLARIO" ItemStyle-CssClass="tab_sx"
                                HeaderStyle-HorizontalAlign="left" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                    <asp:Label ID="TITOLARIO" runat="server" Text='<%# this.GetProjectTitolario((SAAdminTool.DocsPaWR.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
