...
namespace Amministrazione.Gestione_Registri
{
    ...
    public class Registri : System.Web.UI.Page
    {
        ...
        /// semplificata
        /// </summary>
        protected SAAdminTool.AdminTool.UserControl.InteroperabilitySettings isRegistrySettings;
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            //info =SAAdminTool.UserManager.getInfoUtente( //SAAdminTool.UserManager.getInfoUtente(this.Page);
            string valoreChiave = SAAdminTool.utils.InitConfigurationKeys.GetValue(idAmministrazione, "FE_RICEVUTA_PROTOCOLLO_PDF");
            ...
            {
                addRuoloRespReg((SAAdminTool.DocsPaWR.ElementoRubrica[])Session["selRuoloRespReg"]);
            }
            ...
            if (ws.getValueInteropNoMail())
            {
                ...
                {
                    addRuoloInteropNoMail((SAAdminTool.DocsPaWR.ElementoRubrica[])Session["selRuoloRegNoMail"]);
                }
                ...
                //{
                //    addUtenteInteropNoMail((SAAdminTool.DocsPaWR.ElementoRubrica[])Session["selUtenteRegNoMail"]);
                //}
            }
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_IMPORT_PREGRESSI")) && SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_IMPORT_PREGRESSI").Equals("1"))
                {
        ...
        private void dg_Registri_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (commandName.Equals("Select"))
            {
                ...
                if (!registro.idRuoloResp.Equals(""))
                {
                    ...
                    SAAdminTool.DocsPaWR.Ruolo rr = ws.getRuoloById(registro.idRuoloResp);
                ...
                if (ws.getValueInteropNoMail())
                {
                    ...
                    {
                        SAAdminTool.DocsPaWR.Ruolo rr = ws.getRuoloById(registro.ID_RUOLO_AOO);
                        if (rr != null)
        ...
        {
            SAAdminTool.DocsPaWR.Utente[] utenti = ws.GetListaUtentiByIdRuolo(idRuolo);
        ...
        private void btn_aggiungi_Click(object sender, System.EventArgs e)
        {
            ...
            if (CheckUpdParamCasella() && 
                (string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_IMPORT_PREGRESSI")) || !(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_IMPORT_PREGRESSI").Equals("1"))) ||
                ((!string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_IMPORT_PREGRESSI")) && SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_IMPORT_PREGRESSI").Equals("1") && ControlloPregressi())))
            {
        ...
        {
            SAAdminTool.DocsPaWR.OrgRegistro[] registri = this.GetRegistriAmministrazione();
        ...
        /// </summary>
        private void RefreshRegistroFromUI(ref SAAdminTool.DocsPaWR.OrgRegistro registro)
        {

            registro = (SAAdminTool.DocsPaWR.OrgRegistro)Session["REG_SEL"];
            if (registro == null)
        ...
        private void RefreshRegistroFromUI_Save(ref SAAdminTool.DocsPaWR.OrgRegistro registro)
        {
            registro.IDRegistro = this.CurrentIDRegistro;
            registro.Codice = this.txt_codice.Text.Trim();
            registro.Descrizione = this.txt_descrizione.Text.Trim();
        ...
        /// <param name="registro"></param>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.ValidationResultInfo InsertRegistro(ref SAAdminTool.DocsPaWR.OrgRegistro registro)
        {
        ...
        /// <param name="registro"></param>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.ValidationResultInfo UpdateRegistro(ref SAAdminTool.DocsPaWR.OrgRegistro registro)
        {
        ...
        private void addRuoloInteropNoMail(SAAdminTool.DocsPaWR.ElementoRubrica[] selMittDaRubrica)
        {
            SAAdminTool.DocsPaWR.ElementoRubrica el = ((SAAdminTool.DocsPaWR.ElementoRubrica[])Session["selRuoloRegNoMail"])[0];
            SAAdminTool.DocsPaWR.Corrispondente corr = SAAdminTool.UserManager.getCorrispondenteByCodRubricaIE(this, el.codice, el.interno ? SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO : SAAdminTool.DocsPaWR.AddressbookTipoUtente.ESTERNO);
        ...
        private void addRuoloRespReg(SAAdminTool.DocsPaWR.ElementoRubrica[] selMittDaRubrica)
        {
            SAAdminTool.DocsPaWR.ElementoRubrica el = ((SAAdminTool.DocsPaWR.ElementoRubrica[])Session["selRuoloRespReg"])[0];
            SAAdminTool.DocsPaWR.Corrispondente corr = SAAdminTool.UserManager.getCorrispondenteByCodRubricaIE(this, el.codice, el.interno ? SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO : SAAdminTool.DocsPaWR.AddressbookTipoUtente.ESTERNO);
        ...
        #region commentato
        //private void addUtenteInteropNoMail(SAAdminTool.DocsPaWR.ElementoRubrica[] selMittDaRubrica)
        //{
        //    SAAdminTool.DocsPaWR.ElementoRubrica el = ((SAAdminTool.DocsPaWR.ElementoRubrica[]) Session["selUtenteRegNoMail"])[0];
        //    SAAdminTool.DocsPaWR.Corrispondente corr = SAAdminTool.UserManager.getCorrispondenteByCodRubricaIE(this, el.codice, el.interno ? SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO : SAAdminTool.DocsPaWR.AddressbookTipoUtente.ESTERNO);
        //    // EM this.txt_UtInteropNoMail.Text = corr.descrizione;


        //    SAAdminTool.DocsPaWR.Utente ut = (SAAdminTool.DocsPaWR.Utente) SAAdminTool.UserManager.getCorrispondenteByCodRubricaIE(this, el.codice, el.interno ? SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO : SAAdminTool.DocsPaWR.AddressbookTipoUtente.ESTERNO);
        //    ddl_UtInteropNoMail.ClearSelection();
            ...
            try
            {
                if (this.fileupload_ricevuta.HasFile)
                {
                    ...
                    if (validFormat)
                    {
                        ...
                        SAAdminTool.DocsPaWR.OrgRegistro objRegistro = (SAAdminTool.DocsPaWR.OrgRegistro)Session["REG_SEL"];
                        if (objRegistro != null)
                        {
        ...
        private void gestioneStampaRicevute(SAAdminTool.DocsPaWR.OrgRegistro registro)
        {
        ...
        private bool esisteModelloRicevuta(SAAdminTool.DocsPaWR.OrgRegistro registro)
        {
            SAAdminTool.DocsPaWR.DocsPaWebService ws = new SAAdminTool.DocsPaWR.DocsPaWebService();
            SAAdminTool.AdminTool.Manager.SessionManager sessionManager = new SAAdminTool.AdminTool.Manager.SessionManager();
        ...
        protected void btn_test_Click(object sender, EventArgs e)
        {
            ...
            SAAdminTool.DocsPaWR.OrgRegistro registro = registro = (SAAdminTool.DocsPaWR.OrgRegistro)Session["REG_SEL"];
            if (registro != null)
            {
        ...
        protected void dgRepertori_ItemCommand(object sender, DataGridCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case "Select":
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "openSettings", SAAdminTool.popup.ModifyRepertorioSettings.GetOpenScript(((HiddenField)e.Item.FindControl("hfRegistryId")).Value), true);
                    break;
        ...
        protected void img_aggiungiCasella_Click(Object sender, ImageClickEventArgs e)
        {
            ...
            {
                SAAdminTool.DocsPaWR.ValidationResultInfo res = MultiCasellaManager.InsertMailRegistro(this.CurrentIDRegistro, newCaselle, false);
        ...
        private void SetCaselleRegistro(string idRegistro)
        {
            ...
            ddl_caselle.Items.Clear();
            Caselle = SAAdminTool.utils.MultiCasellaManager.GetMailRegistro(idRegistro);
            if (Caselle != null)
            {
                    ...
                    if (c.EmailRegistro.Equals(ddl_caselle.SelectedValue))
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                SAAdminTool.DocsPaWR.CasellaRegistro[] listaCaselleInDB = SAAdminTool.utils.MultiCasellaManager.GetMailRegistro(this.CurrentIDRegistro);
                                ...
                                SAAdminTool.DocsPaWR.ValidationResultInfo result = ws.AmmDeleteMailRegistro(this.CurrentIDRegistro, c.EmailRegistro);
                                if (result.Value)
                                {
