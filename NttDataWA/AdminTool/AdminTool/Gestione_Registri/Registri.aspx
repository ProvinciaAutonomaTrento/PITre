                                                        ...
                                                        <tr width="100%">
                                                            ...
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:TextBox ID="txt_codice" runat="server" CssClass="testo" Width="100px" MaxLength="16"></asp:TextBox>
                                        ...
                                        <asp:DataGrid ID="dgRepertori" runat="server" Width="100%" BorderWidth="1px" CellPadding="1"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Descrizione">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRegistryDescription" runat="server" Text="<%# ((SAAdminTool.DocsPaWR.RegistroRepertorio)Container.DataItem).CounterDescription %>"
                                                            Font-Strikeout="<%# !((SAAdminTool.DocsPaWR.RegistroRepertorio)Container.DataItem).Enabled %>" />
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="Descrizione Tipologia">
                                                    <HeaderStyle HorizontalAlign="Center" Width="40%" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTypologyDescription" runat="server" Text="<%# ((SAAdminTool.DocsPaWR.RegistroRepertorio)Container.DataItem).TipologyDescription %>"
                                                            Font-Strikeout="<%# !((SAAdminTool.DocsPaWR.RegistroRepertorio)Container.DataItem).Enabled %>" />
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton CommandName="Select" runat="server" ID="imgDetails" ImageUrl="~/AdminTool/Images/lentePreview.gif"
                                                            ToolTip="Dettagli registro" Visible="<%# ((SAAdminTool.DocsPaWR.RegistroRepertorio)Container.DataItem).Enabled %>" />
                                                        <asp:HiddenField ID="hfRegistryId" runat="server" Value="<%# ((SAAdminTool.DocsPaWR.RegistroRepertorio)Container.DataItem).CounterId %>" />
                                                        <asp:HiddenField ID="hfTipology" runat="server" Value="<%# ((SAAdminTool.DocsPaWR.RegistroRepertorio)Container.DataItem).Tipology %>" />
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
                                        </asp:DataGrid>
                                        <asp:ObjectDataSource ID="RegistriRepertorioManagerDataSource" runat="server" SelectMethod="GetRegisteredRegistries"
                                            TypeName="SAAdminTool.utils.RegistriRepertorioUtils" OnSelecting="RegistriRepertorioManagerDataSource_Selecting">
                                            <SelectParameters>
