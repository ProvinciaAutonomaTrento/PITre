namespace Amministrazione.UserControl
{
	...
	public class MenuTendina : System.Web.UI.UserControl
	{
        ...
        protected SAAdminTool.DocsPaWR.InfoUtenteAmministratore _datiAmministratore = null;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{	
                ...
                valoreChiave = SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_ABILITA_GEST_DOCS_ST_FINALE");
              ...
              SAAdminTool.AdminTool.Manager.AmministrazioneManager am = new SAAdminTool.AdminTool.Manager.AmministrazioneManager();
                ...
                valoreChiave2 = SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_GESTIONE_DISSERVIZIO");
                ...
                valoreChiave3 = SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_IMPORT_PREGRESSI");
                ...
                //gestSistemiEsterni= SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_GEST_SYS_EXT");
                ...
                if(string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0","FE_AUTH_SYS_EXT_FE_ADMIN")) || SAAdminTool.utils.InitConfigurationKeys.GetValue("0","FE_AUTH_SYS_EXT_ADMIN") =="0")
                {
                    this.hd_gestione_sistemi_esterni.Value = "0";
                }
            }
        ...
        {
            SAAdminTool.DocsPaWR.ConfigurazioniRubricaComune config = SAAdminTool.RubricaComune.Configurazioni.GetConfigurazioni(this._datiAmministratore);
        ...
        private void impostaCampiNascosti()
        {
            /**** FUNZIONALITA' PARAMETRIZZATE DA WEB.CONFIG ****/
                    ...
                    //--case "LISTE DI DISTRIBUZIONE": //---------------------------------------------------------------------------
                        ...
                        if (this.hd_gestione_asserzioni.Value.Equals("1"))
                            this.hd_gestione_asserzioni.Value = isAttivo("GE");
