<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportPregressiDetails.aspx.cs"
    Inherits="SAAdminTool.AdminTool.Gestione_Import.ImportDetails" %>
                ...
                <asp:DataGrid ID="grvItems" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <asp:TemplateColumn Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="SYSTEM_ID" runat="server" Text='<%# this.GetItemID((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ...
                            <ItemTemplate>
                                <asp:Label ID="DATA" runat="server" Text='<%# this.GetData((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="ESITO" ItemStyle-CssClass="tab_sx3" HeaderStyle-HorizontalAlign="left"
                            ...
                            <ItemTemplate>
                                <asp:Label ID="ESITO" runat="server" Text='<%# this.GetEsito((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ItemStyle-CssClass="tab_sx3" HeaderText="ERRORE" ItemStyle-Width="15%">
                            <ItemTemplate>
                                <asp:Label ID="ERR" runat="server" Text='<%# this.GetErrore((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ItemStyle-CssClass="tab_sx3" HeaderText="ID DOCUMENTO" ItemStyle-Width="15%">
                            <ItemTemplate>
                                <asp:Label ID="NDOC" runat="server" Text='<%# this.GetDocumento((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ItemStyle-CssClass="tab_sx3" HeaderText="NUM PROTO/ID VECCHIO DOC" ItemStyle-Width="15%">
                            <ItemTemplate>
                                <asp:Label ID="NUMPROTO" runat="server" Text='<%# this.GetNumProtoExcel((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ItemStyle-CssClass="tab_sx3" HeaderText="REGISTRO" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="REG" Text='<%# this.GetRegistro((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ItemStyle-CssClass="tab_sx3" HeaderText="PROPRIETARIO" ItemStyle-Width="15%">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="Ruolo" Text='<%# this.GetUtenteRuolo((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ItemStyle-CssClass="tab_sx3" HeaderText="TIPO OPERAZIONE" ItemStyle-Width="5%">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="TIPO" Text='<%# this.GetTipoOperazione((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab"
                            ItemStyle-CssClass="tab_sx3" HeaderText="N° ALLEGATI" ItemStyle-Width="5%">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="TIPO" Text='<%# this.GetNumeroAllegati((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
                </asp:DataGrid>
