...
<%@ Page Language="c#" CodeBehind="GestImport.aspx.cs" AutoEventWireup="true" Inherits="SAAdminTool.AdminTool.Gestione_Import.GestImport" %>
                                                    ...
                                                    <asp:DataGrid ID="grvItems" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab2"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Image ID="btn_periodo" runat="server" AlternateText='<%# this.GetTipoAvviso((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'
                                                                        ImageUrl='<%# this.GetImageAvviso((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'
                                                                        ToolTip='<%# this.GetTipoAvviso((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'>
                                                                    </asp:Image>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <%--<asp:TemplateColumn ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab2"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="TIPOERRORE" runat="server" Text='<%# this.GetTipoAvviso((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>--%>
                                                            <asp:TemplateColumn ItemStyle-Width="70%" HeaderText="ERRORE" ItemStyle-CssClass="tab_sx2"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="ERRORE" runat="server" Text='<%# this.GetErrore((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <%--<asp:TemplateColumn ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab2"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="RIGAEXCEL" runat="server" Text='<%# this.GetLineaExcel((SAAdminTool.DocsPaWR.ItemReportPregressi)Container.DataItem) %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                        </Columns>
                                                    </asp:DataGrid>
