<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirittiRuoloOggettoCustomDoc.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_ProfDinamica.DirittiRuoloOggettoCustomDoc" %>
		...
		<tr>
		    ...
		    <asp:DataGrid id="dg_Ruoli" runat="server" AutoGenerateColumns="False" Width="100%" Visible="true">
				...
				<Columns>
                    ...
                    <asp:BoundColumn DataField="ANNULLA REP"  HeaderText="Annulla Rep." ItemStyle-HorizontalAlign="Center">
						<HeaderStyle Width="15%"></HeaderStyle>
					    <ItemStyle HorizontalAlign="Center" />
					</asp:BoundColumn>
				</Columns>
