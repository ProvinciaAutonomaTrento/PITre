...
namespace SAAdminTool.AdminTool.Gestione_ProfDinamica
{
    public class ProfiloDoc : System.Web.UI.Page
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            this.btnStorico.Enabled = Session["template"] != null && ((SAAdminTool.DocsPaWR.Templates)Session["template"]).SYSTEM_ID > 0 && ((SAAdminTool.DocsPaWR.Templates)Session["template"]).ELENCO_OGGETTI.Length > 0;
        ...
        void btn_associaRuolo_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom = (SAAdminTool.DocsPaWR.OggettoCustom)template.ELENCO_OGGETTI[this.dg_listaComponenti.SelectedIndex];
        ...
        */
        ...
        private void dg_listaComponenti_ItemCommand(object sender, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            {
                SAAdminTool.DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)Session["template"];
                SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom = (SAAdminTool.DocsPaWR.OggettoCustom)template.ELENCO_OGGETTI[elSelezionato];
        ...
        public void visualizzaPannelloPersonalizzazzione(string tipoComponente, SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom)
        {
        ...
        private void btn_confermaPrivato_Click(object sender, System.EventArgs e)
        {
            ...
            if (!template.PRIVATO.Equals(check))
            {
                ...
                if (numDoc > 0)
                {
                    ...
                    //conferma all'utente 
                    string messaggio = SAAdminTool.InitMessageXml.getInstance().getMessage("PD_DocPrivato");
        ...
        {
            SAAdminTool.DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)Session["templateSelPerInvioCons"];
        ...
        {
            SAAdminTool.DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)Session["template"];
            SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom = (SAAdminTool.DocsPaWR.OggettoCustom)template.ELENCO_OGGETTI[Convert.ToInt32(Session["temp_c1"])];
        ...
        private void btn_confermaConservaOgg_Click(object sender, System.EventArgs e)
        {
            ...
            SAAdminTool.DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)Session["template"];
            SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom = (SAAdminTool.DocsPaWR.OggettoCustom)template.ELENCO_OGGETTI[Convert.ToInt32(Session["temp_c2"])];
        ...
        public void compilaPersContSottocontatore(SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom)
        {
        ...
        public void compilaPersSeparatore(SAAdminTool.DocsPaWR.OggettoCustom oggettoCustom)
        {
        ...
        private bool controllaTipoDiDocumento()
        {
            ...
            {
                if (txt_TipoDocumento.Text.Equals(((SAAdminTool.DocsPaWR.TipologiaAtto)tipiAttoTotali[i]).descrizione))
                {
                    return true;
                }
            }
        ...
        private void popolaTemplateDG()
        {
            ...
            if (System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] != null && System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] == "1")
            {
                ...
                {
                    SAAdminTool.DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)listaTemplates[i];
                    int idDiagrammaAssociato = SAAdminTool.DiagrammiManager.getDiagrammaAssociato(Convert.ToString(template.SYSTEM_ID), this);
        ...
        private void dg_listaTemplates_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            if (((System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("txt_confirmDel")).Value == "si")
            {
                ...
                if (elSelezionato != -1)
                {
                    ...
                    SAAdminTool.DiagrammiManager.disassociaTipoDocDiagramma(template.SYSTEM_ID.ToString(), this);
        ...
        private void dg_listaTemplates_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Select":
                    ...
                    {
                        //SAAdminTool.DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato];
                        SAAdminTool.DocsPaWR.Templates template = ProfilazioneDocManager.getTemplateById(((SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato]).SYSTEM_ID.ToString(), this);
                        Session.Add("template", template);
                        ...
                        string keyInstance = SAAdminTool.utils.InitConfigurationKeys.GetValue(idAmministrazione, "BE_INSTANCE_ACCESS_PATH");
                ...
                case "Diagrammi":
                    ...
                    SAAdminTool.DocsPaWR.Templates temp = ProfilazioneDocManager.getTemplateById(((SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato]).SYSTEM_ID.ToString(), this);
                ...
                case "Modelli":
                    ...
                    SAAdminTool.DocsPaWR.Templates temp_1 = ProfilazioneDocManager.getTemplateById(((SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato]).SYSTEM_ID.ToString(), this);
                ...
                case "Visibilita":
                    //SAAdminTool.DocsPaWR.Templates temp_1 = (SAAdminTool.DocsPaWR.Templates) listaTemplates[elSelezionato];
                    SAAdminTool.DocsPaWR.Templates temp_2 = ProfilazioneDocManager.getTemplateById(((SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato]).SYSTEM_ID.ToString(), this);
                    ...
                    break;
                case "Privato":
                    SAAdminTool.DocsPaWR.Templates temp_3 = ProfilazioneDocManager.getTemplateById(((SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato]).SYSTEM_ID.ToString(), this);
                    ...
                    break;
                case "MesiCons":
                    SAAdminTool.DocsPaWR.Templates temp_4 = ProfilazioneDocManager.getTemplateById(((SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato]).SYSTEM_ID.ToString(), this);
                    ...
                    break;
                case "InvioCons":
                    SAAdminTool.DocsPaWR.Templates temp_5 = ProfilazioneDocManager.getTemplateById(((SAAdminTool.DocsPaWR.Templates)listaTemplates[elSelezionato]).SYSTEM_ID.ToString(), this);
        ...
        private void settaDllDiagrammi()
        {
            ...
            int idDiagrammaAssociato = SAAdminTool.DiagrammiManager.getDiagrammaAssociato(idTipoDoc, this);
        ...
        private void btn_confermaDiagrTrasm_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                ProfilazioneDocManager.updateScadenzeTipoDoc(((SAAdminTool.DocsPaWR.Templates)Session["templateSelPerDiagrTrasm"]).SYSTEM_ID, txt_scadenza.Text, txt_preScadenza.Text, this);
            }
            catch (Exception ex)
            {
            ...
            if (ddl_Diagrammi.SelectedItem.Value != "0")
            {
                ...
                SAAdminTool.DiagrammiManager.associaTipoDocDiagramma(idTipoDoc, idDiagramma, this);
            }
            else
            {
                settaDllDiagrammi();
        ...
        private void btn_cambiaDiag_Click(object sender, System.EventArgs e)
        {
            ...
            {
                SAAdminTool.DocsPaWR.DiagrammaStato diagrammaAssociato = SAAdminTool.DiagrammiManager.getDiagrammaById(ddl_Diagrammi.SelectedValue, this);
                if (SAAdminTool.DiagrammiManager.isDocumentiInStatoFinale(Convert.ToString(diagrammaAssociato.SYSTEM_ID), idTipoDoc, this))
                    result = true;
                ...
                //{
                //    if(SAAdminTool.DiagrammiManager.isDocumentiInStatoFinale(Convert.ToString(diagrammaAssociato.SYSTEM_ID),idTipoDoc,Convert.ToString( ((SAAdminTool.DocsPaWR.Stato) statiFinali[j]).SYSTEM_ID),this))
                //        result = true;
                //}
            }
            ...
            if (result)
            {
                SAAdminTool.DiagrammiManager.disassociaTipoDocDiagramma(idTipoDoc, this);
                settaDllDiagrammi();
            }
            else
            {
        ...
        protected bool IsConservazionePARER()
        {
            ...
            IS_CONSERVAZIONE_PARER = SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_WA_CONSERVAZIONE");
