<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Visibilita.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_ProfDinamica.Visibilita" validateRequest="false"%>
...
<body >
    <form id="form1" runat="server">
        ...
        <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "AMMINISTRAZIONE > Visibilita' Tipologia Documenti" />
	...
	<table width="100%">
		...
		<tr>
			...
			<td align="right" width="33%" bgColor="#e0e0e0" style="padding-right:15px;">
                <asp:Button id="btn_estendiARuoli" runat="server" Text="Estendi a Ruoli" ToolTip="Estende la configurazione attuale dei diritti sui campi, a tutti i ruoli presenti nella lista."                 
                    CssClass="testo_btn_p_large" onclick="btn_estendiARuoli_Click" OnClientClick="showWait();"></asp:Button>
                <cc1:ConfirmButtonExtender ID="ConfirmButtonEstendiALista" runat="server" ConfirmText="Gli attuali diritti sui campi verranno estesi a tutti i ruoli presenti nella lista, sovrascrivendo i vecchi diritti. Confermare ?" TargetControlID="btn_estendiARuoli">
                </cc1:ConfirmButtonExtender>   
            </td>
		</tr>
		<tr>
			    ...
			    <asp:DataGrid id="dg_Campi" runat="server" AutoGenerateColumns="False" Width="100%" Visible="true" onitemcommand="dg_Campi_ItemCommand">
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Visibilità">
							...
							<ItemStyle HorizontalAlign="Center"></ItemStyle>
							<ItemTemplate>
								<asp:CheckBox id="cb_visListaCampi" runat="server" AutoPostBack="True" oncheckedchanged="cb_insListaCampi_CheckedChanged"></asp:CheckBox>
							</ItemTemplate>							
						</asp:TemplateColumn>	
                        <asp:TemplateColumn HeaderText="Annulla">
						    <HeaderStyle HorizontalAlign="Center" Width="15%"></HeaderStyle>
						    <ItemStyle HorizontalAlign="Center"></ItemStyle>
							<ItemTemplate>
								<asp:CheckBox id="cb_annullaListaCampi" runat="server"></asp:CheckBox>
							</ItemTemplate>							
						</asp:TemplateColumn>							
