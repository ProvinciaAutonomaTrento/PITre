	...
	public class AssociaModelli : System.Web.UI.Page
	{
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            if (CheckBox3.Checked)
            {
                ...
                ((SAAdminTool.DocsPaWR.Templates)Session["templateSelPerModelli"]).PATH_ALLEGATO_1 = "";
                DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)Session["templateSelPerModelli"];
                ProfilazioneDocManager.eliminaModelli(template.DESCRIZIONE, codiceAmministrazione, "Allegato1.rtf", "doc", (SAAdminTool.DocsPaWR.Templates)Session["templateSelPerModelli"], this);
        ...
        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            if (CheckBox4.Checked)
            {
                ...
                ((SAAdminTool.DocsPaWR.Templates)Session["templateSelPerModelli"]).PATH_MODELLO_STAMPA_UNIONE = "";
                DocsPaWR.Templates template = (SAAdminTool.DocsPaWR.Templates)Session["templateSelPerModelli"];
                ProfilazioneDocManager.eliminaModelli(template.DESCRIZIONE, codiceAmministrazione, "ModelloSU.rtf", "doc", (SAAdminTool.DocsPaWR.Templates)Session["templateSelPerModelli"], this);
