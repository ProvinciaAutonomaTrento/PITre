...
namespace Amministrazione.Gestione_MezzoSpedizione
{
	...
	{		
       ...
       // private const int GRID_COL_CHATIPOCANALE = 2;
		...
		/// </summary>
		/// <returns></returns>
        private SAAdminTool.DocsPaWR.MezzoSpedizione[] GetListaMezzoSpedizione()
		{
        ...
        /// </summary>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.MezzoSpedizione GetMezzoSpedizione(string idMezzoSpedizione)
        {
            DocsPaWR.DocsPaWebService ws = new SAAdminTool.DocsPaWR.DocsPaWebService();
        ...
        {
            SAAdminTool.DocsPaWR.MezzoSpedizione[] m_sped = this.GetListaMezzoSpedizione();
            if (m_sped != null)
            {
		...
		/// <returns></returns>
		private SAAdminTool.DocsPaWR.ValidationResultInfo UpdateMezzoSpedizione(ref SAAdminTool.DocsPaWR.MezzoSpedizione m_sped)
		{
			DocsPaWR.DocsPaWebService ws=new SAAdminTool.DocsPaWR.DocsPaWebService();
		...
		/// </summary>
		/// <param name="tipoRuolo"></param>
		private void BindUI(SAAdminTool.DocsPaWR.MezzoSpedizione m_sped)
		{
			this.ClearData();
		...
		private void RefreshGridItem(SAAdminTool.DocsPaWR.MezzoSpedizione m_sped)
		{
		...
		/// <returns></returns>
        private DataSet ConvertToDataSet(SAAdminTool.DocsPaWR.MezzoSpedizione[] m_sped)
		{
