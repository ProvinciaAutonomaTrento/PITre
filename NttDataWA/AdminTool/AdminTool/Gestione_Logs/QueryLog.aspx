...
<%@ Page language="c#" Codebehind="QueryLog.aspx.cs" AutoEventWireup="false" Inherits="Amministrazione.Gestione_Logs.QueryLog" %>
...
<HTML>
	<HEAD runat = "server">
		...
		<SCRIPT language="JavaScript">
			...
			{				
				var args=new Object;
				args.window=window;
				window.showModalDialog("exportLog.aspx?export=FE",
										args,
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onunload="ClosePopUp()">
		<form id="Form1" method="post" runat="server">
		    <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "AMMINISTRAZIONE > Ricerca Log" />
		<!-- Gestione del menu a tendina --><uc3:menutendina id="MenuTendina" runat="server"></uc3:menutendina>
			<table height="100%" cellSpacing="1" cellPadding="0" width="100%" border="0">
				...
				<tr>
					<!-- TITOLO PAGINA -->
					<td class="titolo" align="center" width="100%" bgColor="#e0e0e0" height="20">Ricerca log</td>
				</tr>
				<tr>
					<td vAlign="top" align="center" bgColor="#f6f4f4" height="100%">
						...
						<table height="100" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr height="100%" width="100%">
								<td width="120" height="100%"><uc2:menulog id="MenuLog" runat="server"></uc2:menulog>
