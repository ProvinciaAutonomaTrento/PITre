<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AUR.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_Logs.AUR" %>
                                                                                            ...
                                                                                            <asp:GridView ID="GrdAssertionResult" runat="server" BorderColor="Gray" CellPadding="1" BorderWidth="1px" AllowPaging="true"
                                                                                                ...
                                                                                                <Columns>
                                                                                                    <asp:TemplateField HeaderText='ID' HeaderStyle-Width="0%" Visible="false">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:Label runat="server" ID='lblSystemIdAggregator' Text='<%# this.GetSystemIdAggregatorRole((SAAdminTool.AdminTool.Gestione_Logs.AggregatorRole) Container.DataItem) %>' />
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                    <asp:TemplateField HeaderText='Codice' HeaderStyle-Width="35%">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:Label runat='server' ID='lblCode' Text='<%# this.GetCodeAggregatorRole((SAAdminTool.AdminTool.Gestione_Logs.AggregatorRole) Container.DataItem) %>'/>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                    <asp:TemplateField HeaderText='Descrizione' HeaderStyle-Width="65%">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:Label runat='server' ID='lblDescription' Text='<%# this.GetDescriptionAggregatorRole((SAAdminTool.AdminTool.Gestione_Logs.AggregatorRole) Container.DataItem) %>'/>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                </Columns>
                                                                                            </asp:GridView>
                                                ...
                                                <asp:GridView ID="GrdAsserzioni" runat="server" BorderColor="Gray" CellPadding="1" BorderWidth="1px"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText='Id Asserzione' HeaderStyle-Width="1%" Visible="false">
                                                           <ItemTemplate>
                                                           <asp:Label runat="server" ID="lblSystemId" Text='<%# this.GetSystemId((SAAdminTool.DocsPaWR.Assertion) Container.DataItem) %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText='Tipo evento' HeaderStyle-Width="20%">
                                                           <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblTypeEvent" Text='<%# this.GetTypeEvent((SAAdminTool.DocsPaWR.Assertion) Container.DataItem) %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText='Tipo aggregato di ruoli' HeaderStyle-Width="20%">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblArg" Text='<%#this.GetTypeAur((SAAdminTool.DocsPaWR.Assertion) Container.DataItem) %>'/>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText='Aggregato di ruoli' HeaderStyle-Width="20%">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblAur" Text='<%# this.GetDescAur((SAAdminTool.DocsPaWR.Assertion) Container.DataItem) %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText='Classifica notifica' HeaderStyle-Width="20%">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblIO" Text='<%#this.GetNotificationType((SAAdminTool.DocsPaWR.Assertion) Container.DataItem) %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText='In esercizio' HeaderStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblState" Text='<%#this.GetInExercise((SAAdminTool.DocsPaWR.Assertion) Container.DataItem) %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
