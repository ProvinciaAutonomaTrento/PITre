...
using SAAdminTool.AdminTool.Gestione_Logs;
...
namespace Amministrazione.Gestione_Logs
{
    public partial class EstrazioneLog : System.Web.UI.Page
    {
        ...
        private void estrazioneLog_PreRender(object sender, EventArgs e)
        {
            ...
            SAAdminTool.DocsPaWR.Corrispondente corrRuolo = SAAdminTool.UserManager.getCorrispondenteSelezionatoRuoloAmministrazione(this);
            if (corrRuolo != null)
            {
                ...
                if (!corrRuolo.codiceRubrica.Equals(""))
                {
                    ...
                    this.txt_descRuolo.Text = SAAdminTool.UserManager.getDecrizioneCorrispondenteSemplice(corrRuolo);
                    this.hd_systemIdCorrRuolo.Value = corrRuolo.systemId;
                    SAAdminTool.UserManager.setCorrispondenteSelezionatoRuoloAmministrazione(this.Page, corrRuolo);
                }
            }

            //carico la UO, se esiste
            SAAdminTool.DocsPaWR.Corrispondente corrUO = SAAdminTool.UserManager.getCorrispondenteSelezionatoUOAmministrazione(this);
            if (corrUO != null)
            {
                SAAdminTool.UserManager.removeCorrispondentiSelezionati(this);
                if (!corrUO.codiceRubrica.Equals(""))
                {
                    ...
                    this.txt_descUo.Text = SAAdminTool.UserManager.getDecrizioneCorrispondenteSemplice(corrUO);
                    this.hd_systemIdCorrUO.Value = corrUO.systemId;
                    SAAdminTool.UserManager.setCorrispondenteSelezionatoUOAmministrazione(this.Page, corrUO);
                }
            }
        }
        ...
        private void setDescCorrRuolo(string codiceRubrica)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SAAdminTool.UserManager.setCorrispondenteSelezionatoRuoloAmministrazione(this.Page, corr);
                    this.txt_codRuolo.Text = codiceRubrica;
                    this.txt_descRuolo.Text = SAAdminTool.UserManager.getDecrizioneCorrispondenteSemplice(corr);
        ...
        private void setDescCorrUO(string codiceRubrica)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SAAdminTool.UserManager.setCorrispondenteSelezionatoUOAmministrazione(this.Page, corr);
                    this.txt_codUo.Text = codiceRubrica;
                    this.txt_descUo.Text = SAAdminTool.UserManager.getDecrizioneCorrispondenteSemplice(corr);
        ...
        private void abilitaCampi()
        {
            ...
            {
                if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_da").txt_Data.Text) || !SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_a").txt_Data.Text))
                {

                    if (!string.IsNullOrEmpty(txt_data_da.Text) && !SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_da").txt_Data.Text))
                    {
                    ...
                    if (!string.IsNullOrEmpty(txt_data_a.Text) && !SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_a").txt_Data.Text))
                    {
            ...
            if (!string.IsNullOrEmpty(txt_data_da.Text) && !string.IsNullOrEmpty(txt_data_a.Text) && contIpa)
            {
                if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_da").txt_Data.Text) || !SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_a").txt_Data.Text))
                {
                    ...
                    if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_da").txt_Data.Text))
                    {
                        this.Page.ClientScript.RegisterStartupScript(this.GetType(), "Seleziona_data_iop", "alert('Verificare il formato della data di inzio');", true);
                        txt_data_da.Text = "";
                    }

                    if (!SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_aa").txt_Data.Text))
                    {
                        this.Page.ClientScript.RegisterStartupScript(this.GetType(), "Seleziona_data_iop", "alert('Verificare il formato della data di fine');", true);
                        txt_data_a.Text = "";
                    }
                ...
                if (SAAdminTool.Utils.verificaIntervalloDate(this.GetCalendarControl("txt_data_da").txt_Data.Text, this.GetCalendarControl("txt_data_a").txt_Data.Text))
                {
                    contIpa = false;
                ...
                this.giorniIOP = SAAdminTool.Utils.getIntervalloDate(this.GetCalendarControl("txt_data_da").txt_Data.Text, this.GetCalendarControl("txt_data_a").txt_Data.Text);
                ...
                if (contIpa == true)
                {
                    ...
                    string mese_inizio = SAAdminTool.Utils.getMonthFromData(this.dataInitIOP);
                    string mese_inizio_normale = SAAdminTool.Utils.getMonthFromData(this.dataInitIOP);
                    ...
                    string mese_fine = SAAdminTool.Utils.getMonthFromData(this.dataFineIOP);
                    string mese_fine_normale = SAAdminTool.Utils.getMonthFromData(this.dataFineIOP);
        ...
        private void ddl_ampiezza_ipa_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            if (!this.ddl_ampiezza_ipa.SelectedItem.Value.Equals("niente"))
            {
                ...
                string mese = SAAdminTool.Utils.getMonthFromData(this.dataInitIOP);
                ...
                risultato_IPA += "periodicità " + ddl_periodo_ipa.SelectedItem.Text + ", ampiezza " + ddl_ampiezza_ipa.SelectedItem.Text + ", collocazione iniziale " + giorno + " " + mese + " " + anno + " " + "(" + SAAdminTool.Utils.getDayWeekFromData(this.dataInitIOP) + ")";
...
*/
        ...
        public bool controllaDati()
        {
            ...
            if (contIpa && (!SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_da").txt_Data.Text) || !SAAdminTool.Utils.isDate(this.GetCalendarControl("txt_data_a").txt_Data.Text)))
            {
                contIpa = false;
            ...
            if (contIpa && SAAdminTool.Utils.verificaIntervalloDate(this.GetCalendarControl("txt_data_da").txt_Data.Text, this.GetCalendarControl("txt_data_a").txt_Data.Text))
            {
                contIpa = false;
...
*/
        ...
        {
            SAAdminTool.DocsPaWR.OrgTipoRuolo[] tipiRuolo = this.GetTipiRuolo();
