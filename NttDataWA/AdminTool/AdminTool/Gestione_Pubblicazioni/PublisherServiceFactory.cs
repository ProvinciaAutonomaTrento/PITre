    ...
    public sealed class PublisherServiceFactory
    {
        ...
        public static string ServiceUrl
        {
            get
            {
                ...
                string standardWebServiceUrl = SAAdminTool.Properties.Settings.Default.AdminTool_DocsPaWR_DocsPaWebService;

                Uri uri = new Uri(SAAdminTool.Properties.Settings.Default.AdminTool_DocsPaWR_DocsPaWebService);
