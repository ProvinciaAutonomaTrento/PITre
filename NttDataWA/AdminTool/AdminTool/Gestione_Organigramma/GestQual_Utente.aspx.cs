...
namespace SAAdminTool.AdminTool.Gestione_Organigramma
{
    public partial class GestQual_Utente : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DocsPaWR.Corrispondente uo = SAAdminTool.UserManager.getCorrispondenteBySystemID(this, idUo);
                DocsPaWR.Ruolo ruolo = SAAdminTool.UserManager.getRuoloByIdGruppo(idGruppo, this);
                DocsPaWR.Utente utente = SAAdminTool.UserManager.GetUtenteByIdPeople(idPeople);
        ...
        private DataSet ConvertToDataSet_dg_qualifiche(List<DocsPaWR.Qualifica> qualifiche)
        {
            ...
            foreach (SAAdminTool.DocsPaWR.Qualifica qualifica in qualifiche)
            {
        ...
        private DataSet ConvertToDataSet_dg_utente(List<DocsPaWR.PeopleGroupsQualifiche> pgqs)
        {
            ...
            foreach (SAAdminTool.DocsPaWR.PeopleGroupsQualifiche pgq in pgqs)
            {
                DataRow row = dt.NewRow();
        ...
        private void RefreshPGFromUI(ref SAAdminTool.DocsPaWR.PeopleGroupsQualifiche pgq, String idAmm, String idUo, String idGruppo, String idPeople, String idQual)
        {
