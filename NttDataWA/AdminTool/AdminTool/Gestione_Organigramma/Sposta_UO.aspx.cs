...
namespace Amministrazione.Gestione_Organigramma
{
	...
	public class Sposta_UO : System.Web.UI.Page
	{
		...
		{
			SAAdminTool.Utils.SetFocus(this,ctrl,sel);			
		}		
		...
		private ArrayList cercaInUoFiglie(SAAdminTool.DocsPaWR.OrgUO uo)
		{
			...
			{				
				...
				{							
					foreach(SAAdminTool.DocsPaWR.OrgRisultatoRicerca risultato in theManager.getRisultatoRicerca())
					{
						...
						SAAdminTool.Utils.DefaultButton(this, ref txt_codice, ref btn_sposta);
						SAAdminTool.Utils.DefaultButton(this, ref txt_descrizione, ref btn_sposta);
					}
				}
				else
				{
