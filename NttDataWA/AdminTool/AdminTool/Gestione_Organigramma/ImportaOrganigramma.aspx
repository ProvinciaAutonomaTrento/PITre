<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportaOrganigramma.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_Organigramma.ImportaOrganigramma" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript">
		...
		function apriLog() 
		{			
		    var myUrl = "LogImportOrganigramma.aspx";				
...
<body>
    ...
    <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "AMMINISTRAZIONE > Importa Organigramma" />
    <table width="95%" align="center">
        <tr>
            <td class="titolo" align="center" bgColor="#e0e0e0" height="20"><asp:label id="lbl_import" runat="server">Importazione organigramma da foglio Excel.</asp:label></td>
        </tr>
        <tr>
