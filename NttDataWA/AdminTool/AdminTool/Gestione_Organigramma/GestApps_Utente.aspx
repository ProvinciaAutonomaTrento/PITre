<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestApps_Utente.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_Organigramma.GestApps_Utente" %>
...
<body bottomMargin="2" leftMargin="2" topMargin="2" rightMargin="2" MS_POSITIONING="GridLayout">
    <form id="form_gestioneApplicazioni" runat="server">
        <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "AMMINISTRAZIONE > Gestione applicazioni per utente" />	
            ...
            <table height="390" cellSpacing="0" cellPadding="0" width="740" align="center" border="0">
				<tr>
					<td vAlign="top" align="center" width="58%">
						<!-- frame SX-->
						<table cellSpacing="0" cellPadding="0" border="0" style="width: 406px">
							<tr>
								<td class="style1" tabIndex="7" align="center" background="../Images/tasto_a.gif"
									height="25">Applicazioni</td>
						...
						<table class="contenitore">
							<tr>
								<td>
									...
									<DIV style="OVERFLOW: auto; HEIGHT: 331px"><asp:datagrid id="dg_applicazioni" tabIndex="3" runat="server" Width="400px" PageSize="15" AllowPaging="True"
											...
											<Columns>
												<asp:BoundColumn Visible="False" DataField="idApp" ReadOnly="True" HeaderText="idApp"></asp:BoundColumn>
					...
					<td vAlign="top" align="center" width="41%">
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td>
									<DIV style="OVERFLOW: auto; HEIGHT: 369px"><asp:label id="lbl_risultatoUtentiApps" tabIndex="4" CssClass="testo_grigio_scuro_grande"
											Runat="server" Visible="false">Nessuna applicazione associata.</asp:label><asp:datagrid id="dg_appute" tabIndex="5" runat="server" Width="285px" ShowHeader="False" BorderColor="Gray"
