...
<head runat="server">
    ...
    <script type="text/javascript">
			...
			{			
				...
				rtnValue = window.showModalDialog(myUrl,"","dialogWidth:460px;dialogHeight:600px;status:no;resizable:no;scroll:no;center:yes;help:no;"); 				
				Form1.hd_returnValueModal.value = rtnValue;								
				//window.document.Form1.submit();	
			}				
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" onunload="ClosePopUp()"
    ...
    <table style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" width="100%" border="0">
        <tr>
            <td>
                <!-- TESTATA CON MENU' -->
            ...
            <td valign="top" align="center" bgcolor="#f6f4f4" height="100%">
                <table cellspacing="0" cellpadding="0" border="0" style="width: 90%">
                                ...
                                <asp:DataGrid ID="dg_Utenti" TabIndex="7" runat="server" Width="100%" PageSize="6"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="ApplyPdfConvertionOnScan" DataField="ApplyPdfConvertionOnScan"
                                            Visible="False"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="AutenticatoLdap" DataField="AutenticatoLdap"
                                            Visible="False"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="DispositivoStampa" DataField="DispositivoStampa"
                                            Visible="False"></asp:BoundColumn>
                    ...
                    <tr>
                                ...
                                <table class="contenitore" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="testo_grigio_scuro" align="left" style="width: 25%" valign="middle">
                                            <asp:CheckBox ID="cb_abilitato" TabIndex="9" CssClass="testo" runat="server"></asp:CheckBox>
                                            <asp:CheckBox ID="chkUserPasswordNeverExpire" runat="server" Text="Nessuna scadenza" CssClass="testo" TextAlign="Left" />
                                            <asp:CheckBox ID="cb_abilitatoCentroServizi" CssClass="testo" runat="server" Text="Abilitato al Centro Servizi" TextAlign="Left"></asp:CheckBox>
                                            <!-- End Mev CS 1.4 - Esibizione: Flag utilizzato per definire se l'utente può fare Esibizione -->
                                            <asp:CheckBox ID="cb_abilitatoEsibizione" CssClass="testo" runat="server" Text="Abilitato Esibizione" TextAlign="Left"></asp:CheckBox>
                                            <!-- End Mev CS 1.4 - Esibizione -->
                                            <asp:CheckBox runat="server" ID="cbx_chiavi" CssClass="testo" Text="Abilita gestione chiavi conf." TextAlign="Left" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="testo_grigio_scuro" style="width: 25%">
                                            <asp:DropDownList ID="cb_amm" TabIndex="19" CssClass="testo" runat="server" AutoPostBack="True" Width="175px" />
                                            &nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 25%">
                                                ...
                                                <tr>
                                                <td class="style1">
                                                 <asp:RadioButton ID="rdbDisableAll" Text="Default amm." runat="server" 
                                                ...
                                                <asp:RadioButton ID="rdbIsEnabledActiveX" Text="ActiveX" runat="server" 
                                                        GroupName="ClientType"  AutoPostBack="true" CssClass="testo_grigio_scuro"  
                                                        OnCheckedChanged="chkIsEnabledSmartClient_OnCheckedChanged" /><br />
                                            ...
                                            <asp:CheckBox ID="chkSmartClientConvertPdfOnScan" runat="server" CssClass="testo_grigio_scuro" 
                                                ...
                                                <td>
                                                        <asp:DropDownList CssClass="testo" runat="server"  ID="ddlLabelPrinterType"></asp:DropDownList>
                                                  </td>
                                                </tr>
                                                </table>
                                        </td>
                                    ...
                                    <tr id="trLdapIntegrationDetail" runat="server">
                                        ...
                                        <td class="testo_grigio_scuro" colspan="3">
                                            ...
                                            <asp:CheckBox ID="chkAutenticatoLdap" runat="server" AutoPostBack="true" CssClass="testo" TextAlign="Left" Text="Autenticato in LDAP" OnCheckedChanged="chkAutenticatoLdap_OnCheckedChanged"/>
                                        </td>
                                    </tr>
                                    <tr>
					 ...
					 <cc2:MessageBox Width="1" Height="1" CssClass="testo_grigio" ID="msg_conferma" 
                            runat="server" ongetmessageboxresponse="msg_conferma_GetMessageBoxResponse" />
