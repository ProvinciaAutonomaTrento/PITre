<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LdapSyncronization.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_Utenti.LdapSyncronization" validateRequest="false" %>
                                        ...
                                        <asp:datagrid id="grdEsitoSincronizzazione" runat="server" 
                                            ...
                                            <Columns>
                                                <asp:TemplateColumn HeaderText="Utente">
	                                                ...
	                                                <ItemTemplate>
	                                                    <asp:Label ID="lblCellUtente" runat="server" Text='<%# this.GetUtenteCellText((SAAdminTool.DocsPaWR.LdapSyncronizationResponseItem) Container.DataItem) %>' />
	                                                </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn HeaderText="Esito">
	                                                ...
	                                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                                        Font-Strikeout="False" Font-Underline="False"></ItemStyle>
	                                                <ItemTemplate>
	                                                    <asp:Label ID="lblCellTipo" runat="server" Text='<%# this.GetEsitoSincronizzazioneCellText((SAAdminTool.DocsPaWR.LdapSyncronizationResponseItem) Container.DataItem) %>' />
	                                                </ItemTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
                                         </asp:datagrid>
