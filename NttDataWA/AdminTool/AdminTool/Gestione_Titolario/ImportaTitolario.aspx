<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportaTitolario.aspx.cs" Inherits="SAAdminTool.AdminTool.Gestione_Titolario.ImportaTitolario" %>
...
<head runat="server">
	...
	<script language="javascript">
		...
		function apriLog() 
		{			
		    var myUrl = "LogImportTitolario.aspx";				
...
<body>
    ...
    <table width="95%" align="center">
        <tr>
            <td class="titolo" align="center" bgColor="#e0e0e0" height="20"><asp:label id="lbl_import" runat="server">Importazione del titolario da foglio Excel.</asp:label></td>
        </tr>
        <tr>
