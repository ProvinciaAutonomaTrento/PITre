...
namespace SAAdminTool.AdminTool.Gestione_Ruoli
{
	/// <summary>
	...
	public class Utenti_TipoRuolo : System.Web.UI.Page
	{
		...
		private void Inizialize()
		{
			try
			{
				...
				SAAdminTool.AdminTool.Manager.TipiRuoloManager manager = new SAAdminTool.AdminTool.Manager.TipiRuoloManager();
		...
		/// <returns></returns>
		private string LoadUtenti(SAAdminTool.DocsPaWR.OrgRuolo ruolo)
		{
