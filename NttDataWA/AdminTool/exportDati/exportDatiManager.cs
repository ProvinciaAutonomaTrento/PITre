...
namespace SAAdminTool.exportDati
{
	...
	{		
        ...
        private SAAdminTool.DocsPaWR.Folder _folder = null;
        private string codFasc = "";

		private SAAdminTool.DocsPaWR.FiltroRicerca[][] _lstFiltri = null;
		private SAAdminTool.DocsPaWR.FiltroRicerca[] _lstFiltriTrasm = null;
        private SAAdminTool.DocsPaWR.FullTextSearchContext _context = null;
		private SAAdminTool.DocsPaWR.Ruolo _userRuolo = null;
		private SAAdminTool.DocsPaWR.InfoUtente _userInfo = null;
		private SAAdminTool.DocsPaWR.Utente _user = null;
		private SAAdminTool.DocsPaWR.FascicolazioneClassificazione _classificazione = null;
		private SAAdminTool.DocsPaWR.Registro _userReg = null;
