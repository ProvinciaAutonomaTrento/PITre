namespace ProtocollazioneIngresso.Smistamento
{
	...
	public class SmistaUO : System.Web.UI.UserControl
	{
		...
		{
            SAAdminTool.DocsPaWR.UOSmistamento[] listUO = GetListUOSmistamento(idRegistro, this.CreateMittenteSmistamento());
		...
		private void SetSessionListUO(SAAdminTool.DocsPaWR.UOSmistamento[] listUO)
		{
			Session["SmistaUO.ListUO"]=listUO;
		}

		private SAAdminTool.DocsPaWR.UOSmistamento[] GetSessionListUO()
		{
			return Session["SmistaUO.ListUO"] as SAAdminTool.DocsPaWR.UOSmistamento[];
		}
		...
		/// <returns></returns>
		private SAAdminTool.DocsPaWR.UOSmistamento[] GetListUOSmistamento(string idRegistro,SAAdminTool.DocsPaWR.MittenteSmistamento mittente)
		{
            SAAdminTool.DocsPaWR.DocsPaWebService ws = new SAAdminTool.DocsPaWR.DocsPaWebService();
		...
		public void SetDefaultButtonJSHandler(ImageButton btn)
		{
			foreach (DataGridItem itm in this.grdUOApp.Items)
			{
				...
				if (radioButton!=null)
					SAAdminTool.Utils.DefaultButton(this.Page,ref radioButton,ref btn);
