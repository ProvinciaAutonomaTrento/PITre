namespace ProtocollazioneIngresso.Scansione
{
	...
	public class AcquisizioneSmartClient : System.Web.UI.UserControl
	{
        ...
        //afiordi
        protected SAAdminTool.DocsPaWR.SmartClientConfigurations SmartClientConfigurations
        {
            get
            {
                if (this.ViewState["SmartClientConfigurations"] == null)
                    this.ViewState["SmartClientConfigurations"] = SAAdminTool.SmartClient.Configurations.GetConfigurationsPerUser();
                return (SAAdminTool.DocsPaWR.SmartClientConfigurations)this.ViewState["SmartClientConfigurations"];
			}
		}
