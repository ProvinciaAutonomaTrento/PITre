...
namespace ProtocollazioneIngresso
{
    ...
    /// </summary>
    public class Protocollazione : SAAdminTool.CssPage
    {
        //Andrea
        ...
        protected SAAdminTool.UserControls.Calendar txtDataArrivoProt;
        ...
        protected SAAdminTool.UserControls.Calendar txtDataProtocolloMittente;
        ...
        private SAAdminTool.DocsPaWR.Registro[] _registriAperti = null;
        ...
        protected SAAdminTool.documento.Oggetto ctrl_oggetto;
        ...
        protected SAAdminTool.DocsPaWR.Registro regSelezionato;
        ...
        protected SAAdminTool.Note.DettaglioNota dettaglioNota;
        ...
        protected SAAdminTool.UserControls.RubricaVeloce rubrica_veloce;
        protected SAAdminTool.UserControls.RubricaVeloce rubrica_veloce_destinatario;
        protected SAAdminTool.UserControls.RubricaVeloce rubrica_veloce_destinatario_mittente_uscita;
        protected SAAdminTool.UserControls.RubricaVeloce rubrica_mitt_multiplo_semplificato;
        ...
        private void InitializeComponent()
        {
            ...
            this.ctrl_oggetto.OggettoChangedEvent += new SAAdminTool.documento.Oggetto.OggettoChangedDelegate(this.ctrl_oggetto_OggChanged);
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NUOVO_FASC_DIRECT") != null && SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NUOVO_FASC_DIRECT").Equals("1"))
            {
            ...
            string valoreChiaveFasc = SAAdminTool.utils.InitConfigurationKeys.GetValue(idAmm, "FE_FASC_RAPIDA_REQUIRED");
            ...
            if (tipoProto != null)
            {
                switch (tipoProto)
                {
                    case "A": // PROTOCOLLO IN INGRESSO
                        ...
                        if (!string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NEW_RUBRICA_VELOCE")) && (SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NEW_RUBRICA_VELOCE")).Equals("1"))
                        {
          ...
          * */
            ...
            SAAdminTool.DocsPaWR.FascicolazioneClassificazione classificazione = DocumentManager.getClassificazioneSelezionata(this);
            if (classificazione != null && !string.IsNullOrEmpty(classificazione.codice))
            {
                ...
                SAAdminTool.DocsPaWR.Registro registroCorrente = this.GetRegistroCorrente();
        ...
        private bool CheckExistenzaRagioniSmistamento(out RagioneTrasmissione[] listaRagioniSmistamento)
        {
            ...
            bool retValue = false;
            if (SAAdminTool.smistaDoc.SmistaDocSessionManager.ExistSessionRagTrasm())
            {
                retValue = true;
            }
            else
            {
                SAAdminTool.smistaDoc.SmistaDocManager docManager = new SAAdminTool.smistaDoc.SmistaDocManager();
                ...
                if (retValue)
                    SAAdminTool.smistaDoc.SmistaDocSessionManager.SetSessionRagTrasm();
            }
            return retValue;
        }
            ...
            if (ConfigSettings.getKey(ConfigSettings.KeysENUM.MITTENTE_DEFAULT) != null && this.txtDescMittUsc.Text.Equals("") && this.txtCodMittUsc.Text.Equals("") && schedaDocumento != null)
            {
                ...
                if (schedaDocumento != null && schedaDocumento.protocollo != null)
                {
                    if (schedaDocumento.tipoProto == "P")
                        corrMitt = ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).mittente;
            ...
            else if (ConfigSettings.getKey(ConfigSettings.KeysENUM.MITTENTE_DEFAULT) != null && schedaDocumento != null)
            {
                ...
                if (schedaDocumento != null && schedaDocumento.protocollo != null)
                {
                    if (schedaDocumento.tipoProto.Equals("P"))
                        ...
                        corrMitt = ((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittente;
                }
                string descrizione = txtCodMittUsc.Text.Trim();                
                ...
                if (mittenteDefault == "1" && !(corrMitt != null && corrMitt.descrizione != null && corrMitt.descrizione != ""))
                {
                    if (UserManager.getRuolo(this) != null)
                    {
                        ...
                        if (corr != null)
                        {
                            ...
                            {
                                ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).mittente = corr;
                            }
                        }
                    }
                }
              ...
              /*  if (listaTipologiaAtto.Length == 1)
                {
                    ...
                    TipologiaAtto tipologiaAtto = new SAAdminTool.DocsPaWR.TipologiaAtto();
        ...
        /// </summary>
        /// <returns></returns>
        protected SAAdminTool.documento.AclDocumento GetControlAclDocumento()
        {
            return (SAAdminTool.documento.AclDocumento)this.FindControl("aclDocumento");
        }
        ...
        {
            DiagrammaStato dg = (SAAdminTool.DocsPaWR.DiagrammaStato)Session["DiagrammaSelezionato"];
            for (int i = 0; i < dg.STATI.Length; i++)
            {
                Stato st = (SAAdminTool.DocsPaWR.Stato)dg.STATI[i];
        ...
        private void effettuaTrasmissione(SAAdminTool.DocsPaWR.ModelloTrasmissione modello, string idStato)
        {
            Trasmissione trasmissione = new SAAdminTool.DocsPaWR.Trasmissione();
            ...
            {
                trasmissione.tipoOggetto = SAAdminTool.DocsPaWR.TrasmissioneTipoOggetto.DOCUMENTO;
                trasmissione.infoDocumento = DocumentManager.getInfoDocumento(schedaDocumento);
            }
            else
            {
                trasmissione.tipoOggetto = SAAdminTool.DocsPaWR.TrasmissioneTipoOggetto.FASCICOLO;
            ...
            {
                RagioneDest ragDest = (SAAdminTool.DocsPaWR.RagioneDest)modello.RAGIONI_DESTINATARI[i];
                ArrayList destinatari = new ArrayList(ragDest.DESTINATARI);
                for (int j = 0; j < destinatari.Count; j++)
                {
                    MittDest mittDest = (SAAdminTool.DocsPaWR.MittDest)destinatari[j];
            ...
            if (infoUtente.delegato != null)
                trasmissione.delegato = ((SAAdminTool.DocsPaWR.InfoUtente)(infoUtente.delegato)).idPeople;
                ...
                switch (this.numeroRuoliDestInTrasmissione)
                {
                    ...
                    case 1:
                        ...
                        else
                        {
                            ...
                            trasmissione.cessione.idRuoloNewPropr = ((SAAdminTool.DocsPaWR.Ruolo)trasmissione.trasmissioniSingole[0].corrispondenteInterno).idGruppo;
        ...
        private SAAdminTool.DocsPaWR.Trasmissione addTrasmissioneSingola(SAAdminTool.DocsPaWR.Trasmissione trasmissione, SAAdminTool.DocsPaWR.Corrispondente corr, SAAdminTool.DocsPaWR.RagioneTrasmissione ragione, string note, string tipoTrasm, int scadenza)
        {
            if (trasmissione.trasmissioniSingole != null)
            {
                ...
                for (int i = 0; i < trasmissione.trasmissioniSingole.Length; i++)
                {
                    TrasmissioneSingola ts = (SAAdminTool.DocsPaWR.TrasmissioneSingola)trasmissione.trasmissioniSingole[i];
            ...
            TrasmissioneSingola trasmissioneSingola = new SAAdminTool.DocsPaWR.TrasmissioneSingola();
            ...
            if (corr is SAAdminTool.DocsPaWR.Ruolo)
            {
                ...
                else
                {
                    ...
                    {
                        TrasmissioneUtente trasmissioneUtente = new SAAdminTool.DocsPaWR.TrasmissioneUtente();
            ...
            if (corr is SAAdminTool.DocsPaWR.Utente)
            {
            ...
            if (corr is SAAdminTool.DocsPaWR.UnitaOrganizzativa)
            {
                UnitaOrganizzativa theUo = (SAAdminTool.DocsPaWR.UnitaOrganizzativa)corr;
                ...
                {
                    foreach (SAAdminTool.DocsPaWR.Ruolo r in ruoli)
        ...
        private SAAdminTool.DocsPaWR.Corrispondente[] queryUtenti(SAAdminTool.DocsPaWR.Corrispondente corr)
        {
            ...
            AddressbookQueryCorrispondente qco = new SAAdminTool.DocsPaWR.AddressbookQueryCorrispondente();
        ...
        private void Page_PreRender(object sender, System.EventArgs e)
        {
            ...
            SAAdminTool.DocsPaWR.Fascicolo fasc = FascicoliManager.getFascicoloSelezionatoFascRapida(this);
            if (fasc != null)
            {
        ...
        private void popolaComboBoxStatiSuccessivi(SAAdminTool.DocsPaWR.Stato stato, SAAdminTool.DocsPaWR.DiagrammaStato diagramma)
        {
            //Inizializzazione
            ...
            if (stato == null)
            {
                ...
                {
                    Stato st = (SAAdminTool.DocsPaWR.Stato)diagramma.STATI[i];
            ...
            else
            {
                ...
                {
                    Passo step = (SAAdminTool.DocsPaWR.Passo)diagramma.PASSI[i];
                    if (step.STATO_PADRE.SYSTEM_ID == stato.SYSTEM_ID)
                    {
                        for (int j = 0; j < step.SUCCESSIVI.Length; j++)
                        {
                            Stato st = (SAAdminTool.DocsPaWR.Stato)step.SUCCESSIVI[j];
                            ListItem item = new ListItem(st.DESCRIZIONE, Convert.ToString(st.SYSTEM_ID));
                            ddl_statiSuccessivi.Items.Add(item);
                        }
                    }
        ...
        {
            SAAdminTool.Utils.DefaultButton(this, ref this.cboRegistriDisponibili, ref this.btnProtocolla);
            ctrl_oggetto.DefButton_Ogg(ref this.btnProtocolla);
            if (isFascRapidaRequired)
                SAAdminTool.Utils.DefaultButton(this, ref this.txt_CodFascicolo, ref this.btnProtocolla);
        ...
        {
            SAAdminTool.Utils.DefaultButton(this, ref this.txtCodMittente, ref this.btnProtocolla);
            if (string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NEW_RUBRICA_VELOCE")) || !(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NEW_RUBRICA_VELOCE")).Equals("1"))
            {
                SAAdminTool.Utils.DefaultButton(this, ref this.txtDescrMittente, ref this.btnProtocolla);
            }
            SAAdminTool.Utils.DefaultButton(this, ref this.txtDescrProtMittente, ref this.btnProtocolla);
            ...
            //            SAAdminTool.Utils.DefaultButton(this, ref this.txtDataProtocolloMittente, ref this.btnProtocolla);
            //            SAAdminTool.Utils.DefaultButton(this, ref this.txtDataArrivoProt, ref this.btnProtocolla);

            if (isFascRapidaRequired)
                SAAdminTool.Utils.DefaultButton(this, ref this.txt_CodFascicolo, ref this.btnProtocolla);

            if (isTipologiaDocumentoRequired)
                SAAdminTool.Utils.DefaultButton(this, ref ddl_tipoAtto, ref this.btnProtocolla);
        }
        ...
        {
            SAAdminTool.Utils.DefaultButton(this, ref this.txtCodDest, ref this.btnProtocolla);
            if (string.IsNullOrEmpty(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NEW_RUBRICA_VELOCE")) || !(SAAdminTool.utils.InitConfigurationKeys.GetValue("0", "FE_NEW_RUBRICA_VELOCE")).Equals("1"))
            {
                SAAdminTool.Utils.DefaultButton(this, ref this.txtDescrDest, ref this.btnProtocolla);
            }
            if (isFascRapidaRequired)
                SAAdminTool.Utils.DefaultButton(this, ref this.txt_CodFascicolo, ref this.btnProtocolla);
        ...
        private SAAdminTool.DocsPaWR.UOSmistamento[] GetSessionSelectedUO()
        {
            return Session["Protocollazione.SelectedUO"] as SAAdminTool.DocsPaWR.UOSmistamento[];
        }
        ...
        private bool checkFasc()
        {
            ...
            if (this.isFascRapidaRequired)
            {
                ...
                {
                    SAAdminTool.DocsPaWR.Fascicolo fasc = this.getFascicolo();
                    if (fasc == null)
                        retValue = false;
                }
            }
        ...
        private bool PerformActionProtocollaDocumento()
        {
            ...
            if (this.IsValidRequiredData(out validationItems, out firstInvalidControlID) && this.checkFasc())
            {
                ...
                if (!string.IsNullOrEmpty(settingValue) && settingValue == "1")
                {
                    ...
                    if (Session["template"] != null)
                    {
                        if (!ProfilazioneDocManager.verificaCampiObbligatori((SAAdminTool.DocsPaWR.Templates)Session["template"]))
                        {
                            //wws.salvaInserimentoUtenteProfDim(UserManager.getInfoUtente(this), (Templates)Session["template"], schedaDocumento.docNumber, "");
                            schedaDocumento.template = (SAAdminTool.DocsPaWR.Templates)Session["template"];
        ...
        private void btnAcquireAttach_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            SchedaDocumento dp = this.GetProtocolloManager().GetDocumentoCorrente();
            DocumentManager.setDocumentoSelezionato(dp);
            SAAdminTool.DocsPaWR.Allegato[] allegati = DocumentManager.getAllegati(dp, string.Empty);
        ...
        private string GetCssAmministrazione()
        {
            ...
            if ((string)Session["AMMDATASET"] != null)
            {
                ...
                SAAdminTool.UserManager userM = new UserManager();
        ...
        /// </summary>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.Registro GetRegistroCorrente()
        {
        ...
        /// </summary>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.Registro[] GetRegistriAperti()
        {
        ...
        {
            SAAdminTool.DocsPaWR.Registro[] registri = this.GetRegistriAperti();
        ...
        private void CreateNewDocument(bool leaveCurrentData, string tipoProto)
        {
            ...
            SAAdminTool.DocsPaWR.SchedaDocumento currentDoc = this.GetProtocolloManager().GetDocumentoCorrente();
            ...
            else
            {
                ...
                if (tipoProto.Equals("A"))
                {
                    ...
                    protocolloMng.GetDocumentoCorrente().protocollo = new SAAdminTool.DocsPaWR.ProtocolloEntrata();
                    //this.dettaglioNota.AttatchPulsanteConferma(this.btnProtocolla.ClientID);
                    this.dettaglioNota.Fetch();
                }
                else
                {
                    ...
                    protocolloMng.GetDocumentoCorrente().protocollo = new SAAdminTool.DocsPaWR.ProtocolloUscita();
                    //this.dettaglioNota.AttatchPulsanteConferma(this.btnProtocolla.ClientID);
                    this.dettaglioNota.Fetch();
                    SettaMittenteDefault(true);
                }
        ...
        {
            SAAdminTool.DocsPaWR.SchedaDocumento currentDoc = this.GetProtocolloManager().GetDocumentoCorrente();
            SAAdminTool.DocsPaWR.Oggetto oggetto = new SAAdminTool.DocsPaWR.Oggetto();
        ...
        private bool IsValidRequiredData(out ArrayList validationItems, out string firstInvalidControlID)
        {
            ...
            {
                isValidDataProt = SAAdminTool.Utils.isDate(this.txtDataProtocollo.Text);
            ...
            if (tipoProto.Equals("A"))
            {
                ...
                {
                    isValidDataProtMittente = SAAdminTool.Utils.isDate(this.GetCalendarControl("txtDataProtocolloMittente").txt_Data.Text);
                ...
                {
                    isValidDataArrivoProtMittente = SAAdminTool.Utils.isDate(this.GetCalendarControl("txtDataArrivoProt").txt_Data.Text);
            ...
            if (tipoProto.Equals("P"))
            {
                ...
                {
                    ProtocollazioneIngresso.Protocollo.ProtocolloMng protocolloMng = this.GetProtocolloManager();
                    SAAdminTool.DocsPaWR.SchedaDocumento documento = protocolloMng.GetDocumentoCorrente();
                    if (documento != null)
                    {
                        Corrispondente temp = new Corrispondente();
                        if ((((SAAdminTool.DocsPaWR.ProtocolloUscita)documento.protocollo).mittente) != null && ((SAAdminTool.DocsPaWR.ProtocolloUscita)documento.protocollo).mittente.tipoCorrispondente=="O")
                        {
                            retValue = false;
        ...
        private bool ContainsDocumento()
        {
            ...
            SAAdminTool.DocsPaWR.InfoProtocolloDuplicato[] infoProtocolloDuplicato;

            SAAdminTool.DocsPaWR.EsitoRicercaDuplicatiEnum containsDocumento = this.GetProtocolloManager().ContainsDocumento(out infoProtocolloDuplicato);

            if (containsDocumento != SAAdminTool.DocsPaWR.EsitoRicercaDuplicatiEnum.NessunDuplicato)
            {
                // Disabilitazione pulsante protocollazione
                this.RegisterClientScript("EnableButtonProtocollazione", "EnableButtonProtocollazione(false);");
        ...
        /// </summary>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.EsitoSmistamentoDocumento[] SmistaDocumentoCorrente()
        {
            SAAdminTool.DocsPaWR.EsitoSmistamentoDocumento[] retValue = null;
        ...
        private void ShowMessageDocumentiNonSmistati(SAAdminTool.DocsPaWR.EsitoSmistamentoDocumento[] esito)
        {
            string message = string.Empty;

            foreach (SAAdminTool.DocsPaWR.EsitoSmistamentoDocumento item in esito)
            {
        ...
        private bool ProtocollaDocumentoCorrente(out string errorMessage)
        {
            ...
            if (retValue)
            {
                ...
                if (!string.IsNullOrEmpty(settingValue) && settingValue == "1")
                {
                    ...
                    {
                        if (!ProfilazioneDocManager.verificaCampiObbligatori((SAAdminTool.DocsPaWR.Templates)Session["template"]))
                            documento.template = (SAAdminTool.DocsPaWR.Templates)Session["template"];
                    }
                    ...
                    if (System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] != null && System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] == "1")
                    {
                        if (Session["DiagrammaSelezionato"] != null && ddl_statiSuccessivi.SelectedItem.Value != "")
                        {
                            ...
                            {
                                if (SAAdminTool.CheckInOut.CheckInOutServices.IsCheckedOutDocument())
                                {
                            ...
                            if (DiagrammiManager.isStatoAuto(ddl_statiSuccessivi.SelectedItem.Value, Convert.ToString(((SAAdminTool.DocsPaWR.DiagrammaStato)Session["DiagrammaSelezionato"]).SYSTEM_ID),this))
                            {
                            ...
                            {
                                DiagrammiManager.salvaModificaStato(documento.docNumber, ddl_statiSuccessivi.SelectedItem.Value, (SAAdminTool.DocsPaWR.DiagrammaStato)Session["DiagrammaSelezionato"], UserManager.getInfoUtente(this).userId, UserManager.getInfoUtente(this), txt_dataScadenza.Text,this);
                ...
                {
                    SAAdminTool.DocsPaWR.Fascicolo fasc = this.getFascicolo();
                    SAAdminTool.DocsPaWR.Folder selectedFolder = FascicoliManager.getFolder(this, fasc);

                    string idDoc = protocolloMng.GetDocumentoCorrente().systemId;

                    bool isInFolder = false;
                    string msg = string.Empty;
                    SAAdminTool.DocsPaWR.SchedaDocumento currentDocument = protocolloMng.GetDocumentoCorrente();
                ...
                SAAdminTool.DocsPaWR.EsitoSmistamentoDocumento[] esitoSmistamento = this.SmistaDocumentoCorrente();
        ...
        private bool AutoPrintSignature()
        {
            ...
            try
            {
                string configValue = SAAdminTool.ConfigSettings.getKey(SAAdminTool.ConfigSettings.KeysENUM.PROTOINGRESSO_STAMPA_ETICHETTA_AUTO);
        ...
        {
            string valoreChiaveDB = SAAdminTool.utils.InitConfigurationKeys.GetValue(UserManager.getInfoUtente().idAmministrazione, "FE_ENABLE_PROT_RAPIDA_NO_UO");
        ...
        private void RefreshDatiNuovoProtocollo(SAAdminTool.DocsPaWR.SchedaDocumento schedaDocumento)
        {
            ...
            {
                SAAdminTool.DocsPaWR.ProtocolloEntrata protocolloEntrata = schedaDocumento.protocollo as SAAdminTool.DocsPaWR.ProtocolloEntrata;
            ...
            {
                SAAdminTool.DocsPaWR.ProtocolloUscita protocolloUscita = schedaDocumento.protocollo as SAAdminTool.DocsPaWR.ProtocolloUscita;
        ...
        private void RefreshSchedaDocumentoFromUI()
        {
            ...
            SAAdminTool.DocsPaWR.ProtocolloEntrata protocolloEntrata = (SAAdminTool.DocsPaWR.ProtocolloEntrata)currentDocument.protocollo;
            ...
            {
                SAAdminTool.DocsPaWR.Documento[] docs = new SAAdminTool.DocsPaWR.Documento[1];
                docs[0] = new SAAdminTool.DocsPaWR.Documento();
                currentDocument.documenti = docs;
            }

            SAAdminTool.DocsPaWR.Documento doc = ((SAAdminTool.DocsPaWR.Documento)currentDocument.documenti[0]);
        ...
        private void RefreshSchedaDocumentoUscitaFromUI()
        {
            ...
            // Creazione oggetto protocollo per la scheda documento
            SAAdminTool.DocsPaWR.ProtocolloUscita protocolloUscita = (SAAdminTool.DocsPaWR.ProtocolloUscita)currentDocument.protocollo;
        ...
        {
            string valoreChiaveDB = SAAdminTool.utils.InitConfigurationKeys.GetValue(UserManager.getInfoUtente().idAmministrazione, "FE_SMISTA_ABILITA_TRASM_RAPIDA");
            // Se il valore è diverso da null oppure è "1" allora ritorna true, altrimenti torna false;
        ...
        private bool IsEnabledNewRubrica()
        {
            ...
            string configValue = SAAdminTool.ConfigSettings.getKey(SAAdminTool.ConfigSettings.KeysENUM.RUBRICA_V2);
        ...
        private SAAdminTool.DocsPaWR.Corrispondente GetCorrispondenteDaCodice(string codCorrispondente)
        {
            SAAdminTool.DocsPaWR.Corrispondente retValue = null;

            if (codCorrispondente != null)
            {
                retValue = SAAdminTool.UserManager.getCorrispondente(this, codCorrispondente, true);
            }
        ...
        private void SetCorrispondenteInProtocollo(SAAdminTool.DocsPaWR.Corrispondente corrispondente)
        {
            SAAdminTool.DocsPaWR.SchedaDocumento schedaDoc = this.GetProtocolloManager().GetDocumentoCorrente();
            if (schedaDoc != null)
                ((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDoc.protocollo).mittente = corrispondente;
        }
        /// <summary>
        /// Impostazione oggetto corrisponente mittente nel protocollo in uscita corrente        
        /// </summary>
        /// <param name="corrispondente"></param>
        private void SetCorrispondenteMittenteInProtocolloUscita(SAAdminTool.DocsPaWR.Corrispondente corrispondente)
        {
            SAAdminTool.DocsPaWR.SchedaDocumento schedaDoc = this.GetProtocolloManager().GetDocumentoCorrente();
            if (schedaDoc != null)
                ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDoc.protocollo).mittente = corrispondente;
        }




        private void SetCorrispondentiUscitaInProtocollo(SAAdminTool.DocsPaWR.Corrispondente[] corrispondenti)
        {
            SAAdminTool.DocsPaWR.SchedaDocumento schedaDoc = this.GetProtocolloManager().GetDocumentoCorrente();
            if (schedaDoc != null)
            {
                ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDoc.protocollo).destinatari = corrispondenti;

            }
        }

        private void SetCorrispondentiConoscenzaUscitaInProtocollo(SAAdminTool.DocsPaWR.Corrispondente[] corrispondenti)
        {
            SAAdminTool.DocsPaWR.SchedaDocumento schedaDoc = this.GetProtocolloManager().GetDocumentoCorrente();
            if (schedaDoc != null)
            {
                ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDoc.protocollo).destinatariConoscenza = corrispondenti;
        ...
        private void SetMittenteOccasionale()
        {
            ...
            SAAdminTool.DocsPaWR.ProtocolloEntrata protocolloEntrata = currentDoc.protocollo as SAAdminTool.DocsPaWR.ProtocolloEntrata;

            if (protocolloEntrata != null)
            {
                SAAdminTool.DocsPaWR.Corrispondente mittente = null;

                if (this.txtDescrMittente.Text != string.Empty)
                {
                    // Creazione oggetto mittente occasionale
                    mittente = new SAAdminTool.DocsPaWR.Corrispondente();
        ...
        private void SetMittenteOccasionaleInProtoUscita()
        {
            ...
            SAAdminTool.DocsPaWR.ProtocolloUscita protocolloUscita = currentDoc.protocollo as SAAdminTool.DocsPaWR.ProtocolloUscita;
        ...
        private void FillDatiCorrispondente()
        {
            ...
            SAAdminTool.DocsPaWR.SchedaDocumento currentDocument = this.GetProtocolloManager().GetDocumentoCorrente();

            if (currentDocument != null)
            {
                SAAdminTool.DocsPaWR.ProtocolloEntrata protocolloEntrata = currentDocument.protocollo as SAAdminTool.DocsPaWR.ProtocolloEntrata;
        ...
        private void FillDatiCorrispondenteMittenteInUscita()
        {
            ...
            if (currentDocument != null)
            {
                SAAdminTool.DocsPaWR.ProtocolloUscita protocolloUscita = currentDocument.protocollo as SAAdminTool.DocsPaWR.ProtocolloUscita;
        ...
        private void txtCodMittente_TextChanged(object sender, System.EventArgs e)
        {
            ...
            SAAdminTool.DocsPaWR.Corrispondente corrispondente = null;
            ElementoRubrica[] listaCorr = null;
            RubricaCallType calltype = new SAAdminTool.DocsPaWR.RubricaCallType();
            SAAdminTool.DocsPaWR.SchedaDocumento schDoc= this.GetProtocolloManager().GetDocumentoCorrente();
            if (Session["dictionaryCorrispondente"] != null)
            {
            ...
            {
                if (((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittente != null && !checkDuplicatiMittMultipli(((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittente, lbx_mittMultiplo))
                {
                    ...
                    ((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).daAggiornareMittente = false;
                    ((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittente = null;
                    this.txtCodMittente.Text = string.Empty;
                    this.txtDescrMittente.Text = string.Empty;
                }
            }
        ...
        private void setDescrizioneCorrispondenteUscita(string tipoCorr)
        {
            ...
            SAAdminTool.DocsPaWR.ElementoRubrica er;
            SAAdminTool.DocsPaWR.RubricaCallType calltype;

            if (tipoCorr.Equals("Dest"))
            {
                //caso del destinatario in uscita
                calltype = SAAdminTool.DocsPaWR.RubricaCallType.CALLTYPE_PROTO_USCITA_SEMPLIFICATO;
                codiceRubrica = this.txtCodDest.Text;
            }
            else
            {
                //caso del mittente in uscita
                calltype = SAAdminTool.DocsPaWR.RubricaCallType.CALLTYPE_PROTO_OUT_MITT_SEMPLIFICATO;
            ...
            if (codiceRubrica.Trim() != string.Empty)
            {
                ...
                else
                {
                    if (tipoCorr.Equals("Dest"))
                    {
                        ...
                        {
                            SAAdminTool.DocsPaWR.SmistamentoRubrica smistaRubrica = creaSmistamentoRubrica(calltype);
                        ...
                        if (System.Configuration.ConfigurationManager.AppSettings["LISTE_DISTRIBUZIONE"] != null && System.Configuration.ConfigurationManager.AppSettings["LISTE_DISTRIBUZIONE"] == "1")
                        {
                            ...
                            if (lsCorr.Count != 0)
                            {
                                corr = new SAAdminTool.DocsPaWR.Corrispondente();
        ...
        private SAAdminTool.DocsPaWR.SmistamentoRubrica creaSmistamentoRubrica(SAAdminTool.DocsPaWR.RubricaCallType calltype)
        {
            //popolamento oggetto per RUBRICA_USA_PROTO_SMISTAMENTO
            SAAdminTool.DocsPaWR.SmistamentoRubrica smistamentoRubrica = new SAAdminTool.DocsPaWR.SmistamentoRubrica();
            ...
            //callType
            smistamentoRubrica.calltype = SAAdminTool.DocsPaWR.RubricaCallType.CALLTYPE_PROTO_USCITA_SEMPLIFICATO;

            //InfoUtente
            SAAdminTool.DocsPaWR.InfoUtente infoUt = new SAAdminTool.DocsPaWR.InfoUtente();
        ...
        private void ctrl_oggetto_OggChanged(object sender, SAAdminTool.documento.Oggetto.OggTextEvent e)
        {
            // Creazione nuovo oggetto
        ...
        private void txt_cod_fasc_TextChanged(object sender, System.EventArgs e)
        {
            ...
            if (this.txt_CodFascicolo.Text.IndexOf("//") > -1)
            {
                ...
                SAAdminTool.DocsPaWR.Fascicolo SottoFascicolo = getFolder(UserManager.getRegistroSelezionato(this), ref codice, ref descrizione);
            ...
            {
                SAAdminTool.DocsPaWR.Fascicolo[] listaFasc = getFascicoli(UserManager.getRegistroSelezionato(this));
                    ...
                    if (listaFasc.Length > 0)
                    {
                        ...
                        if (listaFasc.Length == 1)
                        {
                            ...
                            else
                            {
                                ...
                                SAAdminTool.DocsPaWR.FascicolazioneClassifica[] gerClassifica = FascicoliManager.getGerarchia(this, listaFasc[0].idClassificazione, UserManager.getUtente(this).idAmministrazione);
        ...
        /// <param name="registro"></param>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.Fascicolo getFolder(SAAdminTool.DocsPaWR.Registro registro, ref string codice, ref string descrizione)
        {
            SAAdminTool.DocsPaWR.Folder[] listaFolder = null;
            SAAdminTool.DocsPaWR.Fascicolo fasc = null;
            string separatore = "//";
        ...
        /// </summary>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.Fascicolo[] getFascicoli(SAAdminTool.DocsPaWR.Registro registro)
        {
            SAAdminTool.DocsPaWR.Fascicolo[] listaFasc = null;
            if (!this.txt_CodFascicolo.Text.Equals(""))
            {
        ...
        private void imgFasc_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ...
            if (fasc != null)
            {
                if (this.txt_CodFascicolo.Text != "" && this.txt_DescFascicolo.Text != "")
                {
                    ...
                    {
                        ///se il fascicolo è procedimentale, ricerco la classifica a cui appartiene
                        SAAdminTool.DocsPaWR.FascicolazioneClassifica[] gerClassifica = FascicoliManager.getGerarchia(this, fasc.idClassificazione, UserManager.getUtente(this).idAmministrazione);
                        string codiceGerarchia = gerClassifica[gerClassifica.Length - 1].codice;
  ...
  */
            ...
            {
                SAAdminTool.DocsPaWR.Fascicolo fascSel = getFascicolo();
                if (fascSel != null)
                {
                    ...
                    {
                        ///se il fascicolo è procedimentale, ricerco la classifica a cui appartiene
                        SAAdminTool.DocsPaWR.FascicolazioneClassifica[] gerClassifica = FascicoliManager.getGerarchia(this, fascSel.idClassificazione, UserManager.getUtente(this).idAmministrazione);
                        string codiceGerarchia = gerClassifica[gerClassifica.Length - 1].codice;
                        RegisterStartupScript("openModale", "<script>ApriRicercaFascicoli('" + codiceGerarchia + "')</script>");
                    }
                }
        ...
        {
            regSelezionato = UserManager.getRegistroSelezionato(this);
            SAAdminTool.DocsPaWR.DocsPaWebService wws = new DocsPaWebService();
            //SAAdminTool.DocsPaWR.SchedaDocumento currentDocument = this.GetProtocolloManager().GetDocumentoCorrente();
        ...
        /// </summary>
        /// <returns></returns>
        private SAAdminTool.DocsPaWR.Fascicolo getFascicolo()
        {

            SAAdminTool.DocsPaWR.Fascicolo fascicoloSelezionato = null;
        ...
        {
            SAAdminTool.DocsPaWR.Fascicolo fascRap = new Fascicolo();
            if (isRiproposto)
            {
        ...
        {
            string valoreChiaveDB = SAAdminTool.utils.InitConfigurationKeys.GetValue(UserManager.getInfoUtente().idAmministrazione, "FE_PROTOIN_ACQ_DOC_OBBLIGATORIA");
        ...
        private void SetWebConfigConfigurations()
        {
            ...
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    documentPDFConvert = Convert.ToBoolean(SAAdminTool.ConfigSettings.getKey(SAAdminTool.ConfigSettings.KeysENUM.DOCUMENT_PDF_CONVERT));
                    documentPDFConvertEnabled = Convert.ToBoolean(SAAdminTool.ConfigSettings.getKey(SAAdminTool.ConfigSettings.KeysENUM.DOCUMENT_PDF_CONVERT_ENABLED));
                    documentoPDFConverterServer = Convert.ToBoolean(SAAdminTool.Utils.isEnableConversionePdfLatoServer());
                }
                catch
                {
                }
            ...
            this.txtSmartClientActivation.Value = SAAdminTool.SmartClient.Configurations.IsActive().ToString().ToLower();
        }
        ...
        private void setListBoxDestinatari(SAAdminTool.DocsPaWR.ProtocolloUscita protocolloUscita)
        {
            //Valido per i documenti in Partenza
            SAAdminTool.DocsPaWR.Corrispondente destinatario;
            this.lbx_dest.Items.Clear();
            this.lbx_destCC.Items.Clear();
        ...
        private void addDestinatari(int index, string tipoDest)
        {
            ...
            SAAdminTool.DocsPaWR.Corrispondente[] listaDest;
            SAAdminTool.DocsPaWR.Corrispondente[] listaDestCC;
            SAAdminTool.DocsPaWR.Corrispondente corr;
        ...
        private void removeDestinatari(int index, string tipoDest, SAAdminTool.DocsPaWR.SchedaDocumento schedaDocumento)
        {
            SAAdminTool.DocsPaWR.Corrispondente[] listaDest;

            if (tipoDest.Equals("P"))
            {
                listaDest = ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).destinatari;
                ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).destinatari = UserManager.removeCorrispondente(listaDest, index);

            }
            else
                if (tipoDest.Equals("C"))
                {
                    listaDest = ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).destinatariConoscenza;
                    ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).destinatariConoscenza = UserManager.removeCorrispondente(listaDest, index);
                }
        ...
        private void aggiungiDestinatariDaCodice()
        {
            ...
            if (corr != null)
            {
                SAAdminTool.DocsPaWR.Corrispondente[] listaDestCC = (protocolloUscita).destinatariConoscenza;
                if (!UserManager.esisteCorrispondente(listaDestCC, corr))
                {
                    SAAdminTool.DocsPaWR.Corrispondente[] listaDest = (protocolloUscita).destinatari;
        ...
        private void inserisciDestinatarioAutomatico(SAAdminTool.DocsPaWR.Corrispondente corr, SAAdminTool.DocsPaWR.SchedaDocumento currentDocument)
        {
            if (corr != null)
            {
                SAAdminTool.DocsPaWR.ProtocolloUscita protocolloUscita = (SAAdminTool.DocsPaWR.ProtocolloUscita)(currentDocument.protocollo);
        ...
        private void completaProtocollazione(SAAdminTool.DocsPaWR.SchedaDocumento currentDocument)
        {
            string message = "";
        ...
        protected SAAdminTool.documento.Oggetto GetControlOggetto()
        {
            return (SAAdminTool.documento.Oggetto)this.FindControl("ctrl_oggetto");
        }
        ...
        private bool CheckDestinatariInterni()
        {
            ...
            SAAdminTool.DocsPaWR.Registro regSelezionato = UserManager.getRegistroSelezionato(this);
            //if (regSelezionato == null)
            //{
            //    regSelezionato = UserManager.getRegistroSelezionato(this);
            //}
            if(schedaDocumento!=null){
                if (schedaDocumento.protocollo.GetType() == typeof(SAAdminTool.DocsPaWR.ProtocolloInterno))
                {
                    listaDest = ((SAAdminTool.DocsPaWR.ProtocolloInterno)schedaDocumento.protocollo).destinatari;
                    listaDestCC = ((SAAdminTool.DocsPaWR.ProtocolloInterno)schedaDocumento.protocollo).destinatariConoscenza;
                }

                if (schedaDocumento.protocollo.GetType() == typeof(SAAdminTool.DocsPaWR.ProtocolloUscita))
                {
                    listaDest = ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).destinatari;
                    listaDestCC = ((SAAdminTool.DocsPaWR.ProtocolloUscita)schedaDocumento.protocollo).destinatariConoscenza;
                }
                ...
                if (listaDest != null && listaDest.Length > 0)
                {
                    ...
                    {
                        if (listaDest[i].GetType() == typeof(SAAdminTool.DocsPaWR.UnitaOrganizzativa))
                        {
                            SAAdminTool.DocsPaWR.UnitaOrganizzativa UO = (SAAdminTool.DocsPaWR.UnitaOrganizzativa)listaDest[i];
                            //Controlla se almeno uno dei registri del ruolo è uguale a quello corrente
                            //foreach (SAAdminTool.DocsPaWR.Registro regUO in UO.registri)
                            //{
                        ...
                        if (listaDest[i].GetType() == typeof(SAAdminTool.DocsPaWR.Ruolo))
                        {
                            SAAdminTool.DocsPaWR.Ruolo ruolo = (SAAdminTool.DocsPaWR.Ruolo)listaDest[i];
                            //Controlla se almeno uno dei registri del ruolo è uguale a quello corrente
                            //foreach(SAAdminTool.DocsPaWR.Registro reg in ruolo.registri)
                            //{
                ...
                if (listaDestCC != null && listaDestCC.Length > 0)
                {
                    ...
                    {
                        if (listaDestCC[i].GetType() == typeof(SAAdminTool.DocsPaWR.UnitaOrganizzativa))
                        {
                            SAAdminTool.DocsPaWR.UnitaOrganizzativa UOcc = (SAAdminTool.DocsPaWR.UnitaOrganizzativa)listaDestCC[i];
                            //Controlla se almeno uno dei registri del ruolo è uguale a quello corrente
                            //foreach (SAAdminTool.DocsPaWR.Registro regUOcc in UOcc.registri)
                            //{
                        ...
                        if (listaDestCC[i].GetType() == typeof(SAAdminTool.DocsPaWR.Ruolo))
                        {
                            SAAdminTool.DocsPaWR.Ruolo ruoloCC = (SAAdminTool.DocsPaWR.Ruolo)listaDestCC[i];
                            //Controlla se almeno uno dei registri del ruolo è uguale a quello corrente
                            //foreach (SAAdminTool.DocsPaWR.Registro regCC in ruoloCC.registri)
                            //{
        ...
        private string getIdTitolario(string codClassificazione, ArrayList titolari)
        {
            ...
            foreach (SAAdminTool.DocsPaWR.OrgTitolario titolario in titolari)
            {
                if (titolario.Stato == SAAdminTool.DocsPaWR.OrgStatiTitolarioEnum.Attivo)
                {
                    result = titolario.ID;
                }
            }
        ...
        private void caricaModelliTrasmRapida()
        {
            ...
            SAAdminTool.DocsPaWR.DocsPaWebService ws = new SAAdminTool.DocsPaWR.DocsPaWebService();
            SAAdminTool.DocsPaWR.Registro[] registri = new SAAdminTool.DocsPaWR.Registro[1];
            ...
            {
                SAAdminTool.DocsPaWR.ModelloTrasmissione mod = (SAAdminTool.DocsPaWR.ModelloTrasmissione)idModelli[i];
                System.Web.UI.WebControls.ListItem li = new System.Web.UI.WebControls.ListItem();
        ...
        private void execTrasmRapidaDaModello()
        {
            ...
            if (indexSel > 0)
            {
                ...
                Session["Modello"] = modello;
                        ...
                        for (int i = 0; i < modello.RAGIONI_DESTINATARI.Length; i++)
                        {
                            SAAdminTool.DocsPaWR.RagioneDest ragDest = (SAAdminTool.DocsPaWR.RagioneDest)modello.RAGIONI_DESTINATARI[i];
                            ArrayList destinatari = new ArrayList(ragDest.DESTINATARI);
                            for (int j = 0; j < destinatari.Count; j++)
                            {
                                SAAdminTool.DocsPaWR.MittDest mittDest = (SAAdminTool.DocsPaWR.MittDest)destinatari[j];
                                ...
                                {
                                    corr = UserManager.getCorrispondenteByCodRubricaIENotdisabled(this, mittDest.VAR_COD_RUBRICA, SAAdminTool.DocsPaWR.AddressbookTipoUtente.INTERNO);
                                }
                                else
                                {
                                ...
                                {   //il corr è null se non esiste o se è stato disabiltato.    
                                    SAAdminTool.DocsPaWR.RagioneTrasmissione ragione =ws.getRagioneById(mittDest.ID_RAGIONE.ToString());
                                    //Andrea - try - catch
                                    try
                                    {
                        ...
                        SAAdminTool.DocsPaWR.Trasmissione t_rs = null;
                        ...
                        if (System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] != null && System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] == "1")
                        {
                            SAAdminTool.DocsPaWR.Stato stato = SAAdminTool.DiagrammiManager.getStatoDoc(schedaDocumento.docNumber, this);
                            bool trasmWF = false;
                            if (trasmissione != null && trasmissione.trasmissioniSingole != null)
                                for (int i = 0; i < trasmissione.trasmissioniSingole.Length; i++)
                                {
                                    SAAdminTool.DocsPaWR.TrasmissioneSingola trasmSing = (SAAdminTool.DocsPaWR.TrasmissioneSingola)trasmissione.trasmissioniSingole[i];
                                    if (trasmSing.ragione.tipo == "W")
                                        trasmWF = true;
                                }
                            if (stato != null && trasmWF)
                                SAAdminTool.DiagrammiManager.salvaStoricoTrasmDiagrammi(trasmissione.systemId, schedaDocumento.docNumber, Convert.ToString(stato.SYSTEM_ID), this);
                        }
                #region modelli vecchi
                //FINE MODELLI TRASMISSIONE NUOVI
                //        SAAdminTool.DocsPaWR.Trasmissione trasmEff = null;
                //try
                //{
                ...
                //            if (System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] != null && System.Configuration.ConfigurationManager.AppSettings["DiagrammiStato"] == "1")
                //            {
                //                DocsPaWR.Stato stato = SAAdminTool.DiagrammiManager.getStatoDoc(schedaDocumento.docNumber, this);
                //                bool trasmWF = false;
                //                for (int i = 0; i < trasmEff.trasmissioniSingole.Length; i++)
                //                {
                //                    DocsPaWR.TrasmissioneSingola trasmSing = (SAAdminTool.DocsPaWR.TrasmissioneSingola)trasmEff.trasmissioniSingole[i];
                //                    if (trasmSing.ragione.tipo == "W")
                //                        trasmWF = true;
                //                }
                //                if (stato != null && trasmWF)
                //                    SAAdminTool.DiagrammiManager.salvaStoricoTrasmDiagrammi(trasmEff.systemId, schedaDocumento.docNumber, Convert.ToString(stato.SYSTEM_ID), this);
                //            }
                //        }
                //}
        ...
        private SAAdminTool.DocsPaWR.Trasmissione impostaNotificheUtentiDaModello(SAAdminTool.DocsPaWR.Trasmissione objTrasm)
        {
        ...
        private bool daNotificareSuModello(string currentIDPeople, string currentIDCorrGlobRuolo)
        {
            ...
            SAAdminTool.DocsPaWR.ModelloTrasmissione modello = (SAAdminTool.DocsPaWR.ModelloTrasmissione)Session["Modello"];
        ...
        private bool cessioneDirittiAbilitato(SAAdminTool.DocsPaWR.Trasmissione trasm, SAAdminTool.DocsPaWR.ModelloTrasmissione modello)
        {
            bool retValue = false;
            if (modello != null)
            ...
            if (modello != null && modello.CEDE_DIRITTI.Equals("1"))
            {
                ...
                {
                    SAAdminTool.DocsPaWR.CessioneDocumento cessione = new SAAdminTool.DocsPaWR.CessioneDocumento();
                    ...
                    string valoreChiaveCediDiritti = SAAdminTool.utils.InitConfigurationKeys.GetValue(UserManager.getInfoUtente().idAmministrazione, "FE_CEDI_DIRITTI_IN_RUOLO");
        ...
        private string GetAnagUtenteProprietario()
        {
            ...
            SAAdminTool.DocsPaWR.SchedaDocumento sd = DocumentManager.getDocumentoSelezionato(this);
            string idProprietario = string.Empty;
        ...
        /// </summary>
        private void verificaRuoliDestInTrasmissione(SAAdminTool.DocsPaWR.Trasmissione trasm)
        {
            foreach (SAAdminTool.DocsPaWR.TrasmissioneSingola trasmy in trasm.trasmissioniSingole)
            {
        ...
        {
            SAAdminTool.utils.CessioneDiritti obj = new SAAdminTool.utils.CessioneDiritti();
        ...
        /// </summary>
        private void utentiConNotifica(SAAdminTool.DocsPaWR.Trasmissione trasm)
        {
            foreach (SAAdminTool.DocsPaWR.TrasmissioneSingola trasmy in trasm.trasmissioniSingole)
                foreach (SAAdminTool.DocsPaWR.TrasmissioneUtente trasmUt in trasmy.trasmissioneUtente)
        ...
        private void setListBoxMittentiMultipli()
        {
            ...
            SAAdminTool.DocsPaWR.Corrispondente mittente;
            lbx_mittMultiplo.Items.Clear();
            SchedaDocumento schedaDocumento = this.GetProtocolloManager().GetDocumentoCorrente();
            if (schedaDocumento != null && ((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittenti != null)
            {
                for (int i = 0; i < ((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittenti.Length; i++)
                {
                    mittente = (((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittenti[i]);
        ...
        private void btn_upMittente_Click(object sender, System.EventArgs e)
        {
            ...
            if (lbx_mittMultiplo.SelectedIndex != -1 && ((SAAdminTool.DocsPaWR.ProtocolloEntrata)schedaDocumento.protocollo).mittenti != null)
            {
        ...
        private void ddl_trasm_rapida_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            if (ddl_trasm_rapida.SelectedValue != null && ddl_trasm_rapida.SelectedValue.Trim() != string.Empty)
            {
                ...
                SAAdminTool.DocsPaWR.ModelloTrasmissione modello = new SAAdminTool.DocsPaWR.ModelloTrasmissione();
        ...
        protected void newRubricaVeloce(string tipo)
        {
            ...
            SAAdminTool.DocsPaWR.Corrispondente cr = (SAAdminTool.DocsPaWR.Corrispondente)this.Session["userData"];
            ...
            {
                dataUser = dataUser + "-" + ((SAAdminTool.DocsPaWR.Registro)ctx.Session["userRegistro"]).systemId;
            }
