namespace ProtocollazioneIngresso
{
	...
	public class StampaEtichetta : System.Web.UI.UserControl
	{
		...
		private SAAdminTool.DocsPaWR.InfoDocumento _infoDocumento=null;
		...
		public void Stampa(SAAdminTool.DocsPaWR.SchedaDocumento schedaDocumento, bool showPrintMessage, string txt_num_stampe)
		{
            ...
            SAAdminTool.DocsPaWR.SchedaDocumento sc = new SAAdminTool.DocsPaWR.SchedaDocumento();
		...
		private string getDescAmministrazione(string IdAmministrazione)
		{
			...
			SAAdminTool.DocsPaWR.Amministrazione[] amministrazioni = UserManager.getListaAmministrazioni(this.Page,out returnMsg);
		...
		private SAAdminTool.DocsPaWR.InfoDocumento GetInfoDocumento()
		{
