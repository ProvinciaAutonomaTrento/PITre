<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DataGridPagingWait.ascx.cs" Inherits="SAAdminTool.waiting.DataGridPagingWait" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
