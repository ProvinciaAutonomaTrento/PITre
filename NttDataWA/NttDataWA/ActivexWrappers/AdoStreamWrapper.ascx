<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdoStreamWrapper.ascx.cs" Inherits="NttDataWA.ActivexWrappers.AdoStreamWrapper" %>
...
<script id="adoStreamWrapperControlScript" type="text/javascript">
    function AdoStreamWrapper_OpenBinaryData(filePath)
    {
		...
		catch(e)
		{
		    ...
		    alert("Errore nella lettura del file '" + filePath + "'");
		}
    }
