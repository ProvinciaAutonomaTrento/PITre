<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectToFSWrapper.ascx.cs"
    Inherits="NttDataWA.ActivexWrappers.ProjectToFSWrapper" %>
<% 
    if (NttDataWA.ActivexWrappers.Configurations.ProjectToFSControl &&
...
<script id="projectToFSScript" type="text/javascript">
    ...
    function ExportPrj(outputFolder)
    {
        try {
            ...
            if ("<%=NttDataWA.ActivexWrappers.Configurations.ProjectToFSControl%>" == "True") {
