<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClientModelProcessor.ascx.cs" Inherits="NttDataWA.ActivexWrappers.ClientModelProcessor" %>
<% if (NttDataWA.ActivexWrappers.Configurations.UserClientModelProcessorControl && 
...
<script id="clientModelProcessorScript" type="text/javascript">
    function ClientModelProcessor_ProcessModel(outputFilePath, documentId, modelType) 
    {
        ...
        try {
            if ("<%=NttDataWA.ActivexWrappers.Configurations.UserClientModelProcessorControl%>" == "True") {
                ...
                //alert('WebServiceUrl: ' + "<%=this.WebServiceUrl%>");
