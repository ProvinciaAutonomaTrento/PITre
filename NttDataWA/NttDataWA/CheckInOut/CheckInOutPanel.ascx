<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CheckInOutPanel.ascx.cs" Inherits="NttDataWA.CheckInOut.CheckInOutPanel" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
