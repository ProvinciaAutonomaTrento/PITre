namespace NttDataWA.CheckInOut
{
    ...
    public class CheckInOutPanel : System.Web.UI.UserControl
    {
        ...
        private FileRequest lastDocument = null;
        ...
        protected bool IsSignedFile
        {
            get
            {
                ...
                {
                    if (DocumentManager.getSelectedNumberVersion() == null || DocumentManager.getSelectedNumberVersion().Equals("0"))
                ...
                */
                ...
                if (fileDocument != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(defaultFileName))
                    {
                        ...
                        this.ViewState["LastAcquiredDocumentExtension"] = fileInfo.Extension.Replace(".", "");
        ...
        protected string CheckOutFilePath
        {
            get
            {
                ...
                if (CheckOutContext.Current != null && CheckInOutServices.GetCheckOutDocumentStatus() != null)
                    retValue = CheckInOutServices.GetCheckOutDocumentStatus().DocumentLocation;
        ...
        private FileRequest LastDocument
        {
            get
            {
                ...
                if (currentScheda != null && currentScheda.documenti != null && currentScheda.documenti.Length > 0)
                {
                    ...
                    //if (DocumentManager.getSelectedNumberVersion() != null && DocumentManager.ListDocVersions != null)
                    //    selectedVersionId = (from v in DocumentManager.ListDocVersions where v.version.Equals(DocumentManager.getSelectedNumberVersion()) select v.versionId).FirstOrDefault();
                    //retValue = FileManager.GetFileRequest(selectedVersionId);


                    String selectedVersionId = null;
                    if (UIManager.DocumentManager.getSelectedAttachId() != null && DocumentManager.ListDocVersions != null)
                    {
                        if (DocumentManager.getSelectedNumberVersion() == null || DocumentManager.getSelectedNumberVersion().Equals("0"))
                            DocumentManager.setSelectedNumberVersion((from doc in DocumentManager.ListDocVersions select Convert.ToInt32(doc.version)).Max().ToString());
