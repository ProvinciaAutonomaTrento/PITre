namespace NttDataWA.CheckInOut
{
	...
	{
        protected System.Web.UI.WebControls.HiddenField OutFilePathController;
        protected System.Web.UI.UpdatePanel pnlTempValue;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if (!this.IsPostBack)
			{
                ...
                this.SetCheckInOutStatus();
                this.SetCheckInOutFolderUrl();

                this.UpdateCheckOutPath();
			}
		}

        private void SetCheckInOutStatus() {
            if (CheckOutContext.Current == null)
                CheckOutContext.Current = new CheckOutContext(UIManager.DocumentManager.getSelectedRecord());
        }

        public void UpdateCheckOutPath()
        {
            this.OutFilePathController.Value = this.CheckOutFilePath;
            this.pnlTempValue.Update();
        }
        ...
        protected virtual void SetCheckInOutFolderUrl()
        {
            ...
            //else
            //{
            this.ViewState["CheckInOutFolderUrl"] = NttDataWA.Utils.utils.getHttpFullPath() + "/CheckInOut/";
            //}
        }
		...
		protected string UndoCheckOutPageUrl
		{
			get
			{
                ...
                if (!String.IsNullOrEmpty(this.CheckOutFilePath) && this.CheckOutFilePath.Contains("mtext://"))
                    undoPageUrl = String.Format("{0}/Models/MText/Delete.aspx", Utils.utils.getHttpFullPath());
		...
		/// </summary>
		public string CheckOutFilePath
		{
			get
			{
                ...
                if (UIManager.DocumentManager.getSelectedAttachId() != null)
                {
                    if (UIManager.DocumentManager.GetSelectedAttachment() != null)
                    {
                        ...
                        if (tempStatus != null)
                            retValue = UIManager.DocumentManager.GetCheckOutDocumentStatus(UIManager.DocumentManager.GetSelectedAttachment().docNumber).DocumentLocation;
                    }
                }
                else
                {
        ...
        public string CheckOutPageTitle
        {
            get
            {
                ...
                return Utils.Languages.GetLabelFromCode("CheckInOutTitle_CheckOut", language);
            }
        }

        public string CheckOutUndoConfirm
        {
            get
            {
                string language = UIManager.UserManager.GetUserLanguage();
                return Utils.Languages.GetLabelFromCode("CheckInOutUndoConfirm", language);
            }
        }
        ...
        public string MsgWait
        {
            get
            {
                return Utils.Languages.GetMessageFromCode("CheckInOutMsgWait", UIManager.UserManager.GetUserLanguage());
            }
        }

        public string MsgCheckIn
        {
            get
            {
                return Utils.Languages.GetMessageFromCode("CheckInOutMsgCheckIn", UIManager.UserManager.GetUserLanguage());
            }
        }

        public string MsgCheckOut
        {
            get
            {
                return Utils.Languages.GetMessageFromCode("CheckInOutMsgCheckOut", UIManager.UserManager.GetUserLanguage());
            }
        }

        public string MsgUndoCheckOut
        {
            get
            {
                return Utils.Languages.GetMessageFromCode("CheckInOutMsgUndoCheckOut", UIManager.UserManager.GetUserLanguage());
            }
        }

        public string MsgOpenCheckOut
        {
            get
            {
                return Utils.Languages.GetMessageFromCode("CheckInOutMsgOpenCheckOut", UIManager.UserManager.GetUserLanguage());
            }
        }

        public string MsgSaveFileVersion
        {
            get
            {
                return Utils.Languages.GetMessageFromCode("CheckInOutMsgSaveFileVersion", UIManager.UserManager.GetUserLanguage());
            }
        }
	}
}
