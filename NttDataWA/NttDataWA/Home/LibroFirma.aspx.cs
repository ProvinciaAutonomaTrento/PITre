...
namespace NttDataWA.Home
{
    public partial class LibroFirma : System.Web.UI.Page
    {
        ...
        private void InitializePage()
        {
            ...
            if (UserManager.ruoloIsAutorized(this, "DO_DOC_FIRMA") || UserManager.ruoloIsAutorized(this, "FIRMA_HSM"))
            {
                TipiFirma_People = new List<string>();
                if (UserManager.ruoloIsAutorized(this, "DO_DOC_FIRMA"))
                    TipiFirma_People.Add(firmaLocale);
                if (UserManager.ruoloIsAutorized(this, "FIRMA_HSM"))
                    TipiFirma_People.Add(firmaHSM);
