...
namespace NttDataWA.Utils
{
    public class MTextUtils
    {
        ...
        static NttDataWA.DocsPaWR.DocsPaWebService ws;
        ...
        public static List<LabelValuePair> GetSampleLabelValueCollection(List<NttDataWA.DocsPaWR.OggettoCustom> customObjects)
        {
            // Creazione della lista
            List<LabelValuePair> values = new List<LabelValuePair>();

            foreach (NttDataWA.DocsPaWR.OggettoCustom obj in customObjects)
        ...
        public static String GetMTextFullQualifiedName(String versionId, String docNumber)
        {
            try
            {
                return ws.GetMTextFullQualifiedName(new NttDataWA.DocsPaWR.MTextDocumentInfo()
                {
                    DocumentVersionId = versionId,
                    DocumentDocNumber = docNumber
                }).FullQualifiedName;
        ...
        private static String GetSampleValueForField(NttDataWA.DocsPaWR.OggettoCustom customObject)
        {
