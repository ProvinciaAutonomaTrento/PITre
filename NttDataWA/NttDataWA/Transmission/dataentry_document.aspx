<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Base.Master" AutoEventWireup="true"
    CodeBehind="dataentry_document.aspx.cs" Inherits="NttDataWA.Transmission.dataentry_document"
                            ...
                            <div class="row">
                                <fieldset>
                                    <div class="row">
                                        <div class="col">
                                            <span class="weight">
                                                <asp:Literal ID="TransmissionLitObject" runat="server" /></span>
                                        </div>
                                    </div>
                                                ...
                                                <fieldset>
                                                    <div class="row">
                                                        <div class="col">
                                                            <p>
                                                                <span class="weight">
                                                                    <asp:Literal ID="TransmissionLitNote" runat="server" /></span></p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <cc1:CustomTextArea ID="TxtNote" runat="server" TextMode="MultiLine"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-right-no-margin">
                                                            <span class="charactersAvailable">
                                                                ...
                                                                <span id="TxtNote_chars" clientidmode="Static" runat="server"></span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </fieldset>
