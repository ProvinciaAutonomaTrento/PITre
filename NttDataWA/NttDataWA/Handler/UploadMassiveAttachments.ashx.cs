...
{
    /// <summary>
    /// Summary description for UploadMassiveAttachments
    /// </summary>
    public class UploadMassiveAttachments : NttDataWA.ImportDati.FileUploadHandlerBase, IHttpHandler, IRequiresSessionState
    {
        ...
        protected override string Upload(HttpPostedFile file, string fileName)
        {
            ...
            try
            {
                ...
                result = FileManager.uploadFile(null, fileDoc, false, _pdf, _pdfConversionSynchronousLC);
