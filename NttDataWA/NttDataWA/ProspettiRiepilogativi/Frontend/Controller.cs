...
namespace ProspettiRiepilogativi.Frontend
{
    ...
    public class Controller
    {
        ...
        private static DocsPaWebService _docsPaWS = ProxyManager.GetWS();

        protected DocsPaWebService WS
        {
            get
            {
                return _docsPaWS;
        ...
        public static DropDownList DO_GetAmministrazioni(DropDownList list)
        {
            try
            {
                ...
                foreach (PR_Amministrazione amm in amministrazioni)
                {
        ...
        public static DropDownList DO_GetRegistriByAmministrazione(DropDownList list, string cod_amm)
        {
            try
            {
                ...
                list.Items.Clear();
                list.Items.Add("");
                foreach (PR_Registro reg in registri)
                {
        ...
        public static FileDocumento DO_StampaReport(string templateFilePath, ReportDisponibili tipoReport, ArrayList filtri, int idPeople, string timeStamp)
        {
            #region Dichiarazioni
            //string templateFilePath = "";
            FileDocumento fileRep = new FileDocumento();
            ...
            switch (tipoReport)
            {
                ...
                case ReportDisponibili.CDC_reportControlloPreventivo:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportControlloPreventivo(UserManager.GetInfoUser(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportSuccessivoSCCLA:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportControlloSuccessivo(UserManager.GetInfoUser(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportControlloPreventivoSRC:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportControlloPreventivoSRC(UserManager.GetInfoUser(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportPensioniCivili:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportPensioniCivili(UserManager.GetInfoUser(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
                ...
                case ReportDisponibili.CDC_reportPensioniMilitari:
                    ...
                    {
                        _docsPaWS.Timeout = System.Threading.Timeout.Infinite;
                        ds = _docsPaWS.DO_CDCGetDSReportPensioniMilitari(UserManager.GetInfoUser(), CDCDataDa, CDCDataA, CDCUffici, CDCMagistrato, CDCRevisore);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            foreach (Parametro p in filtri)
                            {
        ...
        public static PR_Amministrazione Do_GetAmmByIdAmm(int idAmm)
        {
        ...
        public static void DO_GetTitolario(ref DropDownList list, string codiceAmm)
        {
            try
            {
                ...
                foreach (PR_Titolario tit in _docsPaWS.DO_GetTitolari(id_amm))
                {
        ...
        public static Report DO_AddSubReport(Report report, Report subReport)
        {
        ...
        #region DO_NewReport
        public static Report DO_NewReport(string descrizione, string valore)
        {
        ...
        public static PR_Registro DO_NewRegistro(string system_id, string codice, string descrizione)
        {
        ...
        public static PR_Amministrazione DO_NewAmministrazione(string system_id, string codice, string descrizione, string libreria)
        {
        ...
        public static FileDocumento DO_StampaExcel(ArrayList filtri, string timeStamp, InfoUtente infoUtente, string searchType)
        {
            FileDocumento fileRep = new FileDocumento();
        ...
        public static FileDocumento DO_StampaLog(ArrayList filtri, InfoUtente infoUtente)
        {
            FileDocumento fileRep = new FileDocumento();
