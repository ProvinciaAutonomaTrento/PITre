...
namespace ProspettiRiepilogativi.Frontend
{
    ...
    {
        public static FileDocumento do_MakePdfReport(ReportDisponibili tipoReport, string templateFilePath, DataSet ds, ArrayList parametriPDF)
        {
            return do_MakePdfReport(tipoReport, templateFilePath, null, ds, parametriPDF);
        }

        public static FileDocumento do_MakePdfReport(ReportDisponibili tipoReport, string templateFilePath, string titolo, DataSet ds, ArrayList parametriPDF)
        {
