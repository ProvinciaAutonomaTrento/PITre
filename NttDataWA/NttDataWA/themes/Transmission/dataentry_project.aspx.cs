    ...
    public partial class dataentry_project : System.Web.UI.Page
    {
        ...
        private void LoadTransmissionModels()
        {
            ...
            if (this.CustomDocuments && ProjectManager.getProjectInSession() != null && !string.IsNullOrEmpty(ProjectManager.getProjectInSession().systemID) && ProjectManager.getProjectInSession().template != null && ProjectManager.getProjectInSession().template.SYSTEM_ID != 0)
            {
                ...
                {
                    DiagrammaStato dia = DiagrammiManager.getDgByIdTipoFasc(idFasc, this.InfoUser.idAmministrazione);
                    if (dia != null)
                    {
            ...
            ArrayList idModelli = new ArrayList(UIManager.TransmissionModelsManager.GetTransmissionModelsLite(this.UserLog.idAmministrazione, listReg, this.UserLog.idPeople, this.InfoUser.idCorrGlobali, string.Empty, idDiagram, idState, "F", idFasc, this.Role.idGruppo, false, accessRights));
        ...
        protected void Transmissions_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //    }
                //}
                if (ProjectManager.getProjectInSession().privato == "1" && !this.SaveButNotTransmit)
                {
