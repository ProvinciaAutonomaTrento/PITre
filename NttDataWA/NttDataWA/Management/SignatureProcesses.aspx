...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        .TreeSignatureProcess_selected span {
            padding: 0 5px;
            background-color: transparent;
            color: #fff;
        }

        .TreeSignatureProcess_node span {
            color: #006eff;
        }
...
<asp:Content ID="ContentPlaceHolderContent" ContentPlaceHolderID="ContentPlaceHolderContent"
    ...
    <uc:ajaxpopup2 Id="VisibilitySignatureProcess" runat="server" Url="../popup/VisibilitySignatureProcess.aspx"
        Width="1000" Height="600" PermitClose="false" PermitScroll="false" CloseFunction="function (event, ui) { __doPostBack('UpContainerSignatureProcessesTab', '');}" />
    ...
    <uc:ajaxpopup2 Id="CopySignatureProcess" runat="server" Url="../Popup/AddNewProcess.aspx?tipooperazione=c"
        PermitClose="false" Width="700" Height="500" PermitScroll="false" CloseFunction="function (event, ui){__doPostBack('UpPnlButtons', '');}" />
    <div id="containerTop">
                    ...
                    <div id="containerDocumentTabOrangeInternalSpace">
                        ...
                        <div id="containerDocumentTabOrangeDx">
                            <asp:UpdatePanel ID="UpdPlnProcessName" UpdateMode="Conditional" runat="server" ClientIDMode="Static">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlProcessName" runat="server" Visible="true">
                                                        ...
                                                        <asp:Panel ID="pnlDetailsSteps" runat="server" Visible="false">
                                                            ...
                                                            <div class="row">
                                                                <asp:UpdatePanel ID="UplNrStep" runat="server">
                                                                    <ContentTemplate>
                                                                        <div class="col-marginSx2" style="width:20%">
                                                                            <strong>
                                                                        ...
                                                                        <div class="colHalf" style="margin-top:3px">
                                                                            <div class="col-marginSx2">
                                                                                <strong>
                                                                                    <asp:Literal ID="LblFacoltativo" runat="server" Text="Facoltativo" /></strong>
                                                                            </div>
                                                                            <div class="col">
                                                                                <asp:CheckBox ID="cbxFacoltativo" runat="server" />
                                                                            </div>
                                                                    ...
                                                                    <asp:Panel ID="PnlTypeStep" runat="server">
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpPnlCampiPassoAutomatco" UpdateMode="Conditional" runat="server">
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <asp:Panel ID="PnlCampiCambioStatoAutomatico" runat="server" Visible="false">
                                                                                     <%-- TIPOLOGIA --%>
                                                                                    <div class="colHalf16">
                                                                                        <div class="row">
                                                                                            <div class="col">
                                                                                                <p>
                                                                                                    <span class="weight">
                                                                                                        <asp:Literal ID="LtlTipologiaDocumento" runat="server" /></span>
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row">
                                                                                            <asp:DropDownList ID="DdlTipologiaDocumento" runat="server" Width="95%" AutoPostBack="true" Enabled="false"
                                                                                                CssClass="chzn-select-deselect" OnSelectedIndexChanged="DdlTipologiaDocumento_SelectedIndexChanged">
                                                                                            </asp:DropDownList>
                                                                                        </div>
                                                                                    </div>
                                                                                    <%-- STATO --%>
                                                                                    <div class="colHalf16">
                                                                                        <div class="colHalf3">
                                                                                            <asp:UpdatePanel ID="UpPnlStatoDiagramma" UpdateMode="Conditional" runat="server">
                                                                                                <ContentTemplate>
                                                                                                    <div class="row">
                                                                                                        <div class="col">
                                                                                                            <p>
                                                                                                                <span class="weight">
                                                                                                                    <asp:Literal ID="LtlStatoDiagramma" runat="server" /></span>
                                                                                                            </p>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="row">
                                                                                                        <asp:DropDownList ID="DdlStatoDiagramma" runat="server" Width="95%" AutoPostBack="true" Enabled="false"
                                                                                                            CssClass="chzn-select-deselect" OnSelectedIndexChanged="DdlStatoDiagramma_SelectedIndexChanged">
                                                                                                        </asp:DropDownList>
                                                                                                    </div>
                                                                                                </ContentTemplate>
                                                                                            </asp:UpdatePanel>
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdPnlNotes" UpdateMode="Conditional" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:Panel ID="pnlNotes" runat="server">
                                                                                            <div class="row">
                                                                                                <div class="col-marginSx2" style="width: 5%">
                                                                                                    <span class="weight">
...
<asp:Content ID="ContentButtons" ContentPlaceHolderID="ContentPlaceOldersButtons"
    ...
    <asp:UpdatePanel ID="UpPnlButtons" runat="server" ClientIDMode="Static" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <cc1:CustomButton ID="SignatureProcessesBtnDuplica" runat="server" CssClass="btnEnable clickable"
                CssClassDisabled="btnDisable" OnMouseOver="btnHover" OnClientClick="return ajaxModalPopupAddNewProcess();" />
            <cc1:CustomButton ID="SignatureProcessesBtnCopia" runat="server" CssClass="btnEnable clickable"
                CssClassDisabled="btnDisable" OnMouseOver="btnHover" OnClientClick="return ajaxModalPopupCopySignatureProcess();" />
        </ContentTemplate>
    </asp:UpdatePanel>
