                                                            ...
                                                            <div class="row3">
                                                                    ...
                                                                    <div class="col4">
                                                                        <asp:RadioButtonList ID="RblTipoVisibilita" runat="server" RepeatDirection="Vertical">
                                                                            <asp:ListItem Id="rb_Utente" Selected="True" Value="U" runat="server"></asp:ListItem>
                                                                            <asp:ListItem Id="rb_Ruolo" Value="R" runat="server"></asp:ListItem>
                                                                            <asp:ListItem Id="rb_Monitoratore" Value="M" runat="server"></asp:ListItem>
                                                                        </asp:RadioButtonList>
                                                                    </div>
                                                            </div>
