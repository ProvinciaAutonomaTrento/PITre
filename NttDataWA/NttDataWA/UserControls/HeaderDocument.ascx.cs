...
namespace NttDataWA.UserControls
{
    public partial class HeaderDocument : System.Web.UI.UserControl
    {
            ...
            if (!string.IsNullOrEmpty(this.TypeRecord))
            {
                ...
                switch (this.TypeRecord.ToUpper())
                {
                    case "A":
                        ...
                        if (protAborted == null)
                        {
                            if (!IsPredisponi && ((doc == null || doc.protocollo == null) || (doc != null && !string.IsNullOrEmpty(doc.systemId) && doc.protocollo != null && !string.IsNullOrEmpty(doc.protocollo.segnatura)) || (doc != null && string.IsNullOrEmpty(doc.systemId) && doc.protocollo != null)))
                            {
                                if (consolidation)
                                {
                    ...
                    case "P":
                        ...
                        if (protAborted == null)
                        {
                            if (!IsPredisponi && ((doc == null || doc.protocollo == null) || 
                                (doc != null && !string.IsNullOrEmpty(doc.systemId) && doc.protocollo != null && !string.IsNullOrEmpty(doc.protocollo.segnatura)) || 
                                (doc != null && string.IsNullOrEmpty(doc.systemId) && doc.protocollo != null && !this.IsForwarded)))
                            {
                                if (consolidation)
                                {
        ...
        private bool IsPredisponi
        {
            get
            {
                bool result = false;
                if (HttpContext.Current.Session["IsPredisponi"] != null) result = (bool)HttpContext.Current.Session["IsPredisponi"];
                return result;

            }
            set
            {
                HttpContext.Current.Session["IsPredisponi"] = value;
            }
        }
