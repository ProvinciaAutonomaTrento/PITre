...
namespace NttDataWA.Popup
{
    ...
    public partial class MassiveDigitalSignature_Socket : System.Web.UI.Page
    {
        ...
        protected void BtnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (IsLF)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "reallowOp", "reallowOp();", true);
                this.CloseMask(true);
                //ScriptManager.RegisterStartupScript(this, this.GetType(), "closeAjaxModal", "parent.closeAjaxModal('MassiveDigitalSignatureSocket', 'UP');", true);
            }
        }
        ...
        private void CloseMask(bool withReturnValue)
        {
            ...
            if(IsLF)
                ScriptManager.RegisterStartupScript(this, this.GetType(), "closeMask", "parent.closeAjaxModal('MassiveDigitalSignatureSocket', '" + retValue + "', parent);", true);
                //ScriptManager.RegisterStartupScript(this, this.GetType(), "closeAjaxModal", "parent.parent.closeAjaxModal('MassiveDigitalSignatureSocket', '" + retValue + "');", true);
            else
                ScriptManager.RegisterStartupScript(this, this.GetType(), "closeAjaxModal", "parent.closeAjaxModal('MassiveDigitalSignatureSocket', '" + retValue + "');", true);
        }
        ...
        protected void ShowReport()
        {
            ...
            FileManager.removeSelectedMassSignatureList();
        }
