...
{
    public partial class MassiveRemoveAdlRole : System.Web.UI.Page
    {
        ...
        protected void BtnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (!this.IsFasc)
            {
                this.RemoveDocumentsFromADLR(MassiveOperationUtils.GetSelectedItems(), report);
            }
            else
            {
                this.RemoveProjectsFromADLR(MassiveOperationUtils.GetSelectedItems(), report);
            }
        ...
        private void CloseMask(bool withReturnValue)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "closeAjaxModal", "parent.closeAjaxModal('MassiveRemoveAdlRole', '" + retValue + "');", true);
        }
        ...
        private void RemoveProjectsFromADLR(List<MassiveOperationTarget> projectsId, MassiveOperationReport report)
        {
            ...
            this.RemoveProjectsFromWorkingAreaRole(projectsInfo, report);
        ...
        private void RemoveDocumentsFromADLR(List<MassiveOperationTarget> documentSystemId, MassiveOperationReport report)
        {
            // Salvataggio dei documenti nell'area di lavoro
            this.RemoveDocumentsFromWorkingAreaRole(documentSystemId, report);
        }
