...
{
    public partial class ViewDetailNotify : System.Web.UI.Page
    {
        ...
        private bool RemovedPredisposed
        {
            get
            {
                bool result = false;
                if (HttpContext.Current.Session["RemovedPredisposed"] != null)
                {
                    result = bool.Parse(HttpContext.Current.Session["RemovedPredisposed"].ToString());
                }
                return result;
            }
            set
            {
                HttpContext.Current.Session["RemovedPredisposed"] = value;
            }
        }
        ...
        private ILog logger = LogManager.GetLogger(typeof(ViewDetailNotify));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (RemovedPredisposed)
                {
                    HttpContext.Current.Session.Remove("RemovedPredisposed");
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "function", "<script>reallowOp();</script>", false);
                    if (!string.IsNullOrEmpty(this.HiddenRemovePredisposed.Value))
                    {
                        RemovePredisposed();
                        this.HiddenRemovePredisposed.Value = string.Empty;
                        return;
                    }
                }
        ...
        private void InitializeLanguage()
        {
            ...
            this.BtnRemovePredisposed.Text = Languages.GetLabelFromCode("ViewDetailNotifyBtnRemovePredisposedR", language);
            this.BtnRemovePredisposed.ToolTip = Languages.GetLabelFromCode("ViewDetailNotifyBtnRemovePredisposed", language);
            this.BtnAcquireRights.Text = Languages.GetLabelFromCode("ViewDetailNotifyBtnAcquireRights", language);
            this.BtnAcquireRights.ToolTip = Languages.GetLabelFromCode("ViewDetailNotifyBtnAcquireRightsTooltip", language);
            ...
            this.ImgSearchProjects.AlternateText = Utils.Languages.GetLabelFromCode("DocumentImgSearchProjects", language);
            this.ImgSearchProjects.ToolTip = Utils.Languages.GetLabelFromCode("DocumentImgSearchProjects", language);
            this.ImgOpenTitolario.AlternateText = Utils.Languages.GetLabelFromCode("btnclassificationschema", language);
            this.ImgOpenTitolario.ToolTip = Utils.Languages.GetLabelFromCode("btnclassificationschema", language);
        ...
        private void BuildNotification()
        {
            ...
            if (NotificationManager.GetTypeEvent(Notification.TYPE_EVENT).Equals(NotificationManager.EventType.TRASM))
            {
                ShowTransmission();
            }
            else
            {
                this.PlaceHolderTransmission.Visible = false;
            }
        ...
        {
            this.TableCellTxtSignatureDoc.Text = GetLabelField();
            this.TableCellTxtObjectDoc.Text = GetLabelSpecializedField();
            if (NotificationManager.GetTypeEvent(Notification.TYPE_EVENT).Equals(NotificationManager.EventType.TRASM))
            {
                TrasmissioneUtente trasmU = (Notification.ID_GROUP.Equals("0")) ? (from t in Transmission.trasmissioniSingole
            ...
            {
                this.rowAccepted.Visible = false;
                this.rowDisplayed.Visible = false;
                this.rowNote.Visible = false;
                this.TableCellRoleUserNotification.Text = Notification.ID_GROUP.Equals("0") ? RoleManager.GetRoleInSession().descrizione : UserManager.GetUserInSession().descrizione;
                this.TableCellTypeEvent.Text = NotificationManager.getLabelTypeEvent(Notification.TYPE_EVENT);
            }
        }
        ...
        private Table GetTransmissionTable(TrasmissioneSingola trasmSing)
        {
            ...
            {// header
                ...
                cell1.CssClass = trasmSing.systemId.Equals(TrasmToElaborate.systemId) ? "th header2" : "th header1";
        ...
        private void EnableButtonsNotification()
        {
            if (NotificationManager.GetTypeEvent(Notification.TYPE_EVENT).Equals(NotificationManager.EventType.TRASM))
            {
                ...
                TrasmissioneSingola trasmSing = this.TrasmToElaborate;
                ...
                this.BtnRemovePredisposed.Visible = false;
                this.BtnAcquireRights.Visible = false;
                ...
                if (listTrasmSing != null && listTrasmSing.Length > 0 && !string.IsNullOrEmpty(Transmission.dataInvio))
                {
                    ...
                    if (trasmSing != null)
                    {
                        DocsPaWR.SistemaEsterno sysext = TrasmManager.getSistemaEsterno(infoUtente.idAmministrazione, Transmission.ruolo.codice);
                        if (sysext == null)
                        {
                            ...
                            {
                                bool value = TrasmManager.checkTrasm_UNO_TUTTI_AccettataRifiutata(trasmSing) && isToUserOrRole;
                                ...
                                //Aggiungo il segente controllo "Notification.ID_GROUP.Equals("0")" per verificare se si tratta di una trasmissione a utente
                                if (UIManager.UserManager.IsAuthorizedFunctions("DO_ADL_ROLE") && !Notification.ID_GROUP.Equals("0"))
                                {
                            ...
                            else
                            {
                                ...
                                bool isDocumentReceivedWithIS = false;

                                if (Transmission.infoDocumento != null)
                                {
                                    isDocumentReceivedWithIS = SimplifiedInteroperabilityManager.IsDocumentReceivedWithIS(Transmission.infoDocumento.idProfile);
                                ...
                                if (Notification.DOMAINOBJECT.Equals(NotificationManager.ListDomainObject.DOCUMENT))
                                {
                                    ...
                                    // PALUMBO: inserita variabile isInToDoList per eliminare visualizzazione tasto Visto in caso 
                                    // di trasmissione per IS e già vista incident: INC000000103503 
                                    if (Transmission.tipoOggetto == TrasmissioneTipoOggetto.DOCUMENTO
                                        && isDocumentReceivedWithIS
                                        && !string.IsNullOrEmpty(ConfigurationManager.AppSettings[WebConfigKeys.SET_DATA_VISTA_GRD.ToString()])
                                        && (ConfigurationManager.AppSettings[WebConfigKeys.SET_DATA_VISTA_GRD.ToString()] == "2"
                                    ...
                                    this.BtnRemovePredisposed.Visible = isDocumentReceivedWithIS && SimplifiedInteroperabilityManager.IsRoleEnabledToRemoveDocument() &&
                                            String.IsNullOrEmpty(Transmission.infoDocumento.segnatura) &&
                                            Transmission.infoDocumento.tipoProto != "G";
                                }
                        ...
                        else
                        {
                            ...
                            if (trasmUtente != null && string.IsNullOrEmpty(trasmUtente.dataRifiutata) && string.IsNullOrEmpty(trasmUtente.dataAccettata))
                            {
                                ...
                                this.BtnAcquireRights.Visible = value;
                                this.upPnlNoteAccRif.Visible = value;
                                this.upPnlNoteAccRif.Update();
                            }
                            else
                            ...
                            //this.BtnAcquireRights.Visible = true;
                        }
                    }
                    else
                    {
            ...
            //Se non è una notifica di trasmissione rendo visibile solamente i bottoni di visto
            else
            {
                DisabledButtons();
                if (!string.IsNullOrEmpty(ConfigurationManager.AppSettings[WebConfigKeys.SET_DATA_VISTA_GRD.ToString()])
        ...
        protected void BtnView_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "ajaxDialogModal", "parent.ajaxDialogModal('ErrorSetDataVista', 'error', '','');", true);
                    return;
                }
                ...
                if (NotificationManager.GetTypeEvent(Notification.TYPE_EVENT).Equals(NotificationManager.EventType.TRASM))
                {
                    ...
                    TrasmissioneUtente trasmU = this.TrasmToElaborate.trasmissioneUtente.Where(u => u.utente.idPeople.Equals(UserManager.GetInfoUser().idPeople)).FirstOrDefault();
                    if (trasmU != null)
                        trasmU.dataVista = DateTime.Now.ToShortDateString();
                    ShowTransmission();
                    ShowDetailsNotification();
        ...
        protected void BtnViewAdLU_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (Transmission != null)
                {
                    ...
                    {
                        Fascicolo prj = ProjectManager.getFascicoloById(Transmission.infoFascicolo.idFascicolo);
                        ProjectManager.addFascicoloInAreaDiLavoro(prj, UIManager.UserManager.GetInfoUser());
                    }
                }
                else
                {
                    if (Notification.DOMAINOBJECT.Equals(FiltersNotifications.DOCUMENT))
                    {
                        SchedaDocumento schedaDoc = DocumentManager.getDettaglioDocumentoNoDataVista(this.Page, Notification.ID_OBJECT, Notification.ID_OBJECT);
                        if (schedaDoc != null)
                        {
                            InfoDocumento infoDocumento = DocumentManager.getInfoDocumento(schedaDoc);
                    ...
                    {
                        Fascicolo prj = ProjectManager.getFascicoloById(Notification.ID_OBJECT);
                        ProjectManager.addFascicoloInAreaDiLavoro(prj, UIManager.UserManager.GetInfoUser());
                    }
        ...
        protected void BtnAcquireRights_Click(object sender, System.EventArgs e)
        {
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "function", "<script>reallowOp();</script>", false);
            this.AcquireRights();
        }
        ...
        protected void BtnAcceptAdLU_Click(object sender, System.EventArgs e)
        {
            ...
            if (Transmission.infoDocumento != null)
            {
                ...
                SchedaDocumento sch = DocumentManager.getDocumentDetailsNoSecurity(this.Page, Notification.ID_OBJECT, Notification.ID_OBJECT);
                DocumentManager.setSelectedRecord(sch);
                if (DocumentManager.CheckRevocationAcl())
                {
                    DocumentManager.setSelectedRecord(null);
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "ajaxDialogModal", "function RedirectHome(){$(location).attr('href','" + this.ResolveUrl("~/Index.aspx") + "');} parent.ajaxDialogModal('RevocationAcl', 'warning', '','',null,null,'RedirectHome()'); parent.closeAjaxModal('ViewDetailNotify','');", true);
                    return;
                }
            }
            else
        ...
        protected void BtnAcceptLF_Click(object sender, System.EventArgs e)
        {
            ...
            {
                DocumentManager.addWorkArea(this, Transmission.infoDocumento);
                LibroFirmaManager.InserimentoInLibroFirma(this.Page, Transmission, Notification.ID_SPECIALIZED_OBJECT);
            }
        }
        ...
        protected void BtnCancel_Click(object sender, System.EventArgs e)
        {
            try
            {
                ScriptManager.RegisterClientScriptBlock(this.UpPnlButtons, this.UpPnlButtons.GetType(), "closeAJM", "parent.closeAjaxModal('ViewDetailNotify','');", true);
            }
            catch (System.Exception ex)
            {
                UIManager.AdministrationManager.DiagnosticError(ex);
        ...
        protected void BtnRemovePredisposed_Click(object sender, EventArgs e)
        {
            RemovedPredisposed = true;
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ajaxConfirmModal", "ajaxConfirmModal('ConfirmRemovePredisposed', 'HiddenRemovePredisposed', '');", true);
            return;
        }
        ...
        protected void BtnReject_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (result)
                {
                    if (Transmission.tipoOggetto.Equals(NotificationManager.ListDomainObject.DOCUMENT))
                    {
            ...
            AcceptTransmission()
        {
            ...
            {
                string errorMessage;
                SchedaDocumento doc = DocumentManager.getDocumentDetailsNoDataCheck(this.Page, Notification.ID_OBJECT, Notification.ID_OBJECT, out errorMessage);
                ...
                {
                    if (Transmission.tipoOggetto.ToString().Equals(NotificationManager.ListDomainObject.DOCUMENT))
                    {
                        ChangeStateDocument();
                    }
                    else if (Transmission.tipoOggetto.ToString().Equals(NotificationManager.ListDomainObject.FOLDER))
                    {
                        ChangeStateFolder();
                    }
                }
        ...
        private bool AcceptReject(DocsPaWR.TrasmissioneTipoRisposta tipoRisp)
        {
            ...
            DocsPaWR.Trasmissione trasmissione = Transmission;
            ...
            if (tipoRisp == DocsPaWR.TrasmissioneTipoRisposta.RIFIUTO)
            {
                if (string.IsNullOrEmpty(this.txt_noteAccRif.Text.Trim()))
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "ajaxDialogModal", "parent.ajaxDialogModal('" + msg.Replace("'", @"\'") + "', 'error', 'Accettazione');", true);
            ...
            if (trasmSing != null)
            {
                ...
                this.TrasmToElaborate = trasmSing;
                if (!TrasmManager.executeAccRif(this, trasmUtente, trasmissione.systemId, fascicolo, out errore))
                {
                    ...
                    msg = "ErrorCustom";
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "ajaxDialogModal", "parent.ajaxDialogModal('" + msg.Replace("'", @"\'") + "', 'error', '', '" + errore.Replace("'", @"\'") + "');", true);
                }
                else
                {
        ...
        private void RemovePredisposed()
        {
            InfoDocumento infoDoc = Transmission.infoDocumento;

            try
            {
                SchedaDocumento doc = new SchedaDocumento();
                doc = DocumentManager.getDettaglioDocumentoNoDataVista(this, infoDoc.docNumber, infoDoc.docNumber);
                string errmsg = string.Empty;
                if (DocumentManager.CestinaDocumento(this, doc, "P", "Rimozione predisposto da todolist", out errmsg))
        ...
        private void AcquireRights()
        {
            ...
            DocsPaWR.InfoUtente infoUtente = UserManager.GetInfoUser();
            string prova = Transmission.ruolo.idGruppo;
            string idOggetto = "";
            if (Transmission.infoFascicolo != null && !string.IsNullOrEmpty(Transmission.infoFascicolo.idFascicolo))
            {
                idOggetto = Transmission.infoFascicolo.idFascicolo;
            }
            else
            {
                idOggetto = Transmission.infoDocumento.idProfile;
            }
            bool eseguito = TrasmManager.AcquireRightsFromExtSys(idOggetto, infoUtente.idGruppo, infoUtente.idPeople, Transmission.ruolo.codice, Transmission.utente.idPeople);
            ShowTransmission();
            ShowDetailsNotification();
            this.upPnlNoteAccRif.Visible = false;
            this.UpdatePanelTransmission.Update();
        ...
        protected void ImgSearchProjects_Click(object sender, EventArgs e)
        {
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "function", "<script>reallowOp();</script>", false);
        ...
        {                     
            try
            {
                SchedaDocumento schedaDoc = UIManager.DocumentManager.getDocumentDetailsNoSecurity(this.Page, Notification.ID_OBJECT, Notification.ID_OBJECT);
                DocumentManager.setSelectedRecord(schedaDoc);
                TrasmManager.setSelectedTransmission(this.Transmission);
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "closeAJM", "parent.closeAjaxModal('ViewDetailNotify','OPEN_PROJECT');", true);
            }
            catch (System.Exception ex)
            {
                UIManager.AdministrationManager.DiagnosticError(ex);
        ...
        protected void ImgOpenTitolario_Click(object sender, EventArgs e)
        {
            RegistryManager.SetRegistryInSession(RoleManager.GetRoleInSession().registri[0]);
