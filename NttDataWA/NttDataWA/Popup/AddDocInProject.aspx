<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Popup.Master" AutoEventWireup="true"
    CodeBehind="AddDocInProject.aspx.cs" Inherits="NttDataWA.Popup.AddDocInProject" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $('.container input, .container textarea').keypress(function (e) {
                if (e.which == 13) {
                    e.preventDefault();
                    $('.defaultAction').click();
                }
        ...
        function CheckOtherIsCheckedByGVID(spanChk) {
            ...
            Parent = document.getElementById("<%=AddDocInProjectGrid.ClientID%>");
                    ...
                    <div class="row nowrap">
                        ...
                        <div class="col">
                            <asp:RadioButtonList ID="rbl_TipoDoc" runat="server" RepeatLayout="UnorderedList"
                                ...
                                <asp:ListItem Value="ADL_ROLE" id="ADL_ROLE" runat="server"></asp:ListItem>
                                <asp:ListItem Value="STAMPE" id="DocStampe" runat="server"></asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                    </div>
                </fieldset>
                                                    ...
                                                    <div class="col-full">
                                                        <div class="styled-select_full">
                                                            <asp:DropDownList ID="DocumentDdlTypeDocument" runat="server" OnSelectedIndexChanged="DocumentDdlTypeDocument_OnSelectedIndexChanged"
                                                                AutoPostBack="True" CssClass="chzn-select-deselect" Width="40%" onchange="disallowOp('Content2');">
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="" HeaderStyle-Width="1%">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:RadioButton ID="rbSel" runat="server" onclick="CheckOtherIsCheckedByGVID(this);"
                                                            CssClass="clickable" Visible="false" />
                                                    </ItemTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceOldersButtons" runat="server">
    <asp:UpdatePanel ID="upPnlButtons" runat="server" ClientIDMode="Static" UpdateMode="Conditional">
        <ContentTemplate>
            <cc1:CustomButton ID="AddDocInProjectBtnInserisci" runat="server" CssClass="btnEnable"
                CssClassDisabled="btnDisable" OnMouseOver="btnHover" ClientIDMode="Static" OnClientClick="disallowOp('Content2');"
                OnClick="AddDocInProjectBtnOk_Click" Enabled="false" />
            <cc1:CustomButton ID="AddDocInProjectBtnSearch" runat="server" CssClass="btnEnable defaultAction"
