...
<asp:Content ID="ContentPlaceHolderContent" ContentPlaceHolderID="ContentPlaceHolderContent"
    ...
    <div id="container" style="padding: 20px">
        ...
        <asp:Panel ID="PnlAggiungiVisibilita" runat="server">
            ...
            <asp:UpdatePanel ID="UpPnlOptionNotify" runat="server" UpdateMode="Conditional" ClientIDMode="Static">
                <ContentTemplate>
                    <div class="row">
                        <%-- TIPO VISIBILITA --%>
                        ...
                        <div class="col4">
                            <asp:CheckBoxList ID="CbxTipoVisibilita" runat="server" RepeatDirection="Vertical" OnSelectedIndexChanged="CbxTipoVisibilita_SelectedIndexChanged"
                                OnChange="disallowOp('ContentPlaceHolderContent');" AutoPostBack="true">
                                <asp:ListItem Id="cb_proponente" Selected="True" Value="PROPONENTE" runat="server"></asp:ListItem>
                                <asp:ListItem Id="cb_monitoratore" Value="MONITORATORE" runat="server"></asp:ListItem>
                            </asp:CheckBoxList>
                        </div>
                    </div>
                    <div class="row3">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:CheckBoxList ID="cbxOptionNotify" runat="server" RepeatDirection="Vertical">
                                    <asp:ListItem Id="cbxInterruzione" Value="IP" runat="server"></asp:ListItem>
                                    <asp:ListItem Id="cbxConclusione" Value="CP" runat="server"></asp:ListItem>
                                    <asp:ListItem Id="cbxErrore" Value="EP" Selected="True"  runat="server"></asp:ListItem>
                                </asp:CheckBoxList>
                            </div>
                        </div>
                    </div>
