<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Popup.Master" AutoEventWireup="true" CodeBehind="MassiveRemoveVersions.aspx.cs" Inherits="NttDataWA.Popup.MassiveRemoveVersions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .message {text-align: left; line-height: 2em; width: 90%; min-height: 200px; margin: 50px auto 0 auto;}
    ...
    <asp:UpdatePanel ID="UpPnlMessage" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:PlaceHolder ID="plcMessage" runat="server">
                <div class="message">
                    <img src="<%=Page.ResolveClientUrl("~/Images/Common/messager_question.gif")%>" alt="" /> <asp:Literal ID="litMessage" runat="server" />
                </div>
            </asp:PlaceHolder>
        </ContentTemplate>
    </asp:UpdatePanel>
    <asp:UpdatePanel ID="UpPnlVersions" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:PlaceHolder ID="plcVersions" runat="server">
                <div class="row">
                    <asp:RadioButtonList ID="rbl_versioni" runat="server">
                        <asp:listitem id="opt_no_last" runat="server" Value="opt_no_last" Selected="True" />
                        <asp:listitem id="opt_no_last_two" runat="server" Value="opt_no_last_two" />
                    </asp:RadioButtonList>
                </div>
            </asp:PlaceHolder>
        </ContentTemplate>
