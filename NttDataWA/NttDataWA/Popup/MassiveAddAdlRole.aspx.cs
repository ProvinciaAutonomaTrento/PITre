...
{
    public partial class MassiveAddAdlRole : System.Web.UI.Page
    {
        ...
        protected void BtnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (!this.IsFasc)
            {
                this.MoveDocumentsInADLR(MassiveOperationUtils.GetSelectedItems(), report);
            }
            else
            {
                this.MoveProjectsInADLR(MassiveOperationUtils.GetSelectedItems(), report);
            }
        ...
        private void CloseMask(bool withReturnValue)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "closeAjaxModal", "parent.closeAjaxModal('MassiveAddAdlRole', '" + retValue + "');", true);
        }
        ...
        private void MoveProjectsInADLR(List<MassiveOperationTarget> projectsId, MassiveOperationReport report)
        {
            ...
            this.MoveDocumentsInWorkingAreaRole(projectsInfo, report);
        }
        ...
        private void MoveDocumentsInADLR(List<MassiveOperationTarget> documentSystemId, MassiveOperationReport report)
        {
            // Lista delle informazioni sui documenti
            ...
            this.MoveDocumentsInWorkingAreaRole(documentsInfo, report);
        ...
        private void MoveDocumentsInWorkingAreaRole(List<InfoDocumento> documentsInfo, MassiveOperationReport report)
        {
            // Per ogni documento...
            foreach (InfoDocumento docInfo in documentsInfo)
            {
                ...
                try
                {
                    if (DocumentManager.isDocInADLRole(docInfo.idProfile, this.Page) == 0)
                    {
                        SchedaDocumento sd = DocumentManager.getDocumentDetails(this, docInfo.docNumber, docInfo.docNumber);
                        DocumentManager.addAreaLavoroRole(this, sd);
                        report.AddReportRow(
                            id,
                            MassiveOperationReport.MassiveOperationResultEnum.OK,
