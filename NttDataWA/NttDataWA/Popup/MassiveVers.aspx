<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Popup.Master" AutoEventWireup="true" CodeBehind="MassiveVers.aspx.cs" Inherits="NttDataWA.Popup.MassiveVers" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .message {text-align: left; line-height: 2em; width: 90%; margin: 0px auto 0 auto;}
        .warning {text-align: left; line-height: 2em; width: 90%; min-height: 150px; margin: 25px auto 0 auto;}
        .message img {float: left; display: block; margin: 0 20px 20px 0;}
        .warning img {float: left; display: block; margin: 0 20px 20px 0;}
    </style>
</asp:Content>
            ...
            <asp:PlaceHolder ID="plcMessage" runat="server">
                <div class="warning">
                    <asp:Panel runat="server" ID="pnlWarning" Visible="false">
                        <img src="<%=Page.ResolveClientUrl("~/Images/Common/messager_warning.png")%>" alt="" /><asp:Literal ID="litMassiveVersConsolidationWarning" runat="server" /></br>
                    </asp:Panel>
                </div>
                <div class="message">
                    <img src="<%=Page.ResolveClientUrl("~/Images/Common/messager_question.gif")%>" alt="" /><asp:Literal ID="litMessage" runat="server" /></br>
                </div>
            </asp:PlaceHolder>
        </ContentTemplate>
    </asp:UpdatePanel>
