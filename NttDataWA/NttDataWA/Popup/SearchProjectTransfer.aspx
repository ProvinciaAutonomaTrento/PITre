<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Popup.Master" AutoEventWireup="true"
    CodeBehind="SearchProjectTransfer.aspx.cs" Inherits="NttDataWA.Popup.SearchProjectTransfer" %>
                    ...
                    <div id="centerContentAddressbookSx">
                        <fieldset class="basic3">
                            ...
                            <div class="row">
                                ...
                                <div class="colHalf2">
                                    <cc1:CustomTextArea ID="txt_Description" runat="server" CssClass="txt_input" CssClassReadOnly="txt_input_disabled" /></div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="colHalf2">
                                    <cc1:CustomTextArea ID="txt_subProject" runat="server" CssClass="txt_input" CssClassReadOnly="txt_input_disabled" /></div>
                            </div>
                            <div class="row">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <uc1:AutoCompleteExtender runat="server" ID="RapidSenderDescriptionProprietario"
                                            ...
                                            ServiceMethod="GetListaCorrispondentiVeloce" MinimumPrefixLength="2" CompletionInterval="500"
                                            ...
                                            <div class="col">
                                                <p>
                                                    <span class="black">
                                                        ...
                                                        <cc1:CustomTextArea ID="txtInitDtaOpen" runat="server" CssClass="txt_date datepicker"
                                            ...
                                            <div class="col">
                                                <p>
                                                    <span class="black">
                                                        ...
                                                        <cc1:CustomTextArea ID="txtEndDtaOpen" runat="server" CssClass="txt_date datepicker"
                                            ...
                                            <div class="col">
                                                <p>
                                                    <span class="black">
                                                        ...
                                                        <cc1:CustomTextArea ID="txtInitDtaClosed" runat="server" CssClass="txt_date datepicker"
                                                            CssClassReadOnly="txt_date_disabled" />
                                                    </span>
                                                </p>
                                            </div>
                                            <div class="col">
                                                <p>
                                                    <span class="black">
                                                        ...
                                                        <cc1:CustomTextArea ID="txtEndDtaClosed" runat="server" CssClass="txt_date datepicker"
                                                            CssClassReadOnly="txt_date_disabled" Visible="false" />
                                                    </span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="col">
                                            <p>
                                                <span class="black">
                                                    ...
                                                    <cc1:CustomTextArea ID="txtInitDtaCreated" runat="server" CssClass="txt_date datepicker"
                                                        CssClassReadOnly="txt_date_disabled" />
                                                </span>
                                            </p>
                                        </div>
                                        <div class="col">
                                            <p>
                                                <span class="black">
                                                    ...
                                                    <cc1:CustomTextArea ID="txtEndDtaCreated" runat="server" CssClass="txt_date datepicker"
                                                        CssClassReadOnly="txt_date_disabled" Visible="false" />
                                                </span>
                                            </p>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="colHalf2">
                                    <cc1:CustomTextArea ID="TxtNoteProject" runat="server" CssClass="txt_input" CssClassReadOnly="txt_input_disabled"></cc1:CustomTextArea>
                                </div>
                            </div>
                        </fieldset>
                        <div class="row">
                            ...
                            <asp:Panel ID="pnlAdvFilters" CssClass="basic3 hidden" ClientIDMode="Static" runat="server">
                                <div class="row">
                                    <fieldset class="basic4">
                                        <div class="row">
                                            ...
                                            <div class="col-no-margin">
                                                <cc1:CustomTextArea ID="TxtNumProject" runat="server" CssClass="txt_input_half" CssClassReadOnly="txt_input_half_disabled" />
                                            </div>
                                            <div class="col-no-margin">
                                                <strong>
                                                    <asp:Literal ID="litYear" runat="server" /></strong></div>
                                            <div class="col-no-margin">
                                                <cc1:CustomTextArea ID="TxtYear" runat="server" CssClass="txt_input_half" CssClassReadOnly="txt_input_half_disabled" />
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="row">
                                    <fieldset class="azure" style="width: 96%;">
                                        ...
                                        <div class="collapse" style="border-width: 0">
                                                ...
                                                <div class="col">
                                                    <p>
                                                        <span class="black">
                                                            ...
                                                            <cc1:CustomTextArea ID="dtaExpire_TxtFrom" runat="server" CssClass="txt_date datepicker"
                                                ...
                                                <div class="col">
                                                    <p>
                                                        <span class="black">
                                                            ...
                                                            <cc1:CustomTextArea ID="dtaExpire_TxtTo" runat="server" CssClass="txt_date datepicker"
                                        ...
                                        <asp:TemplateField Visible="false" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:RadioButton ID="rbSel" runat="server" onclick="SingleSelect('rbS',this);" OnCheckedChanged="rbSel_CheckedChanged"
                                                    AutoPostBack="true" CssClass="clickable" />
                                            </ItemTemplate>
    ...
    <asp:UpdatePanel ID="upPnlButtons" runat="server" ClientIDMode="Static">
        <ContentTemplate>
            <cc1:CustomButton ID="BtnSearch" runat="server" CssClass="btnEnable" CssClassDisabled="btnDisable"
                OnMouseOver="btnHover" OnClick="BtnSearch_Click" OnClientClick="disallowOp('Content2');" />
            <cc1:CustomButton ID="btnSelectPRJ" runat="server" CssClass="btnEnable" CssClassDisabled="btnDisable"
                OnMouseOver="btnHover" OnClick="BtnSelectPRJ_Click" Enabled="false" OnClientClick="disallowOp('Content2');" />
        ...
        function JsTree() {
            $(function () {
                ...
                .jstree({
                    ...
                    "html_data": {
                        "ajax": {
                            "url": "../Project/Project_getFolders.aspx?d" + new Date().getTime(),
                            "data": function (n) {
                        ...
                        "drag_finish": function (data) {
                            ...
                            if ($('.jstree-draggable-selected').length > 0 && confirm('<asp:Literal id="litConfirmMoveDocuments" runat="server" />'.replace('##', titles.replace('\'', '\\\'')))) {
                                ...
                                $.ajax({
                                    ...
                                    'timeout': 2160000,
                                    'type': 'POST',
                                    'url': "../Project/Project_getFolders.aspx",
                                    'data': {
                ...
                function searchTree(qry) {
                    ...
                    $.getJSON('../Project/Project_getFolders.aspx', { 'q': qry }, function (data) {
                        if (data != null) {
