...
{
    public partial class SearchProjectTransfer : System.Web.UI.Page
    {
        ...
        private static bool codeChanged;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //}
            //else if (caller != null && !caller.Equals("search") && DocumentInWorking != null && !String.IsNullOrEmpty(DocumentInWorking.systemId))
            //{
            //    this.divObjSegn.Visible = true;
            //    this.LblOggetto.InnerText = DocumentInWorking.oggetto.descrizione;
        ...
        protected void PopulateDDLRegistry(DocsPaWR.Ruolo role)
        {
            ...
            if (Request.QueryString["caller"].ToString() == "protocollo")
            {
        ...
        private void InitLanguage()
        {
            ...
            this.btnSelectPRJ.Text = Utils.Languages.GetLabelFromCode("BtnSelectPRJ", language);
            ...
            this.ltrCode.Text = Utils.Languages.GetLabelFromCode("SearchProjectCode", language);
        ...
        protected void BtnSelectPRJ_Click(object sender, EventArgs e)
        {
            ...
            if (caller != null)
            {
                ...
                bool avanza = this.verificaSelezione("authorization", out key, out grid);
                if (avanza)
                {
                    if (HT_fascicoliSelezionati != null)
                    {
        ...
        protected void CloseMask(bool withReturnValue)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "closeMask", "parent.closeAjaxModal('SearchProject',''" + returnValue + ");", true);
            //   ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "closeMask", "if (parent) {parent.closeAjaxModal('SearchProject', '" + returnValue + "');} else {parent.closeAjaxModal('SearchProject', '" + returnValue + "');};", true);
        }
        ...
        private void LoadData(bool updateGrid, int numPage, int nRec, int numTotPage)
        {
            ...
            if (ProjectManager.getProjectInSessionForRicFasc() != null)
                codClass = ProjectManager.getProjectInSessionForRicFasc();
            ...
            if (codClass != null)
            {
                if (codClass != "")
                {
                    ...
                    if (caller != null && caller == "profilo")
                    {
                        ...
                        fascList = ProjectManager.getListaFascicoliPagingCustom(classificazione, regSel, filtroRicerca[0], showChilds, numPage, out  numTotPage, out nRec, rowForPage, false, out idProjects, null, false, false, null, null, true);
                    ...
                    if (caller != null && caller == "protocollo")
                    {
                        fascList = ProjectManager.getListaFascicoliPagingCustom(classificazione, regSel, filtroRicerca[0], showChilds, numPage, out  numTotPage, out nRec, rowForPage, false, out idProjects, null, false, false, null, null, true);
                    ...
                    if (caller != null && caller == "classifica")
                    {
                        fascList = ProjectManager.getListaFascicoliPagingCustom(classificazione, regSel, filtroRicerca[0], showChilds, numPage, out  numTotPage, out nRec, rowForPage, false, out idProjects, null, false, false, null, null, true);
                        //listaFascicoli = ProjectManager.getListaFascicoliPaging(this, classificazione, null, filtroRicerca[0], showChilds, numPage, out numTotPage, out nRec, rowForPage, false, out idProjects, null);
                    }
        ...
        {
            this.btnSelectPRJ.Enabled = true;
            if (HT_fascicoliSelezionati == null)
            {
        ...
        private bool verificaSelezione(string caller, out string key, out bool grid)
        {
            ...
            key = "";
            if (caller != null && caller == "authorization")
            {
                foreach (GridViewRow dgItem in this.GrdFascResult.Rows)
                {
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "closeMask", "if (parent.fra_main) {parent.fra_main.closeAjaxModal('SearchProjectTransfer','" + _ParametroDiRitorno + "');} else {parent.closeAjaxModal('SearchProjectTransfer', '" + _ParametroDiRitorno + "');};", true);
            Response.End();
        }
        ...
        protected void GridDocuments_Details(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(this.rowIndex.Value))
            {
                ...
                if (selRow != -1)
                {
                    ...
                    this.upPnlStruttura.Visible = true;
                    this.upnlStruttura.Visible = true;
                    this.upnlStruttura.Update();
        ...
        protected void BtnChangeSelectedFolder_Click(object sender, EventArgs e)
        {
            ...
            if (project.stato != "C")
            {
                ...
                if (!string.IsNullOrEmpty(folderId))
                {
                    if (caller != null && (caller == "profilo" || caller == "protocollo" || caller == "search"))
                    {
                        ...
                        else
                        {
                            ...
                            returnValue = project.codice + "//" + codice.Substring(0, codice.Length - 1);
                        }
            ...
            if (atList != null && atList.Count > 0)
            {
                ...
                else if (addressBookCallFrom == "CUSTOM")
                {
                    if (HttpContext.Current.Session["idCustomObjectCustomCorrespondent"] != null)
                    {
                        ...
                        {
                            ((UserControls.CorrespondentCustom)this.Page.FindControl(SelectedUniqueIdCustom.ToString())).TxtCodeCorrespondentCustom = corrInSess.CodiceRubrica;
                            ((UserControls.CorrespondentCustom)this.Page.FindControl(SelectedUniqueIdCustom.ToString())).TxtDescriptionCorrespondentCustom = corrInSess.Descrizione;
                            ((UserControls.CorrespondentCustom)this.Page.FindControl(SelectedUniqueIdCustom.ToString())).IdCorrespondentCustom = corrInSess.SystemID;
                        }
                    }
                }
            }
