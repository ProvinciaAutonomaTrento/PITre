<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Popup.Master" AutoEventWireup="true" CodeBehind="transmissions_print_iframe.aspx.cs" Inherits="NttDataWA.Popup.transmissions_print_iframe" %>
...
<div class="container">
    <div class="row">
        <iframe src="transmissions_print.aspx" id="frame" width="100%" frameborder="0"></iframe>
    </div>
</div>
</asp:Content>
