<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDetailTransmission.aspx.cs"
    Inherits="NttDataWA.Popup.ViewDetailTransmission" MasterPageFile="~/MasterPages/Popup.Master" %>
            ...
            <ContentTemplate>
                <div id="containerInfoNotify" style="padding-bottom: 5px">
                    <asp:Table ID="tblInfoNotify" runat="server" CssClass="tbl_rounded2">
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="first2" ID="TableCellLtlObjectDoc" Text='<%$ localizeByText:ViewDetailNotifyDetailTransmission%>'
                        ...
                        <asp:TableRow ID="rowAccepted" runat="server">
                            <asp:TableCell ID="TableCell1" CssClass="first2" runat="server" Text='<%$ localizeByText:ViewDetailNotifyAccepted%>'></asp:TableCell>
                            <asp:TableCell ID="TableCellAccepted" runat="server"></asp:TableCell>
                            <asp:TableCell ID="TableCell2" CssClass="first2" runat="server" Text='<%$ localizeByText:ViewDetailNotifyRejectedThe%>'></asp:TableCell>
                            <asp:TableCell ID="TableCellRejected" runat="server"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow ID="rowNote" runat="server">
                            <asp:TableCell ID="TableCell5" CssClass="first2" runat="server" Text='<%$ localizeByText:ViewDetailNotifyNoteAccRej%>'></asp:TableCell>
                            <asp:TableCell ID="TableCellNoteAccRej" ColumnSpan="3" runat="server"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell CssClass="first2" ID="TableCellLtlNoteGenerali" Text='<%$ localizeByText:ViewDetailNotifyDetailTransmissionNoteGenerali%>'
                                runat="server"></asp:TableCell>
                            <asp:TableCell ID="TableCellTxtNoteGenerali" ColumnSpan="3" runat="server"></asp:TableCell>
                        </asp:TableRow>
...
<asp:Content ID="ContentButtons" ContentPlaceHolderID="ContentPlaceOldersButtons"
    ...
    <asp:UpdatePanel ID="UpPnlButtons" runat="server" ClientIDMode="Static" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <cc1:CustomButton ID="BtnAcceptLF" runat="server" CssClass="btnEnable clickable"
                CssClassDisabled="btnDisable" OnClientClick="disallowOp('ContentPlaceHolderContent');"
                OnMouseOver="btnHover" OnClick="BtnAcceptLF_Click" />
