...
<asp:Content ID="ContentPlaceHolderContent" ContentPlaceHolderID="ContentPlaceHolderContent"
    ...
    <uc:ajaxpopup Id="SelectAttForPublication" runat="server" Url="../popup/SelectAttForPublication.aspx?from=attach"
        Width="1000" Height="600" PermitClose="true" PermitScroll="true" CloseFunction="function (event, ui) {__doPostBack('panelButtons', '');}" />
    <div id="containerTop">
...
<asp:Content ID="ContentButtons" ContentPlaceHolderID="ContentPlaceOldersButtons"
    ...
    <asp:UpdatePanel ID="panelButtons" runat="server" UpdateMode="Conditional" ClientIDMode="Static">
        ...
        <!--<![endif]-->
            <cc1:CustomButton ID="AttachmentsBtnPubbAll" runat="server" CssClass="btnEnable"
                CssClassDisabled="btnDisable" OnMouseOver="btnHover" Text="Pubblicazione Allegati" ClientIDMode="Static" Visible="false"
                OnClick="AttachmentsBtnPubbAll_Click" />
        </ContentTemplate>
    </asp:UpdatePanel>
