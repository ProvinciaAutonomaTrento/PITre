<%@ Page Language="C#" MasterPageFile="~/MasterPages/Base.Master" AutoEventWireup="true"
    CodeBehind="TransmissionsP.aspx.cs" Inherits="NttDataWA.Project.Transmissions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    ...
    <div id="containerTop">
        ...
        <asp:UpdatePanel ID="UpcontainerProjectTabLeftBorder" runat="server" UpdateMode="Conditional"
            ClientIDMode="static">
            <ContentTemplate>
                    ...
                    <div id="containerDocumentTabOrangeInternalSpace">
                        <div id="containerProjectTabOrangeSx">
                            <asp:UpdatePanel runat="server" ID="UpContainerProjectTab" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <uc2:ProjectTabs runat="server" PageCaller="TRANSMISSIONS" ID="ProjectTabs"></uc2:ProjectTabs>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
                            ...
                            <asp:UpdatePanel ID="upPnlGridList" runat="server" class="row" UpdateMode="Conditional"
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grdList" runat="server" Width="98%" AutoGenerateColumns="False"
                                        AllowPaging="True" CssClass="tbl_rounded_custom round_onlyextreme" PageSize="5"
                                        OnRowDataBound="grdList_RowDataBound" OnSelectedIndexChanged="grdList_SelectedIndexChanged">
                                    ...
                                    <asp:Table ID="tblDetails" runat="server" CssClass="tbl_rounded" Visible="false">
                                        <asp:TableRow>
                                            <asp:TableCell ColumnSpan="7" CssClass="th first">
                                                <asp:Literal ID="TransmissionLitDetailsRecipient" runat="server" /></asp:TableCell></asp:TableRow>
                                            ...
                                            <asp:TableCell CssClass="first" ColumnSpan="2">Destinatario</asp:TableCell><asp:TableCell
                                                CssClass="center trasmDetailReason">Ragione</asp:TableCell><asp:TableCell CssClass="center trasmDetailType"
                                                    ColumnSpan="2">Tipo</asp:TableCell><asp:TableCell CssClass="trasmDetailNote">Note</asp:TableCell><asp:TableCell
                                                        CssClass="center trasmDetailDate">Scade il</asp:TableCell></asp:TableRow>
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell CssClass="first">Utente</asp:TableCell><asp:TableCell CssClass="center trasmDetailDate">Vista il</asp:TableCell><asp:TableCell
                                                CssClass="center trasmDetailDate">Acc. il</asp:TableCell><asp:TableCell CssClass="center trasmDetailDate">Rif. il</asp:TableCell><asp:TableCell
                                                    CssClass="center trasmDetailDate">Rimossa</asp:TableCell><asp:TableCell CssClass="center"
                                                        ColumnSpan="2">Info Acc./Info rif.</asp:TableCell></asp:TableRow>
                                        <asp:TableRow ID="rowDetails" runat="server" CssClass="users">
                                        ...
                                        <ContentTemplate>
                                            <fieldset id="fldset_noteAccRif" runat="server" clientidmode="Static">
                                                <div class="row">
                                                    ...
                                                    <cc1:CustomTextArea ID="txt_noteAccRif" runat="server" />
                                                </div>
                                            </fieldset>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
