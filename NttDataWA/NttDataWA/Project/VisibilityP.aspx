<%@ Page Language="C#" MasterPageFile="~/MasterPages/Base.Master" AutoEventWireup="true"
    CodeBehind="VisibilityP.aspx.cs" Inherits="NttDataWA.Project.Visibility" %>
...
<asp:Content ID="ContentPlaceHolderContent" ContentPlaceHolderID="ContentPlaceHolderContent"
    runat="server">
    <uc:ajaxpopup Id="VisibilityHistory" runat="server" Url="../popup/VisibilityHistory.aspx?tipoObj=F"
        Width="800" Height="500" PermitClose="false" PermitScroll="true" CloseFunction="function (event, ui) {__doPostBack('containerProject', ''); }" />
    <uc:ajaxpopup Id="VisibilityRemove" runat="server" Url="../popup/VisibilityRemove.aspx"
        Width="600" Height="400" PermitClose="false" PermitScroll="true" CloseFunction="function (event, ui) {__doPostBack('containerProject', ''); }" />
    ...
    <uc:ajaxpopup Id="MassiveVisibilityRemove" runat="server" Url="../popup/MassiveVisibilityRemove.aspx?objType=P"
        Width="600" Height="400" PermitClose="false" PermitScroll="true" CloseFunction="function (event, ui) {__doPostBack('containerProject', ''); }" />
    <uc:ajaxpopup Id="MassiveVisibilityRestore" runat="server" Url="../popup/MassiveVisibilityRestore.aspx?objType=P"
        Width="600" Height="400" PermitClose="false" PermitScroll="true" CloseFunction="function (event, ui) {__doPostBack('containerProject', ''); }" />
                ...
                <div id="containerDocumentTab" class="containerProjectTab">
                    <div id="containerDocumentTabOrangeInternalSpace">
                        <asp:UpdatePanel runat="server" ID="UpContainerProjectTab" UpdateMode="Conditional"
                            ClientIDMode="Static">
                            <ContentTemplate>
                                <uc2:ProjectTabs runat="server" PageCaller="VISIBILITY" ID="ProjectTabs"></uc2:ProjectTabs>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="PnlInfoVisibility" runat="server" Visible="false">
                                        <div id="containerProjectCxBottomDx">
                                            ...
                                            style=" margin-left:130px" Width="25px" Height="25px" CssClass="clickableLeft"/>
                                        </div>
                                    </asp:Panel>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpPnlRole" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                   ...
                                                   <uc1:AutoCompleteExtender runat="server" ID="RapidRole" TargetControlID="TxtDescriptionRole"
                                                        ...
                                                        OnClientPopulated="acePopulatedRole">
                                                    </uc1:AutoCompleteExtender>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                        ...
                                        <div class="row">
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <%--<div class="colHalf">--%>
                                                    <div class="col-full">
                                                        <asp:DropDownList ID="DdlCause" runat="server" Width="98%" CssClass="chzn-select-deselect">
                                            ...
                                            <ItemTemplate>
                                                <cc1:CustomImageButton ID="ImgRoleHistory" runat="server" CommandName="ShowHistoryRole" ImageUrl="../Images/Icons/obj_history.png"
                                                    ...
                                                    ToolTip='<%$ localizeByText:VisibilityObjHistoryRole%>' CssClass="clickableLeft"
                                                     Visible='<%# this.ShowHistoryRole((NttDataWA.Project.Visibility.DocumentsVisibility) Container.DataItem) %>' />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                                <cc1:CustomImageButton ID="ImgHistory" runat="server" CommandName="History" ImageUrl="../Images/Icons/obj_history.png"
                                                    OnMouseOutImage="../Images/Icons/obj_history.png" OnMouseOverImage="../Images/Icons/obj_history_hover.png"
                                                    OnClientClick="return ajaxModalPopupVisibilityHistory();" ToolTip='<%#  this.GetTitle()%>'
