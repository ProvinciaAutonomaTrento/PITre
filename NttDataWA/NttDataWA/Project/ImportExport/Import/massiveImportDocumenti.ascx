<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="massiveImportDocumenti.ascx.cs" Inherits="NttDataWA.Project.ImportExport.Import.massiveImportDocumenti" %>
    ...
    <TR style="background-color:AntiqueWhite;">
	    ...
	    <TD class="testo_grigio_scuro" vAlign="middle" align="right" height="10%">									    
		    <asp:ImageButton ID="btn_stampa" Visible="true" Runat="server" AlternateText="Esporta il log delle operazioni."
			    ImageUrl="../Images/export.gif"  OnClientClick="lanciaVisPdf();" 
