...
namespace NttDataWA.Project
{
    ...
    public partial class Project_getFolders : System.Web.UI.Page
    {
        ...
        private string GetSubFolders(DocsPaWR.Folder folder, bool isRoot)
        {
            try
            {
                Fascicolo proj = ProjectManager.getProjectInSession();
                ...
                string html = "   <li id=\"" + type + "_" + folder.systemID + "\"" + cssClass + " data-title=\"" + utils.FormatJs(utils.FormatHtml(folder.descrizione)) + "\">\n"
                            + "       <a href=\"#\" class=\"document_ellipsis clickableRightNoHtml\" title=\"" + utils.FormatJs(utils.FormatHtml(folder.descrizione)) + "\">" + utils.FormatHtml(folder.descrizione) + "</a>\n";
        ...
        private bool CreateNewFolder(DocsPaWR.Folder folderSelected, string parentId, out DocsPaWR.ResultCreazioneFolder result)
        {
            ...
            try
            {
                if (folderSelected != null)
                {
                    ...
                    newFolder.idFascicolo = ProjectManager.getProjectInSession().systemID;
