	...
	public partial class Create : System.Web.UI.Page
	{
        ...
        public void ProcessRequest()
        {
            ...
            if (schedaDocumentoSelezionata==null)
                schedaDocumentoSelezionata = CheckInOutApplet.CheckInOutServices.CurrentSchedaDocumento;
            */
            // Carica modello
            String databinding = schedaDocumentoSelezionata.template.PATH_MODELLO_1;

            // Elabora FQN
            String fqn = Utils.MTextUtils.Id2FullQualifiedName(documentNumber);

            // Crea documento
            try
            {
                fqn = mtext.CreateDocument(fqn, Utils.MTextUtils.CustomObject2Dictionary(schedaDocumentoSelezionata.template), databinding);
            }
            catch (Exception e)
            {
