<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Base.Master" AutoEventWireup="true" CodeBehind="ImportRDE.aspx.cs" Inherits="NttDataWA.ImportDati.ImportRDE" %>
                                ...
                                <asp:PlaceHolder id="plcReport" runat="server" Visible="false">
                                    <div id="tabs">
                                        <ul>
                                            ...
                                            <li><a href="#tabs-2"><asp:Literal ID="lblTabArrive" runat="server"></asp:Literal></a></li>
                                            <li><a href="#tabs-3"><asp:Literal ID="lblTabLeaving" runat="server"></asp:Literal></a></li>
                                            <asp:PlaceHolder ID="plcInternal" runat="server"><li><a href="#tabs-4"><asp:Literal ID="lblTabInternal" runat="server"></asp:Literal></a></li></asp:PlaceHolder>
                                            <li><a href="#tabs-7"><asp:Literal ID="lblTabReportPdf" runat="server"></asp:Literal></a></li>
                                        </ul>
                                        <div id="tabs-1">
                                            <!-- generale -->
