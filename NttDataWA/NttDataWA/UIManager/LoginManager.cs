...
namespace NttDataWA.UIManager
{
    public class LoginManager
    {
        ...
        public static DocsPaWR.ValidationResultInfo ResetPasswordUtente(UserLogin userLogin, string otp)
        {
            return docsPaWS.ResetPasswordUtente(userLogin, otp);
        }

        public static DocsPaWR.ResetPasswordResult ResetPasswordInviaOTP(string userId, out string email)
        {
            email = string.Empty;
            return docsPaWS.ResetPasswordInviaOTP(userId, out email);
        }
    }
}