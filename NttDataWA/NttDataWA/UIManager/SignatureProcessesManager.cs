...
namespace NttDataWA.UIManager
{
    public class SignatureProcessesManager
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ProcessoFirma> GetProcessesSignatureVisibleRole(bool asProponente, bool asMonitoratore)
        {
            try
            {
                return docsPaWS.GetProcessesSignatureVisibleRole(asProponente, asMonitoratore, UserManager.GetInfoUser()).ToList<ProcessoFirma>();
            }
            catch (System.Exception ex)
            {
                return null;
