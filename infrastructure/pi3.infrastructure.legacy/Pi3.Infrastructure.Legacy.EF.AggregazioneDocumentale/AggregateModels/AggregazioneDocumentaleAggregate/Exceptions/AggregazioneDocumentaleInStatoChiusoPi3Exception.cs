...
{
    public class AggregazioneDocumentaleInStatoChiusoPi3Exception : Pi3Exception
    {
        #region Public Members

        public AggregazioneDocumentaleInStatoChiusoPi3Exception(string idAggregazioneDocumentale)
            : base(ErrorDescriptions.AggregazioneDocumentaleInStatoChiuso, null, ErrorDescriptions.ResourceManager, idAggregazioneDocumentale)
        {
