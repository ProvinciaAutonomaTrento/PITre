...
{
    public class ProfileNotFoundPi3Exception : NotFoundPi3Exception
    {
        #region Public Members

        public ProfileNotFoundPi3Exception(string idProfile)
            : base(ErrorDescriptions.ProfileNotFound, null, ErrorDescriptions.ResourceManager, idProfile)
        {
            IdProfile = idProfile;
        }
