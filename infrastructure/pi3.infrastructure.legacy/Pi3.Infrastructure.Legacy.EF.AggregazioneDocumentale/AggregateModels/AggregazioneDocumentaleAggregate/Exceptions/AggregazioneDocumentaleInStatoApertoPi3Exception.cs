...
{
    public class AggregazioneDocumentaleInStatoApertoPi3Exception : Pi3Exception
    {
        #region Public Members

        public AggregazioneDocumentaleInStatoApertoPi3Exception(string idAggregazioneDocumentale)
            : base(ErrorDescriptions.AggregazioneDocumentaleInStatoAperto, null, ErrorDescriptions.ResourceManager, idAggregazioneDocumentale)
        {
