...
{
    public class UfficioNotFoundPi3Exception : NotFoundPi3Exception
    {
        #region Public Members

        public UfficioNotFoundPi3Exception(string idUfficio)
            : base(ErrorDescriptions.UfficioNotFound, null, ErrorDescriptions.ResourceManager, idUfficio)
        {
            IdUfficio = idUfficio;
        }
