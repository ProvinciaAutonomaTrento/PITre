...
namespace Doc.Application.Search.DocumentoAmministrativo;

public static class DocumentExtensions
{
    public static void FillDocumentoAmministrativo(this DocumentoAmministrativoEntity doc, Aggregates.DocumentoAmministrativoAggregate.DocumentoAmministrativo aggregate)
    {
