...
builder.Services.AddInfrastructureDocumentoAmministrativo();
builder.Services.AddInfrastructureElasticSearch();

builder.Services.Configure<IndexingOptions>(builder.Configuration.GetSection(key: nameof(IndexingOptions)));
