...
namespace Pi3.App.Search.WebApi.Application.Queries.Elements.GetElements
{
    public class GetElementsQueryHandler : IRequestHandler<GetElementsQuery, GetElementsQueryResults>
    {
        ...
        public GetElementsQueryHandler(
            ...
            DocumentoAmministrativoSearchService documentoAmministativoQueryService)
        {
            this._logger = logger;
        ...
        {
            var serviceRequest = new pi3.Core.Contracts.DocumentoAmministrativo.Query.GetElementsQuery()
            {
                Skip = request.Skip,
                Take = request.Take,
                Types = request.Types,
            ...
            return await this.documentoAmministativoQueryService.GetElements(serviceRequest);
        ...
        private readonly DocumentoAmministrativoSearchService documentoAmministativoQueryService;
