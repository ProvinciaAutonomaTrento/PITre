...
{
    public class RuoloCorrispondenteNotValidPi3Exception : NotFoundPi3Exception
    {
        #region Public Members

        public RuoloCorrispondenteNotValidPi3Exception(string idRuoloCorrispondente)
            : base(ErrorDescriptions.RuoloCorrispondenteNotValid, null, ErrorDescriptions.ResourceManager, idRuoloCorrispondente)
        {
