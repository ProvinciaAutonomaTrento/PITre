...
{
    public class DocAlreadyInFolderPi3Exception : Pi3Exception
    {
        #region Public Members

        public DocAlreadyInFolderPi3Exception()
            : base(ErrorDescriptions.DocAlreadyInFolderPi3Exception, null, ErrorDescriptions.ResourceManager)
        {
        }
