...
{
    public class FolderHasDocInsideException : Pi3Exception
    {
        public FolderHasDocInsideException()
           : base(ErrorDescriptions.FolderHasDocInsideException, null, ErrorDescriptions.ResourceManager)
        {
