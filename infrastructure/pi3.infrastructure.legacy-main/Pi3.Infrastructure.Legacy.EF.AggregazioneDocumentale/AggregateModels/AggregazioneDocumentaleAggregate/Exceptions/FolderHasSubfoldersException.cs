...
{
    public class FolderHasSubfoldersException : Pi3Exception
    {
        public FolderHasSubfoldersException()
           : base(ErrorDescriptions.FolderHasSubfoldersException, null, ErrorDescriptions.ResourceManager)
        {
