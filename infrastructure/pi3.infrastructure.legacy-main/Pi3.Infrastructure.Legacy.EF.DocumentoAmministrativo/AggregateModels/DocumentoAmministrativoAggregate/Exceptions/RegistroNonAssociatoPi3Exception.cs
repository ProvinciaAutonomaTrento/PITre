...
{
    public class RegistroNonAssociatoPi3Exception : Pi3Exception
    {
        #region Public Members

        public RegistroNonAssociatoPi3Exception()
            : base(ErrorDescriptions.RegistroNonAssociato, ErrorDescriptions.ResourceManager)
        {
        }
