...
{
    public class RegistroInStatoChiusoPi3Exception : Pi3Exception
    {
        #region Public Members

        public RegistroInStatoChiusoPi3Exception(string idRegistro)
            : base(ErrorDescriptions.RegistroInStatoChiuso, ErrorDescriptions.ResourceManager, idRegistro)
        {
        }
