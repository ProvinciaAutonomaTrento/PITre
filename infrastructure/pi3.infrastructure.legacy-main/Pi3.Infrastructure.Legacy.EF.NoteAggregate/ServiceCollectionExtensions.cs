...
namespace Pi3.Infrastructure.Legacy.EF
{
    ...
    {
        public static IServiceCollection AddInfrastructureLegacyEFNotaAggregate(
            this IServiceCollection services)
        {
            services.AddPi3Core();

            _ = services.RemoveAll<INotaRepository>().AddScoped<INotaRepository, NotaEFRepository>();
