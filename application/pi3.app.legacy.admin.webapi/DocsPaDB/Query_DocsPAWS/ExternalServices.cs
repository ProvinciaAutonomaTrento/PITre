...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(ExternalServices));
    ...
    public List<Servizio> getServizi()
    {
        ...
        {
            logger.Debug(ex, "errore in getServizi");
    ...
    public void caricaParametri(Servizio servizio)
    {
        ...
        {
            logger.Debug(ex, "errore in caricaParametri");
            throw new Exception(ex.Message);
        }
    }
}
