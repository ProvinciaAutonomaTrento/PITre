...
public class InstanceAccessDB : DBProvider
{
    ...
    private static ILogger logger = Serilog.Log.ForContext(typeof(InstanceAccessDB));
    ...
    {
        logger.Information("Inizio Metodo GetInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetInstanceAccess", exc);
            return null;
        }
        logger.Information("Fine Metodo GetInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
    ...
    {
        logger.Information("Inizio Metodo GetInstanceAccessById in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetInstanceAccessById", exc);
            return null;
        }
        logger.Information("Fine Metodo InsertInstanceAccessById in DocsPaDb.Query_DocsPAWS.InstanceAccess");
    ...
    {
        logger.Information("Inizio Metodo GetInstanceAccessDocuments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetInstanceAccessDocuments", exc);
            return null;
        }
        logger.Information("Fine Metodo GetInstanceAccessDocuments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
    ...
    {
        logger.Information("Inizio Metodo GetInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetInstanceAccessAttachments", exc);
            return null;
        }
        logger.Information("Fine Metodo GetInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
    ...
    {
        logger.Information("Inizio Metodo GetStateDownloadInstanceAccesss in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetStateDownloadInstanceAccess", exc);
            return stateDownload;
        }
        logger.Information("Fine Metodo GetStateDownloadInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return stateDownload;
    }
    ...
    {
        logger.Information("Inizio Metodo GetIdProfileDownload in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        string stateDownload = string.Empty;
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetIdProfileDownload", exc);
            return stateDownload;
        }
        logger.Information("Fine Metodo GetIdProfileDownload in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return stateDownload;
    }

    public DocsPaVO.ProfilazioneDinamica.Templates GetTemplate(DocsPaVO.utente.InfoUtente infoUtente)
    {
        logger.Information("Inizio Metodo GetTemplate in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetTemplate", exc);
            return null;
        }
        logger.Information("Fine Metodo GetTemplate in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return template;
    }
    ...
    {
        logger.Information("Inizio Metodo InsertInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        ...
        {
            RollbackTransaction();
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo InsertInstanceAccess", exc);
        }
        CommitTransaction();
        logger.Information("Fine Metodo InsertInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return instanceAccess;
    }
    ...
    {
        logger.Information("Inizio Metodo InsertInstanceAccessDocuments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = true;
        ...
        catch (Exception exc)
        {
            RollbackTransaction();
            result = false;
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo InsertInstanceAccessDocuments", exc);
        }
        logger.Information("Fine Metodo InsertInstanceAccessDocuments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return result;
    }
    ...
    {
        logger.Information("Inizio Metodo InsertInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = true;
        try
        {
        ...
        catch (Exception exc)
        {
            RollbackTransaction();
            result = false;
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo InsertInstanceAccessAttachments", exc);
        }
        logger.Information("Fine Metodo InsertInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return result;
    }
    ...
    {
        logger.Information("Inizio Metodo UpdateInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = false;
        string query;
        int rowAffected;
        try
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo UpdateInstanceAccess", exc);
            RollbackTransaction();
            instanceAccess = null;
        }
        logger.Information("Fine Metodo UpdateInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return instanceAccess;
    }
    ...
    {
        logger.Information("Inizio Metodo UpdateInstanceAccessDocuments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = true;
        string query;
        int rowAffected;
        try
    ...
    { 
        logger.Information("Inizio Metodo UpdateRequestDateInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = false;
        string query;
        int rowAffected;
        try
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo UpdateRequestDateInstanceAccess", exc);
        }
        logger.Information("Fine Metodo UpdateRequestDateInstanceAccess in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return result;
    }
    ...
    {
        logger.Information("Inizio Metodo UpdateInstanceAccessDocumentEnabled in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = true;
        string query;
        int rowAffected;
        try
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo UpdateInstanceAccessDocumentEnable", exc);
            return false;
        }
        logger.Information("Fine Metodo UpdateInstanceAccessDocumentEnable in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return result;
    }
    ...
    {
        logger.Information("Inizio Metodo RemoveAllInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = true;
        int rowAffected;
        try
        {
        ...
        {
            result = false;
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo RemoveAllInstanceAccessAttachments", exc);
            throw exc;
        }
        logger.Information("Fine Metodo RemoveAllInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return result;
    }
    ...
    {
        logger.Information("Inizio Metodo RemoveInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        bool result = true;
        int rowAffected;
        try
        {
        ...
        catch (Exception exc)
        {
            RollbackTransaction();
            result = false;
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo RemoveInstanceAccessAttachments", exc);
        }
        logger.Information("Fine Metodo RemoveInstanceAccessAttachments in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        return result;
    }
    ...
    private int GetTypeAttach(string docnumber)
    {
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo GetTypeAttach", exc);
            throw exc;
        }
        return type;
    ...
    {
        logger.Information("Inizio Metodo UpdatePrepareDownload in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        string query;
        int rowAffected;
        try
        {
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo CreateDownloadInstanceAccess", exc);
        }
        logger.Information("Fine Metodo CreateDownloadInstanceAccess in DocsPaDb.Query_DocsPAWS.CreateDownloadInstanceAccess");
    }

    public void UpdateIdProfileDownload(string idProfile, string idInstanceAccess, DocsPaVO.utente.InfoUtente infoUtente)
    {
        logger.Information("Inizio Metodo InsertIdProfileDownload in DocsPaDb.Query_DocsPAWS.InstanceAccess");
        string query;
        int rowAffected;
        try
        {
        ...
        {
            logger.Information("Errore in DocsPaDb.Query_DocsPAWS.InstanceAccess - Metodo InsertIdProfileDownload", exc);
        }
        logger.Information("Fine Metodo InsertIdProfileDownload in DocsPaDb.Query_DocsPAWS.InstanceAccess");
    }
