...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(ExportProcessiDiFirmaReport));
    ...
    public DataSet GetProcessiDiFirmaByTitolare(InfoUtente infoUt, List<FiltroRicerca> filters)
    {
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            try
            {
                ...
                {
                    query.setParam("idRuoloTitolare", " AND ID_RUOLO_COINVOLTO = " + idRuoloTitolare);
