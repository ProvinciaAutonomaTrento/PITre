...
///alla storia dei documenti 
/// </summary>
[ReportDataExtractorClass()]
class ReportStoriaDocumenti
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(ReportStoriaDocumenti));

    [ReportDataExtractorMethod(ContextName = "ReportStoriaDocumenti")]
    public DataSet GetReportConservazione(InfoUtente userInfo, List<FiltroRicerca> searchFilters)
    {
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            ...
            Query query = InitQuery.getInstance().getQuery("S_REPORT_STORIA_DOCUMENTI_CONSERVAZIONE");
