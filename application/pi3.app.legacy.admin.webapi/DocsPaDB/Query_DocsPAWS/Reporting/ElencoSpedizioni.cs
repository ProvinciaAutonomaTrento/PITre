...
namespace DocsPaDB.Query_DocsPAWS.Reporting
{
    ...
    public class ElencoSpedizioni
    {
        ...
        public DataSet GetModelliTrasmissioneReport(InfoUtente userInfo, List<FiltroRicerca> searchFilter)
        {
            ...
            if (string.IsNullOrEmpty(searchFilter[0].listaFiltriSpedizioni.IdDocumento) && (searchFilter[0].listaFiltriSpedizioni.idDocumenti == null || searchFilter[0].listaFiltriSpedizioni.idDocumenti.Count == 0))
            ...
            else if (searchFilter[0].listaFiltriSpedizioni.idDocumenti != null && searchFilter[0].listaFiltriSpedizioni.idDocumenti.Count > 0)
            {
                return MappingListSpedizioni(interop.GetReportSpedizioniDocumenti(searchFilter[0].listaFiltriSpedizioni, searchFilter[0].listaFiltriSpedizioni.idDocumenti, userInfo.idGruppo));
            }
            else
            {
