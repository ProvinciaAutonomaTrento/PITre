...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(CheckInOut));
    /// <summary>
    /// 
    /// </summary>
    public CheckInOut()
    ...
    {
        return DocsPaVO.Settings.AppSettings.Instance.DOC_ROOT;
    }
    ...
    /// <summary>
    /// Verifica se per l'ultima versione del documento corrente � stato acquisito un file
    /// </summary>
    /// <param name="fileRequest"></param>
    /// <returns></returns>
