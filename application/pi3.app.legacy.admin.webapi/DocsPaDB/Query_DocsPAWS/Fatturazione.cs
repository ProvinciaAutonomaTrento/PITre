...
public class Fatturazione : DBProvider
{
    ...
    private static ILogger logger = Serilog.Log.ForContext(typeof(Fatturazione));
    ...
    public FatturaPA getFattura(string idamm, string idFattura)
    {
        ...
        {
            logger.Debug(ex, "errore in getFattura");
    ...
    public string getXSDSchema(string idAmm)
    {
        ...
        {
            logger.Debug(ex, "errore in getXSDSchema");
            throw new Exception(ex.Message);
        }
    }
    ...
    public string getXmlTemplate(string idAmm)
    {
        ...
        {
            logger.Debug(ex, "errore in getXmlTemplate");
            throw new Exception(ex.Message);
        }
    }
    ...
    public bool LogFattura(string numero, string dataCreazione, string fornitore, string logMessage, string idProfile)
    {
        ...
        {
            logger.Debug("Errore nell'inserimento del log: {0}\r\n{1}", ex.Message, ex.StackTrace);
            result = false;
        }
    ...
    public string CheckNumFattura(string numero, string idAmm)
    {
        ...
        {
            logger.Debug("Errore nella ricerca del numero fattura : {0}\r\n{1}", ex.Message, ex.StackTrace);
            retVal = "-1";
        }
    ...
    public bool CheckIdRicevutaFattura(string messageId)
    {
        ...
        {
            logger.Debug("Errore nel controllo della presenza della mail: {0}\r\n{1}", ex.Message, ex.StackTrace);
        }
    ...
    public bool InsertIdRicevutaFattura(string messageId)
    {
        ...
        {
            logger.Debug("Errore nell'inserimento della mail: {0}\r\n{1}", ex.Message, ex.StackTrace);
        }
    ...
    public bool UpdateAssociazioneIdSdi(string idFattura, string idSdi, string docnumber)
    {
        ...
        try
        {
            ...
            logger.Debug("{0} rows affected", rowsAffected.ToString());
            result = true;
        }
        catch(Exception ex)
        {
    ...
    public List<string> ImportFatture_GetFatture()
    {
        ...
        try
        {
            ...
            logger.Debug("{0} fatture trovate ", ds.Tables[0].Rows.Count);
    ...
    public List<string> ImportFatture_GetFattureDaInviare()
    {
        ...
        try
        {
            ...
            logger.Debug("{0} fatture da inviare a SDI ", ds.Tables[0].Rows.Count);
