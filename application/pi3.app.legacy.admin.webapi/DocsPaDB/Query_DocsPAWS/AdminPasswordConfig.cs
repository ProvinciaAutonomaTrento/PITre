...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(AdminPasswordConfig));
    ...
    public static bool SavePasswordConfigurations(PasswordConfigurations configurations)
    {
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            ...
            // Se il numero di giorni di validit� � cambiato
    ...
    /// <summary>
    /// Verifica se � abilitata l'autenticazione di dominio per l'amministrazione
    /// </summary>
    /// <param name="idAmministrazione"></param>
    /// <returns></returns>
    ...
    ///       per i giorni di validit� � stato modificato
    ///     - se il numero di giorni impostato � 0, la scadenza
    ///       password � stata disabilitata, quindi per tutti gli utenti
    ///       verr� rimossa la data di creazione
    ///     - se il numero di giorni precedente a quello attuale era 0,
    ///       verr� aggiornata per tutti gli utenti la data di creazione
    /// </remarks>
    /// </summary>
