...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(SmistamentoDocumenti));
    ...
    public DataSet GetDocumentoSmistamento(string idDocumento)
    {
        ...
        if (ds.Tables.Count > 0 && ds.Tables["DOCUMENTI"].Rows.Count > 0)
        {
            ...
            // Se il documento � protocollato e di tipo "A", "P", "I" (arrivo, partenza, interno),
                                ...
                                bool modelloNoNOtify)
    {
        ...
        try
        {
			...
			finally
			{
                ...
                case -5:
                    retValue.DescrizioneEsitoSmistamento = "Si � verificato un errore durante lo smistamento agli utenti";
                                ...
                                bool modelloNoNotify)
    {
        ...
        //RIGHTS ORIGINALI
        //05/02/2018: commentata la riga seguente perch� impostava al ruolo che sta effettuando lo smistamento i diritti del destinatario
        //parameters.Add(this.CreateParameter("OriginalRights", this.GetAccessRightSmistamentoOriginali(ragioneSmistamento)));
                                        ...
                                        string accessRights)
    {
        ...
        // gestione della visibilit� anche ai pari livello (solo per le UO superiori)
        anchePariLivello = DocsPaVO.Settings.AppSettings.Instance.EST_VIS_SUP_PARI_LIV;
        ...
        // FINE ... (gestione della visibilit� anche ai pari livello)
    ...
    /// <summary>
    /// Verifica se il sistema � impostato ad avere la gestione della visibilit� posticipata ai superiori gerarchici
    ...
    /// <summary>
    /// Restituisce la lista degli id_corr_globali all'interno della UO di Appartenenza, per cui il documento � stato gi� trasmesso
    /// </summary>
