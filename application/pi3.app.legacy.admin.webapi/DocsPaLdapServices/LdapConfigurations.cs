...
public sealed class LdapConfigurations
{
    ...
    /// </summary>
    public static void CheckForLdapIntegrationActivated(string idAmministrazione = "0")
    {
        if (!Convert.ToBoolean(DocsPaUtils.Configuration.InitConfigurationKeys.GetValue(idAmministrazione, "LdapIntegrationActive")))
    ...
    public static LdapConfig GetLdapConfig(string idAmministrazione)
    {
        ...
        bool ldapIntegrationActive = Convert.ToBoolean(DocsPaUtils.Configuration.InitConfigurationKeys.GetValue(idAmministrazione, "LdapIntegrationActive"));
    ...
    public static void SaveLdapConfig(string idAmministrazione, LdapConfig ldapInfo)
    {
        ...
        {
            // Verifica se l'integrazione con ldap è attivata
            CheckForLdapIntegrationActivated(idAmministrazione);
