...
class ExternalModule
{
    ...
    */
    ...
    public bool externalClrCheckWS(string CLRWsUrl, string fileToverify, DateTime? dateVerifica, bool isPadesAndCades = false)
    {
        ...
        {
            logger.Error("l'Url del componente di verifica firma non è stato specificato");
            throw new Exception("l'Url del componente di verifica firma non è stato specificato");
        }
