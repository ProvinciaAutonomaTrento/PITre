...
namespace BusinessLogic.Documenti.DigitalSignature
{
    public class SignedDocument
    {
        ...
        { get { return (_SignType); } set { _SignType = value; } }

        public string SignAlgorithm
        { get { return (_SignAlgorithm); } set { _SignAlgorithm = value; } }

        public string SignHash
        { get { return (_SignHash); } set { _SignHash = value; } }

        public string DocumentFileName
        { get { return (_documentFileName); } set { _documentFileName = value; } }
        ...
        { get { return _signersInfo; } set { _signersInfo = value; } }
        ...
        public bool LoadFromFile(string pathName)
        {
            ...
            try
            {
                ...
                var read = fsi.Read(_buf, 0, (int)fileLength);
                _pathName = pathName;
                rc = true;
            }
        ...
        public bool Verify(ref List<string> ErrorMessageLst)
        {
            ...
            try
            {
                ...
                if (DigAlgAsn1 != null)
                    this._SignAlgorithm = Org.BouncyCastle.Security.DigestUtilities.GetAlgorithmName(Org.BouncyCastle.Asn1.X509.AlgorithmIdentifier.GetInstance(DigAlgAsn1).ObjectID);
        ...
        {
#if false // problema con bouncy castle
