...
//	}
	...
	public struct CertificateInfo
	{
        ...
        public string ValidFromDateStr;          // Valido da Stringa [Volute da Luca Luciani: le date in ingresso arrivano dai client delega al server la conversione (Activex Applet Socket SmartClient)]
        public string ValidToDateStr;            // Valido fino a String [Volute da Luca Luciani: le date in ingresso arrivano dai client delega al server la conversione (Activex Applet Socket SmartClient)]
	}
    ...
    public class VerifySignatureResult
	{
        ...
        [DataMember]
        public string FinalDocumentName { get; set; }
        [DataMember]
        public bool CRLOnlineCheck { get; set; }
        [DataMember]
        public PKCS7Document [] PKCS7Documents { get; set; }
        [DataMember]
        public TSInfo[] DocumentTimeStampInfo { get; set; }
        [DataMember]
