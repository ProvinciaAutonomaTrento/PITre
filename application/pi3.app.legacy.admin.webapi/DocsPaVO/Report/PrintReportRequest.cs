...
namespace DocsPaVO.Report
{
    ...
    /// </summary>
    [Serializable()]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(PrintReportRequestDataset))]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(PrintReportObjectTransformationRequest))]
    public class PrintReportRequest
    {
        /// <summary>
        /// Informazioni sull'utente richiedente
        /// </summary>
        public InfoUtenteAmministratore UserInfo { get; set; }
