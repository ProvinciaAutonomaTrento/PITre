...
namespace DocsPaUtils.Interfaces.DbManagement
{
	...
	public interface IDatabase : IDisposable
	{
        ...
        bool ExecuteQuery(out DataSet dataSet, string tableName, string command, ArrayList parameters);
		...
		/// <param name="command">Comando da eseguire sul database</param>
		/// <returns>true = OK; false = Errore durante l'esecuzione del comando</returns>
		bool ExecuteNonQuery(string command, ArrayList parameters);
        ...
        IDataReader ExecuteReader(string qry, ArrayList parameters);
