...
// SPDX-License-Identifier: AGPL-3.0-or-later AND LicenseRef-Chilkat
using Chilkat;
using Serilog;
...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(ChilkatEmailComponent));
    ...
    private void mmInitializeImap()
    {
        ...
        imap.StartTls = (this.smtpSTA == "1") ? true : false;
    }
