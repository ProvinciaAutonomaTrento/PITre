...
namespace BusinessLogic.AS400
{
    public class AS400
    {
        private static ILogger logger = Serilog.Log.ForContext(typeof(AS400));
        public AS400()
        {
        ...
        public static void setAs400InFolder(string idProfile, DocsPaVO.utente.InfoUtente infoUtente, string idFolder, string constAs400)
        {
            ...
            //AS400
            string AS400 = DocsPaVO.Settings.AppSettings.Instance.AS400;
            ...
            {
                logger.Debug(e, "errore in setAs400InFolder");
            }
            finally
            {
                if (db != null)
        ...
        public static void setAs400(DocsPaVO.documento.SchedaDocumento schedaDoc, string constAs400)
        {
            ...
            catch (Exception e)
            {
                ...
                logger.Debug(e, "errore in setAs400");
            }
            finally
            {
                if (db != null)
