                ...
                if (obj is Array array)
                {
                    ...
                    foreach (XmlNode xmlNode in array)
                    {
                        if (pointer == 1 || pointer == 2)
                            dataTable.Columns.Add(new DataColumn(xmlNode.Name));
            ...
            foreach (object obj in objList)
            {
                ...
                else
                {
                    ...
                    if (obj is Array array)
                    {
                        ...
                        {
                            if (pointer == 1){
                                desc = xmlNode.InnerText.Replace("<br />", " ");
                            }
                            else if(pointer == 2){
                                result = xmlNode.InnerText.Replace("<br />", " ");
                            }
                            pointer++;
                        }
                    }
                    dataTable.Rows.Add(new object[] { desc, result }.ToArray());
