...
namespace BusinessLogic.Reporting.Behaviors.ReportGenerator
{
    ...
    public interface IReportGeneratorBehavior
    {
        ...
        FileDocumento GenerateReport(PrintReportRequest request, List<DocsPaVO.Report.Report> reports, ISpreadsheetService spreadsheetService, IFileConverterFactory fileConverterPDF, IReportGeneratorService reportGeneratorService);
