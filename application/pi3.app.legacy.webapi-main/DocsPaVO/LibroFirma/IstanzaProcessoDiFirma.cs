...
namespace DocsPaVO.LibroFirma
{
    ...
    public class IstanzaProcessoDiFirma
    {
        ...
        private string _dataAnnullamentoProtocollo; //DATA ANNULLAMENTO PROTOCOLLO
        ...
        private string _idStatoInterruzione; //ID STATO DEL DIAGRAMMA IN CUI RIPORTARE IL DOCUEMNTO IN CASO DI INTERRUZONE
        #endregion
        ...
        /// <summary>
        /// Data annullamento del protocollo
        /// </summary>
        public string DataAnnullamentoProtocollazione
        {
            get
            {
                return _dataAnnullamentoProtocollo;
            }
            set
            {
                _dataAnnullamentoProtocollo = value;
            }
        }
