...
namespace DocsPaVO.filtri.ricerca 
{
	...
	public enum listaArgomenti 
	{
        ...
        DOCNUMBER_PRINCIPALE,
        DOCNUMBER_PRINCIPALE_DAL,
        DOCNUMBER_PRINCIPALE_AL,
        OGGETTO_ALLEGATO,
		MITT_DEST,
		ID_MITT_DEST,
        ...
        ID_UO_PROTOCOLLATORE,
        ID_RUOLO_PROTOCOLLATORE,
        ID_PEOPLE_PROTOCOLLATORE,
        DESC_PROTOCOLLATORE,
        TIPO_CORR_PROTOCOLLATORE,
        EXTEND_TO_HISTORICIZED_PROTOCOLLATORE,
        MAI_TRASMESSI_AI_DESTINATARI,
        MAI_SPEDITI_AI_DESTINATARI,
        NON_CONFORME,
        IMPRONTA_DOCUMENTO
    }
}
