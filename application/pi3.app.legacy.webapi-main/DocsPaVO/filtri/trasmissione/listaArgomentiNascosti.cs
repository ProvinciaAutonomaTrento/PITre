...
namespace DocsPaVO.filtri.trasmissione
{
    ...
    public enum listaArgomentiNascosti
    {
        ...
        TIPO_FILE_ACQUISITO,
        /// <summary>
        /// Nella pagina ricerca trasmissioni ricevute, � stato selezionato un
        /// ruolo ed � stato flaggato "Estendi a storicizzati"
        /// </summary>
        RUOLO_EXTEND_TO_HISTORICIZED,
        /// <summary>
        /// Nella pagina di ricerca trasmissioni ricevute, � stato selezionato un
        /// ruolo mittente ed � stato flaggato "Estendi a storicizzati"
        /// </summary>
