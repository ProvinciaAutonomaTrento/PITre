	...
	public class SendDocumentResponse
	{
        ...
        public SendDocumentResponse.SendDocumentMailResponse FindDocumentResponse(DocsPaVO.utente.Corrispondente destinatario)
        {
            foreach (SendDocumentResponse.SendDocumentMailResponse response in this.SendDocumentMailResponseList)
            {
                ...
                // Ricerca del destinatario tra i corrispondenti cui � stato inviato il documento
		...
		public SendDocumentMailResponse[] SendDocumentMailResponseList =new SendDocumentMailResponse[0];
		...
		public class SendDocumentMailResponse
		{
			...
			/// <summary>
			/// Flag che definisce se l'indirizzo mail � interoperante o meno
			/// </summary>
           ...
           /// <summary>
			...
			public Corrispondente[] Destinatari =new Corrispondente[0];
