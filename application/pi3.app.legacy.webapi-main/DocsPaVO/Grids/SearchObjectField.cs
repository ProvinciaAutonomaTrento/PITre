...
namespace DocsPaVO.Grids
{
    ...
    {
        public SearchObjectField()
        {
        }

        public SearchObjectField(string searchObjectFieldId, string searchObjectFieldValue)
        {
            this.SearchObjectFieldID = searchObjectFieldId;
            this.SearchObjectFieldValue = searchObjectFieldValue;
        }
