...
namespace DocsPaVO.rubrica
{
	...
	/// string smistamento = indica se � abilitato o meno lo smistamento </summary>
	...
	public class SmistamentoRubrica
	{
		...
		//Flag per indicare se � abilitata o meno la funzionalit� di smistamento
		...
		//Questo perch� lo smistamento deve essere effettuato se smistamento = "1"
