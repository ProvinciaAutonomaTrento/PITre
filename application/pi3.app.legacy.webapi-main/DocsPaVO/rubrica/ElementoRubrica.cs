...
namespace DocsPaVO.rubrica
{
	...
	public class ElementoRubrica 
	{
		...
		/// Pu� essere ripettivamente "I", "E" o "IE"
		/// </summary>
		public string tipo;
		...
		/// <summary>
		/// se true vuol dire che il corrispondente � selezionabile nel contensto corrente
		/// </summary>
        ...
        /// <summary>
        /// se true l'utente � di disabilitato e di Rubrica Comune(inserito perch� per i corr di RC storicizzati "isRubricaComune" � false)
        /// </summary>
        ...
        public string rubricaEsterna = string.Empty;
	}
}
