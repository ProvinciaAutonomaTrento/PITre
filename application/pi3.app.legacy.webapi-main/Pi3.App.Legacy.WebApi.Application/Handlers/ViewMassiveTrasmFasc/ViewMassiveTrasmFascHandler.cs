...
using ViewMassiveTrasmFascRequest = Pi3.App.Legacy.WebApi.Application.Requests.ViewMassiveTrasmFasc;

namespace Pi3.App.Legacy.WebApi.Application.Handlers.ViewMassiveTrasmFasc
{
    public class ViewMassiveTrasmFascHandler : IRequestHandler<ViewMassiveTrasmFascRequest, ViewMassiveTrasmFascResult>
    {
        #region Public Members

        public ViewMassiveTrasmFascHandler(ILogger<ViewMassiveTrasmFascHandler> logger,
        ...
        public async Task<ViewMassiveTrasmFascResult> Handle(ViewMassiveTrasmFascRequest request, CancellationToken cancellationToken)
        {
            bool output = true;
            ...
            try
            {
                ...
                var listTrasmissioni = await this._dbContext.TrasmissioneEntities.AsNoTracking()
                    ...
                    .Where(t => t.ID_PROJECT == idProjectAsLong && t.DTA_INVIO.HasValue
                ...
                await this._webMethodLoggerService.LogOK("CHECKTRASMFOLDER", request.idProject, string.Format(Resources.LogVistoFascicolo, request.idProject, userId));
            }
            catch (Exception ex)
            {
            ...
            return new ViewMassiveTrasmFascResult(output);
        }
        ...
        protected readonly ILogger<ViewMassiveTrasmFascHandler> _logger;
