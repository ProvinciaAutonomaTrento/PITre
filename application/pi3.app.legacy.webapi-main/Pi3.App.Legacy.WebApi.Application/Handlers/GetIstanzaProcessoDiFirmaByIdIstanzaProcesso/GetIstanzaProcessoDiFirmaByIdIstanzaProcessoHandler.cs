...
using GetIstanzaProcessoDiFirmaByIdIstanzaProcessoRequest = Pi3.App.Legacy.WebApi.Application.Requests.GetIstanzaProcessoDiFirmaByIdIstanzaProcesso;

namespace Pi3.App.Legacy.WebApi.Application.Handlers.GetIstanzaProcessoDiFirmaByIdIstanzaProcesso
{
    public class GetIstanzaProcessoDiFirmaByIdIstanzaProcessoHandler : IRequestHandler<GetIstanzaProcessoDiFirmaByIdIstanzaProcessoRequest, GetIstanzaProcessoDiFirmaByIdIstanzaProcessoResult>
    {
        #region Public Members

        public GetIstanzaProcessoDiFirmaByIdIstanzaProcessoHandler(ILogger<GetIstanzaProcessoDiFirmaByIdIstanzaProcessoHandler> logger,
        ...
        public async Task<GetIstanzaProcessoDiFirmaByIdIstanzaProcessoResult> Handle(GetIstanzaProcessoDiFirmaByIdIstanzaProcessoRequest request, CancellationToken cancellationToken)
        {
            IstanzaProcessoDiFirma output = null;

            try
            {
                var idIstanza = request.idIstanzaProcesso.AsLong();
                ...
                var istanzaProcessoFirmaEntity = await this._dbContext.IstanzaProcessoFirmaEntities
                    ...
                    .GroupJoin(this._dbContext.PeopleEntities, j => j.istanza.ID_PEOPLE_DELEGATO, delegato => delegato.SYSTEM_ID, (j, delegato) => new { j.istanza, j.ruoloProponente, j.utenteProponente, delegato })
                ...
                istanzaProcessoFirmaEntity.istanzePassoDiFirma = await this._dbContext.IstanzaPassoFirmaEntities
                    ...
                    .Join(this._dbContext.CorrGlobaliEntities, j => j.istanzaPasso.ID_RUOLO_COINVOLTO, ruoloCoinvolto => ruoloCoinvolto.ID_GRUPPO, (j, ruoloCoinvolto) => new { j.istanzaPasso, j.evento, ruoloCoinvolto })
            ...
            return new GetIstanzaProcessoDiFirmaByIdIstanzaProcessoResult(output);
        }
        ...
        protected readonly ILogger<GetIstanzaProcessoDiFirmaByIdIstanzaProcessoHandler> _logger;
