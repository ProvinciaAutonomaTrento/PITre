...
using getModelloByIDRequest = Pi3.App.Legacy.WebApi.Application.Requests.getModelloByID;
using UtentiConNotificaTrasm = DocsPaVO.Modelli_Trasmissioni.UtentiConNotificaTrasm;

namespace Pi3.App.Legacy.WebApi.Application.Handlers.getModelloByID
{
    public class getModelloByIDHandler : IRequestHandler<getModelloByIDRequest, getModelloByIDResult>
    {
        #region Public Members

        public getModelloByIDHandler(ILogger<getModelloByIDHandler> logger, 
        ...
        public async Task<getModelloByIDResult> Handle(getModelloByIDRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                //output.RAGIONI_DESTINATARI = new DocsPaVO.Modelli_Trasmissioni.RagioneDest[] { ragioneDest };
            ...
            return new getModelloByIDResult(output);
        }
        ...
        protected readonly ILogger<getModelloByIDHandler> _logger;
