...
namespace Pi3.App.Legacy.WebApi.Application.Handlers.AddressbookGetRuoliRiferimentoAutorizzati
{

    public class AddressbookGetRuoliRiferimentoAutorizzatiHandler : IRequestHandler<AddressbookGetRuoliRiferimentoAutorizzatiRequest, AddressbookGetRuoliRiferimentoAutorizzatiResult>
    {
        #region Public Members

        public AddressbookGetRuoliRiferimentoAutorizzatiHandler(ILogger<AddressbookGetRuoliRiferimentoAutorizzatiHandler> logger, 
        ...
        public async Task<AddressbookGetRuoliRiferimentoAutorizzatiResult> Handle(AddressbookGetRuoliRiferimentoAutorizzatiRequest request, CancellationToken cancellationToken)
        {
            Ruolo[] output = null;
            ...
            return new AddressbookGetRuoliRiferimentoAutorizzatiResult(output);
        }
        ...
        protected readonly ILogger<AddressbookGetRuoliRiferimentoAutorizzatiHandler> _logger;
