...
namespace Pi3.App.Legacy.WebApi.Application.Handlers.getTemplateFascById
{

    // Richiede libreria MediatR
    public class getTemplateFascByIdHandler : IRequestHandler<Application.Requests.getTemplateFascById, getTemplateFascByIdResult>
    {
        #region Public Members

        public getTemplateFascByIdHandler(ILogger<getTemplateFascByIdHandler> logger, IClaimsPrincipalService claimsPrincipalService, IMediator mediator, IPi3DbContext dbContext)
        {
            this._logger = logger;
        ...
        public async Task<getTemplateFascByIdResult> Handle(Application.Requests.getTemplateFascById request, CancellationToken cancellationToken)
        {
            ...
            return new getTemplateFascByIdResult(result);
        }
        ...
        protected readonly ILogger<getTemplateFascByIdHandler> _logger;
        ...
        protected virtual void InitializeMapper()
        {
            var configuration = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<AssValoriFascEntity, DocsPaVO.ProfilazioneDinamica.ValoreOggetto>()
                     ...
                     .ForMember(dest => dest.VALORE_DI_DEFAULT, opt => opt.MapFrom(src => src.VALORE_DI_DEFAULT ?? string.Empty))
