...
namespace Pi3.App.Legacy.WebApi.Services.OracleDbContextFactory
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            Pi3.App.Legacy.WebApi.Application.Services.OracleDbContextFactory.ServiceCollectionExtensions.AddInfrastructureLegacyEFOracleDbContextFactory(services);
