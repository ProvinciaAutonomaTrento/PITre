...
{
    [ResourceSwaggerSchema("SpedizioneCommandResponse")]
    public class SpedizioneCommandResponse : ValueObject {
    ...
    public class SpedizioneCommand : IRequest<SpedizioneCommandResponse>
    {
