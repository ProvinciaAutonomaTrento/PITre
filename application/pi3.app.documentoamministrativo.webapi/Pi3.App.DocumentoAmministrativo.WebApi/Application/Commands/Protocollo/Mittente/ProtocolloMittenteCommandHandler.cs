...
public class ProtocolloMittenteCommandHandler : IRequestHandler<ProtocolloMittenteCommand, ProtocolloMittenteCommandResponse>
{
    #region Public Members
    public ProtocolloMittenteCommandHandler(
        ILogger<ProtocolloMittenteCommandHandler> logger,
    ...
    public async Task<ProtocolloMittenteCommandResponse> Handle(ProtocolloMittenteCommand request, CancellationToken cancellationToken)
    {
        ...
        if (request.Protocollo != null)
            aggregate.AssignProtocolloMittente(_mapper.Map<Core.AggregateModels.DocumentoAmministrativoAggregate.ValueObjects.ProtocolloMittente>(request.Protocollo));

        await this._repository.Update(aggregate);

        return new ProtocolloMittenteCommandResponse
        {
    ...
    private readonly ILogger<ProtocolloMittenteCommandHandler> _logger;
