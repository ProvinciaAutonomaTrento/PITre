...
namespace Pi3.App.DocumentoAmministrativo.WebApi.Application.Commands.Ripristina
{
    public class RipristinaCommandHandler : IRequestHandler<RipristinaCommand, RipristinaCommandResponse>
    {
        private readonly IPi3DbContext _context;
        private readonly IDocumentoAmministrativoRepository _repository;
        private readonly IClaimsPrincipalService _claimsPrincipalService;

        public RipristinaCommandHandler(IPi3DbContext context,
        ...
        public async Task<RipristinaCommandResponse> Handle(RipristinaCommand request, CancellationToken cancellationToken)
        {
            ...
            return new RipristinaCommandResponse
            {
