...
public class OggettoDocumentoCommandHandler : IRequestHandler<OggettoDocumentoCommand, OggettoDocumentoCommandResponse>
{
    #region Public Members
    public OggettoDocumentoCommandHandler(
        ILogger<OggettoDocumentoCommandHandler> logger,
    ...
    public async Task<OggettoDocumentoCommandResponse> Handle(OggettoDocumentoCommand request, CancellationToken cancellationToken)
    {
        ...
        aggregate.ChangeOggettoDelDocumento(new Core.AggregateModels.DocumentoAmministrativoAggregate.ValueObjects.OggettoDelDocumento()
        {
            Descrizione = new TextValue(request.Descrizione)
        });

        await this._repository.Update(aggregate);

        return new OggettoDocumentoCommandResponse
        {
    ...
    private readonly ILogger<OggettoDocumentoCommandHandler> _logger;
