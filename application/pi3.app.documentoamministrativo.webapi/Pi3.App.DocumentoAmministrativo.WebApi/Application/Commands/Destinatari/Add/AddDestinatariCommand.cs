...
{
    [ResourceSwaggerSchema("AddDestinatariCommandResponse")]
    public class AddDestinatariCommandResponse : ValueObject
    {
    ...
    public class AddDestinatariCommand : IRequest<AddDestinatariCommandResponse>
    {
