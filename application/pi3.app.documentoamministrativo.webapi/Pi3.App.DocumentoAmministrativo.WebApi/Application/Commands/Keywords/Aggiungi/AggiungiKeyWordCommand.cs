...
{
    [ResourceSwaggerSchema("AggiungiKeyWordCommandResponse")]
    public class AggiungiKeyWordCommandResponse : ValueObject {
    ...
    public class AggiungiKeyWordCommand: IRequest<AggiungiKeyWordCommandResponse>
    {
