...
namespace Pi3.App.DocumentoAmministrativo.WebApi.Application.Commands.Keywords.Rimuovi
{
    public class RimuoviKeyWordCommandHandler : IRequestHandler<RimuoviKeyWordCommand, RimuoviKeyWordCommandResponse>
    {
        private readonly IPi3DbContext _context;
        private readonly IDocumentoAmministrativoRepository _repository;
        private readonly IClaimsPrincipalService _claimsPrincipalService;

        public RimuoviKeyWordCommandHandler(IPi3DbContext context,
        ...
        public async Task<RimuoviKeyWordCommandResponse> Handle(RimuoviKeyWordCommand request, CancellationToken cancellationToken)
        {
            ...
            aggregate.RemoveKeyword(new TextValue(request.Valore));
            await _repository.Update(aggregate);

            return new RimuoviKeyWordCommandResponse
            {
