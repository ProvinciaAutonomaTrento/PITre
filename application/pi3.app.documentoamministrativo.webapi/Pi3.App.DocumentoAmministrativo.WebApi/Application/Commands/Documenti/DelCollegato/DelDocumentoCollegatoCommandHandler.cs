...
public class DelDocumentoCollegatoCommandHandler : IRequestHandler<DelDocumentoCollegatoCommand, DelDocumentoCollegatoCommandResponse>
{
    private readonly IPi3DbContext _context;
    private readonly IDocumentoAmministrativoRepository _repository;
    private readonly IClaimsPrincipalService _claimsPrincipalService;

    public DelDocumentoCollegatoCommandHandler(IPi3DbContext context,
    ...
    public async Task<DelDocumentoCollegatoCommandResponse> Handle(DelDocumentoCollegatoCommand request, CancellationToken cancellationToken)
    {
        ...
        aggregate.RemoveReleatedElement(request.IdCollegato);

        await _repository.Update(aggregate);

        return new DelDocumentoCollegatoCommandResponse
        {
