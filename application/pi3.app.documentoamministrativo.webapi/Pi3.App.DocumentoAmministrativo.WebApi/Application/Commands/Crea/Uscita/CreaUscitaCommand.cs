...
namespace Pi3.App.DocumentoAmministrativo.WebApi.Application.Commands.Crea.Entrata
{
    ...
    public class CreaUscitaCommandResponse : ValueObject
    {
    ...
    [ResourceSwaggerSchema("CreaDocumentoUscita")]
    public class CreaUscitaCommand : IRequest<CreaUscitaCommandResponse>
    {
        [Required]
