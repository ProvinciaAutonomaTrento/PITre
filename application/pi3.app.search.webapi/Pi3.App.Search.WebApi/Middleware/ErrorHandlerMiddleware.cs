...
namespace Pi3.App.Search.WebApi.Middleware
{
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            catch (Pi3Exception pi3Ex)
            {
                ...
                await response.WriteAsync(JsonSerializer.Serialize(new ExceptionInfo()
                {
                    ...
                    Type = pi3Ex.GetType().FullName,
                    StackTrace = pi3Ex.StackTrace
                }));
            }
            catch (Exception ex)
            {
                ...
                await response.WriteAsync(JsonSerializer.Serialize(new ExceptionInfo()
                {
                    ErrorCode = Pi3.App.Search.WebApi.Resources.ErrorDescriptions.UnhandledError,
                    Message = ex.Message,
