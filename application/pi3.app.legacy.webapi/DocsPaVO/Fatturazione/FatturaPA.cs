...
namespace DocsPaVO.Fatturazione
{
    ...
    public class FatturaPA
    {
        ...
        // DatiOrdineAcquisto
        public DocsPaVO.Fatturazione.DatiOrdineAcquisto[] ordineAcquisto = new DocsPaVO.Fatturazione.DatiOrdineAcquisto[0];

        // DatiBeniServizi
        public DocsPaVO.Fatturazione.DatiBeniServizi[] servizi = new DocsPaVO.Fatturazione.DatiBeniServizi[0];
