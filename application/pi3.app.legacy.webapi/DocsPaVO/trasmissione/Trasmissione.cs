...
namespace DocsPaVO.trasmissione
{
	...
	{
		public DocsPaVO.trasmissione.TrasmissioneSingola[] trasmissioniSingole;
		...
		public Trasmissione()
		{
			trasmissioniSingole = new DocsPaVO.trasmissione.TrasmissioneSingola[0];
        ...
        /// siano stati tolti i diritti di visiblit� su questa trasmissione
        /// </summary>
