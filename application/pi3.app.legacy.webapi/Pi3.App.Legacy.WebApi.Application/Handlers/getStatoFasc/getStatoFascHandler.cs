...
using getStatoFascRequest = Pi3.App.Legacy.WebApi.Application.Requests.getStatoFasc;

namespace Pi3.App.Legacy.WebApi.Application.Handlers.getStatoFasc
{
    public class getStatoFascHandler : IRequestHandler<getStatoFascRequest, getStatoFascResult>
    {
        #region Public Members

        public getStatoFascHandler(ILogger<getStatoFascHandler> logger,
        ...
        public async Task<getStatoFascResult> Handle(getStatoFascRequest request, CancellationToken cancellationToken)
        {
            Stato output = null;
            ...
            return new getStatoFascResult(output);
        }
        ...
        protected readonly ILogger<getStatoFascHandler> _logger;
