...
using GetRagioneRequest = Pi3.App.Legacy.WebApi.Application.Requests.GetRagione;

namespace Pi3.App.Legacy.WebApi.Application.Handlers.GetRagione
{
    public class GetRagioneHandler : IRequestHandler<GetRagioneRequest, GetRagioneResult>
    {
        protected readonly ILogger<GetRagioneHandler> _logger;
        protected readonly IPi3DbContext _dbContext;

        public GetRagioneHandler(
            ILogger<GetRagioneHandler> logger,
        ...
        public async Task<GetRagioneResult> Handle(GetRagioneRequest request , CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                //tipoDest = {COMPETENZA,CONOSCENZA,REFERENTE,TO,CC}
                ...
                query.ForEach(row =>
                {
                    ...
                    objRagione.tipoDestinatario = (DocsPaVO.trasmissione.TipoGerarchia)this.GetKeyFromVal(DocsPaVO.trasmissione.RagioneTrasmissione.tipoDirittoStringa, row.ChaTipoDest);
