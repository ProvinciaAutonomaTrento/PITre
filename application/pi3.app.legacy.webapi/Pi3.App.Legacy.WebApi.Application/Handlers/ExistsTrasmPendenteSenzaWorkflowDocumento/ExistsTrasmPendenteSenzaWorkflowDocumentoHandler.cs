...
namespace Pi3.App.Legacy.WebApi.Infrastructure.EF.Oracle.Handlers.ExistsTrasmPendenteSenzaWorkflowDocumento
{
    public class ExistsTrasmPendenteSenzaWorkflowDocumentoHandler : IRequestHandler<Application.Requests.ExistsTrasmPendenteSenzaWorkflowDocumento, ExistsTrasmPendenteSenzaWorkflowDocumentoResult>
    {
        public ExistsTrasmPendenteSenzaWorkflowDocumentoHandler(ILogger<ExistsTrasmPendenteSenzaWorkflowDocumentoHandler> logger,
        ...
        public async Task<ExistsTrasmPendenteSenzaWorkflowDocumentoResult> Handle(Application.Requests.ExistsTrasmPendenteSenzaWorkflowDocumento request, CancellationToken cancellationToken)
        {
            bool output = false;
            ...
            return new ExistsTrasmPendenteSenzaWorkflowDocumentoResult(output);
        }


        protected ILogger<ExistsTrasmPendenteSenzaWorkflowDocumentoHandler> _logger;
