...
namespace Pi3.App.Legacy.WebApi.Application.Handlers.FascicolazioneGetTitolario2
{
    public class FascicolazioneGetTitolario2Handler : IRequestHandler<Application.Requests.FascicolazioneGetTitolario2, FascicolazioneGetTitolario2Result>
    {
        public FascicolazioneGetTitolario2Handler(ILogger<FascicolazioneGetTitolario2Handler> logger, IClaimsPrincipalService claimsPrincipalService, IMediator mediator, IPi3DbContext dbContext, IWebMethodLoggerService webMethodLoggerService)
        {
            this._logger = logger;
        ...
        public async Task<FascicolazioneGetTitolario2Result> Handle(Application.Requests.FascicolazioneGetTitolario2 request, CancellationToken cancellationToken)
        {

            List<DocsPaVO.fascicolazione.Classificazione> output  = new List<Classificazione>();
            ...
            try
            {
                ...
                if (estraiTitolario)
                {
                    ...
                    foreach (var classTit in classificazioni.Where(c => c.NUM_LIVELLO == numLivello.AsLong()))
                    {
                        ...
                        rootClass.idRegistroNodoTit = (classTit.ID_REGISTRO != null) ? classTit.ID_REGISTRO.Value.ToString() : "";
            ...
            return new FascicolazioneGetTitolario2Result(output != null ? output.ToArray() : new Classificazione[0]);
        }

        #region Private Members

        protected readonly ILogger<FascicolazioneGetTitolario2Handler> _logger;  
