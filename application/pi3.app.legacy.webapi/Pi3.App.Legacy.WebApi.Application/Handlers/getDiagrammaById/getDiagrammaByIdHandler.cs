...
namespace Pi3.App.Legacy.WebApi.Infrastructure.EF.Oracle.Handlers.getDiagrammaById
{

    // Richiede libreria MediatR
    public class getDiagrammaByIdHandler : IRequestHandler<Application.Requests.getDiagrammaById, getDiagrammaByIdResult>
    {
        #region Public Members

        public getDiagrammaByIdHandler(ILogger<getDiagrammaByIdHandler> logger,
        ...
        public async Task<getDiagrammaByIdResult> Handle(Application.Requests.getDiagrammaById request, CancellationToken cancellationToken)
        {
            ...
            return new getDiagrammaByIdResult(output);
        }
        ...
        protected readonly ILogger<getDiagrammaByIdHandler> _logger;
        ...
        protected virtual void InitializeMapper()
        {
            var configuration = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<StatoEntity, Stato>()
                    ...
                    .ForMember(dest => dest.STATO_SISTEMA, src => src.MapFrom(opt => opt.CHA_STATO_SISTEMA == "1"))
