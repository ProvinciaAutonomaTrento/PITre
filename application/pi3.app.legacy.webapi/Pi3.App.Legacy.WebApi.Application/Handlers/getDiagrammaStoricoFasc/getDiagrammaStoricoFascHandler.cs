...
using getDiagrammaStoricoFascRequest = Pi3.App.Legacy.WebApi.Application.Requests.getDiagrammaStoricoFasc;

namespace Pi3.App.Legacy.WebApi.Application.Handlers.getDiagrammaStoricoFasc
{
    public class getDiagrammaStoricoFascHandler : IRequestHandler<getDiagrammaStoricoFascRequest, getDiagrammaStoricoFascResult>
    {
        #region Public Members

        public getDiagrammaStoricoFascHandler(ILogger<getDiagrammaStoricoFascHandler> logger,
        ...
        public async Task<getDiagrammaStoricoFascResult> Handle(getDiagrammaStoricoFascRequest request, CancellationToken cancellationToken)
        {
            ...
            var diagrammaStoricoEntities = await this._dbContext.DiagrammiStoEntities.AsNoTracking()
                .Where(d => d.ID_PROJECT == idProjectAsLong)
            ...
            return new getDiagrammaStoricoFascResult(storico);
        }
        ...
        protected readonly ILogger<getDiagrammaStoricoFascHandler> _logger;
