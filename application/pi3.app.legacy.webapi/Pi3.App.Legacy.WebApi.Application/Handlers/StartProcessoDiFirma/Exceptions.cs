...
namespace Pi3.App.Legacy.WebApi.Application.Handlers.StartProcessoDiFirma
{
    ...
    public class AvvioProcessoFirmaVersionIdNonValido : Pi3Exception
    {
        #region Public Members

        public AvvioProcessoFirmaVersionIdNonValido()
            : base(ErrorDescriptions.AvvioProcessoFirmaVersionIdNonValido, null, ErrorDescriptions.ResourceManager)
        { }
        #endregion
    }
}
