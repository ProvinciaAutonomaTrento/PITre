...
namespace DocsPaVO.documento
{
    public class InfoFile
    {
        ...
        private StatoConformitaDocumento statoVerifica;
        ...
        /// <summary>
        /// Stato di verifica del documento
        /// </summary>
        public StatoConformitaDocumento StatoVerifica
        {
            get
            {
    ...
    public enum StatoConformitaDocumento
    {
        CONFORME,
        NON_CONFORME,
        NON_VERIFICATO,
