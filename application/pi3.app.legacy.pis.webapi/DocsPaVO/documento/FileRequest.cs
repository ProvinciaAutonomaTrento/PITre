...
namespace DocsPaVO.documento 
{
	...
	public class FileRequest : System.ICloneable
	{
        ...
        public string autoreFile; //utente che ha effettuato l'acquisizione
        public string dataAcquisizione; //data in cui � stato acquisito il file
        ...
        public string tipoFirma = DocsPaVO.documento.TipoFirma.NESSUNA_FIRMA.ToString();
		...
		public bool conSegnaturaPermanente = false;
		...
		public DocsPaVO.documento.Firmatario[] firmatari;
