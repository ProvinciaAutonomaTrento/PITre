...
{
    public class UtentiConNotificaTrasmCommandHandler : IRequestHandler<UtentiConNotificaTrasmCommand, UtentiConNotificaTrasmCommandResponse>
    {
        public UtentiConNotificaTrasmCommandHandler(
            ILogger<UtentiConNotificaTrasmCommandHandler> logger,
        ...
        public async Task<UtentiConNotificaTrasmCommandResponse> Handle(UtentiConNotificaTrasmCommand request, CancellationToken cancellationToken)
        {
        ...
        protected readonly ILogger<UtentiConNotificaTrasmCommandHandler> _logger;
