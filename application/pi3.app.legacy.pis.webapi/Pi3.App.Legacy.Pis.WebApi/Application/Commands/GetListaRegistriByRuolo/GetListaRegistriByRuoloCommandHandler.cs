...
namespace Pi3.App.Legacy.Pis.WebApi.Application.Commands.GetListaRegistriByRuolo
{
    ...
    public class GetListaRegistriByRuoloCommandHandler : IRequestHandler<GetListaRegistriByRuoloCommand, GetListaRegistriByRuoloCommandResponse>
    {
        ...
        public GetListaRegistriByRuoloCommandHandler(
            ILogger<GetListaRegistriByRuoloCommandHandler> logger,
        ...
        public async Task<GetListaRegistriByRuoloCommandResponse> Handle(GetListaRegistriByRuoloCommand request, CancellationToken cancellationToken)
        {
            ...
            await Task.Run(() => {
                ...
                var query = this._dbContext.RegistroEntities.
                    ...
                    .OrderByDescending(o => o.ruolo.CHA_PREFERITO == null)
                    .ThenByDescending(o => o.ruolo.CHA_PREFERITO)
