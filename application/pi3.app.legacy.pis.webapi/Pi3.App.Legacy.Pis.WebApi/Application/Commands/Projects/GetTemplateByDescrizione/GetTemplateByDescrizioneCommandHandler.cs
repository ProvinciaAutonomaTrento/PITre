...
{
    public class GetTemplateByDescrizioneCommandHandler : IRequestHandler<GetTemplateByDescrizioneCommand, GetTemplateByDescrizioneCommandResponse>
    {
        public GetTemplateByDescrizioneCommandHandler(ILogger<GetTemplateByDescrizioneCommandHandler> logger, IClaimsPrincipalService claimsPrincipalService, IMediator mediator, IPi3DbContext dbContext)
        {
            this._logger = logger;
        ...
        public async Task<GetTemplateByDescrizioneCommandResponse> Handle(GetTemplateByDescrizioneCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var tipoFascEntity = await this._dbContext.TipoFascEntities.AsNoTracking().Where(tf => tf.VAR_DESC_FASC.ToUpper().Equals(request.Desc.ToUpper())).FirstAsync();
                long idTemplateAsLong = tipoFascEntity.SYSTEM_ID;
        ...
        protected readonly ILogger<GetTemplateByDescrizioneCommandHandler> _logger;
