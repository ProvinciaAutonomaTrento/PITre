...
{
    public class DocumentoGetAllegatiHandler : IRequestHandler<DocumentoGetAllegatiCommand, DocumentoGetAllegatiCommandResponse>
    {
        ...
        public async Task<DocumentoGetAllegatiCommandResponse> Handle(DocumentoGetAllegatiCommand request, CancellationToken cancellationToken)
        {
            ...
            return new DocumentoGetAllegatiCommandResponse(output.ToArray());
        }
