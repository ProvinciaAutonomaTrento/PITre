...
{
    public class ConsolidateDocumentByIdCommandHandler : IRequestHandler<ConsolidateDocumentByIdCommand, ConsolidateDocumentByIdCommandResponse>
    {
        public ConsolidateDocumentByIdCommandHandler(ILogger<ConsolidateDocumentByIdCommandHandler> logger, IClaimsPrincipalService claimsPrincipalService, IMediator mediator,
        ...
        public async Task<ConsolidateDocumentByIdCommandResponse> Handle(ConsolidateDocumentByIdCommand request, CancellationToken cancellationToken)
        {
        ...
        protected readonly ILogger<ConsolidateDocumentByIdCommandHandler> _logger;
