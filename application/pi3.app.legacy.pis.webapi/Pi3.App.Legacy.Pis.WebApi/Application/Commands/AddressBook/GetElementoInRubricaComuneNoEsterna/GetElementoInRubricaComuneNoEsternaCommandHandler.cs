...
{
    public class GetElementoInRubricaComuneNoEsternaCommandHandler : IRequestHandler<GetElementoInRubricaComuneNoEsternaCommand, GetElementoInRubricaComuneNoEsternaCommandResponse>
    {
        #region Public Members

        public GetElementoInRubricaComuneNoEsternaCommandHandler(ILogger<GetElementoInRubricaComuneNoEsternaCommandHandler> logger,
        ...
        public async Task<GetElementoInRubricaComuneNoEsternaCommandResponse> Handle(GetElementoInRubricaComuneNoEsternaCommand request, CancellationToken cancellationToken)
        {
                    ...
                    if (await corrGlobaliQueryable.AnyAsync())
                    {
                        ...
                        if (daStoricizzare)
                        {
                            var modifyRequest = new CorrispondentiDeleteModifyCorrispondenteEsternoCommand()
                            {
                                ...
                                DatiModificaCorr = this.GetDatiModificaCorr(corrGlobaliEntity, dettGlobaliEntity),
                                Action = "M",
                                FlagListe = 0
                            };
            ...
            return new GetElementoInRubricaComuneNoEsternaCommandResponse()
            {
        ...
        protected ILogger<GetElementoInRubricaComuneNoEsternaCommandHandler> _logger;
