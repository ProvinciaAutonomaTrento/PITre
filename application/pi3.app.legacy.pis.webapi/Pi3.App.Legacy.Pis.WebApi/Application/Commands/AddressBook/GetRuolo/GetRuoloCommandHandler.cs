...
{
    public class GetRuoloCommandHandler : IRequestHandler<GetRuoloCommand, GetRuoloCommandResponse>
    {
        public GetRuoloCommandHandler(
            IConfigurationService configurationService,
            IPi3DbContext dbContext,
            ILogger<GetRuoloCommandHandler> logger)
        {
            this._logger = logger;
        ...
        public async Task<GetRuoloCommandResponse> Handle(GetRuoloCommand request, CancellationToken cancellationToken)
        {
        ...
        private readonly ILogger<GetRuoloCommandHandler> _logger;
        ...
        private async Task<DocsPaVO.utente.Ruolo> GetRuolo(string idRuolo, bool loadFunzioni)
        {
            ...
            List<RoleInfoEntity> roles = await (from a in this._dbContext.PeopleGroupEntities.AsNoTracking()
                                                ...
                                                where b.ID_GRUPPO == a.GROUPS_SYSTEM_ID &&
                                                b.ID_TIPO_RUOLO == c.SYSTEM_ID &&
                                                d.SYSTEM_ID == b.ID_UO
                                                && !a.DTA_FINE.HasValue
