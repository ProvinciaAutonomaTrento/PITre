...
using Pi3.App.StampaRepertori.Batch.Infrastructure.AggregateModels.DocumentBlobAggregate;
using Pi3.App.StampaRepertori.Batch.Infrastructure.Services.Configuration;
using Pi3.App.StampaRepertori.Batch.Infrastructure.Services.DigitalPreservation;
using Pi3.App.StampaRepertori.Batch.Infrastructure.Services.Email.Sender;
using Pi3.App.StampaRepertori.Batch.Infrastructure.Services.OracleDbContextFactory;
using Pi3.App.StampaRepertori.Batch.Infrastructure.Services.StampaRepertori;
using Pi3.App.StampaRepertori.Batch.Services.Principal;
...
namespace Pi3.App.StampaRepertori.Batch
{
        ...
        public async static Task Run(string[] args)
        {
            ...
            var builder = Host.CreateDefaultBuilder()
                    ...
                    .ConfigureServices((hostingContext, services) =>
                    {
                        ...
                        services.AddScoped<IStampaRepertoriService, StampaRepertoriService>();
                    });
            ...
            if (environment == "Test")
            {
                ...
                var service = host.Services.GetRequiredService<IStampaRepertoriService>();
