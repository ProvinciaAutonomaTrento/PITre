...
namespace DocsPaDocumentale_ETDOCS.Documentale
{
    ...
    {
        private static Serilog.ILogger logger = Serilog.Log.ForContext(typeof(CheckInOutDocumentManager));
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Verifica se un documento � in stato checkedout
        /// </summary>
        /// <param name="idDocument"></param>
        ...
        public bool CheckOut(string idDocument, string documentNumber, string documentLocation, string machineName, out CheckOutStatus checkOutStatus)
        {
            ...
            try
            {
                ...
                queryDef.setParam("documentLocation", (documentLocation==null)? documentLocation : documentLocation.Replace("'", "''") );
        ...
        protected bool CreateDocumentVersion(CheckOutStatus checkOutStatus, byte[] checkedOutFileContent, string checkInComments, InfoUtente checkOutOwner)
        {
            ...
            {
                // Se per l'ultima versione del documento � stato acquisito un file,
            ...
            {
                // Se per l'ultima versione del documento non � stato acquisito un file,
