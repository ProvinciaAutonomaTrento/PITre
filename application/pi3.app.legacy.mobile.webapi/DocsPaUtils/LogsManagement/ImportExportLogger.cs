...
namespace DocsPaUtils.LogsManagement
{
	...
	public class ImportExportLogger
	{
		...
		{
			Initialize(DocsPaVO.Settings.AppSettings.Instance.importExportLogPath, logType, totalItems);
		}
		...
		public static bool ReadImportState(out int counter, out int total, out string message)
		{
			...
			try
			{
				string logFile = DocsPaVO.Settings.AppSettings.Instance.importExportLogPath;
