...
namespace DocsPaUtils
{
    ...
    //
    // Summary:
    //     Defines the SOAP fault codes that appear in a SOAP message when an error occurs
    //     while communicating with XML Web services using the SOAP version 1.2 protocol.
    public sealed class Soap12FaultCodes
    {
        //
        // Summary:
        //     Represents the SOAP version 1.2 Receiver fault code indicating an error occurred
        //     during the processing of a client call on the server due to a problem with the
        //     recipient.
        ...
        //
        // Summary:
        //     Represents the SOAP version 1.2 Sender fault code indicating a client call was
        //     not formatted correctly or did not contain the appropriate information.
        ...
        //
        // Summary:
        //     Represents the SOAP version 1.2 VersionMismatch fault code indicating the XML
        //     Web service expected SOAP messages conforming to the SOAP 1.2 specification,
        //     yet received one conforming to SOAP 1.1.
        ...
        //
        // Summary:
        //     Represents the SOAP version 1.2 MustUnderstand fault code indicating a SOAP header
        //     marked with the MustUnderstand attribute was not processed.
        ...
        //
        // Summary:
        //     Represents the SOAP version 1.2 DataEncodingUnknown fault code indicating the
        //     SOAP message is encoded in an unrecognized format.
        ...
        //
        // Summary:
        //     Represents the SOAP version 1.2 rpc:ProcedureNotPresent fault subcode indicating
        //     the XML Web service does not support the requested XML Web service method.
        ...
        //
        // Summary:
        //     Represents the SOAP version 1.2 rpc:BadArguments fault subcode indicating that
        //     arguments sent to the XML Web service method were incorrect or could not be parsed.
        ...
        //
        // Summary:
        //     Represents the SOAP version 1.2 enc:UntypedValue fault subcode indicating that
        //     the SOAP message was RPC-encoded and the type name property of an encoded graph
    ...
    //
    // Summary:
    //     Represents the contents of the optional Subcode element of a SOAP fault when
    //     SOAP version 1.2 is used to communicate between a client and an XML Web service.
    [Serializable]
    public class SoapFaultSubCode
    {
        ...
        //
        // Returns:
        //     An System.Xml.XmlQualifiedName representing the application specific error code.
        ...
        //
        // Returns:
        //     A System.Web.Services.Protocols.SoapFaultSubcode containing additional error
        //     information.
        public SoapFaultSubCode SubCode => subCode;

        //
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapFaultSubcode
        //     class sets the application specific error code.
        //
        // Parameters:
        //   code:
        //     An System.Xml.XmlQualifiedName specifying the application specific error code.
        //     Sets the System.Web.Services.Protocols.SoapFaultSubcode.Code property.
        ...
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapFaultSubCode
        //     class setting the application specific error code and additional error information.
        //
        //
        // Parameters:
        //   code:
        ...
        //
        //   subCode:
        //     A System.Web.Services.Protocols.SoapFaultSubCode specifying additional application
        //     specific error information. Sets the System.Web.Services.Protocols.SoapFaultSubCode.SubCode
        //     property.
    ...
    //
    // Summary:
    //     Specifies the version of the SOAP protocol used to communicate with an XML Web
    //     service.
    public enum SoapProtocolVersion
    {
        ...
        //
        // Summary:
        //     SOAP protocol version 1.1.
        Soap11,
        //
        // Summary:
        //     SOAP protocol version 1.2.
        Soap12
    }
    ...
    public class SoapException : SystemException
    {
        ...
        //
        // Summary:
        //     Specifies that a SOAP fault code that represents an error occurred during the
        //     processing of a client call on the server, where the problem is not due to the
        //     message contents.
        ...
        //
        // Summary:
        //     Specifies a SOAP fault code that represents a client call that is not formatted
        //     correctly or does not contain the appropriate information.
        ...
        //
        // Summary:
        //     A SOAP fault code that represents an invalid namespace for a SOAP envelope was
        //     found during the processing of the SOAP message.
        ...
        //
        // Summary:
        //     Gets an System.Xml.XmlQualifiedName that represents the System.Web.Services.Protocols.SoapException.Detail
        //     element of a SOAP Fault code.
        ...
        //
        // Returns:
        //     An System.Xml.XmlQualifiedName that specifies the SOAP fault code that occurred.
        public XmlQualifiedName Code => code;

        //
        // Summary:
        //     Gets an System.Xml.XmlNode that represents the application-specific error information
        //     details.
        //
        // Returns:
        ...
        //
        // Returns:
        //     A System.String value that identifies the human language associated with the
        //     exception.
        [ComVisible(false)]
        public string Lang
        {
        ...
        //
        // Summary:
        //     Gets a URI that represents the XML Web service's function in processing the SOAP
        //     message.
        //
        // Returns:
        //     The role of the XML Web service throwing the System.Web.Services.Protocols.SoapException.
        ...
        //
        // Summary:
        //     Gets the optional error information contained in the subcode XML element of a
        //     SOAP fault.
        //
        // Returns:
        //     A System.Web.Services.Protocols.SoapFaultSubCode that represents the contents
        //     of the subcode XML element of a SOAP fault.
        [ComVisible(false)]
        public SoapFaultSubCode SubCode => subCode;
        ...
        //     Server SOAP fault code regardless of the version of the SOAP protocol used.
        //
        // Parameters:
        //   code:
        ...
        //
        // Returns:
        //     true if code is equivalent to the Server SOAP fault code; otherwise, false.
        ...
        // Summary:
        //     Returns a value that indicates whether the SOAP fault code is equivalent to the
        //     Client SOAP fault code regardless of the version of the SOAP protocol used.
        //
        // Parameters:
        //   code:
        //     An System.Xml.XmlQualifiedName that contains a SOAP fault code.
        ...
        // Summary:
        //     Returns a value that indicates whether the SOAP fault code is equivalent to the
        //     VersionMismatch SOAP fault code regardless of the version of the SOAP protocol
        //     used.
        //
        // Parameters:
        //   code:
        ...
        //
        // Returns:
        //     true if code is equivalent to the VersionMismatch SOAP fault code; otherwise,
        //     false.
        ...
        //
        // Returns:
        //     true if code is equivalent to the MustUnderstand SOAP fault code; otherwise,
        //     false.
        ...
        //
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class.
        ...
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message, exception code, and URI that identifies
        //     the piece of code that caused the exception.
        //
        // Parameters:
        //   message:
        //     A message that identifies the reason the exception occurred. This parameter sets
        //     the System.Exception.Message property.
        //
        //   code:
        //     An System.Xml.XmlQualifiedName that specifies the type of error that occurred.
        //     This parameter sets the System.Web.Services.Protocols.SoapException.Code property.
        //
        //
        //   actor:
        //     A URI that identifies the code that caused the exception. Typically, this is
        //     a URL to an XML Web service method. This parameter sets the System.Web.Services.Protocols.SoapException.Actor
        //     property.
        ...
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message, exception code, URI that identifies
        //     the code that caused the exception, and reference to the root cause of the exception.
        //
        //
        // Parameters:
        //   message:
        ...
        //
        //   actor:
        //     A URI that identifies the piece of code that caused the exception. Typically,
        //     this is a URL to an XML Web service method. This parameter sets the System.Web.Services.Protocols.SoapException.Actor
        //     property.
        //
        //   innerException:
        //     An exception that is the root cause of the exception. This parameter sets the
        ...
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message and exception code.
        //
        // Parameters:
        //   message:
        //     A message that identifies the reason the exception occurred. This parameter sets
        ...
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message, exception code, and reference to
        ...
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message, exception code, URI that identifies
        //     the piece of code that caused the exception, and application specific exception
        //     information.
        //
        // Parameters:
        //   message:
        ...
        //
        //   detail:
        //     An System.Xml.XmlNode that contains application specific exception information.
        //     This parameter sets the System.Web.Services.Protocols.SoapException.Detail property.
        ...
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message, exception code, URI that identifies
        //     the piece of code that caused the exception, application-specific exception information,
        //     and reference to the root cause of the exception.
        //
        // Parameters:
        //   message:
        //     A message that identifies the reason the exception occurred. This parameter sets
        ...
        // Summary:
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message, exception code, and subcode.
        //
        // Parameters:
        //   message:
        //     A message that identifies the reason the exception occurred. This parameter sets
        ...
        //
        //   subCode:
        //     An optional subcode for the SOAP fault. This parameter sets the System.Web.Services.Protocols.SoapException.SubCode
        //     property.
        ...
        //
        //   role:
        //     A URI that represents the XML Web service's function in processing the SOAP message.
        //     This parameter sets the System.Web.Services.Protocols.SoapException.Role property.
        //
        //
        //   detail:
        //     An System.Xml.XmlNode that contains application specific exception information.
        ...
        //     Initializes a new instance of the System.Web.Services.Protocols.SoapException
        //     class with the specified exception message, exception code, URI that identifies
        //     the piece of code that caused the exception, URI that represents the XML Web
        //     service's function in processing the SOAP message, the human language associated
        //     with the exception, the application-specific exception information, the subcode
        //     for the SOAP fault and reference to the root cause of the exception.
        //
        // Parameters:
        //   message:
        //     A message that identifies the reason the exception occurred. This parameter sets
        ...
        //
        //   lang:
        //     A human language associated with the exception. This parameter sets the System.Web.Services.Protocols.SoapException.Lang
        //     property.
        //
        //   detail:
        //     An System.Xml.XmlNode that contains application specific exception information.
        ...
        //
        //   context:
        //     The T:System.Runtime.Serialization.StreamingContext that contains contextual
