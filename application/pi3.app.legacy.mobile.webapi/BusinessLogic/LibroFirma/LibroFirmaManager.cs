...
public class LibroFirmaManager
{
    ...
    private static bool Protocolla(string docnumber, IstanzaPassoDiFirma passo, DocsPaVO.utente.InfoUtente infoUtente, DocsPaVO.utente.Ruolo ruolo, out string segnatura, out string error)
    {
        ...
        try
        {
            BusinessLogic.Documenti.ProtoManager.protocolla(schedaDoc, ruolo, infoUtente, out resultProtocollazione, null, "", "", true);
        }
        catch (Exception e)
        {
    ...
    private static bool Spedisci(string docnumber, IstanzaPassoDiFirma passo, DocsPaVO.utente.InfoUtente infoUtente, DocsPaVO.utente.Ruolo ruolo, out string error)
    {
        ...
        try
        {
            BusinessLogic.Spedizione.SpedizioneManager.SpedisciDocumento(infoUtente, schedaDoc, infoSpedizione, null);
        }
        catch (Exception e)
        {
    ...
    public static bool AggiornaStatoElementoInLibroFirma(ElementoInLibroFirma elemento, string nuovoStato, DocsPaVO.utente.Ruolo ruolo, DocsPaVO.utente.InfoUtente infoUtente, out string message)
    {
        ...
        try
        {
            ...
            if (retValue && (nuovoStato.Equals(TipoStatoElemento.DA_FIRMARE.ToString()) || nuovoStato.Equals(TipoStatoElemento.DA_RESPINGERE.ToString()) || nuovoStato.Equals(TipoStatoElemento.IN_SOSPESO.ToString())))
            {
