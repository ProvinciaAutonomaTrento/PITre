...
public class DocManager
{
    ...
    public static List<DocsPaVO.documento.BaseInfoDoc> GetBaseInfoForDocument(string idProfile, string docNumber, string versionNumber, bool inoltroMassivo = false)
    {
        ...
        try
        {
            ...
            result = infoDoc.GetBaseInfoForDocument(idProfile, docNumber, versionNumber, inoltroMassivo);
    ...
    public static bool InsertFirmatarioDocumento(FirmatarioDocumento firmatarioDoc)
    {
        DocsPaDB.Query_DocsPAWS.Documenti doc = new DocsPaDB.Query_DocsPAWS.Documenti();
        return doc.InsertFirmatarioDocumento(firmatarioDoc);
    }
}
