...
namespace BusinessLogic.Documenti
{
    ...
    {
        private static ILogger logger = Log.ForContext(typeof(SignedFileManager));

        public static bool AppendDocumentoFirmatoPades(
                            byte[] signedContent,
                            bool cofirma,
                            ref DocsPaVO.documento.FileRequest fileRequest,
                            DocsPaVO.utente.InfoUtente infoUtente, string repositoryRootPath = "",  string temporaryRootPath = "", bool isConvertedToPdf = false)
        {
            return AppendDocumentoFirmato(signedContent, cofirma, ref fileRequest, infoUtente, true, isConvertedToPdf, repositoryRootPath, temporaryRootPath);
        }
        ...
        public static bool AppendDocumentoFirmato(
                                ...
                                bool cofirma,
                                ref DocsPaVO.documento.FileRequest fileRequest,
                                DocsPaVO.utente.InfoUtente infoUtente, string repositoryRootPath = "", string temporaryRootPath = "")
        {
            return AppendDocumentoFirmato(Convert.FromBase64String(base64content), cofirma, ref fileRequest, infoUtente, false, false, repositoryRootPath, temporaryRootPath);
        }
        ...
        public static bool AppendDocumentoFirmato(
                                ...
                                bool cofirma,
                                ref DocsPaVO.documento.FileRequest fileRequest,
                                DocsPaVO.utente.InfoUtente infoUtente, bool isPades, bool isConvertedToPdf = false, string repositoryRootPath = "", string temporaryRootPath = "")
        {
            bool retValue = true;
            ...
            try
            {
                ...
                BusinessLogic.Documenti.FileManager.putFile(fileRequest, fileDoc, infoUtente, false, repositoryRootPath, temporaryRootPath);
