...
public class StampeRepertoriReport
{
    ...
    /// 
    private static ILogger logger = Serilog.Log.ForContext(typeof(StampeRepertoriReport));
    ...
    private void SetFilters(Query query, List<FiltroRicerca> searchFilters)
    {
        ...
        else
        {
            ...
            {
                query.setParam("firstNumber", firstNumber + " AND CONVERT(INT,valore_oggetto_db) <= " + lastNumber);
            }
            else
            {
