...
namespace DocsPaDB.Query_DocsPAWS
{
    ...
    {
        private static ILogger logger = Serilog.Log.ForContext(typeof(UserPassword));
        ...
        /// � attiva la gestione della validit� delle password
        /// </summary>
...
//            this._idAmministrazione = idAmministrazione;
        ...
        public bool IsPasswordExpired()
        {
            ...
            {
                // La password � senza scadenza qualora l'utente sia un amministratore (di qualsiasi tipo)
                expired = false;
            }
            else if (data.CreationDate == DateTime.MinValue)
            {
                // Se la data di creazione della password non � impostata,
                // la password � considerata scaduta (anche se � stata definita "Nessuna scadenza password")
                expired = true;
            }
        ...
        public DateTime GetPasswordExpirationDate()
        {
            ...
            {
                // Data di creazione non definita, la password � scaduta
        ...
        /// <summary>
        /// Reperimento del numero di giorni di validit� della password rimanenti
        /// </summary>
        /// <returns></returns>
        public int GetPasswordRemainingDays()
        {
            ...
            if (data.PasswordNeverExpire)
            {
                // Se la password per l'utente � senza scadenza
        ...
        /// <summary>
        /// Verifica se la password richiesta � uguale a quella dell'utente
        /// </summary>
        ...
        /// <summary>
        /// Verifica se la password richiesta � uguale a quella dell'utente in una amministrazione
        /// </summary>
        /// <param name="encryptedPassword"></param>
        /// <returns></returns>
        ...
        public void SetPassword(string newEncryptedPassword, bool isAdminPassword)
        {
            try
            {
                using (DocsPaDB.DBProvider dbProvider = new DBProvider())
                {
                    ...
                    // Verifica se la gestione scadenza password � abilitata da amministrazione
            ...
            {
                logger.Debug(ex, "errore in SetPassword");
                logger.Error(ex, "errore in SetPassword");
                throw ex;
            }
        }
        ...
        public void SetPasswordForUserinAmm(string newEncryptedPassword, string modulo="")
        {
            ...
            {
                logger.Debug(ex, "errore in SetPasswordForUserInAmm");
                logger.Error(ex, "errore in SetPasswordForUserInAmm");
                throw ex;
            }
        }
        ...
        public void SetPasswordNeverExpireOption(bool neverExpire)
        {
            ...
            {
                logger.Error(ex, "errore in SetPasswordNeerExpireOption");
                throw ex;
            }
        }
        ...
        /// <summary>
        /// Verifica se la password � stata impostata dall'utente richiesto
