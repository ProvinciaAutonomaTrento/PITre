...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(Log));
    #region Property
                            ...
                            DocsPaVO.utente.InfoUtente delegato, string codWorkingApplication, string checkNotify = "", string idTrasm = "", string dataAzione = "")
    {
        ...
        try
        {
            ...
            else
            {
                ...
                //Se il log � tra i log definiti di tipo amministrazione scrivo come descrizione "Amministratore di sistema"
    ...
    /// <summary>
    /// Verifica se il log in input � un log di amministrazione
    /// </summary>
    ...
    public bool InsertEventDocument(string idPeople, string idGruppo, string idAmministrazione, string VarOggetto, string IdOggetto, string VarDescOggetto, string VarCodAzione, string VarDescAzione, string IdTrasm, string idPeopleDelegante)
    {
        bool result = true;
        try
        {
            DocsPaUtils.Query q = DocsPaUtils.InitQuery.getInstance().getQuery("I_DPA_EVENT_DOCUMENT");           
            using (DocsPaDB.DBProvider db = new DocsPaDB.DBProvider())
            {
                ArrayList parameters = new ArrayList();
                if(dbType.ToUpper().Equals("ORACLE"))
                    q.setParam("SystemId", DocsPaDbManagement.Functions.Functions.GetSystemIdNextVal("DPA_EVENT_DOCUMENT"));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("idPeople", Convert.ToInt32(idPeople), System.Data.DbType.Int32));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("idGruppo", Convert.ToInt32(idGruppo), System.Data.DbType.Int32));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("idAmministrazione", Convert.ToInt32(idAmministrazione), System.Data.DbType.Int32));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("VarOggetto", VarOggetto));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("IdOggetto", Convert.ToInt32(IdOggetto), System.Data.DbType.Int32));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("VarDescOggetto", VarDescOggetto));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("VarCodAzione", VarCodAzione));
                parameters.Add(new DocsPaUtils.Data.CommandParameter("VarDescAzione", VarDescAzione));
                if (!string.IsNullOrEmpty(IdTrasm))
                    parameters.Add(new DocsPaUtils.Data.CommandParameter("IdTrasm", Convert.ToInt32(IdTrasm), System.Data.DbType.Int32));
                else
                    parameters.Add(new DocsPaUtils.Data.CommandParameter("IdTrasm", 0, System.Data.DbType.Int32));
                if (!string.IsNullOrEmpty(idPeopleDelegante))
                    parameters.Add(new DocsPaUtils.Data.CommandParameter("idPeopleDelegante", Convert.ToInt32(idPeopleDelegante), System.Data.DbType.Int32));
                else
                    parameters.Add(new DocsPaUtils.Data.CommandParameter("idPeopleDelegante", 0, System.Data.DbType.Int32));
