...
public class Conservazione
{
    ...
    ///
    /// </summary>
    private static ILogger logger = Serilog.Log.ForContext(typeof(Conservazione));
    ...
    public string CreateAreaConservazione(DocsPaVO.utente.InfoUtente infoUtente, string descrizione, string note, string idPolicy, string stato, bool consolidamento, string tipoIstanza)
    {
        ...
        //using (DocsPaDB.DBProvider dbProvider = new DBProvider())
        {
            ...
            logger.Information("I_INSERT_ISTANZA_CONSERVAZIONE: {0}", commandText);
                                        ...
                                        string idPolicy)
    {
        ...
        try
        {
            ...
            {
                logger.Debug("{0} -> {1}", al.Nome, al.Valore);
            }
            //*/
            DataSet ds = null;
            logger.Debug("Chiamo > SP_INSERT_AREA_CONS");
    ...
    public string InsertInRegistroCons(DocsPaVO.Conservazione.RegistroCons registroCons)
    {
        ...
        using (DocsPaDB.DBProvider dbProvider = new DBProvider())
        {
            ...
            string commandText = queryDef.getSQL();
            logger.Information("I_INSERT_REGISTRO_CONSERVAZIONE: {0}", commandText);
    ...
    public bool checkItemEsibizionePresenteInIstanzaEsibizione(string id_profile, string id_project, string type, DocsPaVO.utente.InfoUtente infoUtente, string idIstanzaConservazione)
    {
        ...
        try
        {
            string dbType = DocsPaVO.Settings.AppSettings.Instance.DBType;
                                                ...
                                                String ruolo_Prop)
    {
        ...
        using (DocsPaDB.DBProvider dbProvider = new DBProvider())
        {
            ...
            string commandText = queryDef.getSQL();
            logger.Information("I_INSERT_VERIFICA_FORMATI_CONS: {0}", commandText);
    ...
    public bool UpdateItemReportFormatiConservazione(ReportFormatiConservazione elemento)
    {
        ...
        using (DocsPaDB.DBProvider dbProvider = new DBProvider())
        {
            ...
            string commandText = queryDef.getSQL();
            logger.Information("U_UPDATE_VERIFICA_FORMATI_CONS: {0}", commandText);
    ...
    public bool updateStatoConservazione(string idConservazione, string stato)
    {
        ...
        using (DocsPaDB.DBProvider dbProvider = new DocsPaDB.DBProvider())
        {
            ...
            string commandText = queryDef.getSQL();
            logger.Information("U_UPDATE_STATO_ISTANZA_CONSERVAZIONE: {0}", commandText);
            ...
            logger.Information("U_UPDATE_STATO_ITEMS_CONSERVAZIONE: {0}", commandText);
    ...
    public bool updateStatoConservazioneWhithEsitoVerifica(string idConservazione, string stato, int esitoVerifica)
    {
        ...
        using (DocsPaDB.DBProvider dbProvider = new DocsPaDB.DBProvider())
        {
            ...
            string commandText = queryDef.getSQL();
            logger.Information("U_UPDATE_STATO_ISTANZA_CONSERVAZIONE_WITH_ESITO_VERIFICA: {0}", commandText);
                                            ...
                                            )
    {
        ...
        try
        {
            ...
            DataSet ds = null;
            logger.Debug("Chiamo --> SP_INS_AREA_CONS_VINCOLI");
            ...
            {
                result = Convert.ToString(versionIdParam.Valore);
                logger.Debug("SP_INS_AREA_CONS_VINCOLI --> Result {0}", result);
                //  dbProvider.SetLargeText("DPA_ITEMS_CONSERVAZIONE", sysId, "VAR_XML_METADATI", xmlMetadati[1]);
            }
            else
            {
    ...
    public string getSumSizeItem_byIdConservazione(string idConservazione)
    {
        ...
        try
        {
            using (DocsPaDB.DBProvider dbProvider = new DBProvider())
            {
                ...
                string commandText = q.getSQL();
                logger.Debug("Query - S_SUM_SIZE_ITEMS_DPA_ITEMS_CONSERVAZIONE: {0}", commandText);
                DataSet ds = new DataSet();
                dbProvider.ExecuteQuery(ds, commandText);
    ...
    public string getCountNumDocInIstanza_byIdConservazione(string idConservazione)
    {
        ...
        try
        {
            using (DocsPaDB.DBProvider dbProvider = new DBProvider())
            {
                ...
                string commandText = q.getSQL();
                logger.Debug("Query - S_COUNT_DPA_ITEMS_CONSERVAZIONE: {0}", commandText);
                DataSet ds = new DataSet();
                dbProvider.ExecuteQuery(ds, commandText);
    ...
    public string getStatoConservazione(string idDoc)
    {
        ...
        {
            logger.Debug(ex, "errore in getStatoConservazione");
        }
    ...
    public bool addDocToQueueCons(string idDoc, InfoUtente infoUtente, string ente, string struttura)
    {
        ...
        {
            result = false;
            logger.Debug(ex, "errore in addDocToQueueCons");
        }
    ...
    public bool updateQueueCons(string idDoc, InfoUtente infoUtente, string stato, bool dataInvio, string warning, string numTentativo)
    {
        ...
        using (DocsPaDB.DBProvider dbProvider = new DocsPaDB.DBProvider())
        {
            ...
            catch (Exception ex)
            {
                dbProvider.RollbackTransaction();
                result = false;
                logger.Debug(ex, "errore in updateQueueCons");
            }
        }
    ...
    public bool updateQueueConsList(ArrayList lista, string stato)
    {
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            ...
            catch (Exception ex)
            {
                dbProvider.RollbackTransaction();
                result = false;
                logger.Debug(ex, "errore in updateQueueConsList");
            }
        }
    ...
    public string getTemplateXML(string idAmm, string tipo)
    {
        ...
        {
            logger.Debug(ex, "errore in getTemplateXML");
        }
    ...
    public string getFileXML(string idProfile, string colName)
    {
        ...
        {
            logger.Debug(ex, "errore in getFileXML");
        }
    ...
    public bool insertFileXML(string tableName, string id, string colName, string val)
    {
        ...
        {
            retVal = false;
            logger.Debug(ex, "errore in insertFileXML");
        }
    ...
    public DocsPaVO.areaConservazione.StampaRegistro getInfoStampaRegistro(string idDoc)
    {
        ...
        {
            logger.Debug(ex, "errore in getInfoStampaRegistro");
            result = null;
        }
    ...
    public DocsPaVO.areaConservazione.StampaRegistro getInfoStampaReperiorio(string idDoc)
    {
        ...
        {
            logger.Debug(ex, "errore in getInfoStampaReperiorio");
            result = null;
        }
    ...
    public string getDataRepertoriazione(string anno, string value, string idOgg)
    {
        ...
        {
            logger.Debug(ex, "errore in getDataRepertoriazione");
            result = string.Empty;
        }
    ...
    public string getVersioneDatiSpecifici(string idAmm, string tipo)
    {
        ...
        {
            logger.Debug(ex, "errore in getVersioneDatiSpecifici");
        }
    ...
    public string getNomeTipologia(string idContatore)
    {
        ...
        {
            logger.Debug(ex, "errore in getNomeTipologia");
            result = string.Empty;
        }
    ...
    /// <param name="idAmm"></param>
    /// <returns></returns>
    public string GetIdRoleResponsabileConservazione(string idAmm, string idAOO)
    {
        string result = string.Empty;
        ...
        try
        {
            ...
            {
                q = InitQuery.getInstance().getQuery("S_GET_ID_ROLE_RESP_CONS_AOO");
                q.setParam("idRegistro", idAOO);
            }
            else
            {
                q = InitQuery.getInstance().getQuery("S_GET_ID_ROLE_RESP_CONS");
            }
    ...
    public string GetIdUtenteResponsabileConservazione(string idAmm, string idAOO)
    {
        string result = string.Empty;
        ...
        try
        {
            ...
            if(!string.IsNullOrEmpty(idAOO))
            {
                q = InitQuery.getInstance().getQuery("S_GET_ID_USER_RESP_CONS_AOO");
                q.setParam("idRegistro", idAOO);
            }
            else
            {
                q = InitQuery.getInstance().getQuery("S_GET_ID_USER_RESP_CONS");
            }
    ...
    public ArrayList GetListaPolicyPARER(string idAmm, string tipo)
    {
        ...
        try
        {
            using (DBProvider dbProvider = new DBProvider())
            {
                if (tipo == "F")
                {
                    Query q = InitQuery.getInstance().getQuery("S_GET_LISTA_POLICY_FASC_PARER");
                    q.setParam("idAmm", idAmm);
                    ...
                    using (IDataReader reader = dbProvider.ExecuteReader(command))
                    {
                        while (reader.Read())
                        {
                            DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER p = new PolicyFascicoliPARER();
    ...
    public DocsPaVO.Conservazione.PARER.EsecuzionePolicy GetInfoEsecuzionePolicy(string idPolicy, string tipo)
    {
        ...
        try
        {
            ...
            if(tipo == "D")
            {
                q = InitQuery.getInstance().getQuery("S_DPA_EXEC_POLICY_PARER");
            }
            else
            {
                q = InitQuery.getInstance().getQuery("S_DPA_EXEC_POLICY_FASC_PARER");
            }
            q.setParam("id", idPolicy);
    ...
    public bool SetInfoEsecuzionePolicy(DocsPaVO.Conservazione.PARER.EsecuzionePolicy info, string tipo)
    {
        logger.Debug("BEGIN");
        bool result = false;
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            try
            {
                ...
                if(tipo == "D")
                {
                    q = InitQuery.getInstance().getQuery("U_DPA_EXEC_POLICY_PARER");
                }
                else
                {
                    q = InitQuery.getInstance().getQuery("U_DPA_EXEC_POLICY_FASC_PARER");
                }
    ...
    private string GetFiltriPolicy(DocsPaVO.Conservazione.PARER.PolicyPARER policy)
    {
            ...
            if (!string.IsNullOrEmpty(policy.tipoClassificazione))
            {
                ...
                if (policy.tipoClassificazione.Equals("C"))
                {
                    ...
                    else
                    {
                        ...
                        //           "))";
                        queryGer = "SELECT LINK FROM PROJECT_COMPONENTS PC, PROJECT P WHERE PC.PROJECT_ID=P.SYSTEM_ID AND " +
                                   "P.CHA_TIPO_PROJ='C' AND P.ID_FASCICOLO=ID_PARENT AND ID_PARENT IN ( " +
                                   "SELECT SYSTEM_ID FROM PROJECT WHERE CHA_TIPO_FASCICOLO='G' AND ID_PARENT IN ( " +
                                   "SELECT SYSTEM_ID FROM PROJECT WHERE CHA_tIPO_PROJ='T' -- CHA_TIPO_FASCICOLO='G' " +
                                   "CONNECT BY PRIOR SYSTEM_ID=ID_PARENT START WITH SYSTEM_ID IN (SELECT ID_PARENT FROM PROJECT WHERE SYSTEM_ID=" + policy.idFascicolo + ")))";
                ...
                if (policy.tipoClassificazione.Equals("F"))
                {
                    ...
                    else
                    {
                        ...
                        //           "CONNECT BY PRIOR SYSTEM_ID=ID_PARENT START WITH SYSTEM_ID IN (SELECT ID_PARENT FROM PROJECT WHERE SYSTEM_ID=" + policy.idFascicolo +
                        //           "))";
                        queryGer = "select link from project_components where project_id in (select system_id from project where id_fascicolo=" + policy.idFascicolo + ")";
                        result = result + string.Format(" AND A.SYSTEM_ID IN ({0}) ", queryGer);
                    }
                }
                if (policy.tipoClassificazione.Equals("CF"))
                {
                    ...
                    else
                    {
                        ...
                        //           "CONNECT BY PRIOR SYSTEM_ID=ID_PARENT START WITH SYSTEM_ID IN (SELECT ID_PARENT FROM PROJECT WHERE SYSTEM_ID=" + policy.idFascicolo +
                        //           "))";
                        queryGer = "select link from project_components where project_id in (select system_id from project where id_fascicolo=" + policy.idFascicolo + ") UNION ";
        ...
        if(!string.IsNullOrEmpty(policy.numGiorniFirma))
        {
            ...
            {
                result = result + string.Format(" AND EXISTS (SELECT 'X' FROM DPA_INFO_FIRMA_DIGITALE FD WHERE FD.ID_PROFILE=A.SYSTEM_ID AND TRUNC(FD.DATA_APPOSIZIONE) <= TRUNC(SYSDATE-{0},'DD'))", policy.numGiorniFirma);
            }
        }
        #endregion
    ...
    public string GetDataProssimaEsecuzione(DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER policy)
    {
        string result = string.Empty;
    ...
    public ReportConfiguration GetReportConfiguration(string idAmm)
    {
        ...
        try
        {
            Query q = InitQuery.getInstance().getQuery("S_CONFIG_REPORT_CONSERVAZIONE");
            q.setParam("idAmm", idAmm);

            logger.Debug("QUERY:" + q.getSQL());

            using (DBProvider dbProvier = new DBProvider())
            {
                DataSet ds = new DataSet();

                if (!dbProvier.ExecuteQuery(out ds, q.getSQL()))
                    throw new Exception(dbProvier.LastExceptionMessage);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            conf.Recipients[i] = recipients[i].ToString();
                        }
                        conf.FixedRecipients = new string[hiddenRecipients.Count];
                        ...
                        {
                            Server = ds.Tables[0].Rows[0]["VAR_SMTP_SERVER"].ToString(),
                            From = ds.Tables[0].Rows[0]["VAR_MAIL_FROM"].ToString(),
                            Username = ds.Tables[0].Rows[0]["VAR_USERNAME_SMTP"].ToString(),
                            Password = ds.Tables[0].Rows[0]["VAR_PASSWORD_SMTP"].ToString(),
                            Port = ds.Tables[0].Rows[0]["VAR_PORT_SMTP"].ToString(),
                            UseSSL = (ds.Tables[0].Rows[0]["CHA_SSL"].ToString() == "1")
                        };

                        if (!string.IsNullOrEmpty(conf.MailBoxConfiguration.Username) && !string.IsNullOrEmpty(conf.MailBoxConfiguration.Password))
                        {
        ...
        {
            conf = null;
            logger.Debug(ex, "errore in GetReportConfiguration");
        }
    ...
    {
        logger.Debug("BEGIN");
        DocsPaVO.Conservazione.PARER.Mailbox result = new Mailbox();

        try
        {
            Query query = InitQuery.getInstance().getQuery("S_MAIL_STRUTTURA");
            query.setParam("idAmm", idAmm);
            ...
            using (DBProvider dbProvider = new DBProvider())
            {
                ...
                {
                    result.Server = ds.Tables[0].Rows[0]["VAR_SMTP_SERVER"].ToString();
                    result.From = ds.Tables[0].Rows[0]["VAR_MAIL_FROM"].ToString();
                    result.Username = ds.Tables[0].Rows[0]["VAR_USERNAME_SMTP"].ToString();
                    result.Password = ds.Tables[0].Rows[0]["VAR_PASSWORD_SMTP"].ToString();
        ...
        {
            logger.Debug("Errore in GetMailStruttura - ", ex);
            result = null;
        }
    ...
    public bool SaveMailStruttura(string idAmm, DocsPaVO.Conservazione.PARER.Mailbox mailbox, bool insert)
    {
        logger.Debug("BEGIN");
        bool result = false;
    ...
    {
        logger.Debug("BEGIN");
        DocsPaVO.Conservazione.PARER.Report.ReportSingolaAmmResponse response;

        try
        {
            response = new DocsPaVO.Conservazione.PARER.Report.ReportSingolaAmmResponse();
            ...
            using (DBProvider dbProvider = new DBProvider())
            {
                ...
                string filtroData = string.Format(" BETWEEN {0} AND {1}", DocsPaDbManagement.Functions.Functions.ToDateBetween(request.DataInizio, true), DocsPaDbManagement.Functions.Functions.ToDateBetween(request.DataFine, false));

                query1.setParam("id_amm", request.IdAmm);
                query1.setParam("filtro_data", filtroData);

                query2.setParam("id_amm", request.IdAmm);
                query2.setParam("filtro_data", filtroData);

                string command = query1.getSQL();
                logger.Debug("QUERY - 1:  " + command);

                if (!dbProvider.ExecuteQuery(ds, "SHEET1", command))
                {
                    throw new Exception(dbProvider.LastExceptionMessage);
                }

                command = query2.getSQL();
                logger.Debug("QUERY - 2: " + command);

                if (!dbProvider.ExecuteQuery(ds, "SHEET2", command))
                {
                    throw new Exception(dbProvider.LastExceptionMessage);
                }
        ...
        {
            logger.Debug("Errore in Conservazione>GetDataReportSingolaAmm ", ex);
            response = null;
        }
    ...
    public bool GetStatoAttivazione(string idAmm)
    {
        ...
        try
        {
            Query q = InitQuery.getInstance().getQuery("S_ATTIVAZIONE_CONSERVAZIONE");
    ...
    public bool SetStatoAttivazione(string idAmm, string stato)
    {
        ...
        try
        {
            Query q = InitQuery.getInstance().getQuery("U_ATTIVAZIONE_CONSERVAZIONE");
            q.setParam("id_amm", idAmm);
            q.setParam("val", stato);
    ...
    #region CONSERVAZIONE FASCICOLI
    public string getStatoConservazioneFascicolo(string idProject)
    {
        string retVal = string.Empty;
        ...
        try
        {
            using (DocsPaDB.DBProvider dbProvider = new DocsPaDB.DBProvider())
            {
                DocsPaUtils.Query query = DocsPaUtils.InitQuery.getInstance().getQuery("S_GET_VERSAMENTO_FASC");
                query.setParam("idProj", idProject);
                query.setParam("fields", "CHA_STATO");
                string commandText = query.getSQL();
        ...
        {
            logger.Debug(ex, "errore in getStatoConservazioneFascicolo");
        }
    ...
    public IList<ItemsVersamento> GetFascInQueue()
    {
        //throw new NotImplementedException();

        var result = new List<ItemsVersamento>();

        try
        {
            Query query = DocsPaUtils.InitQuery.getInstance().getQuery("S_VERSAMENTO_GET_FASC_TO_SEND");
            string commandText = query.getSQL();
            logger.Debug(commandText);
            ...
            using (DocsPaDB.DBProvider dbProvider = new DBProvider())
            {
                using (IDataReader reader = dbProvider.ExecuteReader(commandText))
                {
                    ...
                    {
                        ItemsVersamento item = new ItemsVersamento();
                        item.idProfile = reader.GetValue(reader.GetOrdinal("ID_PROJECT")).ToString();
                        item.idPeople = reader.GetValue(reader.GetOrdinal("ID_PEOPLE")).ToString();
                        item.idGruppo = reader.GetValue(reader.GetOrdinal("ID_RUOLO")).ToString();
                        item.idAmm = reader.GetValue(reader.GetOrdinal("ID_AMM")).ToString();
                        item.tentativiInvio = reader.GetValue(reader.GetOrdinal("NUM_TENTATIVI_INVIO")).ToString();
    ...
    public string getFileXMLFasc(string idProject, string colName)
    {
        string retVal = string.Empty;
        ...
        {
            logger.Debug(ex, "errore in getFileXMLFasc");
        }

        return retVal;
    }

    public bool insertFileXMLFasc(string id, string val)
    {
        logger.Debug("BEGIN");
        string tableName = "DPA_VERSAMENTO_FASCICOLI";
        string colName = "VAR_FILE_RISPOSTA";
        ...
        try
        {
            using (DBProvider dbProvider = new DBProvider())
            {
                Query query = DocsPaUtils.InitQuery.getInstance().getQuery("S_GET_VERSAMENTO_FASC");
                query.setParam("idProj", id);
                query.setParam("fields", "SYSTEM_ID");
                ...
                if (!string.IsNullOrEmpty(sysId))
                    ...
                    throw new Exception("Salvataggio del file dei metadati fallito: " + dbProvider.LastExceptionMessage);
        ...
        {
            retVal = false;
            logger.Debug(ex, "errore in insertFileXMLFasc");
        }
    ...
    public bool addFascToQueueCons(string idProject, InfoUtente utente, string ente, string struttura)
    {
        bool result = false;
        ...
        try
        {
            using (DocsPaDB.DBProvider dbProvider = new DocsPaDB.DBProvider())
            {
                DocsPaUtils.Query q = DocsPaUtils.InitQuery.getInstance().getQuery("I_INSERT_FASC_IN_QUEUE_CONS");

                string dbType = DocsPaVO.Settings.AppSettings.Instance.DBType;

                if (dbType.ToUpper().Equals("ORACLE"))
                    q.setParam("sysId", DocsPaDbManagement.Functions.Functions.GetSystemIdNextVal("DPA_VERSAMENTO_FASCICOLI"));

                q.setParam("idProject", idProject);
                q.setParam("idPeople", utente.idPeople);
                q.setParam("idRuolo", utente.idGruppo);
                q.setParam("idAmm", utente.idAmministrazione);
                q.setParam("ente", !string.IsNullOrEmpty(ente) ? ente : string.Empty);
                q.setParam("struttura", !string.IsNullOrEmpty(struttura) ? struttura : string.Empty);
        ...
        {
            result = false;
            logger.Debug(ex, "errore in errFascToQueueCons");
        }

        return result;
    }

    public bool UpdateQueueConsFasc(string idProject, string stato, InfoUtente infoUtente, string warning, bool dataInvio, string numTentativo)
    {
        bool result = false;
        logger.Debug("BEGIN");
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            try
            {
                DocsPaUtils.Query q = DocsPaUtils.InitQuery.getInstance().getQuery("U_UPDATE_QUEUE_VERS_FASC");

                q.setParam("idProj", "=" + idProject);
                q.setParam("stato", stato);
            ...
            catch (Exception ex)
            {
                dbProvider.RollbackTransaction();
                result = false;
                logger.Debug(ex, "errore in UpdateQueueConsFasc");
            }
        }
    ...
    public bool UpdateQueueConsFascList(IList<ItemsVersamento> list, string status)
    {
        bool result = false;
        logger.Debug("BEGIN");
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            try
            {
                ...
                // gestione liste con più di 1000 elementi
                int counter = 1;
                foreach (ItemsVersamento id in list)
                {
                    if (counter > 998)
                    {
                        whereCond += id.idProfile + ") OR ID_PROJECT IN (";
                        counter = 0;
                    }
                    else
                    {
                ...
                q.setParam("idProj", whereCond);
                q.setParam("stato", status);
            ...
            catch (Exception ex)
            {
                dbProvider.RollbackTransaction();
                result = false;
                logger.Debug(ex, "errore in UpdateQueueConsFascList");
            }
        }
    ...
    public bool updateQueueConsFascSetCustomParams(string idProject, string ente, string struttura)
    {
        bool result = false;
        logger.Debug("BEGIN");
        ...
        try
        {
            Query query = InitQuery.getInstance().getQuery("U_VERSAMENTO_FASC_CUSTOM_PARAMS");
            query.setParam("ente", ente);
            query.setParam("struttura", struttura);
    ...
    public bool InsertNewPolicyFascPARER(PolicyFascicoliPARER policy)
    {
        bool result = false;
        logger.Debug("BEGIN");
        ...
        using(var dbProvider = new DBProvider())
        {
            try
            {
                ...
                Query q = InitQuery.getInstance().getQuery("I_DPA_POLICY_FASC_PARER");

                q.setParam("codice_policy", policy.codice);
                q.setParam("descrizione_policy", policy.descrizione);
                q.setParam("id_amm", policy.idAmm);
                q.setParam("id_ruolo_resp", policy.idGruppoRuoloResp);
                q.setParam("cha_attiva", policy.isAttiva);
                q.setParam("cha_periodicita", policy.periodicita);
                q.setParam("giorno_esecuzione", policy.giornoEsecuzione);
                q.setParam("mese_esecuzione", policy.meseEsecuzione);
                q.setParam("data_esecuzione", !string.IsNullOrEmpty(policy.dataEsecuzione) ? DocsPaDbManagement.Functions.Functions.ToDate(policy.dataEsecuzione) : "''");
                q.setParam("stato_versamento", policy.statoVersamento);
                q.setParam("id_registro", policy.idRegistro);
                q.setParam("id_titolario", policy.idTitolario);
                q.setParam("id_classifica", policy.idClassifica);
                q.setParam("id_template", policy.idTemplate);
                q.setParam("data_apertura_tipo", policy.filtroDataApertura);
                q.setParam("data_apertura_from", !string.IsNullOrEmpty(policy.dataAperturaDa) ? DocsPaDbManagement.Functions.Functions.ToDate(policy.dataAperturaDa) : "''");
                q.setParam("data_apertura_to", !string.IsNullOrEmpty(policy.dataAperturaA) ? DocsPaDbManagement.Functions.Functions.ToDate(policy.dataAperturaA) : "''");
                q.setParam("data_chiusura_tipo", policy.filtroDataChiusura);
                q.setParam("data_chiusura_from", !string.IsNullOrEmpty(policy.dataChiusuraDa) ? DocsPaDbManagement.Functions.Functions.ToDate(policy.dataChiusuraDa) : "''");
                q.setParam("data_chiusura_to", !string.IsNullOrEmpty(policy.dataChiusuraA) ? DocsPaDbManagement.Functions.Functions.ToDate(policy.dataChiusuraA) : "''");
                ...
                //string idPolicy = DocsPaDbManagement.Functions.Functions.GetQueryLastSystemIdInserted("DPA_POLICY_PARER");
                string idPolicy = string.Empty;
                if (!dbProvider.ExecuteScalar(out idPolicy, DocsPaDbManagement.Functions.Functions.GetQueryLastSystemIdInserted("DPA_POLICY_FASC_PARER")))
                    throw new Exception(dbProvider.LastExceptionMessage);
                ...
                // Inserimento informazioni di esecuzione
                logger.Debug("Inserimento informazioni di esecuzione");
                Query qExec = InitQuery.getInstance().getQuery("I_DPA_EXEC_POLICY_FASC_PARER");
                qExec.setParam("id", policy.id);
                qExec.setParam("execDate", DocsPaDbManagement.Functions.Functions.ToDate(this.GetDataProssimaEsecuzione(policy), false));
    ...
    public bool UpdatePolicyFascPARER(PolicyFascicoliPARER policy)
    {
        logger.Debug("BEGIN");
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            try
            {
                ...
                Query q = InitQuery.getInstance().getQuery("U_POLICY_FASC_PARER");
                q.setParam("idPolicy", policy.id);
                q.setParam("idAmm", policy.idAmm);
                //q.setParam("cod", policy.codice);
                q.setParam("descr", policy.descrizione.Replace("'", "''"));
                ...
                if(!string.IsNullOrEmpty(policy.dataEsecuzione))
                {
                    q.setParam("data_esecuzione", string.Format("DTA_ESECUZIONE_POLICY={0},", DocsPaDbManagement.Functions.Functions.ToDate(policy.dataEsecuzione)));
                }
                else
                {
                    q.setParam("data_esecuzione", "DTA_ESECUZIONE_POLICY='',");
                }

                q.setParam("stato_versamento", policy.statoVersamento);
                q.setParam("id_registro", policy.idRegistro);
                q.setParam("idTitolario", policy.idTitolario);
                q.setParam("idClassifica", policy.idClassifica);
                q.setParam("id_template", policy.idTemplate);

                q.setParam("dataApertura", policy.filtroDataApertura);
                q.setParam("dataChiusura", policy.filtroDataChiusura);

                if (!string.IsNullOrEmpty(policy.dataAperturaDa))
                    q.setParam("dataAperturaFrom", string.Format("DATA_APERTURA_FROM={0},", DocsPaDbManagement.Functions.Functions.ToDate(policy.dataAperturaDa)));
                else
                    q.setParam("dataAperturaFrom", "DATA_APERTURA_FROM='',");

                if (!string.IsNullOrEmpty(policy.dataAperturaA))
                    q.setParam("dataAperturaTo", string.Format("DATA_APERTURA_TO={0},", DocsPaDbManagement.Functions.Functions.ToDate(policy.dataAperturaA)));
                else
                    q.setParam("dataAperturaTo", "DATA_APERTURA_TO='',");

                if (!string.IsNullOrEmpty(policy.dataChiusuraDa))
                    q.setParam("dataChiusuraFrom", string.Format("DATA_CHIUSURA_FROM={0},", DocsPaDbManagement.Functions.Functions.ToDate(policy.dataChiusuraDa)));
                else
                    q.setParam("dataChiusuraFrom", "DATA_CHIUSURA_FROM='',");

                if (!string.IsNullOrEmpty(policy.dataChiusuraA))
                    q.setParam("dataChiusuraTo", string.Format("DATA_CHIUSURA_TO={0},", DocsPaDbManagement.Functions.Functions.ToDate(policy.dataChiusuraA)));
                else
                    q.setParam("dataChiusuraTo", "DATA_CHIUSURA_TO='',");
                ...
                // Aggiornamento informazioni di esecuzione
                logger.Debug("Aggiornamento informazioni di esecuzione");
                Query qExec = InitQuery.getInstance().getQuery("U_DPA_EXEC_POLICY_FASC_PARER");
                qExec.setParam("id", policy.id);
                qExec.setParam("par", string.Format("DATA_PROSSIMA_ESECUZIONE={0}", DocsPaDbManagement.Functions.Functions.ToDate(this.GetDataProssimaEsecuzione(policy), false)));
    ...
    public bool DeletePolicyFascicoliPARER(PolicyFascicoliPARER policy)
    {
        logger.Debug("BEGIN");
        bool result = false;
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            try
            {
                ...
                // Rimozione policy da DPA_POLICY_FASC_PARER
                Query q = InitQuery.getInstance().getQuery("D_POLICY_FASC_PARER");
                q.setParam("id", policy.id);
                string command = q.getSQL();
                logger.Debug(command);
    ...
    public DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER GetPolicyFascicoliPARERById(string idPolicy)
    {
        ...
        DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER policy = new DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER();

        try
        {
            Query q = InitQuery.getInstance().getQuery("S_GET_POLICY_FASC_PARER_BY_ID");
            q.setParam("idPolicy", idPolicy);
            ...
            using (DBProvider dbProvider = new DBProvider())
            {
                using (IDataReader reader = dbProvider.ExecuteReader(command))
                {
                    while (reader.Read())
                    {
                        ...
                        policy.giornoEsecuzione = reader.GetValue(reader.GetOrdinal("CHA_ESECUZIONE_GIORNO")).ToString();
                        policy.meseEsecuzione = reader.GetValue(reader.GetOrdinal("CHA_ESECUZIONE_MESE")).ToString();
                        policy.dataEsecuzione = reader.GetValue(reader.GetOrdinal("DATA_ESECUZIONE_POLICY")).ToString();
                        policy.statoVersamento = reader.GetValue(reader.GetOrdinal("CHA_STATO_VERSAMENTO")).ToString();
                        policy.idRegistro = reader.GetValue(reader.GetOrdinal("ID_REGISTRO")).ToString();
                        policy.idTitolario = reader.GetValue(reader.GetOrdinal("ID_TITOLARIO")).ToString();
                        policy.idClassifica = reader.GetValue(reader.GetOrdinal("ID_CLASSIFICA")).ToString();
                        policy.idTemplate = reader.GetValue(reader.GetOrdinal("ID_TEMPLATE")).ToString();
                        policy.filtroDataApertura = reader.GetValue(reader.GetOrdinal("CHA_DATA_APERTURA_TIPO")).ToString();
                        policy.dataAperturaDa = reader.GetValue(reader.GetOrdinal("DTA_APERTURA_FROM")).ToString();
                        policy.dataAperturaA = reader.GetValue(reader.GetOrdinal("DTA_APERTURA_TO")).ToString();
                        policy.filtroDataChiusura = reader.GetValue(reader.GetOrdinal("CHA_DATA_CHIUSURA_TIPO")).ToString();
                        policy.dataChiusuraDa = reader.GetValue(reader.GetOrdinal("DTA_CHIUSURA_FROM")).ToString();
                        policy.dataChiusuraA = reader.GetValue(reader.GetOrdinal("DTA_CHIUSURA_TO")).ToString();
                    }
    ...
    public DocsPaVO.fascicolazione.InfoFascicolo[] GetListaFascFromPolicy(DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER policy)
    {
        DocsPaVO.fascicolazione.InfoFascicolo[] result = null;
        string queryFrom = " LEFT JOIN DPA_VERSAMENTO_FASCICOLI V ON V.ID_PROJECT=A.SYSTEM_ID ";

        var ds = new DataSet();
        Query q = InitQuery.getInstance().getQuery("S_GET_FASC_FROM_POLICY_PARER");

        q.setParam("idAmm", policy.idAmm);
        q.setParam("filtri", this.GetFiltriPolicyFasc(policy));
        q.setParam("queryFrom", queryFrom);
        ...
        using(var dbProvider = new DBProvider())
        {
            ...
            if(ds != null && ds.Tables != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
            {
                result = new DocsPaVO.fascicolazione.InfoFascicolo[ds.Tables[0].Rows.Count];
                for(int i=0; i < ds.Tables[0].Rows.Count; i++)
                {
                    var infoFasc = new DocsPaVO.fascicolazione.InfoFascicolo
                    {
                        idFascicolo = ds.Tables[0].Rows[i]["SYSTEM_ID"].ToString(),
                        codice = ds.Tables[0].Rows[i]["VAR_CODICE"].ToString(),
                        descrizione = ds.Tables[0].Rows[i]["DESCRIPTION"].ToString(),
                        apertura = ds.Tables[0].Rows[i]["DATA_APERTURA"].ToString()
                    };
    ...
    public string GetCountFascicoliFromPolicy(DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER policy, string idAmm)
    {
        logger.Debug("BEGIN");
        ...
        Query q = InitQuery.getInstance().getQuery("S_GET_COUNT_FASC_FROM_POLICY");
        //filtri = filtroOgg + " AND A.ID_UO_CREATORE=C.SYSTEM_ID AND C.ID_AMM=" + idAmm + this.GetFiltriPolicy(policy);
        filtri = this.GetFiltriPolicyFasc(policy);
        queryFrom = " LEFT JOIN DPA_VERSAMENTO_FASCICOLI V ON V.ID_PROJECT=A.SYSTEM_ID ";
    ...
    private string GetFiltriPolicyFasc(DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER policy)
    {
        logger.Debug("BEGIN");
        string result = string.Empty;
        string dbType = DocsPaVO.Settings.AppSettings.Instance.DBType;
        ...
        if (!string.IsNullOrEmpty(policy.filtroDataApertura) && !policy.filtroDataApertura.Equals("0"))
        {
            switch(policy.filtroDataApertura)
            {
                // Valore singolo
                case "S":
                    if(!string.IsNullOrEmpty(policy.dataAperturaDa))
                    {
                        result += " AND A.DTA_APERTURA >= " + DocsPaDbManagement.Functions.Functions.ToDateBetween(policy.dataAperturaDa, true);
                        result += " AND A.DTA_APERTURA <= " + DocsPaDbManagement.Functions.Functions.ToDateBetween(policy.dataAperturaDa, false);
                    }
                    break;
                ...
                case "R":
                    ...
                    if(!string.IsNullOrEmpty(policy.dataAperturaA))
                    {
                        result += " AND A.DTA_APERTURA <= " + DocsPaDbManagement.Functions.Functions.ToDateBetween(policy.dataAperturaA, false);
                    }
                    break;
                // Numero giorni prima
                case "P":
                    ...
                    if(dbType.ToUpper().Equals("SQL"))
                    {
                        //result += string.Format(" AND A.DTA_APERTURA BETWEEN CONVERT(DATETIME, DATEDIFF(day, {0}, GETDATE())) AND CONVERT(DATETIME, DATEDIFF(day, {0}-1, GETDATE()))", policy );
                    }
                    else
                    {
                        //result += string.Format(" AND A.DTA_APERTURA BETWEEN TRUNC(SYSDATE-{0},'DD') AND (TRUNC(SYSDATE-{0}+1, 'DD')-1/86400) ", policy.numGiorniCreazione);
                    }
                    */
                    break;
            }
        ...
        if (!string.IsNullOrEmpty(policy.filtroDataChiusura) && !policy.filtroDataChiusura.Equals("0"))
        {
            switch (policy.filtroDataChiusura)
            {
                // Valore singolo
                case "S":
                    if (!string.IsNullOrEmpty(policy.dataChiusuraDa))
                    {
                        result += " AND A.DTA_CHIUSURA >= " + DocsPaDbManagement.Functions.Functions.ToDateBetween(policy.dataChiusuraDa, true);
                        result += " AND A.DTA_CHIUSURA <= " + DocsPaDbManagement.Functions.Functions.ToDateBetween(policy.dataChiusuraDa, false);
                    }
                    break;
                ...
                case "R":
                    ...
                    if (!string.IsNullOrEmpty(policy.dataAperturaA))
                    {
                        result += " AND A.DTA_CHIUSURA <= " + DocsPaDbManagement.Functions.Functions.ToDateBetween(policy.dataChiusuraA, false);
                    }
                    break;
                // Numero giorni prima
                case "P":
        ...
        if(!string.IsNullOrEmpty(policy.idRegistro) && !policy.idRegistro.Equals("0"))
        {
            result += " AND ID_REGISTRO=" + policy.idRegistro;
        }
        #endregion

        #region Titolario
        if (!string.IsNullOrEmpty(policy.idTitolario) && !policy.idTitolario.Equals("0"))
        {
            result += " AND ID_TITOLARIO=" + policy.idTitolario;
        }
        #endregion

        #region Classificazione
        if(!string.IsNullOrEmpty(policy.idClassifica) && !policy.idClassifica.Equals("0"))
        {
            result += " AND ID_PARENT=" + policy.idClassifica;
        }
        #endregion

        #region Campi profilati (ex tipologia fascicolo)
        if(!string.IsNullOrEmpty(policy.idTemplate) && !policy.idTemplate.Equals("0"))
        {
            if(policy.idTemplate == "-1")
            {
                result += " AND ID_TIPO_FASC IS NULL";
            }
            else
            {
                result += " AND ID_TIPO_FASC=" + policy.idTemplate;
            }
        }
        #endregion
    ...
    public bool UpdateStatoPolicyFascicoli(List<DocsPaVO.Conservazione.PARER.PolicyFascicoliPARER> lista, InfoUtente utente)
    {
        logger.Debug("BEGIN");
        bool result = false;
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            try
            {
                ...
                foreach (var policy in lista)
                {
                    Query q = InitQuery.getInstance().getQuery("U_STATO_POLICY_FASC_PARER");
                    q.setParam("id", policy.id);
                    q.setParam("attiva", policy.isAttiva);
                    q.setParam("notifica", policy.notificaMail);
                    string command = q.getSQL();
                    ...
                    if (policy.isAttiva.Equals("1"))
                    {
                        ...
                        Log.InsertLog(utente.userId, utente.idPeople, utente.idGruppo, utente.idAmministrazione, ogg.Oggetto, policy.id, string.Format("Attivazione policy fascicoli {0} da parte dell'utente {1}", policy.codice, utente.userId),
                           ogg.Codice, ogg.Descrizione, DocsPaVO.Logger.CodAzione.Esito.OK, null, null);
                    }
                    else
                    {
                        ...
                        Log.InsertLog(utente.userId, utente.idPeople, utente.idGruppo, utente.idAmministrazione, ogg.Oggetto, policy.id, string.Format("Disattivazione policy fascicoli {0} da parte dell'utente {1}", policy.codice, utente.userId),
                            ogg.Codice, ogg.Descrizione, DocsPaVO.Logger.CodAzione.Esito.OK, null, null);
                     }
    ...
    public bool UpdateStatoSingolaPolicyFascicoli(string idPolicy, string attiva, string notifica)
    {
        logger.Debug("BEGIN");
        bool result = false;
    ...
    public bool SetInfoVersamentoAutomaticoFascicoli(string idProject, DocsPaVO.Conservazione.PARER.EsecuzionePolicy info)
    {
        logger.Debug("BEGIN");
        bool result = false;
        ...
        using (DBProvider dbProvider = new DBProvider())
        {
            ...
            {
                dbProvider.BeginTransaction();
                Query q = InitQuery.getInstance().getQuery("I_DPA_VERSAMENTO_POLICY_FASC_PARER");
    ...
    public ArrayList GetListaPolicyFascDaEseguire(string idAmm)
    {
        ArrayList lista = new ArrayList();
        ...
        try
        {
            using (DBProvider dbProvider = new DBProvider())
            {
                Query q = InitQuery.getInstance().getQuery("S_GET_POLICY_FASC_TO_EXECUTE");
                q.setParam("idAmm", idAmm);
    ...
    public bool GetCustomParamsSacerFasc(string idProject, out string ente, out string struttura)
    {
        bool result = false;
        logger.Debug("BEGIN");
        ...
        try
        {
            Query query = InitQuery.getInstance().getQuery("S_VERSAMENTO_FASC_GET_CUSTOM_ENTE");
            query.setParam("id_project", idProject);
        ...
        {
            logger.Debug("Errore in GetCustomParamsSacerFasc - ", ex);
            ente = string.Empty;
            struttura = string.Empty;
            result = false;
        }
    ...
    public ArrayList getResponsabiliCons(string idAmm)
    {
        ...
        using (DocsPaDB.DBProvider dbProvider = new DocsPaDB.DBProvider())
        {
            DocsPaUtils.Query query = DocsPaUtils.InitQuery.getInstance().getQuery("S_GET_ROLE_CONS_RESP");
            query.setParam("idAmm", idAmm);
            ...
            if(ds!=null && ds.Tables[0].Rows.Count>0)
            {
                ...
                {
                    resp.Add(string.Format("{0} ({1})", dr["RUOLO"].ToString(), dr["AOO"].ToString()));
                }
            }
        }
