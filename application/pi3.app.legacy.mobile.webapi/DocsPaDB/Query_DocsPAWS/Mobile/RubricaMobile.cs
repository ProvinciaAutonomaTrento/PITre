...
{
    private static ILogger logger = Serilog.Log.ForContext(typeof(RubricaMobile));
    ...
    public bool PrefMobile_Insert(DocsPaVO.Mobile.InfoPreferito infoPref)
    {
        ...
        {
            logger.Error(ex, "errore in PrefMobile_Insert");
            retval = false;
        }
    ...
    public bool PrefMobile_Delete(DocsPaVO.Mobile.InfoPreferito infoPref)
    {
        ...
        {
            logger.Error(ex, "errore in PrefMobile_Delete");
            retval = false;
        }
    ...
    public List<InfoPreferito> PrefMobile_getList(string idpeopleowner, bool soloP, string tipoPref)
    {
        ...
        {
            logger.Error(ex, "errore in PrefMobile_getList"); retval = null;
        }
        return retval;
    }
