...
namespace DocsPaVO.rubrica
{
    ...
    {
        /// <summary>
        /// Il tipo di chiamata (ricerca) che la rubrica � chiamata ad effettuare
        /// </summary>
        /// <remarks>
        /// Questo enumeratore permette di definire il tipo di chiamata (ricerca)
        /// che la rubrica � chiamata ad effettuare. In base al tipo di chiamata
        ...
        public enum CallType
        {
            ...
            /// <summary>
            /// Protocollo in uscita - mittente (in DocsPA3 � selezionabile da rubrica)
            /// </summary>
            CALLTYPE_PROTO_OUT_MITT,

            /// <summary>
            /// Protocollo interno - mittente (in DocsPA3 � selezionabile da rubrica)
            /// </summary>
            ...
            /// <summary>
            /// Visibilit� Ricerca Utente
            /// </summary>
            CALLTYPE_VIS_UTENTE,

            /// <summary>
            /// Visibilit� Ricerca Ruolo
            /// </summary>
            CALLTYPE_VIS_RUOLO,
        ...
        /// <summary>
        /// L'identit� dell'utente che effettua la ricerca
        /// </summary>
        ...
        public class CallerIdentity
        {
            ...
            /// <summary>
            /// Contiene la stringa dei registri (uno o pi� registri concatenati) necessari
        ...
        /// la query � effettuata in modo esatto senza like.
        /// </summary>
        ...
        /// <summary>
        /// La citt� in cui si trova il corrispodennte o i corrispondenti da ricercare
        /// </summary>
        /// <remarks>La ricerca sulla citt� viene eseguita anche su una parte
        ...
        /// <summary>
        /// Note associate alla email
        /// </summary>
        public string noteEmail;

        /// <summary>
        /// Note associate alla email, campo dedicato ai servizi perch� ha un funzionamento differente rispetto a quello da FE
        /// </summary>
        public string noteEmailPISREST;

        /// <summary>
        /// Email principali o secondarie associate all'utente. Filtro dedicato per i PIS REST.
        /// </summary>
        public string emailsPISREST;
