...
namespace DocsPaVO.filtri 
{
    ...
    [XmlInclude(typeof(DocsPaVO.filtri.filtriConservazione.listaArgomenti))]
    
    
    [XmlInclude(typeof(DocsPaVO.Spedizione.FiltriReportSpedizioni))]
    [XmlInclude(typeof(DocsPaVO.ProfilazioneDinamica.Templates))]       
    public class FiltroRicerca 
	{
        ...
        // indica la modalit� di ricerca di un filtro di tipo testo
        ...
        public DocsPaVO.filtri.filtriConservazione.listaArgomenti listaFiltriConservazione;

        //aggiunta oggetto filtro per report spedizioni
        public DocsPaVO.Spedizione.FiltriReportSpedizioni listaFiltriSpedizioni;
