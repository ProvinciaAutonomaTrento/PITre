...
{
    public class CorrispondentiDeleteModifyCorrispondenteEsternoHandler : IRequestHandler<CorrispondentiDeleteModifyCorrispondenteEsterno, CorrispondentiDeleteModifyCorrispondenteEsternoResult>
    {
        ...
        public async Task<CorrispondentiDeleteModifyCorrispondenteEsternoResult> Handle(CorrispondentiDeleteModifyCorrispondenteEsterno request, CancellationToken cancellationToken)
        {
            bool result = false;
