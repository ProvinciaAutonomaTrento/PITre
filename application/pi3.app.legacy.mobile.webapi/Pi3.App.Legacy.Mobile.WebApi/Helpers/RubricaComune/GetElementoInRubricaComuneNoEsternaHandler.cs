...
using Pi3.App.Legacy.Mobile.WebApi.Helpers.AddressBook;
...
{
    public class GetElementoInRubricaComuneNoEsternaHandler : IRequestHandler<GetElementoInRubricaComuneNoEsterna, GetElementoInRubricaComuneNoEsternaResult>
    {
        ...
        public GetElementoInRubricaComuneNoEsternaHandler(ILogger<GetElementoInRubricaComuneNoEsternaHandler> logger,
            ...
            IAacFetcherService aacFetcherService,
            IConfiguration configuration)
        {
            ...
            this._aacFetcherService = aacFetcherService;
            this._configuration = configuration;
        }

        public async Task<GetElementoInRubricaComuneNoEsternaResult> Handle(GetElementoInRubricaComuneNoEsterna request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (itemRubricaComune is not null)
                {
                    ...
                    if (await corrGlobaliQueryable.AnyAsync())
                    {
                        ...
                        if (daStoricizzare)
                        {
                            var modifyRequest = new CorrispondentiDeleteModifyCorrispondenteEsterno(request.u,
        ...
        protected IAacFetcherService _aacFetcherService;
