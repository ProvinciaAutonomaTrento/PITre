...
using Pi3.App.Legacy.Mobile.WebApi.Model.Decorators;
...
namespace Pi3.App.Legacy.Mobile.WebApi.Model
{
    public class RicercaStrategies
    {
        public abstract class RicercaStrategy
        {
            ...
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaStrategy));
            ...
            protected FiltroRicerca[] getFiltriDoc(RicercaRequest request, InfoUtente iu, bool inAdl)
            {
                ...
                {
                    logger.Debug("Presenti i valori DataDa {0} e DataA {1}", request.DataDa, request.DataA);
                ...
                {
                    logger.Debug("Presenti il valore DataDa {0}",request.DataDa);
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaSalvataFascicoloStrategy));
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaSalvataDocumentoStrategy));
            public override bool canSolve(RicercaRequest request)
            {
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaTestoFascicoloStrategy));
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaAdlTestoFascicoloStrategy));
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaTestoDocumentoStrategy));
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaAdlTestoDocumentoStrategy));
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaTestoDocFascStrategy));
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(RicercaAdlDocFascStrategy));
        ...
        {
            private static Serilog.ILogger logger = Log.ForContext(typeof(FolderContentStrategy));
