...
{
    public class ApriAggregazioneCommandHandler : IRequestHandler<ApriAggregazioneCommand, ApriAggregazioneCommandResponse>
    {
        ...
        public ApriAggregazioneCommandHandler(
        ...
        public async Task<ApriAggregazioneCommandResponse> Handle(ApriAggregazioneCommand request, CancellationToken cancellationToken)
        {
            ...
            return new ApriAggregazioneCommandResponse();
        }
    }
}
