# Pi3.App.AggregazioneDocumentale.WebApi

## Introduzione
Nell'ambito della nuova architettura del PiTre in cloud, **Pi3.App.AggregazioneDocumentale.WebApi** è il nuovo microservizio che espone agli applicativi gestionali le funzionalità dell'Aggregazione Documentale secondo le regole ed il formato stabiliti dalla normativa [AGID](https://www.agid.gov.it/sites/default/files/repository_files/allegato_5_metadati.pdf).

Nella figura seguente, la Web Application è rappresentata dal POD denominato **web-api-aggregazionedocumentale** all'interno del Cluster Kubernates : 

![Panoramica.drawio.png](./Docs/Images/Panoramica.drawio.png)

## Url Swagger

| Ambiente | Url Swagger |
| ---------| ------------|
| TEST | https://pitre-test.cloud-test-intra.tndigit.it/AggregazioneDocumentale/swagger/index.html |
| QUALITY | https://pitre-qual.cloud-qual-intra.tndigit.it/AggregazioneDocumentale/swagger/index.html |
| COLLAUDO | https://pitre-coll.cloud-qual-intra.tndigit.it/AggregazioneDocumentale/swagger/index.html |
| FORMAZIONE | https://pitre-formazione.cloud-intra.tn.it/AggregazioneDocumentale/swagger/index.html |
| PRODUZIONE | https://pitre.cloud-intra.tn.it/AggregazioneDocumentale/swagger/index.html |
...
| ------------- | ------------- |
| Pi3.App.AggregazioneDocumentale.WebApi | Progetto che implementa l'applicazione Web con gli Api controller, i middleware, gli action filters, il layer applicativo CQRS, gli aspetti di registrazione delle librerie e dei package utilizzati. |
| Pi3.App.AggregazioneDocumentale.WebApi.Tests | Progetto che implementa i test unitari. |
| Pi3.App.AggregazioneDocumentale.WebApi.sln | File di solution. |
