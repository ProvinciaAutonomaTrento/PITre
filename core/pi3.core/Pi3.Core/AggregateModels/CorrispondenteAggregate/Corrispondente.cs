...
namespace Pi3.Core.AggregateModels.CorrispondenteAggregate
{
    public abstract class Corrispondente : Element
    {
        ...
        protected void AssertEmail(string indirizzoEmail)
        {
            ...
            if (string.IsNullOrEmpty(indirizzoEmail) || !System.Text.RegularExpressions.Regex.Match(indirizzoEmail.TrimStart(" ".ToCharArray()).TrimEnd(" ".ToCharArray()), pattern).Success)
