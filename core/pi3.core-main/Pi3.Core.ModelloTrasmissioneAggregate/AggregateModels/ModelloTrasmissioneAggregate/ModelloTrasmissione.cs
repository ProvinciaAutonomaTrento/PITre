...
using Pi3.Core.AggregateModels.ModelloTrasmissioneAggregate.Exceptions;
...
namespace Pi3.Core.AggregateModels.ModelloTrasmissioneAggregate
{
    ...
    public class ModelloTrasmissione : Element
    {
                ...
                TipiOggettiTrasmessiEnum tipoOggettoTrasmesso)
        {
            ...
            {
                Id = id,
                TypeName = nameof(ModelloTrasmissione),
                IdTenant = idTenant,
                    ...
                    bool? nascondiVersioniPrecedenti)
        {
            ...
            this.ApplyChange(new GruppoDestinatarioAddedEvent()
            {
                Id = this.Id,
                IdGruppo = id,
        ...
        public virtual void RemoveGruppoDestinatario(string id)
        {
            ...
            this.ApplyChange(new GruppoDestinatarioRemovedEvent()
            {
                Id = this.Id,
                IdGruppo = id
            });
            ...
            bool? nascondiVersioniPrecedenti)
        {
            ...
            this.ApplyChange(new UtenteDestinatarioAddedEvent()
            {
                Id = this.Id,
                IdUtente = id,
                UserId = userId,
        ...
        protected virtual void Handle(GruppoDestinatarioAddedEvent @event)
        {
        ...
        protected virtual void Handle(GruppoDestinatarioRemovedEvent @event)
        {
        ...
        protected virtual void Handle(UtenteDestinatarioAddedEvent @event)
        {
