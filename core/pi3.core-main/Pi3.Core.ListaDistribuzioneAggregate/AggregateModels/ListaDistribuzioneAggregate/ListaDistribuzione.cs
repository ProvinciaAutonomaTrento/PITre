...
using Pi3.Core.AggregateModels.ListaDistribuzioneAggregate.Entities;
using Pi3.Core.AggregateModels.ListaDistribuzioneAggregate.Events;
using Pi3.Core.AggregateModels.ListaDistribuzioneAggregate.Exceptions;
...
namespace Pi3.Core.AggregateModels.ListaDistribuzioneAggregate
{
    public class ListaDistribuzione : Element
    {
        ...
        public ListaDistribuzione(string idTenant, DateTime creationDate, TextValue name, TextValue description)
            : base(idTenant, nameof(ListaDistribuzione), creationDate, name, description)
        {
        ...
        public ListaDistribuzione(string id, string idTenant, DateTime creationDate, TextValue name, TextValue description = null)
            : base(id, idTenant, nameof(ListaDistribuzione), creationDate, name, description)
        {
            description = description ?? throw new ArgumentNullException(nameof(description));
        }
        ...
        public void AddDestinatario(string id, TipiDestinatariEnum tipoDestinatario, TextValue? descrizione, bool? esterno)
        {
            ...
            {
                throw new DestinatarioPi3Exception(ErrorDescriptions.DestinatarioGiaPresente, id);
        ...
        public void RemoveDestinatario(string id)
        {
            ...
            {
                throw new DestinatarioPi3Exception(ErrorDescriptions.DestinatarioGiaRimosso, id);
            }
        }
