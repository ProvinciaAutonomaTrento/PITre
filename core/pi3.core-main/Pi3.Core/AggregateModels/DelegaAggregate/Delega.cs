...
namespace Pi3.Core.AggregateModels.DelegaAggregate
{
    ...
    public class Delega : Element
    {
        ...
        public Delega(string idTenant, DateTime creationDate, TextValue name, TextValue? description = null)
            : base(idTenant, "Delega", creationDate, name, description)
        {
        }
        ...
        public Delega(
            ...
            : base(id, idTenant, "Delega", creationDate, name, description)
        {
        }
        ...
        public virtual IEnumerable<Pi3Exception> GetErrors()
        {
            ...
            if (this.DataScadenza != null && this.DataScadenza < this.DataDecorrenza)
                pi3Exceptions.Add(new DelegaIntervalloDataInvalidPi3Exception());
