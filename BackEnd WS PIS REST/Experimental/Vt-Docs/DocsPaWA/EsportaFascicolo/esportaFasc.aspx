<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="esportaFasc.aspx.cs" Inherits="DocsPAWA.EsportaFascicolo.esportaFasc" %>

<%@ Register Src="../ActivexWrappers/ProjectToFSWrapper.ascx" TagName="ProjectToFSWrapper"
    TagPrefix="uc1" %>
            ...
            <tr class="testo_grigio_scuro">
                <td align="center">
                    <asp:Button ID="btnEsporta" runat="server" OnClientClick="esporta();" CssClass="pulsante"
                        Text="Invia" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnCancel" runat="server" Text="Chiudi" CssClass="pulsante" OnClientClick="window.close();window.returnValue='chiuso';">
                    </asp:Button>
                </td>
            </tr>
        </table>
