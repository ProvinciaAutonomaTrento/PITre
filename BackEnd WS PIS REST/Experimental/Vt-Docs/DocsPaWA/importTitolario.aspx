<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="importTitolario.aspx.cs" Inherits="DocsPAWA.importTitolario" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Import Titolario</title>
    ...
    <table width="100%" style="BORDER-RIGHT: #810d06 1px solid; BORDER-TOP: #810d06 1px solid; BORDER-LEFT: #810d06 1px solid; BORDER-BOTTOM: #810d06 1px solid">
        ...
        <tr>
            <td style="width:20%;"><br />
                &nbsp;&nbsp;<asp:Label ID="lbl_Codice" runat="server" Text="Numero Operazione * :" Font-Bold="True" ForeColor="#404040"></asp:Label></td>
            <td style="width:80%"><br />
                <asp:TextBox ID="txt_Codice" CssClass="testo_grigio" Width="300px" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width:20%">
                &nbsp;&nbsp;<asp:Label ID="lbl_Descrizione" runat="server" Text="Descrizione * :" Font-Bold="True" ForeColor="#404040"></asp:Label></td>
            <td style="width:80%">
                <asp:TextBox ID="txt_Descrizione" CssClass="testo_grigio" Width="300px" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td><br /></td>
