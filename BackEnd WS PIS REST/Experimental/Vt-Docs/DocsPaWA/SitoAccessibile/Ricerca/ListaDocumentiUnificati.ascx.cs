namespace DocsPAWA.SitoAccessibile.Ricerca
{
	...
	/// </summary>
	public class ListaDocumentiUnificati : ListaDocumenti
	{
		...
		protected override FiltroRicerca[] GetFiltriRicerca()
		{
            ...
            filterItem.valore = "tipo";
            filtri.Add(filterItem);
            filterItem = new FiltroRicerca();
            filterItem.argomento = DocsPAWA.DocsPaWR.FiltriDocumento.GRIGIO.ToString();
            filterItem.valore = Convert.ToString(searchProperties.DocumentiGrigi);
            filtri.Add(filterItem);
            filterItem = new FiltroRicerca();
            filterItem.argomento = DocsPAWA.DocsPaWR.FiltriDocumento.PROT_ARRIVO.ToString();
            filterItem.valore = Convert.ToString(searchProperties.ProtocolliArrivo);
            filtri.Add(filterItem);
            filterItem = new FiltroRicerca();
            filterItem.argomento = DocsPAWA.DocsPaWR.FiltriDocumento.PROT_PARTENZA.ToString();
            filterItem.valore = Convert.ToString(searchProperties.ProtocolliPartenza);
            filtri.Add(filterItem);
            filterItem = new FiltroRicerca();
            filterItem.argomento = DocsPAWA.DocsPaWR.FiltriDocumento.PROT_INTERNO.ToString();
            filterItem.valore = Convert.ToString(searchProperties.ProtocolliInterni);
            filtri.Add(filterItem);
