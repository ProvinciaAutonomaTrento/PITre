<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentAcquisitionDlg.aspx.cs" Inherits="DocsPAWA.SmartClient.DocumentAcquisitionDlg" %>
     ...
     <script type="text/javascript">
         ...
         function ShowImageViewer() {
             try {
                 ...
                 acquisizione.myControl.Signature = "<%=this.segnatura%>"
