<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportPregressiDettaglio.aspx.cs"
    Inherits="DocsPAWA.Import.Documenti.ImportPregressiDettaglio" %>
...
<body>
    ...
    <div id="container">
        <div id="content">
            <div class="topGrid">
                <asp:Label ID="titlePage" runat="server" Text="REPORT IMPORT PREGRESSO" CssClass="title"></asp:Label>
            </div>
        ...
        <asp:UpdatePanel ID="up" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <table id="Table3" align="center">
                    <tr>
                        <td align="center">
                            <asp:Button ID="btn_esporta" runat="server" CssClass="pulsante_mini_3" Text="Esporta"
                                OnClick="BtnEsporta_Click"></asp:Button>
                        </td>
                        <td>
