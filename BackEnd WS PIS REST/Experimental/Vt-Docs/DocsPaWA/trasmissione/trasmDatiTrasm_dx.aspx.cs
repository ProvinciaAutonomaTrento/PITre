...
namespace DocsPAWA.trasmissione
{
    ...
    public class trasmDatiTrasm_dx : DocsPAWA.CssPage
    {
        ...
        private bool utenteProprietario(string docNumber)
        {
            ...
            //estendo la cessione dei diritti anche a chi non è il proprietario.
            //In questo caso se cedo più volte i diritti all'interno dello stesso ruolo
