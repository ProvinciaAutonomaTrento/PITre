<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectToFSWrapper.ascx.cs"
    Inherits="DocsPAWA.ActivexWrappers.ProjectToFSWrapper" %>
<% 
    if (DocsPAWA.ActivexWrappers.Configurations.ProjectToFSControl &&
...
<script id="projectToFSScript" type="text/javascript">
    ...
    function ExportPrj(outputFolder)
    {
        try {
            ...
            if ("<%=DocsPAWA.ActivexWrappers.Configurations.ProjectToFSControl%>" == "True") {
