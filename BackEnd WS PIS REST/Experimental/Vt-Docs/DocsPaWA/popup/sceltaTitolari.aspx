<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sceltaTitolari.aspx.cs" Inherits="DocsPAWA.popup.sceltaTitolari" %>
...
<body>
    ...
    <TABLE class="info" id="Table1" height="100%" width="100%" align="center" border="0">
        <TR>
			<TD align="center">
			    <br />
				<P class="boxform_item">Codice presente su più titolari. Selezionare un  titolario.</P>
			</TD>
		</TR>
		<TR>
			<TD align="center">
			    <DIV id="gw_listaTitolari" style="OVERFLOW: auto; HEIGHT: 180px; width:100%">
			        <br/>
		            <asp:GridView ID="gw_Titolari" runat="server" SkinID="gridview" AutoGenerateColumns="False" Width="90%">
