...
<%@ Page language="c#" Codebehind="RicercaDocumentiPerClassifica.aspx.cs" AutoEventWireup="false" Inherits="DocsPAWA.popup.RicercaDocumentiPerClassifica" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="5" topMargin="5" rightMargin="5" MS_POSITIONING="GridLayout">
		<form id="frm_rispostaProtoUscita" method="post" runat="server">
		    <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "Ricerca documenti per classifica" />
			...
			<TABLE class="contenitore" id="tbl_rispostaProtoUscita" height="603" width="580" align="center"
				...
				<TR vAlign="middle" height="20">
					<td class="menu_1_rosso" align="center">Ricerca Documenti per la fascicolazione</td>
				</TR>
				<tr height="120">
					<td>
								...
								<td vAlign="top" align="center">
									<table id="tblNumeroProtocollo" cellSpacing="0" cellPadding="0" width="98%" align="center"
										...
										<TR height="20">
											...
											<td align="center" colSpan="4"><asp:radiobuttonlist id="rbl_sceltaRicerca" Runat="server" AutoPostBack="True" Width="400px" CssClass="testo_grigio_scuro"
													RepeatDirection="Horizontal">
													<asp:ListItem Value="P" Selected="True">Doc. protocollati</asp:ListItem>
													<asp:ListItem Value="G">Doc. non prot. </asp:ListItem>
													...
													<asp:panel id="pnl_filtri_prot" Runat="server">
														...
														<TR>
															...
															<TD class="testo_grigio" width="59%" height="29">
																...
																<asp:textbox id="txt_fineIdDoc" runat="server" CssClass="testo_grigio" Width="80px" Visible="False"></asp:textbox>
                                                                <asp:label id="lbl_annoDoc" runat="server" CssClass="titolo_scheda" Width="20px"><IMG height="2" src="../images/proto/spaziatore.gif" width="5px" border="0">anno:&nbsp;</asp:label>
                                                                <asp:textbox id="txt_annoDoc" runat="server" CssClass="testo_grigio" Width="55px" maxlength="4"></asp:textbox></TD>
														</TR>
														<TR>
				...
				<TR vAlign="top" height="295">
					<TD align="center">
						...
						<DIV id="DivDataGrid" style="OVERFLOW: auto; WIDTH: 570px; HEIGHT: 270px" align="center">
							<table>
								<tr>
									<td><p align="left"><asp:checkbox id="chkSelectDeselectAll" runat="server" AutoPostBack="True" CssClass="testo_grigio_scuro"
												Text="Seleziona / deseleziona tutti" Checked="False" Visible="False"></asp:checkbox></p>
									</td>
								</tr>
								<tr>
									<td>
