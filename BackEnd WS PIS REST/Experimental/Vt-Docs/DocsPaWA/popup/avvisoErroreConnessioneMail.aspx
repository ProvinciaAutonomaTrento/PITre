<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="avvisoErroreConnessioneMail.aspx.cs" Inherits="DocsPAWA.popup.avvisoErroreConnessioneMail" %>
    ...
    <TABLE class="contenitore" id="tbl_avviso" height="140" width="300" align="center" border="0">
		<TR vAlign="middle" height="20">
			...
			<td class="style2" align="justify">
                <asp:Label ID="erroreMail" runat="server" Text="ERRORE"></asp:Label>
			</td>
		</TR>
		<TR>
