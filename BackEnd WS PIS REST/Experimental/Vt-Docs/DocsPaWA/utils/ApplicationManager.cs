...
namespace DocsPAWA
{
    ...
    public class ApplicationManager
    {
      ...
      public static DocsPAWA.DocsPaWR.ValidationResultInfo ExtAppDeleteUte(String idApplicazione, String idUtente)
      {
          AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
          DocsPAWA.DocsPaWR.ValidationResultInfo retValue = docsPaWS.ExtAppDeleteUte(idApplicazione, idUtente);
          return retValue;
      }
