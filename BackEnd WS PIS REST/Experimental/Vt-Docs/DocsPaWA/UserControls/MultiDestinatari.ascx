<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiDestinatari.ascx.cs" Inherits="DocsPAWA.UserControls.MultiDestinatari" %>
                ...
                <asp:DataGrid ID="grvListaCorr" runat="server" AllowSorting="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <asp:TemplateColumn ItemStyle-Width="5%" HeaderText="" ItemStyle-HorizontalAlign="center"
                            ...
                            <ItemTemplate>
                                <input name="rbl_pref" type="radio" class="testo_grigio_scuro" value='<%# this.GetCorrID((DocsPAWA.DocsPaWR.Corrispondente)Container.DataItem) %>'>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <%--<asp:TemplateColumn ItemStyle-Width="14%" HeaderText="Visibilità" ItemStyle-HorizontalAlign="center"
                            HeaderStyle-HorizontalAlign="center" ItemStyle-CssClass="tab_dx">
                            <ItemTemplate>
                            <asp:Label ID="gridTipo" runat="server" Text='<%# this.GetCorrTipo((DocsPAWA.DocsPaWR.Corrispondente)Container.DataItem) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn> --%> 
                    </Columns>
                </asp:DataGrid>
