<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calendario.aspx.cs" Inherits="DocsPAWA.TodoList.Calendario" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
    <HEAD>
		<title>DOCSPA > Seleziona...</title>				
		<style> 
			td {font-family: Verdana, sans-serif; font-size: 9px;}
		</style>		
		...
		var STR_ICONPATH = '../AdminTool/Images/';
	...
	<body bgcolor="#ffffff" bottomMargin="0" leftMargin="3" topMargin="3" rightMargin="3">
