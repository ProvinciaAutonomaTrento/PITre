...
namespace DocsPAWA.AdminTool.Gestione_Utenti
{
    ...
    public partial class LdapSyncronization : System.Web.UI.Page
    {
        ...
        protected string GetEsitoSincronizzazioneCellText(DocsPaWR.LdapSyncronizationResponseItem item)
        {
            ...
            if (item.Result == DocsPAWA.DocsPaWR.LdapSyncronizationResultEnum.Inserted)
                esito = "Inserito";
            else if (item.Result == DocsPAWA.DocsPaWR.LdapSyncronizationResultEnum.Updated)
                esito = "Modificato";
            else if (item.Result == DocsPAWA.DocsPaWR.LdapSyncronizationResultEnum.Deleted)
                esito = "Cancellato";
            else if (item.Result == DocsPAWA.DocsPaWR.LdapSyncronizationResultEnum.Error)
                esito = "Errore";
