...
namespace Amministrazione.Gestione_Ruoli
{
	...
	{		
		...
		{			
			...
			switch(e.CommandName) 
			{
				case "Select":
                    ...
                    if (DocsPAWA.Utils.GetAbilitazioneAtipicita())
                    ...
                    this.txt_livello.Enabled = !DocsPAWA.Utils.GetAbilitazioneAtipicita();
		...
		/// <returns></returns>
		private DocsPAWA.DocsPaWR.OrgTipoRuolo GetTipoRuolo(string idTipoRuolo)
		{
			DocsPaWR.DocsPaWebService ws=new DocsPAWA.DocsPaWR.DocsPaWebService();
		...
		/// <returns></returns>
		private DocsPAWA.DocsPaWR.ValidationResultInfo InsertTipoRuolo(ref DocsPAWA.DocsPaWR.OrgTipoRuolo tipoRuolo)
		{
		...
		/// <returns></returns>
		private DataSet ConvertToDataSet(DocsPAWA.DocsPaWR.OrgTipoRuolo[] tipiRuolo)
		{
