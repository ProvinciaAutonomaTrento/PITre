...
{
    public partial class PolicyStampePARER : System.Web.UI.Page
    {
        #region Events
        ...
        {
            this.listaPolicy = this._wsInstance.GetListaPolicyPARER(this.IdAmministrazione, "S");
        ...
        protected string UrlNewPolicy
        {
            get
            {
                return "newPolicyStampePARER.aspx?s=new";
            }
        }
        ...
        protected string UrlViewPolicy
        {
            get
            {
                return "newPolicyStampePARER.aspx";
            }
        }
