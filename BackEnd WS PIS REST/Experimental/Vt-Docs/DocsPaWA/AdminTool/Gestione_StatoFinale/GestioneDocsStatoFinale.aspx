<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestioneDocsStatoFinale.aspx.cs"
    Inherits="DocsPAWA.AdminTool.Gestione_StatoFinale.GestioneDocsStatoFinale" %>
                ...
                <div id="divGrdDocuments" style="overflow: auto; width: 100%; height: 357px" visible="false"
                    ...
                    <asp:DataGrid ID="grdDocuments" runat="server" AutoGenerateColumns="False" BorderColor="Gray"
                        ...
                        <Columns>
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                    <asp:Label ID="lblIdDoc" runat="server" Text='<%#((DocsPAWA.DocsPaWR.DocumentoStatoFinale) Container.DataItem).IdDocumento%>' />
                                </ItemTemplate>
                            </asp:TemplateColumn>
