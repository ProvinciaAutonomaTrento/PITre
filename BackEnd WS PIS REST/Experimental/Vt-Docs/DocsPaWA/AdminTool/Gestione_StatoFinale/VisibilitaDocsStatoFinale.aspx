<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisibilitaDocsStatoFinale.aspx.cs" Inherits="DocsPAWA.popup.VisibilitaDocsStatoFinale" %>
                                ...
                                <asp:TemplateColumn Visible="false">
									...
									<ItemTemplate>
                                        <asp:Label ID="lblIdRuolo" runat="server"
                                            Text = '<%#((DocsPAWA.DocsPaWR.DocumentoDiritto) Container.DataItem).personorgroup%>'>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                         </asp:Label>
									</ItemTemplate>									
								</asp:TemplateColumn>									
                                <asp:TemplateColumn HeaderText="Ruolo" ItemStyle-HorizontalAlign="Left">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemTemplate>
                                        <asp:Label ID="lblCodiceRuolo" runat="server" Font-Bold="true" Text = '<%#((DocsPAWA.DocsPaWR.DocumentoDiritto) Container.DataItem).soggetto.codiceRubrica%>'></asp:Label>
                                        <br />
                                        <asp:Label ID="lblRuolo" runat="server" Text = '<%#((DocsPAWA.DocsPaWR.DocumentoDiritto) Container.DataItem).soggetto.descrizione%>'></asp:Label>
									</ItemTemplate>									
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
								...
								<asp:TemplateColumn HeaderText="">
									...
									<ItemTemplate>
										<asp:CheckBox ID="cb_Abilita" runat="server" Checked='<%#this.IsUnLocked((DocsPAWA.DocsPaWR.DocumentoDiritto) Container.DataItem)%>'  AutoPostBack="False" />
									</ItemTemplate>
								</asp:TemplateColumn>							
							</Columns>
