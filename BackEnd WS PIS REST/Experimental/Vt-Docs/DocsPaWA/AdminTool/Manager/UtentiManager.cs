...
namespace Amministrazione.Manager
{
	...
	public class UtentiManager
	{
		...
		public void InsRegistriUtente(DocsPAWA.DocsPaWR.OrgRegistro[] listaRegistri, string idCorrGlob)
		{
      ...
      public List<DocsPAWA.DocsPaWR.Qualifica> GetQualifiche(int id_amm)
      {
      ...
      {
          AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
          DocsPAWA.DocsPaWR.ValidationResultInfo retValue = ws.UpdateQual(idQualifica, descrizione);
          return retValue;
      }
      ...
      {
          AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
          DocsPAWA.DocsPaWR.ValidationResultInfo retValue = ws.DeleteQual(idQualifica, idAmministrazione);
          return retValue;
      }

      public List<DocsPAWA.DocsPaWR.PeopleGroupsQualifiche> GetPeopleGroupsQualifiche(String idAmm, String idUo, String idGruppo, String idPeople)
      {
      ...
      {
          AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
          DocsPAWA.DocsPaWR.ValidationResultInfo retValue = ws.InsertPeopleGroupsQual(pgq);
          return retValue;
      }
      ...
      {
          AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
          DocsPAWA.DocsPaWR.ValidationResultInfo retValue = ws.DeletePeopleGroups(idPeopleGroups);
          return retValue;
      }
        ...
        public void InsMenuUtente(DocsPAWA.DocsPaWR.Menu[] listaMenu, string idCorrGlob,string idAmm)
        {
		...
		private void AmmVerificaEliminazioneUtente(DocsPAWA.DocsPaWR.OrgUtente utente)
		{
			AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
		...
		private void AmmInsRegistriUtente(DocsPAWA.DocsPaWR.OrgRegistro[] listaRegistri, string idCorrGlob)
		{
			AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
      ...
      private List<DocsPAWA.DocsPaWR.Qualifica> AmmGetQualifiche(int id_amm)
      {
          AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
          List<DocsPAWA.DocsPaWR.Qualifica> qualifiche = new List<DocsPAWA.DocsPaWR.Qualifica>(ws.GetQualifiche(id_amm));
          return qualifiche;
      }

      private List<DocsPAWA.DocsPaWR.PeopleGroupsQualifiche> AmmGetPeopleGroupsQualifiche(String idAmm, String idUo, String idGruppo, String idPeople)
      {
          AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
          List<DocsPAWA.DocsPaWR.PeopleGroupsQualifiche> pgqs = new List<DocsPAWA.DocsPaWR.PeopleGroupsQualifiche>(ws.GetPeopleGroupsQualifiche(idAmm, idUo, idGruppo, idPeople));
          return pgqs;
      }      
      ...
      //SABRINA  -- voci di menù
        ...
        private void AmmInsMenuUtente(DocsPAWA.DocsPaWR.Menu[] listaMenu, string idCorrGlob, string idAmm)
        {
            AmmUtils.WebServiceLink ws = new AmmUtils.WebServiceLink();
