...
namespace DocsPAWA.AdminTool.Gestione_Organigramma
{
    public partial class GestApps_Utente : System.Web.UI.Page
    {
        ...
        {
            DocsPaWR.ExtApplication[] applicatons = DocsPAWA.ApplicationManager.getListaApplicazioni(this);
        ...
        {
            DocsPaWR.Utente utente = DocsPAWA.UserManager.GetUtenteByIdPeople(idUtente);
        ...
        //cancellazione peopleGroups
        private DocsPAWA.DocsPaWR.ValidationResultInfo DeleteApplicazioneUtente(String idApplicazione)
        {
            DocsPAWA.DocsPaWR.ValidationResultInfo retValue = DocsPAWA.ApplicationManager.ExtAppDeleteUte(idApplicazione, idUtente);
            return retValue;
        }

        private DocsPAWA.DocsPaWR.ValidationResultInfo AddApplicazioneUtente(String idApplicazione)
        {
            DocsPAWA.DocsPaWR.ValidationResultInfo retValue = DocsPAWA.ApplicationManager.ExtAppAddUte(idApplicazione, idUtente); ;
            return retValue;
        }
        ...
        private void RefreshPGFromUI(ref DocsPAWA.DocsPaWR.PeopleGroupsQualifiche pgq, String idAmm, String idUo, String idGruppo, String idUtente, String idApp)
        {
