<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaveChangesToRole.aspx.cs" Inherits="DocsPAWA.AdminTool.Gestione_Organigramma.SaveChangesToRole" %>
	        ...
	        <asp:DataGrid ID="dgReport" runat="server" AutoGenerateColumns="False"
	            ...
	            <Columns>
	                ...
	                <asp:TemplateColumn ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
	                    <ItemTemplate>
	                        <asp:Image runat="server" ID="imgIcon" ImageUrl="<%# ((DocsPAWA.DocsPaWR.SaveChangesToRoleReport)Container.DataItem).ImageUrl %>" />
	                    </ItemTemplate>
	                </asp:TemplateColumn>
	            </Columns>
	        </asp:DataGrid>
