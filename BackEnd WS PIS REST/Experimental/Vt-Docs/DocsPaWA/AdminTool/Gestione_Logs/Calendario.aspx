<%@ Page language="c#" Codebehind="Calendario.aspx.cs" AutoEventWireup="false" Inherits="Amministrazione.Gestione_Logs.Calendario" %>
	...
	<HEAD>
		...
		function set_datetime(n_datetime, b_close) {
			...
			if (b_close) {
				...
				if((window.opener).document.title == "AnteprimaProfDinamica"){
