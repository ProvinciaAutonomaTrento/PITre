...
<%@ Page language="c#" Codebehind="GestLogs.aspx.cs" AutoEventWireup="false" Inherits="Amministrazione.Gestione_Logs.GestLogs" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="GridLayout"
		...
		<form id="Form1" method="post" runat="server">
		    <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "AMMINISTRAZIONE > Gestione Log" />
			...
			<table height="100%" cellSpacing="1" cellPadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td class="titolo" align="center" bgColor="#e0e0e0" height="20">Gestione Log</td>
				</tr>
				<tr>
