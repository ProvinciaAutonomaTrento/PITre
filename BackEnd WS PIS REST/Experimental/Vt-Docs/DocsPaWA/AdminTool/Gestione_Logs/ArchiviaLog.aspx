...
<%@ Page language="c#" Codebehind="ArchiviaLog.aspx.cs" AutoEventWireup="false" Inherits="Amministrazione.Gestione_Logs.ArchiviaLog" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="GridLayout" onunload="ClosePopUp()">
		<form id="Form1" method="post" runat="server">
            <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "AMMINISTRAZIONE > Archivia log" />
