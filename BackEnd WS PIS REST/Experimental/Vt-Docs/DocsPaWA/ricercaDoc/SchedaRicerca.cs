...
namespace DocsPAWA.ricercaDoc
{
    ...
    public class SchedaRicerca
    {
        ...
        public DocsPAWA.DocsPaWR.Ruolo Ruolo
        {
            get { return ruolo; }
            set { ruolo = value; }
        }

        public DocsPAWA.DocsPaWR.FiltroRicerca[][] FiltriRicerca
        {
            get { return filters; }
            set { filters = value; }
        }
        ...
        public DocsPAWA.DocsPaWR.FiltroRicerca GetFiltro(string nomeFiltro)
        {
            ...
            if (idx != -1)
                filtro = (DocsPAWA.DocsPaWR.FiltroRicerca)al[idx];
        ...
        public ListItem[] ElencoRicercheADL(string tipo, bool allPages, System.Web.UI.WebControls.DropDownList ddl, string selVal)
        {
            ...
            try
            {
                ...
                if (itemList != null)
                {
                    ...
                    foreach (DocsPAWA.DocsPaWR.SearchItem item in itemList.lista)
                    {
        ...
        public static string FiltersToString(DocsPAWA.DocsPaWR.FiltroRicerca[][] filtriRicerca)
        {
            try
            {
