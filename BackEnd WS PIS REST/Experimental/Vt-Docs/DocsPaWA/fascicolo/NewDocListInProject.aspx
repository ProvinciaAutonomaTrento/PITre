<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewDocListInProject.aspx.cs"
    Inherits="DocsPAWA.fascicolo.NewDocListInProject" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .menu_pager_grigio a:link
        {
            text-decoration: none;
            color:#ffffff;
        }
        .menu_pager_grigio a:visited
        {
            text-decoration: none;
            color:#ffffff;
        }
        .menu_pager_grigio a:hover
        {
            text-decoration: none;
            color:#ffffff;
        }
...
<body>
    <form id="frmNewTabSearchResult" method="post" runat="server">
        ...
        <asp:UpdatePanel ID="upButtons" runat="server">
            <contenttemplate>
                <uc1:MassiveOperationButtons ID="mobButtons" runat="server" DataGridId="dgResult"
                    MessageBoxID="mbAlert" ObjType="D" GridType="Document" IsDocumentsInProject="true" />
            </contenttemplate>
        </asp:UpdatePanel>
    </div>
    <div id="divResult">
        <asp:UpdatePanel ID="upResult" runat="server">
            <contenttemplate>
                    ...
                    <ItemStyle BackColor="#eaeaea" CssClass="text_search"
