...
contenType='normal';
	...
	function setHeightZoom(h) {
		...
		if(zoomScroll){	$('#zoomScroll').getNiceScroll().resize();	}
	}
...
var mobileclient = {
    ...
    zoomDocument: function (IdDoc) {
       ...
       if(DEVICE=='ipad'){document.removeEventListener("touchmove", preventBehavior, false);}
        ...
        imageZoomed = $('<div id="image_zoomed"><div class="green_bar"><div class="pulsante_classic fll  paddingLeft"><a href="javascript:;" onclick="mobileclient.closezoom()">Indietro</a></div></div><div id="zoomWrapper"><div id="zoomScroller" style="width:'+width+'px;height:'+height+'px"><img src="' + this.context.WAPath + '/Documento/Preview/' + IdDoc + '" width="' + width + '" /></div></div></div>');
