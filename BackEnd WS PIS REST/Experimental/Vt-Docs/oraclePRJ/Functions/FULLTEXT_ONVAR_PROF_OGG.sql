--------------------------------------------------------
--  DDL for Function FULLTEXT_ONVAR_PROF_OGG
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "ITCOLL_6GIU12"."FULLTEXT_ONVAR_PROF_OGG" (
   stringa               VARCHAR,
   --myregistro            INTEGER,
...
IF (  start_creation_date = '01/01/2009' and start_date  =  '01/01/2009' ) THEN
