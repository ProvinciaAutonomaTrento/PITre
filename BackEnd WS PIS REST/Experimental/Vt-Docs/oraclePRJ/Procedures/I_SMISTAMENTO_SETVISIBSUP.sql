--------------------------------------------------------
--  DDL for Procedure I_SMISTAMENTO_SETVISIBSUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ITCOLL_6GIU12"."I_SMISTAMENTO_SETVISIBSUP" (
