...
BEGIN
  CODICE := 'FE_URL_XSL_RAPPORTO_VERS';
  DESCRIZIONE := 'URL del foglio di stile XSL per il rapporto di versamento';
  VALORE := 'http://collaudo.pitre.tn.it/parer/xml/rapporto_versamento.xsl';
  TIPO_CHIAVE := 'F';
  VISIBILE := '1';
  MODIFICABILE := '1';
  GLOBALE := '1';
