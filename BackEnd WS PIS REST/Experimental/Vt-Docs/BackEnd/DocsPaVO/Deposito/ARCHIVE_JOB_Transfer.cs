...
{
    public partial class ARCHIVE_JOB_Transfer
    {
        ...
        public ARCHIVE_JOB_Transfer(Int32 system_ID, Int32 transfer_ID, Int32 jobType_ID, DateTime insertJobTimestamp, DateTime? startJobTimestamp, DateTime? endJobTimestamp, Int32 executed)
        {
            System_ID = system_ID;
