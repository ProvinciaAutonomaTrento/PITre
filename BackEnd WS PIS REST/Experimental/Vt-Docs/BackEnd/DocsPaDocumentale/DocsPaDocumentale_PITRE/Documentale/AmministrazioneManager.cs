...
namespace DocsPaDocumentale_PITRE.Documentale
{
    ...
    public class AmministrazioneManager : IAmministrazioneManager
    {
        ...
        /// 
        /// </summary>
        private IAmministrazioneManager _instanceDCTM = null;
        ...
        /// <summary>
        /// Reperimento istanza gestore amministratore in documentum
        /// </summary>
        protected IAmministrazioneManager InstanceDCTM
        {
            get
            {
                if (this._instanceDCTM == null)
                    this._instanceDCTM = new DocsPaDocumentale_DOCUMENTUM.Documentale.AmministrazioneManager(this.InfoUtente);
