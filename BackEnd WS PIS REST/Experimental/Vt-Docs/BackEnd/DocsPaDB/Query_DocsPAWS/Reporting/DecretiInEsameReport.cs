...
namespace DocsPaDB.Query_DocsPAWS.Reporting
{
    ...
    public class DecretiInEsameReport
    {
        /// <summary>
        /// Metodo per l'estrazione dei dati relativi ai descreti in esame
        /// </summary>
        ...
        [ReportDataExtractorMethod(ContextName = "DecretiInEsame")]
        public DataSet GetDescretiInEsameData(InfoUtente userInfo, List<FiltroRicerca> searchFilters)
        {
            ...
            using (DBProvider dbProvider = new DBProvider())
            {
                ...
                Query query = InitQuery.getInstance().getQuery("CDC_REPORT_DECRETI_IN_ESAME");
