...
namespace anmar.SharpMimeTools
{
            ...
            switch (part.Header.TopLevelMediaType)
            {
                ...
                case anmar.SharpMimeTools.MimeTopLevelMediaType.video:
                    ...
                    if (attachment != null)
                    {
                        ...
                        attachment.ContentTransferEncoding = part.Header.ContentTransferEncoding;
    ...
    public class SharpAttachment
    {
        ...
        private System.String _content_transfer_encoding;
        ...
        /// <summary>
        /// Gets or sets ContentTransferEncoding media type for this <see cref="SharpAttachment" /> instance
        /// </summary>
        public System.String ContentTransferEncoding
        {
            get { return this._content_transfer_encoding; }
            set { this._content_transfer_encoding = value; }
        }
