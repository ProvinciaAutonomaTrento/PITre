...
namespace dpaItextSharp.text.pdf.codec.wmf {
    public class MetaFont : MetaObject {
        ...
        public BaseFont Font {
            get {
                if (font != null)
                    return font;
                dpaItextSharp.text.Font ff2 = FontFactory.GetFont(faceName, BaseFont.CP1252, true, 10, ((italic != 0) ? dpaItextSharp.text.Font.ITALIC : 0) | ((bold != 0) ? dpaItextSharp.text.Font.BOLD : 0));
                font = ff2.BaseFont;
                if (font != null)
                    return font;
                string fontName;
