...
namespace dpaItextSharp.text 
{
    ...
    /// <seealso cref="T:dpaItextSharp.text.Chunk"/>
    /// <seealso cref="T:dpaItextSharp.text.Gif"/>
    /// <seealso cref="T:dpaItextSharp.text.Graphic"/>
    /// <seealso cref="T:dpaItextSharp.text.Header"/>
    /// <seealso cref="T:dpaItextSharp.text.Image"/>
    /// <seealso cref="T:dpaItextSharp.text.Jpeg"/>
    /// <seealso cref="T:dpaItextSharp.text.List"/>
    /// <seealso cref="T:dpaItextSharp.text.ListItem"/>
    /// <seealso cref="T:dpaItextSharp.text.Meta"/>
    /// <seealso cref="T:dpaItextSharp.text.Paragraph"/>
    /// <seealso cref="T:dpaItextSharp.text.Phrase"/>
    /// <seealso cref="T:dpaItextSharp.text.Rectangle"/>
    /// <seealso cref="T:dpaItextSharp.text.Row"/>
    /// <seealso cref="T:dpaItextSharp.text.Section"/>
    /// <seealso cref="T:dpaItextSharp.text.Table"/>
