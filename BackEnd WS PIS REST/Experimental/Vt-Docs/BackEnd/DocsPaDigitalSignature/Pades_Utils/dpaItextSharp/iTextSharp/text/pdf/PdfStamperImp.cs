    ...
    public class PdfStamperImp : PdfWriter {
        ...
        */
        ...
        internal void Close(Hashtable moreInfo) {
            ...
            //Faillax , imposto la data odierna ma non l'ora per avere l'has file sempre uguale
            PdfDate date = new PdfDate(DateTime.Now.Date);
            if (altMetadata != null) {
                PdfStream xmp;
                try {
            ...
            {
                //Faillax modificato per non avere date nel file
                //fileID = PdfEncryption.CreateInfoId(PdfEncryption.CreateDocumentId());
                fileID = CreateDummyInfoId();
            }
        ...
        public static PdfObject CreateDummyInfoId()
        {
            byte[] id = new byte[16];
