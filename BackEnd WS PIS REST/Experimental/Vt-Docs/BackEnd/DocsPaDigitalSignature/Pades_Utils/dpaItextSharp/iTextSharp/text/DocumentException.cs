...
namespace dpaItextSharp.text {
    ...
    /// </summary>
    /// <seealso cref="T:dpaItextSharp.text.BadElementException"/>
    /// <seealso cref="T:dpaItextSharp.text.Document"/>
    /// <seealso cref="T:dpaItextSharp.text.DocWriter"/>
    /// <seealso cref="T:dpaItextSharp.text.IDocListener"/>
