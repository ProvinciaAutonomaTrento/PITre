...
using dpaItextSharp.text.rtf.direct;
using dpaItextSharp.text.rtf.parser;
using dpaItextSharp.text.rtf.parser.ctrlwords;
/*
...
namespace dpaItextSharp.text.rtf.parser.destinations {
    ...
    */
    public sealed class RtfDestinationFontTable : RtfDestination {
        ...
        * 
        * @return itextProperties object with environment variable information
        * @throws Throwable
        * 
        * @since 2.0.8
        */
//        private itextProperties GetEnvironmentVariables() {
//            itextProperties environmentVariables = new itextProperties();
