...
namespace dpaItextSharp.text.xml {
	...
	public class XmlPeer {
		...
		protected itextProperties attributeAliases = new itextProperties();
    
		/// <summary> This is the Map that contains the default values of the attributes. </summary>
		protected itextProperties attributeValues = new itextProperties();
		...
		public itextProperties DefaultValues {
			get {
