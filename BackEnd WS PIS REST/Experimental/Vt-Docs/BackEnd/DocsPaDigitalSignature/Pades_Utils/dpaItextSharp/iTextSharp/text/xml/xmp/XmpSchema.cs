...
namespace dpaItextSharp.text.xml.xmp {

    /**
    * Abstract superclass of the XmpSchemas supported by iText.
    */
    public abstract class XmpSchema : itextProperties {
        /** the namesspace */
        ...
        */
        ...
        /**
        * @see java.util.itextProperties#setProperty(java.lang.String, java.lang.String)
        * 
        * @param key
        * @param value
        * @return the previous property (null if there wasn't one)
