...
return queryWhere;
       ...
       DocsPaVO.filtri.FiltroRicerca[][] objQueryList, bool security, String[] documentsSystemId)
        ...
        public static ArrayList getDocModifiedByDates(string dateFrom, string dateTo, bool soloModificati, bool allActions, bool security, DocsPaVO.utente.InfoUtente infoUt)
        {
            DocsPaDB.Query_DocsPAWS.Documenti dbDocs = new DocsPaDB.Query_DocsPAWS.Documenti();
            return dbDocs.getDocModifiedByDates(dateFrom, dateTo, soloModificati, allActions, security, infoUt);
        }
    }
}
