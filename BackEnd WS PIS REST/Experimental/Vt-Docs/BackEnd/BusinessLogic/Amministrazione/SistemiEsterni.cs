...
namespace BusinessLogic.Amministrazione
{
    public class SistemiEsterni
    {
        ...
        public static bool importPregressiRestWS(string idDocument, string numProto, string numAnnoProto,
            string dtaProto, string idRegistro, string codRegistro, string segnatura)
        {
            DocsPaDB.Query_DocsPAWS.Documenti docDB = new DocsPaDB.Query_DocsPAWS.Documenti();
            return docDB.importPregressiRestUpdProfile(idDocument, numProto, numAnnoProto, dtaProto, idRegistro, codRegistro, segnatura);
        }

        public static string getFormatoSegnatura(string idAmm)
        {
            return DocsPaDB.Utils.Personalization.getInstance(idAmm).FormatoSegnatura;
        }

        public static string getSeparatore(string idAmm)
        {
            return DocsPaDB.Utils.Personalization.getInstance(idAmm).getSeparator();
        }

        public static ArrayList getLinkedDocRest(string idDoc)
        {
            DocsPaDB.Query_DocsPAWS.Documenti docDB = new DocsPaDB.Query_DocsPAWS.Documenti();
            return docDB.getLinkedDocsRest(idDoc);
        }

        public static bool updLinkedDocRest(string idParent, string idLinked)
        {
             DocsPaDB.Query_DocsPAWS.Documenti docDB = new DocsPaDB.Query_DocsPAWS.Documenti();
            return docDB.UpdLinkedDocREST(idParent,idLinked);
        }
        ...
        public static string FattElCtrlDupl(string idTibco)
        {
            DocsPaDB.Query_DocsPAWS.Amministrazione dbAmm = new DocsPaDB.Query_DocsPAWS.Amministrazione();
            return dbAmm.FattElCtrlDupl(idTibco);
        }

        public static bool FattElInsTabellaIntegrazione(string idDoc, string idTibco, string oggFattura)
        {
            DocsPaDB.Query_DocsPAWS.Amministrazione dbAmm = new DocsPaDB.Query_DocsPAWS.Amministrazione();
            return dbAmm.FattElInsTabellaIntegrazione(idDoc, idTibco, oggFattura);
        }
        ...
        public static bool IsVerticalePubbAlbo(string codeAppVerticale)
        {
            DocsPaDB.Query_DocsPAWS.Amministrazione dbAmm = new DocsPaDB.Query_DocsPAWS.Amministrazione();
            return dbAmm.IsVerticalePubbAlbo(codeAppVerticale);
        }

        public static List<string> Albo_GetFileDaPubblicare(string idDocPrincipale, string option)
        {
            DocsPaDB.Query_DocsPAWS.Amministrazione dbAmm = new DocsPaDB.Query_DocsPAWS.Amministrazione();
            return dbAmm.Albo_GetFileDaPubblicare(idDocPrincipale, option);
        }
