...
namespace BusinessLogic.Reporting
{
    ...
    /// </summary>
    [ReportGeneratorAttribute(Name = "Elenco Decreti Restituiti Con Rilievo", ContextName = "ProspettiRiepilogativi", Key = "ElencoDecretiRestituitiConRilievoSCCLA")]
    public class ElencoDecretiRestituitiConRilievoSCCLAReportGeneratorCommand : ReportGeneratorCommand
    {
        /// <summary>
