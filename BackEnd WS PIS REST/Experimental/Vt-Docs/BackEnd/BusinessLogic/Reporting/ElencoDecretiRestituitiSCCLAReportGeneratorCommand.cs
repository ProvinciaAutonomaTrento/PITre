...
namespace BusinessLogic.Reporting
{
    ...
    /// </summary>
    [ReportGeneratorAttribute(Name = "Elenco Decreti Restituiti", ContextName = "ProspettiRiepilogativi", Key = "ElencoDecretiRestituitiSCCLA")]
    public class ElencoDecretiRestituitiSCCLAReportGeneratorCommand : ReportGeneratorCommand
    {
        /// <summary>
