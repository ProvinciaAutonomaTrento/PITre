...
{
    [ReportGenerator(Name="Notifiche Rifiuto", ContextName="NotificheRifiuto", Key="NotificheRifiuto")]
    public class NotificheRifiutoReportGeneratorCommand : ReportGeneratorCommand
    {
        private ILog logger = LogManager.GetLogger(typeof(NotificheRifiutoReportGeneratorCommand));
