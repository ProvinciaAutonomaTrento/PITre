...
namespace BusinessLogic.Reporting
{
    ...
    /// </summary>
    [ReportGeneratorAttribute(Name = "Elenco Decreti", ContextName = "ProspettiRiepilogativi", Key = "ElencoDecretiSCCLA")]
    public class ElencoDecretiSCCLAReportGeneratorCommand : ReportGeneratorCommand
    {
        /// <summary>
