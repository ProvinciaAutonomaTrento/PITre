...
namespace BusinessLogic.Reporting
{
    ...
    /// </summary>
    [ReportGeneratorAttribute(Name = "Report Decreti pervenuti in intervallo temporale", ContextName = "ProspettiRiepilogativi", Key = "DecretiInEsamePervenutiInIntTemporale")]
    class DecretiPervenutiInIntTemporaleReportGeneratorCommand : ReportGeneratorCommand
    {
        /// <summary>
