...
namespace BusinessLogic.Reporting
{
    ...
    /// </summary>
    [ReportGeneratorAttribute(Name = "Elenco Decreti", ContextName = "ProspettiRiepilogativi", Key = "ElencoDecretiSCCLASucc")]
    public class ElencoDecretiSuccSCCLAReportGeneratorCommand : ReportGeneratorCommand
    {
        /// <summary>
