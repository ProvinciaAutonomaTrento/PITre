...
namespace BusinessLogic.Reporting
{
    ...
    /// </summary>
    [ReportGeneratorAttribute(Name = "Scadenzario - Decreti in esame", ContextName = "ProspettiRiepilogativi", Key = "DecretiInEsameSRC")]
    public class DecretiInEsameSRCReportGeneratorCommand : ReportGeneratorCommand
    {
        /// <summary>
        ...
        protected override HeaderColumnCollection GenerateReportHeader(System.Data.DataSet dataSet, HeaderColumnCollection fieldsToExport)
        {
            ...
            header["Revisore"].DataType = HeaderProperty.ContentDataType.String;
