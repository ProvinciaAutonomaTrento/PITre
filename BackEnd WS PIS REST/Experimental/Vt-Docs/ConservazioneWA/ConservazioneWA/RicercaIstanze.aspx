<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RicercaIstanze.aspx.cs"
    Inherits="ConservazioneWA.RicercaIstanze" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function showModalDialogFirma() {
            ...
            {
                //alert("Apro Applet!");
                var returnValue = window.showModalDialog("DialogFirma.aspx?idIstanza=" + form1.hd_idIstanza.value + "&applet=1", "", "dialogWidth:600px;dialogHeight:600px;status:no;resizable:no;scroll:no;center:yes;help:no");
                form1.hd_firma.value = returnValue;
            }
        }
        function controllo() {
...
<body>
    ...
    <div id="container">
        ...
        <uc6:menu id="menuTop" runat="server" paginachiamante="ISTANZE" />
        <div id="title">
            <h1>
                Ricerca Istanze</h1>
        </div>
                                ...
                                <table class="tabDate">
                                    <tr>
                                        ...
                                        <td class="tabDateDx">
                                            ...
                                            <uc1:Calendario ID="txt_dataAp_da" runat="server" Visible="true" PAGINA_CHIAMANTE="RICERCAISTANZE" />
                                            <asp:Label ID="Label3" runat="server" Text="a" CssClass="testo_grigio_spazio"></asp:Label>
                                            <uc1:Calendario ID="txt_dataAp_a" runat="server" PAGINA_CHIAMANTE="RICERCAISTANZE" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tabDateSx">
                                        ...
                                        <td class="tabDateDx">
                                            ...
                                            <uc1:Calendario ID="dataInvio_da" runat="server" PAGINA_CHIAMANTE="RICERCAISTANZE" />
                                            <asp:Label ID="Label5" runat="server" Text="a" CssClass="testo_grigio_spazio"></asp:Label>
                                            <uc1:Calendario ID="dataInvio_a" runat="server" PAGINA_CHIAMANTE="RICERCAISTANZE" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tabDateSx">
                              ...
                              OnPreRender="gv_istanzeCons_PreRender" 
                               ...
                               <%--    <asp:BoundColumn DataField="data_apertura" HeaderText="Aperta il" />
                                 ...
                                 --%>
                                    ...
                                    <asp:TemplateColumn HeaderText="Verifiche">
                                        <ItemTemplate>
                            ...
                            <asp:Panel ID="Panel_dettaglio" runat="server" Visible="false">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td class="testo_grigio_scuro" style="width: 10%;" align="right">
                                            <asp:CheckBox ID="chkMostraTutti" runat="server" Checked="true" Visible="false" Text="Mostra tutti"
                                             AutoPostBack="true" OnCheckedChanged="chkMostraTutti_OnCheckedChanged" ToolTip="Mostra tutti i documenti contenuti nell'istanza" />
                                        </td>
                                    </tr>
                                </table>
                                <table style="width: 100%;">
...
<%--                                                      <asp:BoundColumn DataField="data_ins" HeaderText="DATA INSERIMENTO" HeaderStyle-Width="10%" />--%>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="Verifiche" HeaderStyle-Width="13%">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:BoundColumn DataField="idProject" HeaderText="ID PROJECT" Visible="false"></asp:BoundColumn>
                                                </Columns>
                                            </asp:DataGrid>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            ...
                                            <div id="box_button">
                                                <asp:Button ID="btn_rifiuta" runat="server" Text="Rifiuta" OnClientClick="controllo();"
                                                    OnClick="BtnRifiuta_Click" ToolTip="Rifiuta l'istanza" />
                                                <asp:Button ID="btn_lavorazione" runat="server" Text="Passa in Lavorazione"
                                                    OnClick="btn_lavorazione_OnClick" ToolTip="Metti l'istanza in lavorazione" />
                                                <asp:Button ID="btn_firma" runat="server" Text="Firma" OnClick="btn_firma_Click"
                                                    OnClientClick="showModalDialogFirma();" ToolTip="Firma l'istanza" />
                                                <asp:Button ID="btn_hsm" runat="server" Text ="Firma HSM" OnClick="btn_firmaHSM_Click"
                                                    OnClientClick="" Tooltip="Firma l'istanza con HSM"/>
                                                 <asp:Button ID="btn_verificaLeggibilita" runat="server" Text="Verifica Leggibilità"
                                                    ...
                                                    onclick="btn_verificaLeggibilita_Click" OnClientClick="showTestLeggibilita2()" Visible="True" />
                                                <asp:Button ID="btn_standBy" runat="server" Text="Rigenera marca"
                                                    OnClick="btn_standBy_Click" ToolTip="Rigenera la marca dell'istanza" />
                                            </div>
