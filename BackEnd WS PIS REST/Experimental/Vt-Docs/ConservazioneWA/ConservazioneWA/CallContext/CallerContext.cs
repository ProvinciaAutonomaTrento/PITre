...
public class CallContext : IDisposable
{
    ...
    public override bool Equals(object obj)
    {
        ...
        {
            return (this.Url.Equals(((CallContext)obj).Url));
        }
        else
            return false;
    }
    ...
    /// 
    /// </summary>
    public CallContext(string title)
    {
        this.Title = title;
    ...
    public CallContext(string title, string url)
    {
        this.Title = title;
        this.Url = url;
    }
    ...
    /// <summary>
    /// Indica l'indice dell'elemento selezionato nel contesto di chiamata
    /// </summary>
