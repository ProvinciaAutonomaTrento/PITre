<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePageEsibizione.aspx.cs"
    Inherits="ConservazioneWA.Esibizione.HomePageEsibizione" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        * html .horizontalcssmenu ul li a
        ...
        .tab_riepiologo tr.RowOverFirstEsib
        {
...
<body>
    ...
    <div id="container">
        <div id="header">
            ...
            <%--<h2>
                <asp:Label ID="lbl_amm" runat="server" Font-Size="Small"></asp:Label>
                <asp:Label ID="lbl_selectedRole" runat="server" Font-Size="Small"></asp:Label>
            </h2>--%>
            <h3>
        ...
        <uc6:Menu ID="menuTop" runat="server" PaginaChiamante="HOME_ESIBIZIONE" />
        <div id="title">
            <h1>
                Riepilogo</h1>
        </div>
        <div id="comboRuoli" style="text-align: center">
            <asp:UpdatePanel ID="uPnl_comboRuoli" runat="server">
                <ContentTemplate>
                    <asp:Label ID="lbl_ruoli" runat="server" Text="Ruoli: " Font-Size="Smaller" ToolTip="Selezionare il ruolo desiderato"></asp:Label>
                    <asp:Label ID="lbl_ruoli_info" runat="server" Font-Size="Smaller" Visible="false"></asp:Label>
                    <asp:DropDownList ID="ddl_ruoli" runat="server" Visible="false" OnSelectedIndexChanged="ddl_ruoli_onSelectedIndexChanged"
                        AutoPostBack="true">
                    </asp:DropDownList>
                </ContentTemplate>
            </asp:UpdatePanel>
                ...
                <ContentTemplate>
                    <div id="box_riepilogo">
                        <!--<table class="tab_riepiologo" align="center">
                            <caption>
                                Riepilogo istanze</caption>
                            <tr class="RowOverFirst" onmouseover="this.className='RowOverSelected';" onmouseout="this.className='RowOverFirst';"
                                onclick="location.href='RicercaIstanze.aspx?q=I';" title="Nuove Istanze">
                                <td class="tab_riepiologo_sx">
                                    Nuove
                                </td>
                                <td class="tab_riepiologo_dx">
                                    <asp:Label runat="server" ID="lbl_nuove"></asp:Label>
                                </td>
                            </tr>
                            <tr class="RowOverFirst" onmouseover="this.className='RowOverSelected';" onmouseout="this.className='RowOverFirst';"
                                onclick="location.href='RicercaIstanze.aspx?q=L';" title="Istanze in Lavorazione">
                                <td class="tab_riepiologo_sx">
                                    In lavorazione
                                </td>
                                <td class="tab_riepiologo_dx">
                                    <asp:Label runat="server" ID="lbl_lavorazione"></asp:Label>
                                </td>
                            </tr>
                            <tr class="RowOverFirst" onmouseover="this.className='RowOverSelected';" onmouseout="this.className='RowOverFirst';"
                                onclick="location.href='RicercaIstanze.aspx?q=F';" title="Istanze Firmate">
                                <td class="tab_riepiologo_sx">
                                    Firmate
                                </td>
                                <td class="tab_riepiologo_dx">
                                    <asp:Label runat="server" ID="lbl_firmate"></asp:Label>
                                </td>
                            </tr>
                            <tr class="RowOverFirst" onmouseover="this.className='RowOverSelected';" onmouseout="this.className='RowOverFirst';"
                                onclick="location.href='RicercaIstanze.aspx?q=V';" title="Istanze Conservate">
                                <td class="tab_riepiologo_sx">
                                    Conservate
                                </td>
                                <td class="tab_riepiologo_dx">
                                    <asp:Label runat="server" ID="lbl_conservate"></asp:Label>
                                </td>
                            </tr>
                            <tr class="RowOverFirst" onmouseover="this.className='RowOverSelected';" onmouseout="this.className='RowOverFirst';"
                                onclick="location.href='RicercaIstanze.aspx?q=C';" title="Istanze Chiuse">
                                <td class="tab_riepiologo_sx">
                                    Chiuse
                                </td>
                                <td class="tab_riepiologo_dx">
                                    <asp:Label runat="server" ID="lbl_chiuse"></asp:Label>
                                </td>
                            </tr>
                            <tr class="RowOverFirst" onmouseover="this.className='RowOverSelected';" onmouseout="this.className='RowOverFirst';"
                                onclick="location.href='RicercaNotifiche.aspx';" title="Notifiche">
                                <td class="tab_riepiologo_sx">
                                    Notifiche
                                </td>
                                <td class="tab_riepiologo_dx">
                                    <asp:Label runat="server" ID="lbl_notifiche"></asp:Label>
                                </td>
                            </tr>
                        </table>-->
                        <asp:Table ID="table_riepilogo" runat="server" Caption="Riepilogo istanze" CssClass="tab_riepiologo"
