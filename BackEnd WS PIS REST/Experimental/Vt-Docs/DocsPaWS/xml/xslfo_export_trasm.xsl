									...
									<fo:table-row>
										...
										<fo:table-cell border-style="solid" border-color="black" border-width="0.5pt" padding-before="2pt" padding-after="2pt" padding-start="2pt" padding-end="2pt">
											<fo:block font-family="Verdana" font-size="10pt">																			
												<fo:inline color="#000000" font-weight="bold">ID: </fo:inline> 														
												<fo:inline color="#000000"><xsl:value-of select="DOC_ID" /></fo:inline>
											</fo:block>
											<fo:block font-family="Verdana" font-size="10pt">																			
												<fo:inline color="#000000" font-weight="bold">Protocollo: </fo:inline> 														
												<fo:inline color="#000000"><xsl:value-of select="DOC_PROT" /></fo:inline>
											</fo:block>
											<fo:block font-family="Verdana" font-size="10pt">																			
												<fo:inline color="#000000" font-weight="bold">Data: </fo:inline> 
												<fo:inline color="#000000"><xsl:value-of select="DOC_DATA" /></fo:inline>												
											</fo:block>
											<fo:block font-family="Verdana" font-size="10pt">																			
												<fo:inline color="#000000" font-weight="bold">Oggetto: </fo:inline>
												 <fo:inline color="#000000"><xsl:value-of select="DOC_OGG" /></fo:inline>												
											</fo:block>
										</fo:table-cell>	
										<fo:table-cell border-style="solid" border-color="black" border-width="0.5pt" padding-before="2pt" padding-after="2pt" padding-start="2pt" padding-end="2pt">
											<fo:block font-family="Verdana" font-size="10pt">																			
