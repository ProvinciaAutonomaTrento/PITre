...
namespace Dpa.DataAccess.OracleClient
{
    ...
    {
        private OracleDataAccess.Client.OracleDataReader innerReader;

        public static explicit operator OracleDataAccess.Client.OracleDataReader(OracleDataReaderWrapper oracleDataReaderWrapper)
        {
        ...
        public OracleDataAccess.Client.OracleDataReader InnerReader
        {
