...
namespace Dpa.DataAccess.OracleClient
{
    ...
    public class OracleDatabase : Database
    {
        ...
        {
            return new OracleDataAccess.Client.OracleConnection(base.ConnectionString);
        }
        ...
        public override IDataReader ExecuteReader(DBCommandWrapper commandWrapper)
        {
            ...
            return new OracleDataReaderWrapper((OracleDataAccess.Client.OracleDataReader)base.ExecuteReader(commandWrapper));
        }
        ...
        {
            PrepareCWRefCursor(commandWrapper);
            return new OracleDataReaderWrapper((OracleDataAccess.Client.OracleDataReader)base.ExecuteReader(commandWrapper, transaction));
        }
        ...
        /// </devdoc>
        private void OnOracleRowUpdated(object sender, OracleDataAccess.Client.OracleRowUpdatedEventArgs args)
        {
