...
{
	public partial class UIViewControllerSignature : ExtensionTabBarControllerRoot
	{
		public UIViewControllerSignature(IntPtr handle) : base(handle)
		{
		}
		...
		public override void PrepareForSegue(UIStoryboardSegue segue, NSObject sender)
		{
			...
			{
				((UIViewControllerDocumentList)segue.DestinationViewController).stateDocument = Home.Network.SectionType.SIGN;
			}
		}
	}
}
