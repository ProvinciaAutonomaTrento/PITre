...
using static InformaticaTrentinaPCL.Droid.ChooseInstance.SelectInstanceRecyclerViewAdapter;

namespace InformaticaTrentinaPCL.Droid.ChooseInstance
{

    [Activity(Label = "ChooseInstanceActivity" ,  ScreenOrientation = ScreenOrientation.Portrait)]
    public class ChooseInstanceActivity : BaseActivity, IChooseInstanceView, IInstanceRecyclerViewItemClickListener
    {

        ChooseNativePresenter presenter;
        ...
        protected override int LayoutResource => Resource.Layout.activity_choose_instance;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            presenter = new ChooseNativePresenter(this, AndroidNativeFactory.Instance());
        ...
        {
           presenter.SetInstancePreferred(selectedInstance);
        }
