...
{
    public class AdlDocumentModel : AbstractDocumentListItem
    {
        ...
        public AdlDocumentModel(string id, int tipo, string note, string tipoProto, string segnatura, string extension, string oggetto, string data)
        {
            this.id = id;
            this.tipo = tipo;
            this.note = note;
