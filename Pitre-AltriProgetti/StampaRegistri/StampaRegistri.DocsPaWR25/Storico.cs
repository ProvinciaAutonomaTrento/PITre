...
{
	[GeneratedCode("System.Xml", "2.0.50727.42"), DesignerCategory("code"), DebuggerStepThrough, XmlInclude(typeof(DocumentoStoricoOggetto)), XmlType(Namespace = "http://localhost")]
	[Serializable]
