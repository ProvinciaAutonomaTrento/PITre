...
//		private String dateTimeFormat;
        ...
        /// <summary>        /// Legge nel file di configurazione web.config il nome del file xml contenente le query
        /// </summary>
        ...
        public static string getKey(string keyName)
        {
            ...
            try
            {
                ...
                {
                    if (System.Configuration.ConfigurationManager.AppSettings["pathDirectoryQueryXml"] != null)
                    {
                        retValue = retValue = System.Configuration.ConfigurationManager.AppSettings["pathDirectoryQueryXml"];
                    }
                    else
                    {
                        retValue = retValue = System.IO.Path.GetFullPath("../../ServiceLibroFirma");
                    }
                }
                else
                {
