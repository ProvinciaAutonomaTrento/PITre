...
namespace DocsPaDbManagement.Database.Oracle
{
	...
	public class Database : IDatabase	
	{
        ...
        private List<String> getSPParams(string sp_name)
        {
            ...
            {
                DataSet ds;
                string commandText = String.Format("select argument_name, in_out, data_type from user_arguments where object_name = '{0}' order by position", sp_name.ToUpperInvariant());
