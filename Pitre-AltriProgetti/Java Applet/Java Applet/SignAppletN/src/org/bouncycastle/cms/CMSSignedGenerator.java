...
public class CMSSignedGenerator
{
    ...
    //added
	public static AlgorithmIdentifier GetEncAlgorithmIdentifier(
			DERObjectIdentifier	encOid,
			ASN1Encodable		sigX509Parameters)
		{
			if (NO_PARAMS.contains(encOid.getId()))
			{
    ...
    public Map getBaseParameters(ASN1ObjectIdentifier contentType, AlgorithmIdentifier digAlgId, byte[] hash)
    {
    ...
    public ASN1Set getAttributeSet(
        AttributeTable attr)
    {
        if (attr != null)
        {
