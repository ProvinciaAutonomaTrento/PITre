...
{
	public partial class UITVCellPasswordDimenticata : UITableViewCell,IUITextFieldDelegate
	{
        private ClassCellPasswordDimenticata calsscel;

        public UITVCellPasswordDimenticata(IntPtr handle) : base (handle)
		{
		}

        public void Update(ClassCellPasswordDimenticata calsscel)
        {
        ...
        public bool ShouldChangeCharacters(UITextField textField, NSRange range, string replacementString)
        {
            ...
            if (calsscel.typeCell == TypeCellPassword.CONFIRM)
                ...
                calsscel.presenterPassword.UpdateOTP(textField.Text);
