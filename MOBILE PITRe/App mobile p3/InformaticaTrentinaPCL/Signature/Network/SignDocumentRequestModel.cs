...
{
    public class SignDocumentRequestModel : BaseRequestModel
    {
        public Body body { get; set; }

        public SignDocumentRequestModel(Body body, string token)
        {
            this.body = body;
            this.token = token;
        }
        public class Body
        {
            ...
            public Body(string aliasCertificato, string dominioCertificato, string idDoc, string otpFirma, string pinCertificato, string tipoFirma)
            {
