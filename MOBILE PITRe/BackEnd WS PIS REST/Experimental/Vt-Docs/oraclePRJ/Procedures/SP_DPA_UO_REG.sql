--------------------------------------------------------
--  DDL for Procedure SP_DPA_UO_REG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ITCOLL_6GIU12"."SP_DPA_UO_REG" (
   iduo          IN       NUMBER,
            ...
            BEGIN
               ...
               BEGIN
                  SELECT system_id
                    INTO rec
                    FROM dpa_uo_reg
                   WHERE id_uo = uoid AND id_registro = record_corr_registro;
               ...
               THEN
                  BEGIN
                     INSERT INTO dpa_uo_reg
                          ...
                          VALUES (seq.NEXTVAL, uoid, record_corr_registro
                                 );
                  EXCEPTION
                     WHEN OTHERS
                     THEN
