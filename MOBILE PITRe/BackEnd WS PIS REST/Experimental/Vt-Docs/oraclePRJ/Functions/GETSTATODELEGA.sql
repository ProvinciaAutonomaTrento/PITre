--------------------------------------------------------
--  DDL for Function GETSTATODELEGA
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "ITCOLL_6GIU12"."GETSTATODELEGA" (id_delega NUMBER)
   RETURN VARCHAR
IS
...
/******************************************************************************
 ...
 se     data_scadenza < sysdate, lo stato e 'SCADUTA'
 se sysdate < data_decorrenza < data_scadenza  , lo stato e 'IMPOSTATA'
 se data_decorrenza < sysdate < data_scadenza  , lo stato e 'ATTIVA'
