...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestArchivio.aspx.cs" Inherits="DocsPAWA.Archivio.GestArchivio" %>
...
<body ms_positioning="GridLayout" onmouseover="Body_OnMouseOver()" onload="Body_OnLoad()">
    <form id="gestArchivio" method="post" runat="server">
    <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName="Gestione Archivio" />
        ...
        <tr valign="top" height="50%">
            <td width="316" valign="top" style="width: 300px">
                <cf1:iframewebcontrol id="iFrame_opzioni" runat="server" marginwidth="0" marginheight="2"
                    iwidth="415" iheight="100%" frameborder="0" scrolling="no" navigateto="OpzioniArchivio.aspx"
            ...
            <td width="*">
                <cf1:iframewebcontrol id="iFrame_dettagli" runat="server" marginwidth="10" marginheight="2"
                    iwidth="100%" iheight="100%" frameborder="0" scrolling="no" navigateto="tabRisultatiRicArchivio.aspx"></cf1:iframewebcontrol>
