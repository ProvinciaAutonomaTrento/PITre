...
namespace DocsPAWA.AdminTool.Manager
{
	...
	public class ModelliTrasmManager
	{
		...
		public static DocsPAWA.DocsPaWR.RagioneTrasmissione[] getlistRagioniTrasm(string idAmm,bool all,string tipo_trasm,bool sysExt = false)
		{
			try
			{            
                ...
                {
                    DocsPaWR.Ruolo role = DocsPAWA.UserManager.getRuolo();
