												...
												<table cellSpacing="1" cellPadding="3" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        <td colspan="4" align="right">&nbsp;&nbsp;
                                                            <asp:label id="lbl_consentiFasc" runat="server" CssClass="testo_grigio_scuro">Consenti fascicolazione</asp:label>&nbsp;
                                                            <asp:dropdownlist id="ddl_consentiFasc" CssClass="testo" Runat="server" AutoPostBack ="true" >
																<asp:ListItem Value="NO">No</asp:ListItem>
																<asp:ListItem Value="SI">Sì</asp:ListItem>
															</asp:dropdownlist>
                                                        </td>
                                                    ...
                                                    <asp:Panel ID="pnl_StrutturaTemplate" runat="server" Visible="false">
                                                    <tr>
													    <td><asp:Label ID="lbStrutturaTemplate" runat="server" CssClass="testo_grigio_scuro" Width="100%">Template Struttura</asp:Label></td>													   
													    <td><asp:DropDownList ID="ddStrutturaTemplate" runat="server" CssClass="testo" Width="100%"></asp:DropDownList></td>
                                                        <td colspan="4"></td>
                                                    </tr>
                                                    </asp:Panel>
												</table>
