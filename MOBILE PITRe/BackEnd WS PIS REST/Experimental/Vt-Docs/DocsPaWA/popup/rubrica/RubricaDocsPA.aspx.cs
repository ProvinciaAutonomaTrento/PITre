...
{
    /// <exclude></exclude>
    public class RubricaDocsPA : DocsPAWA.CssPage
    {
        ...
        private DocsPAWA.DocsPaWR.ElementoRubrica[] _A_recipients;
        private DocsPAWA.DocsPaWR.ElementoRubrica[] _CC_recipients;
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            _A_recipients = new DocsPAWA.DocsPaWR.ElementoRubrica[0];
            _CC_recipients = new DocsPAWA.DocsPaWR.ElementoRubrica[0];
            ...
            if (IsPostBack)
            {
                //				corrSearch = (DocsPAWA.DocsPaWR.ElementoRubrica[]) Session["current_search_resultset"];
        ...
        private void select_item_types(ref DocsPAWA.DocsPaWR.ParametriRicercaRubrica qco)
        {
            switch ((RubricaCallType)Convert.ToInt32(calltype))
            {
                case RubricaCallType.CALLTYPE_UFFREF_PROTO:
       ...
       private void Search()
        {
            try
            {
                ...
                qco.calltype = (DocsPAWA.DocsPaWR.RubricaCallType)Convert.ToInt32(calltype);
        ...
        private void addNewCorrToA(string systemId)
        {
            try
            {
                ...
                _A_recipients = new DocsPAWA.DocsPaWR.ElementoRubrica[tmp.Count + hidden_selection.Length];
                ...
                DocsPaWR.ElementoRubrica[] searchCorr = (DocsPAWA.DocsPaWR.ElementoRubrica[])Session["current_search_resultset"];                
                if (searchCorr != null)
                {
        ...
        private void SelectFirstCorrispondente(DocsPAWA.DocsPaWR.ElementoRubrica[] items, bool selectOnlyIfOneElement, bool moveOnToList)
        {
        ...
        private void openList(string codice)
        {
            ...
            {
                DocsPaWR.Corrispondente c = (DocsPAWA.DocsPaWR.Corrispondente)corr[i];
        ...
        private void dgCorr_OpenSubItems(object sender, OpenSubItemsArgs e)
        {
            ...
            if (ddlIE.SelectedValue.Equals("IE"))
            {
                ...
                {
                    smistamentoRubrica.daFiltrareSmistamento = "1";
                    smistamentoRubrica.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_TOTALE_PROTOCOLLO;
                }
                else
                {
                    ...
                    {
                        smistamentoRubrica.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_INTERNO; //callType: CALLTYPE_ORGANIGRAMMA_INTERNO 
                    }
                    else
                    {
                        smistamentoRubrica.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_TOTALE; //callType: CALLTYPE_ORGANIGRAMMA_TOTALE
                    }
                    //				else
                    //				{
                    //					smistamentoRubrica.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_INTERNO;
                    //				}
                }
            }
            else
            {
                if (((RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_PROTO_INT_DEST)
                   ...
                   || ((RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_PROTO_USCITA_SEMPLIFICATO))
                {
                    smistamentoRubrica.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA;
                    smistamentoRubrica.daFiltrareSmistamento = "1";
                ...
                else
                {
                    ...
                    {
                        smistamentoRubrica.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_TOTALE;
                    }
                    else
                    {
                        smistamentoRubrica.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_INTERNO;
            ...
            DocsPAWA.DocsPaWR.ElementoRubrica er1 = UserManager.getElementoRubrica(this, (Server.UrlDecode(e.Codice).Replace("|@ap@|", "'")));
            string id_amm = UserManager.getInfoUtente(this).idAmministrazione;
            DocsPAWA.DocsPaWR.ElementoRubrica[] ers = UserManager.getGerarchiaElemento((er1.codice),
                er1.interno ? DocsPAWA.DocsPaWR.AddressbookTipoUtente.INTERNO : DocsPAWA.DocsPaWR.AddressbookTipoUtente.ESTERNO,
           ...
           // DocsPaWR.Ruolo ruoloPred = userHome.ruoli[0]; //Questo non trova niente
            ...
            if (Session["userRuolo"] != null)
            {
                ruoloPred = (DocsPAWA.DocsPaWR.Ruolo)Session["userRuolo"];
            }
            ...
            {
                DocsPAWA.DocsPaWR.ElementoRubrica er = ers[n];
                nd = new NodoRubrica();
                nd.ID = er.systemId;
                ...
                cur_nodes.Add(nd);
                DocsPAWA.DocsPaWR.ElementoRubrica next_child = (n < (ers.Length - 1)) ? ers[n + 1] : null;
        ...
        private void add_children(Microsoft.Web.UI.WebControls.TreeNode root, DocsPAWA.DocsPaWR.ElementoRubrica er, DocsPAWA.DocsPaWR.ElementoRubrica next_child, DocsPAWA.DocsPaWR.RubricaCallType calltype, DocsPAWA.DocsPaWR.SmistamentoRubrica smistamentoRubrica)
        {
            DocsPaWR.ParametriRicercaRubrica qco = new DocsPAWA.DocsPaWR.ParametriRicercaRubrica();
            qco.calltype = calltype;
            UserManager.setQueryRubricaCaller(ref qco);
            qco.parent = er.codice;
            qco.tipoIE = er.interno ? DocsPAWA.DocsPaWR.AddressbookTipoUtente.INTERNO : DocsPAWA.DocsPaWR.AddressbookTipoUtente.ESTERNO;
            select_item_types(ref qco);
            ...
            if (children != null && children.Length > 0)
            {
                ...
                foreach (DocsPAWA.DocsPaWR.ElementoRubrica e in children)
                {
        ...
        {
            DocsPaWR.ElementoRubrica[] corrSearch = (DocsPAWA.DocsPaWR.ElementoRubrica[])Session["current_search_resultset"];
            if (corrSearch == null)
        ...
        private void muovi_elementi(ref DocsPAWA.DocsPaWR.ElementoRubrica[] _rcptlist)
        {
            ...
            if (!dgCC.Visible && dgA.PageSize == 1)
                src = new DocsPAWA.DocsPaWR.ElementoRubrica[0];
            else
                src = _rcptlist;
            ...
            _rcptlist = new DocsPAWA.DocsPaWR.ElementoRubrica[tmp.Count + hidden_selection.Length];
        ...
        private void tvOrganigramma_Expand(object sender, TreeViewClickEventArgs e)
        {
            ...
            if (ddlIE.SelectedValue.Equals("IE"))
            {
                if ((RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_PROTO_OUT
                    ||(RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_PROTO_USCITA_SEMPLIFICATO)
                {
                    qco.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_TOTALE_PROTOCOLLO;
                }
                else
                {
                    ...
                    if (((RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_PROTO_OUT_MITT)
                        ...
                        || ((RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_DEST_FOR_SEARCH_MODELLI))
                    {
                        qco.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_INTERNO; //callType: CALLTYPE_ORGANIGRAMMA_INTERNO 
                    }
                    else
                    {
                        qco.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_TOTALE; //callType: CALLTYPE_ORGANIGRAMMA_TOTALE
                    }
                }
                //				else
                //				{
                //					qco.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_INTERNO;
                //				}
            }
            else
            {
                if (((RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_PROTO_INT_DEST)
                    ...
                    ||((RubricaCallType)Convert.ToInt32(calltype) == RubricaCallType.CALLTYPE_PROTO_USCITA_SEMPLIFICATO)))
                {
                    qco.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA;
                ...
                else
                {
                        ...
                        )
                    {
                        ...
                        qco.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_TOTALE;
                    }
                    else
                    {
                        qco.calltype = DocsPAWA.DocsPaWR.RubricaCallType.CALLTYPE_ORGANIGRAMMA_INTERNO;
            ...
            if (children != null && children.Length > 0)
            {
                ...
                foreach (DocsPAWA.DocsPaWR.ElementoRubrica er in children)
                {
        ...
        private DocsPAWA.DocsPaWR.ElementoRubrica[] get_tv_selected_elements()
        {
            ArrayList sn = new ArrayList();
            get_tv_checked_nodes(ref sn, tvOrganigramma.Nodes);
            DocsPaWR.ElementoRubrica[] ers = new DocsPAWA.DocsPaWR.ElementoRubrica[sn.Count];
            if (sn.Count > 0)
                sn.CopyTo(ers, 0);
        ...
        private void remove_recipient(ref DocsPAWA.DocsPaWR.ElementoRubrica[] rcpts, string cod)
        {
            string app = "";
            for (int n = 0; n < rcpts.Length; n++)
            {
                ...
                if (app == cod)
                {
                    DocsPaWR.ElementoRubrica[] ers = new DocsPAWA.DocsPaWR.ElementoRubrica[rcpts.Length - 1];
                    if (ers.Length > 0)
                    {
                        int idx = 0;
        ...
        private void btnOk_Click(object sender, ImageClickEventArgs e)
        {
            ...
            RubricaCallType rct = (DocsPAWA.DocsPaWR.RubricaCallType)Convert.ToInt32(calltype);
        ...
        bool selector_filter(SelectorFilterArgs e)
        {
            ...
            {
                DocsPaWR.ElementoRubrica[] ers = (DocsPAWA.DocsPaWR.ElementoRubrica[])dgCorr.DataSource;
                if (ers != null)
                {
