<%@ Page language="c#" Codebehind="Calendario.aspx.cs" AutoEventWireup="false" Inherits="DocsPAWA.popup.Calendario" %>
  ...
  <HEAD>
		...
		function set_datetime(n_datetime, b_close) {
			...
			if (b_close) {
				...
				if( (window.opener).document.title.indexOf('Anteprima') != -1 || (window.opener).document.title.indexOf('fascicolo') != -1) {	
