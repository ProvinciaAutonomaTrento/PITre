...
*/
            ...
            try
            {
                ...
                foreach (InfoDelega temp in deleghe)
                {
                    ...
                    else
                    {
                        ...
                        resp.Elements.Add(Delega.buildInstance(temp, ruolo,null));
                    }
                }
        ...
        public static AccettaDelegaResponse accettaDelega(AccettaDelegaRequest request)
        {
            ...
            try
            {
                ...
                Ruolo ruolo = BusinessLogic.Utenti.UserManager.getRuoloById(temp.id_ruolo_delegante);
                if (temp != null) resp.DelegaAccettata = Delega.buildInstance(temp, ruolo,null);
                return resp;
            }
            catch (Exception e)
            {
        ...
        */
        ...
        public static LibroFirmaResponse GetLibroFirmaElements(LibroFirmaRequest request)
        {
            try
            {
                ...
                infoUser.idGruppo = request.IdGruppo;
                // non funziona più
                List<DocsPaVO.LibroFirma.ElementoInLibroFirma> elements = BusinessLogic.LibroFirma.LibroFirmaManager.GetElementiInLibroFirmaIntoPage(infoUser, request.PageSize, request.RequestedPage, request.Testo, request.TipoRicerca, out totalRecordCount, null);
