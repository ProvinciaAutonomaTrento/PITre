<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseProject.aspx.cs" Inherits="ConservazioneWA.ChooseProject" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="head" runat="server">
    <title>Seleziona un fascicolo</title>
                    ...
                    <asp:DataGrid ID="grvFileType" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateColumn Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="SYSTEM_ID" runat="server" Text='<%# this.GetProjectID((ConservazioneWA.WSConservazioneLocale.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="8%" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                     <input name="rbl_pref" type="radio" class="testo_grigio_scuro" value='<%# this.GetProjectID((ConservazioneWA.WSConservazioneLocale.Fascicolo)Container.DataItem) %>'>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="20%" HeaderText="CODICE" ItemStyle-CssClass="tab_sx2"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="CODEPROJECT" runat="server" Text='<%# this.GetProjectCode((ConservazioneWA.WSConservazioneLocale.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="37%" HeaderText="DESCRIZIONE" ItemStyle-CssClass="tab_sx"
                                HeaderStyle-HorizontalAlign="left" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                    <asp:Label ID="PROJECTDESCRIPTION" runat="server" Text='<%# this.GetProjectDescription((ConservazioneWA.WSConservazioneLocale.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn ItemStyle-Width="35%" HeaderText="TITOLARIO" ItemStyle-CssClass="tab_sx"
                                HeaderStyle-HorizontalAlign="left" HeaderStyle-CssClass="head_tab">
                                <ItemTemplate>
                                    <asp:Label ID="TITOLARIO" runat="server" Text='<%# this.GetProjectTitolario((ConservazioneWA.WSConservazioneLocale.Fascicolo)Container.DataItem) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
