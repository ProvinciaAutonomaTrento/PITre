<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalvaStampaConservazione.aspx.cs" Inherits="ConservazioneWA.PopUp.SalvaStampaConservazione" %>
...
<head runat="server">
    <title>Salva stampa registro di conservazione</title>
    <base target="_self" />
...
<body style="background-color: #f2f2f2">
    ...
    <div>
    <table cellspacing="0" cellpadding="2" width="370" align="center" border="0" runat="server">
        <tr>
        ...
        <tr>
            <td align="left" width="240">
                ...
                <asp:Label ID="lblFileExt" runat="server" CssClass="titolo_scheda">.p7m</asp:Label>
            </td>
        </tr>
        <tr>
            <td align="left" colspan="2">
