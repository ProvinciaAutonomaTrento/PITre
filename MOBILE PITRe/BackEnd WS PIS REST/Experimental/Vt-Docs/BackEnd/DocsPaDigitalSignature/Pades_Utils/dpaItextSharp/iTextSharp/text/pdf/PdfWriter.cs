...
using iTextSharpSystem.util.collections;
using iTextSharpSystem.util;
using dpaItextSharp.text;
using dpaItextSharp.text.pdf.events;
using dpaItextSharp.text.pdf.interfaces;
using dpaItextSharp.text.pdf.intern;
using dpaItextSharp.text.pdf.collection;
using dpaItextSharp.text.xml.xmp;
...
namespace dpaItextSharp.text.pdf {
    ...
    */
    ...
    //  [F13] Optional Content Groups    
        ...
        /**
        * Gets the <B>Optional Content itextProperties Dictionary</B>. Each call fills the dictionary with the current layer
        * state. It's advisable to only call this method right before close and do any modifications
        * at that time.
        * @return the Optional Content itextProperties Dictionary
        */    
