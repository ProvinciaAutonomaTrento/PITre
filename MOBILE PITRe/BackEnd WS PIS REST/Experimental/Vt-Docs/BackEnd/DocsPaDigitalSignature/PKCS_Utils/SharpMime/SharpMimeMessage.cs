        ...
        public System.Byte[] BodyBytes
        {
            get
            {
                ...
                if (this.mi.parts.Count == 0)
                {
                    ...
                    if (this.mi.end == -1)
                    {
                        return this.message.ReadAllBytes(this.mi.start_body);
                    }
                    else
                    {
                        int removeCRLF=0;
                        byte[] lastBytes = this.message.ReadBytes(this.mi.end - 2, this.mi.end);
                        if (lastBytes[0]=='\r')
                            removeCRLF++;
                        ...
                        return this.message.ReadBytes(this.mi.start_body, this.mi.end - removeCRLF);//remove CR LF
                    }
                }
                else
                {
