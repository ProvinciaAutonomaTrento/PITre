...
namespace DocsPaDB.Query_DocsPAWS.Reporting
{
    ...
    public class DecretiPervenutiInIntTemporaleSRCReport
    {
        [ReportDataExtractorMethod(ContextName = "DecretiInEsamePervenutiInIntTemporaleSRC")]
        public DataSet GetDescretiInEsamePervenutiInRangeDateData(InfoUtente userInfo, List<FiltroRicerca> searchFilters)
        {
            ...
            using (DBProvider dbProvider = new DBProvider())
            {
                ...
                Query query = InitQuery.getInstance().getQuery("CDC_REPORT_DECRETI_PERVENUTI_IN_INT_TEMPORALE_SRC");
