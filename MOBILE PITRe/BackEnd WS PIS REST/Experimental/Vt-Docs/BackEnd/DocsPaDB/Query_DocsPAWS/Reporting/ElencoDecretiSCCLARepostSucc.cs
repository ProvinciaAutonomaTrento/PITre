...
namespace DocsPaDB.Query_DocsPAWS.Reporting
{
    ...
    public class ElencoDecretiSCCLAReportSucc
    {

        [ReportDataExtractorMethod(ContextName = "ElencoDecretiSCCLASucc")]
        public DataSet GetDescretiInEsameData(InfoUtente userInfo, List<FiltroRicerca> searchFilters)
        {
            ...
            using (DBProvider dbProvider = new DBProvider())
            {
                ...
                Query query = InitQuery.getInstance().getQuery("CDC_REPORT_ELENCO_DECRETI_SCCLA_SUCC");
