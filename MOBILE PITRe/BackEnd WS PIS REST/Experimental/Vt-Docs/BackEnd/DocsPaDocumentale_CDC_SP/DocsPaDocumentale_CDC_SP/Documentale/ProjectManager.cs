...
namespace DocsPaDocumentale_CDC_SP.Documentale
{
    ...
    /// 
    /// <remarks>
    /// Da specifiche per l’integrazione con DocsPa, SP è utilizzato come:
    ...
    {
        private static ILog logger = LogManager.GetLogger(typeof(ProjectManager));
        #region Constructors
        ...
        {
            return this.ProjectManagerETDOCS.DeleteFolder(folder);
        }
        ...
        {
            return this.ProjectManagerETDOCS.ModifyFolder(folder);
        }
