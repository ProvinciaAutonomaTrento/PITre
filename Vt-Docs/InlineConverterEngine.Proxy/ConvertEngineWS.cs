...
namespace InlineConverterEngine.Proxy
{
    ...
    public partial class ConvertEngineWS : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        private System.Threading.SendOrPostCallback IsPdfPadesOperationCompleted;
        ...
        /// <remarks/>
        public event IsPdfPadesCompletedEventHandler IsPdfPadesCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.valueteam.com/VTDocs/ConverterEngine/IsPdfPades", RequestNamespace = "http://www.valueteam.com/VTDocs/ConverterEngine", ResponseNamespace = "http://www.valueteam.com/VTDocs/ConverterEngine", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool IsPdfPades([System.Xml.Serialization.XmlElementAttribute(DataType = "base64Binary")] byte[] content)
        {
            object[] results = this.Invoke("IsPdfPades", new object[] {
                    content});
            return ((bool)(results[0]));
        }

        /// <remarks/>
        public System.IAsyncResult BeginIsPdfPades(byte[] content, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("IsPdfPades", new object[] {
                    content}, callback, asyncState);
        }

        /// <remarks/>
        public bool EndIsPdfPades(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((bool)(results[0]));
        }
        ...
        /// <remarks/>
        public void IsPdfPadesAsync(byte[] content)
        {
            this.IsPdfPadesAsync(content, null);
        }

        /// <remarks/>
        public void IsPdfPadesAsync(byte[] content, object userState)
        {
            if ((this.IsPdfPadesOperationCompleted == null))
            {
                this.IsPdfPadesOperationCompleted = new System.Threading.SendOrPostCallback(this.OnIsPdfPadesOperationCompleted);
            }
            this.InvokeAsync("IsPdfPades", new object[] {
                    content}, this.IsPdfPadesOperationCompleted, userState);
        }

        private void OnIsPdfPadesOperationCompleted(object arg)
        {
            if ((this.IsPdfPadesCompleted != null))
            {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.IsPdfPadesCompleted(this, new IsPdfPadesCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
    public delegate void IsPdfPadesCompletedEventHandler(object sender, IsPdfPadesCompletedEventArgs e);

    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class IsPdfPadesCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {

        private object[] results;

        internal IsPdfPadesCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) :
                base(exception, cancelled, userState)
        {
            this.results = results;
        }
