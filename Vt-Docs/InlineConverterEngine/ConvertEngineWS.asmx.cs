...
namespace InlineConverterEngine
{
    ...
    public class ConvertEngineWS : System.Web.Services.WebService
    {
        ...
        /// <summary>
        /// Metodo web per la verifica della presenza firma Pades
        /// </summary>
        /// <param name="content">Contenuto del file da verificare</param>
        /// <returns></returns>
        [WebMethod(Description = "Metodo web per la verifica della presenza firma Pades")]
        public bool IsPdfPades(byte[] content)
        {
            try
            {
                DigitalSignature.Pades pades = new DigitalSignature.Pades();
                return pades.IsPdfPades(content);
