--------------------------------------------------------
--  DDL for Function MENSILEFASCICOLITABLEFUNCTION
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "ITCOLL_6GIU12"."MENSILEFASCICOLITABLEFUNCTION" (p_ID_AMM number, p_ID_REGISTRO number, ANNO number, mese number)
...
-- commentata condizione su dta_chiusura perche vale il filtro su stato 
