...
-- PALUMBO: problema ricerca con griglia

begin
Utl_Backup_Plsql_code ('PROCEDURE','Getvalcampoprofdoc');
end;
/
...
if(tipoOggetto = 'CasellaDiSelezione') then
    ...
    begin
        select getContatoreDoc2(DocNumber,tipoCont, CustomObjectId)  into result from dpa_associazione_templates where id_oggetto = CustomObjectId and doc_number = DocNumber; 
