...
BEGIN
  CODICE := 'BE_RECUPERO_URL';
  DESCRIZIONE := 'URL del web service del servizio di recupero';
  VALORE := 'https://parer.regione.emilia-romagna.it/sacer/RecDIPStatoConservazioneSync';
  TIPO_CHIAVE := 'B';
  VISIBILE := '1';
  MODIFICABILE := '1';
  GLOBALE := '1';
