create or replace
PROCEDURE create_new_nodo_titolario (
   p_idamm                           NUMBER,
   ...
   p_consentiFascicolazione         VARCHAR,
      ...
      BEGIN
         ...
         INSERT INTO project
                     (system_id, description, iconized, cha_tipo_proj,
                      ...
                      num_prot_tit, cha_consenti_class, cha_consenti_fasc
                     )
              VALUES (secproj, p_description, 'Y', 'T',
                      ...
                      p_numprottit, consenticlass, p_consentiFascicolazione
                     );
