--------------------------------------------------------
--  DDL for View DPA_V_DOCUMENTI
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "ITCOLL_6GIU12"."DPA_V_DOCUMENTI" ("ID_PROFILE", "NUM_PROTO", "DTA_PROTO", "COD_FASC", "CHA_TIPO_PROTO", "DTA_PROTO_IN", "VAR_PROTO_IN", "VAR_PROF_OGGETTO", "VAR_NOTE", "AMBITO", "SETTORE", "OPERAZIONE", "OPERATORE", "MITTENTE", "DATATRASMISSIONE") AS 
