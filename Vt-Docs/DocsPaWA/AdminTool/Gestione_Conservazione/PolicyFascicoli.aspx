<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyFascicoli.aspx.cs" Inherits="DocsPAWA.AdminTool.Gestione_Conservazione.PolicyFascicoli" %>
...
<head id="Head1" runat="server">
    <title>Conservazione - Policy Fascicoli</title>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function NewPolicyFascicoli() {
            var newLeft = (screen.availWidth / 2 - 225);
            var newTop = (screen.availHeight - 704);

            var retval = window.showModalDialog(_url_new_policy, 'NewPolicyFascicoli', 'dialogWidth:700px;dialogHeight:660px;status:no;resizable:no;scroll:yes;dialogLeft:' + newLeft + ';dialogTop:' + newTop + ';center:no;help:no;', '');
            if (retval != null) {
        ...
        function OpenPolicyDetails(id) {
            var newLeft = (screen.availWidth / 2 - 225);
            var newTop = (screen.availHeight - 704);
            var retval = window.showModalDialog(_url_view_policy + "?id=" + id, 'OpenPolicyDetails', 'dialogWidth:700px;dialogHeight:660px;status:no;resizable:no;scroll:yes;dialogLeft:' + newLeft + ';dialogTop:' + newTop + ';center:no;help:no;', '');
            if (retval != null) {
                window.document.getElementById('<%= Page.Form.ClientID %>').submit();
            }
        }
...
<body onunload="ClosePopUp()" style="margin:0px;padding:0px;">
    ...
    <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName="AMMINISTRAZIONE > Conservazione > Policy Fascicoli" />
    ...
    <table height="100%" cellspacing="1" cellpadding="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td class="titolo" align="center" bgcolor="#e0e0e0" height="20">
                Conservazione -> Policy Fascicoli
            </td>
        </tr>
        <tr>
