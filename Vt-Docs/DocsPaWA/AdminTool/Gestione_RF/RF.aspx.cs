...
namespace Amministrazione.Gestione_RF
{
    ...
    public partial class RF : System.Web.UI.Page
    {
       ...
       // protected System.Web.UI.WebControls.CheckBox cbx_inviomanuale;
        ...
        protected DocsPAWA.AdminTool.UserControl.RubricaComune RubricaComune1;
        ...
        void ddl_registri_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.ddl_registri != null && this.ddl_registri.SelectedIndex > 0)
            {
                ...
                DocsPAWA.DocsPaWR.Registro reg = ws.GetRegistroBySistemId(this.ddl_registri.SelectedValue);
                if (reg.Sospeso)
                {
        ...
        {
            DocsPAWA.DocsPaWR.OrgRegistro[] registri = this.GetRegistri_RF_Amministrazione("1");
        ...
        /// </summary>
        private void RefreshRFFromUI(ref DocsPAWA.DocsPaWR.OrgRegistro registro, bool insertMode)
        {
            if(!insertMode)
        ...
        /// </summary>
        /// <returns></returns>
        public DocsPAWA.DocsPaWR.OrgRegistro[] GetRegistri_RF_Amministrazione(string chaRF)
        {
            string codiceAmministrazione = AmmUtils.UtilsXml.GetAmmDataSession((string)Session["AMMDATASET"], "0");
        ...
        /// <returns></returns>
        public DocsPAWA.DocsPaWR.OrgRegistro[] GetRegistri_RF_Amministrazione(string codiceAmministrazione, string chaRF)
        {
       ...
       /* private void Save()
        ...
        /// <param name="registro"></param>
        /// <returns></returns>
        private DocsPAWA.DocsPaWR.ValidationResultInfo InsertRF(ref DocsPAWA.DocsPaWR.OrgRegistro registro)
        {
            DocsPAWA.AdminTool.Manager.SessionManager sessionManager = new DocsPAWA.AdminTool.Manager.SessionManager();
        ...
        /// <param name="registro"></param>
        /// <returns></returns>
        private DocsPAWA.DocsPaWR.ValidationResultInfo UpdateRF(ref DocsPAWA.DocsPaWR.OrgRegistro registro)
        {
        ...
        public void CaricaComboRegistri()
        {
            try
            {
                ...
                DocsPAWA.DocsPaWR.OrgRegistro[] registri = this.GetRegistri_RF_Amministrazione("0");
        ...
        {
            DocsPAWA.DocsPaWR.OrgRegistro registro = this.GetRegistro(this.CurrentIDRF);
        ...
        { 
            ...
            {
                DocsPAWA.DocsPaWR.ValidationResultInfo res = DocsPAWA.utils.MultiCasellaManager.InsertMailRegistro(this.CurrentIDRF, newCaselle, false);
