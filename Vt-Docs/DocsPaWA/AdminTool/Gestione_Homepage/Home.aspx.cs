...
namespace Amministrazione.Gestione_Homepage
{
	...
	public class Home : System.Web.UI.Page
	{
        ...
        protected System.Web.UI.WebControls.TextBox txt_banner;
        ...
        protected System.Web.UI.WebControls.Panel pnlFascObbligatoria;
        protected System.Web.UI.WebControls.ImageButton btn_fascObbligatoria;
        protected System.Web.UI.WebControls.Panel pnlFascObbligatoriaTipiDoc;
        protected System.Web.UI.WebControls.ImageButton btn_chiudiFascObbligatoria;
        protected System.Web.UI.WebControls.CheckBox cbxTipoDoc1;
        protected System.Web.UI.WebControls.CheckBox cbxTipoDoc2;
        protected System.Web.UI.WebControls.CheckBox cbxTipoDoc3;
        protected System.Web.UI.WebControls.CheckBox cbxTipoDoc4;
        protected System.Web.UI.WebControls.CheckBox cbxTipoDoc5;
        protected System.Web.UI.WebControls.CheckBox cbxTipoDoc6;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if (DocsPAWA.ConfigSettings.getKey(DocsPAWA.ConfigSettings.KeysENUM.T_DO_SMISTA) != null && DocsPAWA.ConfigSettings.getKey(DocsPAWA.ConfigSettings.KeysENUM.T_DO_SMISTA).Equals("1"))
            {
		...
		private void onDDLAmmSelectedIndexChanged()
		{
			...
			DocsPAWA.AdminTool.Manager.AmministrazioneManager mng = new DocsPAWA.AdminTool.Manager.AmministrazioneManager();
            ...
            try
            {
                ...
                //Aggiorno i dati per l'amministrazione selezionata
                string oldTipoAmministratore = _datiAmministratore.tipoAmministratore;
                if (_datiAmministratore != null && (oldTipoAmministratore.Equals("3") || oldTipoAmministratore.Equals("2")))
                {
                    ...
                    InfoUtenteAmministratore userAmm = manager.GetDatiAmministratore(_datiAmministratore.userId, idAmm);

                    if (userAmm != null && !string.IsNullOrEmpty(_datiAmministratore.idCorrGlobali))
                        _datiAmministratore = userAmm;

                    manager.GetAmmListaVociMenu(_datiAmministratore.idCorrGlobali, idAmm);
                    DocsPAWA.DocsPaWR.Menu[] listaVociMenu = manager.getListaVociMenu();

                    if (listaVociMenu != null && listaVociMenu.Length > 0)
                    {
                        _datiAmministratore.VociMenu = listaVociMenu;
                        session.removeUserAmmSession();
                        session.setUserAmmSession(_datiAmministratore);
                    }
		...
		private void ViewCurrentAmm()
		{
            ...
            if (_datiAmministratore != null && (_datiAmministratore.tipoAmministratore.Equals("2") || _datiAmministratore.tipoAmministratore.Equals("3")))
            {
                this.LoadDDLAmministrazioniPerUtenteAmministratore(amm.getListaAmministrazioni(), idAmm, _datiAmministratore.userId);
            }
            else
		...
		private DocsPAWA.DocsPaWR.InfoAmministrazione getInfoCurrentAmm(ArrayList lista, string idCurrentAmm)
		{			
			DocsPAWA.DocsPaWR.InfoAmministrazione currAmm = new DocsPAWA.DocsPaWR.InfoAmministrazione();
			foreach(DocsPAWA.DocsPaWR.InfoAmministrazione amm in lista)
			{
        ...
        private void LoadDDLAmministrazioniPerUtenteAmministratore(ArrayList listaAmministrazioni, string idAmmSelected, string userId)
        {
            string returnMsg = string.Empty;
            DocsPAWA.DocsPaWR.Amministrazione[] listaAmm = DocsPAWA.UserManager.GetDatiAmministrazioneByUserAdministrator(this, userId, true, out returnMsg);
            this.ddl_amministrazioni.Items.Clear();

            foreach (DocsPAWA.DocsPaWR.InfoAmministrazione currAmm in listaAmministrazioni)
            {
                if((from a in listaAmm where a.systemId.Equals(currAmm.IDAmm) select a).FirstOrDefault() != null)
                {
                    ListItem items = new ListItem(currAmm.Descrizione, currAmm.IDAmm);
                    this.ddl_amministrazioni.Items.Add(items);
                }
		...
		private void LoadInfoAmm(DocsPAWA.DocsPaWR.InfoAmministrazione currAmm)
		{
            ...
            this.rdbIsEnabledHTML5Socket.Checked = (currAmm.SmartClientConfigurations.ComponentsType == "4");
        ...
        private void LoadTimbro(DocsPAWA.DocsPaWR.InfoAmministrazione currAmm)
        {
		...
		private DocsPAWA.DocsPaWR.InfoAmministrazione getVideoData()
		{
            ...
            amm.SmartClientConfigurations = new DocsPAWA.DocsPaWR.SmartClientConfigurations();
            amm.SmartClientConfigurations.ComponentsType = (this.rdbIsEnabledSmartClient.Checked ? "2" : (this.rdbIsEnabledJavaApplet.Checked ? "3" : (this.rdbIsEnabledHTML5Socket.Checked ? "4" : (this.rdbDisableAll.Checked ? "1" : "0"))));
            ...
            amm.SpedizioneDocumenti = new DocsPAWA.DocsPaWR.ConfigSpedizioneDocumento();
            //*******************************************************
            // Giordano Iacozzilli 20/09/2012 
            // Ripristino della sola trasmissione in automatico ai 
            // destinatari interni nei protocolli in uscita
			...
			switch (from)
			{
				...
				case "Normal":
                    ...
                    if (DocsPAWA.utils.InitConfigurationKeys.GetValue("0", "FE_FASC_REQUIRED_TIPI_DOC") != null && DocsPAWA.utils.InitConfigurationKeys.GetValue("0", "FE_FASC_REQUIRED_TIPI_DOC").ToString().Equals("1"))
                        this.pnlFascObbligatoria.Visible = true;
                    this.pnlFascObbligatoriaTipiDoc.Visible = false;
                    ...
                    {   // SUPER ADMIN
                        ...
                        //03/07/2017: VISUALIZZO TUTTE LE AMMINISTRAZIONI IN CUI L'UTENTE SUPER ADMIN è ABILITATO
                        //this.ddl_amministrazioni.Enabled = false;
                    }
                    else if (_datiAmministratore.tipoAmministratore.Equals("3"))
                    {
                        //USER ADMIN
                        this.btn_nuova.Visible = false;
                        this.pnl_info.Visible = false;
				...
				case "Nuova":
                    ...
                    this.txt_banner.Text = string.Empty;
                    ...
                    if (DocsPAWA.utils.InitConfigurationKeys.GetValue("0", "FE_FASC_REQUIRED_TIPI_DOC") != null && DocsPAWA.utils.InitConfigurationKeys.GetValue("0", "FE_FASC_REQUIRED_TIPI_DOC").ToString().Equals("1"))
                        this.pnlFascObbligatoria.Visible = true;
                    this.pnlFascObbligatoriaTipiDoc.Visible = false;
                    this.cbxTipoDoc1.Checked = false;
                    this.cbxTipoDoc2.Checked = false;
                    this.cbxTipoDoc3.Checked = false;
                    this.cbxTipoDoc4.Checked = false;
                    this.cbxTipoDoc5.Checked = false;
                    this.cbxTipoDoc6.Checked = false;
        ...
        private void GetRagioniTrasm(string idAmm, string idRagTrasmTO, string idRagTrasmCC, string IDRagTrasmComp, string IDRagTrasmCono)
		{
			...
			if(mng.getListaRagioniTrasm()!=null && mng.getListaRagioniTrasm().Count>0)
			{
				...
				foreach(DocsPAWA.DocsPaWR.OrgRagioneTrasmissione currRag in mng.getListaRagioniTrasm())
				{
					//prende solo le ragione di trasm. con destinatari "TUTTI"
					if(currRag.TipoDestinatario==DocsPAWA.DocsPaWR.TipiDestinatariTrasmissioneEnum.Tutti)
					{
		...
		private void btn_salva_Click(object sender, System.EventArgs e)
		{
            ...
            if (this.txt_banner.Text != string.Empty) 
            { 
            //banner
            }
		}
		...
		private void InsertAmm()
		{
			try
			{
                ...
                DocsPAWA.DocsPaWR.InfoAmministrazione infoAmm = this.getVideoData();
        ...
        private void btn_fascObbligatoria_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            this.pnl_autenticazione.Visible = false;
            this.pnl_fasc_segn.Visible = false;
            this.pnl_timbro.Visible = false;
            this.pnl_etichette.Visible = false;
            this.pnlFascObbligatoriaTipiDoc.Visible = true;
            this.clearDgFascSegn();
            GetFascicolazioneTipiDoc();

        }

        private void GetFascicolazioneTipiDoc()
        {
            ...
            String idAmm = AmmUtils.UtilsXml.GetAmmDataSession((string)Session["AMMDATASET"], "3");
            List<DocsPAWA.DocsPaWR.FascicolazioneTipiDocumento> listFascDoc = wws.GetFascicolazioneTipiDocumento(idAmm, infoUtente).ToList<DocsPAWA.DocsPaWR.FascicolazioneTipiDocumento>();
            if (listFascDoc != null && listFascDoc.Count > 0)
            {
                foreach (DocsPAWA.DocsPaWR.FascicolazioneTipiDocumento fascDoc in listFascDoc)
                {
                    switch (fascDoc.Codice)
                    {
                        case "A":
                            this.cbxTipoDoc1.Checked = fascDoc.FascicolazioneObbligatoria;
                            break;
                        case "P":
                            this.cbxTipoDoc2.Checked = fascDoc.FascicolazioneObbligatoria;
                            break;
                        case "I":
                            this.cbxTipoDoc3.Checked = fascDoc.FascicolazioneObbligatoria;
                            break;
                        case "G":
                            this.cbxTipoDoc4.Checked = fascDoc.FascicolazioneObbligatoria;
                            break;
                        case "C":
                            this.cbxTipoDoc5.Checked = fascDoc.FascicolazioneObbligatoria;
                            break;
                        case "R":
                            this.cbxTipoDoc6.Checked = fascDoc.FascicolazioneObbligatoria;
                            break;
                    }
                }
            }
        ...
        private bool SetFascicolazioneTipiDoc()
        {
            DocsPAWA.DocsPaWR.DocsPaWebService wws = new DocsPAWA.DocsPaWR.DocsPaWebService();
            ...
            List<DocsPAWA.DocsPaWR.FascicolazioneTipiDocumento> listFascDoc = new List<FascicolazioneTipiDocumento>();

            listFascDoc.Add(new FascicolazioneTipiDocumento() { Codice = "A", FascicolazioneObbligatoria = this.cbxTipoDoc1.Checked, IdAmministrazione = idAmm });
            listFascDoc.Add(new FascicolazioneTipiDocumento() { Codice = "P", FascicolazioneObbligatoria = this.cbxTipoDoc2.Checked, IdAmministrazione = idAmm });
            listFascDoc.Add(new FascicolazioneTipiDocumento() { Codice = "I", FascicolazioneObbligatoria = this.cbxTipoDoc3.Checked, IdAmministrazione = idAmm });
            listFascDoc.Add(new FascicolazioneTipiDocumento() { Codice = "G", FascicolazioneObbligatoria = this.cbxTipoDoc4.Checked, IdAmministrazione = idAmm });
            listFascDoc.Add(new FascicolazioneTipiDocumento() { Codice = "C", FascicolazioneObbligatoria = this.cbxTipoDoc5.Checked, IdAmministrazione = idAmm });
            listFascDoc.Add(new FascicolazioneTipiDocumento() { Codice = "R", FascicolazioneObbligatoria = this.cbxTipoDoc6.Checked, IdAmministrazione = idAmm });

            return wws.SetFascicolazioneTipiDocumento(listFascDoc.ToArray(), idAmm, infoUtente);
        }

        private void btn_chiudiFascObbligatoria_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            this.pnlFascObbligatoriaTipiDoc.Visible = false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="currAmm"></param>
        private void SetClientModelProcessor(DocsPAWA.DocsPaWR.InfoAmministrazione currAmm)
        {
        ...
        protected void btn_test_Click(object sender, EventArgs e)
        {
            ...
            DocsPAWA.DocsPaWR.MailRegistro registro = new DocsPAWA.DocsPaWR.MailRegistro();
            DocsPAWA.AdminTool.Manager.AmministrazioneManager amm = new DocsPAWA.AdminTool.Manager.AmministrazioneManager();
            DocsPAWA.DocsPaWR.InfoAmministrazione firstTime = null;
            amm.ListaAmministrazioni();
            ...
            if (amm.getListaAmministrazioni() != null && amm.getListaAmministrazioni().Count > 0)
            {
                ...
                else
                {
                    ...
                    this.LoadDDLAmministrazioni(amm.getListaAmministrazioni(), null);
                    firstTime = (DocsPAWA.DocsPaWR.InfoAmministrazione)amm.getListaAmministrazioni()[0];
                }
            }
