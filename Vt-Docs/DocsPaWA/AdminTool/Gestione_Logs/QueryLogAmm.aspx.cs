		...
		{		
			if(ViewState["LOG"] != null)
			{
				...
				{		
                    ...
                    if (!((this.DisableAmmGestCons() || this.IsConservazionePARER()) && riga[1].ToString() == "CONSERVAZIONE") &&
                        !(!this.IsConservazionePARER() && riga[1].ToString().Equals("CONSERVAZIONE_PARER")))
