<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestioneStoricoProfDinamica.aspx.cs"
    Inherits="DocsPAWA.AdminTool.Gestione_ProfDinamica.GestioneStoricoProfDinamica" %>
        ...
        <asp:DataGrid ID="dgFields" runat="server" AllowCustomPaging="false" Width="100%" AutoGenerateColumns="false">
         <SelectedItemStyle CssClass="bg_grigioS"></SelectedItemStyle>
            ...
            <Columns>
                <asp:TemplateColumn>
                    <ItemTemplate>
                        <asp:HiddenField ID="hfObjectId" runat="server" Value="<%# ((DocsPAWA.DocsPaWR.CustomObjHistoryState)Container.DataItem).FieldId %>"  />
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:BoundColumn DataField="Description" />
                <asp:TemplateColumn>
                    <ItemTemplate>
                        <asp:CheckBox ID="chkEnabled" runat="server" Checked="<%# ((DocsPAWA.DocsPaWR.CustomObjHistoryState)Container.DataItem).Enabled %>" onclick="chkEnabled_onClick(this);" />
                    </ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
        </asp:DataGrid>
