<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportDettagli.aspx.cs" Inherits="DocsPAWA.AdminTool.Gestione_Organigramma.ExportDettagli" %>
                ...
                <div id="content_field">
                    ...
                    <asp:Panel runat="server" ID="pnl_confirm">
                        <table id="Table3" align="center">
                            <tr>
                                <td align="center">
                                    <asp:Button ID="btn_conferma" runat="server" CssClass="cbtn" Text="Esporta" OnClick="btnConferma_Click"></asp:Button>
                                </td>
                                <td>
