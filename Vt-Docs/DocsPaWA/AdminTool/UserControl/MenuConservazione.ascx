...
<table border="0" cellpadding="0" cellspacing="1" width="120" bgcolor="#c0c0c0" height="100%">
    ...
    <tr>
        <%
            if (Request.QueryString["menuConservazione"] == "gestReportistica")
            { %>
        <!--  TASTO : Gestione reportistica  -->
        <td width="120" height="25" bgcolor="#ad736b" class="testo_bianco" align="left" style="padding-left: 5px;">
            Gest. Reportistica
        </td>
        <% }
        ...
        <td width="120" height="25" bgcolor="#800000" align="left" class="testo_bianco" style="padding-left: 5px;">
            <asp:HyperLink CssClass="menu" ID="HyperLink5" runat="server" Target="_parent"
                NavigateUrl="../Gestione_Conservazione/GestioneReportistica.aspx?from=CON&amp;menuConservazione=gestReportistica"
                ToolTip="Gestione reportistica">Gest. Reportistica</asp:HyperLink>
        </td>
        <% } %>
        <% } %>
    </tr>
