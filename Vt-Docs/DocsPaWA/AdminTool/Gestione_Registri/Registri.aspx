                                            ...
                                            <tr valign="top">
                                                <td>
                                                    <table cellspacing="0" cellpadding="0" border="0">
                                                        ...
                                                        <tr>
                                                            <td width="100" align="right">
                                                                <asp:Label runat="server" CssClass="testo_grigio_scuro" ID="lbl_utRespStampa" Text="Resp. stampa"></asp:Label>&nbsp;
                                                            </td>
                                                            <td>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td align="right"  width="60%">
                                                                ...
                                                                <asp:Button ID="btn_SbloccaCasella" runat="server" Visible="false" CssClass="testo_btn" Text="Sblocca casella">
                                                                    </asp:Button>&#160;&#160;
