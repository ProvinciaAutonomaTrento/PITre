<%@ Page language="c#" Codebehind="MezzoSpedizione.aspx.cs" AutoEventWireup="false" Inherits="Amministrazione.Gestione_MezzoSpedizione.MezzoSpedizione" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="javascript: DivHeight();"
		...
		<form id="Form1" method="post" runat="server">
			<uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "AMMINISTRAZIONE > Mezzo di Spedizione" />
			...
			<table height="100%" cellSpacing="1" cellPadding="0" width="100%" border="0">
				...
				<tr>
					<!-- TITOLO PAGINA -->
					<td class="titolo" align="center" bgColor="#e0e0e0" height="20">Mezzi di Spedizione</td>
				</tr>
				<tr>
						...
						<table cellSpacing="0" cellPadding="0" align="center" border="0">
							...
							<tr>
								<td class="pulsanti" align="center" width="700">
									<table width="100%">
										<tr>
											<td align="left"><asp:label id="lbl_tit" CssClass="titolo" Runat="server">Lista Mezzi di Spedizione</asp:label></td>
											<td align="right"><asp:button id="btn_nuovoMezzo" runat="server" CssClass="testo_btn" Text="Nuovo mezzo di spedizione"></asp:button>&nbsp;</td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								<td style="HEIGHT: 157px" align="center" valign="top">
									<DIV id="DivDGList" style="OVERFLOW: auto; WIDTH: 720px; HEIGHT: 150px">
										<asp:datagrid id="dg_mezzi" runat="server" BorderColor="Gray" CellPadding="1" BorderWidth="1px"
											...
											<Columns>
												<asp:BoundColumn Visible="False" DataField="IDSYSTEM_MS" HeaderText="ID">
													<HeaderStyle Width="0px"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="DESCRIPTION" HeaderText="Descrizione">
													<HeaderStyle Width="65%"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="CANCELLATO" HeaderText="Eliminato">
											...
											<TR>
												<TD colSpan="3">
													<TABLE cellSpacing="0" cellPadding="0" width="100%">
														<TR>
															<TD class="titolo_pnl" align="left">Dettagli mezzo di spedizione</TD>
												...
												<TD width="50%">
													<TABLE>
														<TR>
															...
															<TD>
																<asp:TextBox id="txt_descrizione" Runat="server" CssClass="testo" Width="250px" MaxLength="60"></asp:TextBox></TD>
														</TR>
													</TABLE>
												</TD> 
											</TR>
