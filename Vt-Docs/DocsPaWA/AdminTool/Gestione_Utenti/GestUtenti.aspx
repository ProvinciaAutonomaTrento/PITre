                            ...
                            <asp:Panel ID="pnl_info" runat="server" Visible="False" Width="100%">
                                <table class="contenitore" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="testo_grigio_scuro" align="left" style="width: 25%" valign="middle">
                                            ...
                                            <asp:CheckBox ID="chkUserAutomatic" runat="server" Text="Automatico"
                                                CssClass="testo" TextAlign="Left" />
                                            <asp:CheckBox ID="chkApplicativoVerticale" runat="server" Text="Applicativo verticale" AutoPostBack="true"
                                                CssClass="testo" TextAlign="Left" OnCheckedChanged="chkApplicativoVerticale_OnCheckedChanged"/>                              
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 25%;">
                                            <asp:UpdatePanel ID="UpPnlAggiungiCasella" runat="server" UpdateMode="Always">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txt_email" TabIndex="16" runat="server" CssClass="testo" Width="90%" MaxLength="100"></asp:TextBox>
                                                    <asp:ImageButton AlternateText="Aggiungi casella di posta" ImageAlign="AbsMiddle" Visible="false" OnClick="imgAggiungiCasella_Click"
                                                        ID="imgAggiungiCasella" runat="server" ToolTip="Aggiungi casella di posta" ImageUrl="~/images/proto/aggiungi.gif" />
                                                    <asp:GridView ID="gvCaselle" runat="server" Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvCaselle_RowDataBound"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Email" ShowHeader="true">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox AutoPostBack="true" OnTextChanged="txtEmailCorr_TextChanged" CssClass="testo" Style="width: 98%; margin: 1px;" ID="txtEmailCorr" runat="server" Text ='<%# ((string)Container.DataItem) %>'></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>                                                        
                                                           <%--< <asp:TemplateField HeaderText="Note E-mail" ShowHeader="true" Visible="false">
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="20%"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:TextBox AutoPostBack="true" MaxLength="20" CssClass="testo" OnTextChanged="txtNoteMailCorr_TextChanged" Style="width: 96%;" ID="txtNoteMailCorr" runat="server" ></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
