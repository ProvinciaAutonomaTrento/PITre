<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestioneStato.aspx.cs" Inherits="DocsPAWA.AdminTool.Gestione_DiagrammiStato.GestioneStato" %>
...
<body MS_POSITIONING="GridLayout">
    <form id="form1" runat="server">
	    ...
	    <table width="100%" bgColor="#f6f4f4" style="BORDER-RIGHT: #810d06 1px solid; BORDER-TOP: #810d06 1px solid; BORDER-LEFT: #810d06 1px solid; BORDER-BOTTOM: #810d06 1px solid">
            ...
            <tr>
		        <td class="testo_grigio_scuro">Pubblicazione Files</td>
		        <td>
                    <asp:CheckBox ID="cb_pubb_files" runat="server" Checked="false" CssClass="testo" ToolTip="Permette di selezionare i files da mandare in pubblicazione"/>
                </td>
		    </tr>
