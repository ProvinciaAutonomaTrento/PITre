...
{
    /// <summary>
    /// Summary description for gestioneReg.
    /// </summary>
    public partial class gestioneRegRepertorio : System.Web.UI.Page
    {
        private void Page_Load(object sender, System.EventArgs e)
        {
            // Put user code to initialize the page here
            Utils.startUp(this);
            Session["Bookmark"] = "GestioneRegRepertorio";
        ...
        {
            string url = DocsPAWA.Utils.getHttpFullPath() + "/gestione/registro/gestioneRegRepertorio.aspx";
