...
namespace DocsPAWA.popup
{
    ...
    public class Inserisci : System.Web.UI.Page
    {
        ...
        private void btn_Insert_Click(object sender, System.EventArgs e)
        {
            ...
            {
                case "U":
                    DocsPaWR.UnitaOrganizzativa uo = new DocsPAWA.DocsPaWR.UnitaOrganizzativa();
                    ...
                    {
                        if (!DocsPAWA.utils.MultiCasellaManager.InsertMailCorrispondenteEsterno(
        ...
        private DocsPaWR.Registro[] getListaRegistri()
        {
            ...
            if (schedaDoc != null && (modify != null && modify != "" && modify.Equals("false")))// se creo un cprrispondente mentre protocollo
            {
                ...
                {
                    DocsPaWR.Registro[] protoReg = new DocsPAWA.DocsPaWR.Registro[1];
        ...
        protected void BindGridViewCaselle()
        {
            if (ViewState["gvCaselle"] == null)
                ViewState["gvCaselle"] = new List<DocsPAWA.DocsPaWR.MailCorrispondente>();
