...
<%@ Page language="c#" Codebehind="RicercaProtocolliUscita.aspx.cs" AutoEventWireup="false" Inherits="DocsPAWA.popup.RicercaProtocolliUscita" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="5" topMargin="5" rightMargin="5" MS_POSITIONING="GridLayout">
		<form id="frm_rispostaProtoUscita" method="post" runat="server">
		    <uct:AppTitleProvider ID="appTitleProvider" runat="server" PageName = "Ricerca protocolli" />
			...
			<TABLE class="contenitore" id="tbl_rispostaProtoUscita" height="603" width="580" align="center"
				...
				<TR vAlign="middle" height="20">
					<td class="menu_1_rosso" align="center">Ricerca protocolli in uscita</td>
				</TR>
				<tr height="120">
					<td>
						...
						<DIV id="DivDataGrid" style="OVERFLOW: auto; WIDTH: 570px; HEIGHT: 295px"><asp:datagrid id="DataGrid1" runat="server" SkinID="datagrid" Width="98%" Visible="False" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:TemplateColumn Visible="False" HeaderText="Destinatario">
										...
										<ItemTemplate>
											<asp:Label runat="server" Text='<%# DocsPAWA.Utils.TruncateString_MittDest(DataBinder.Eval(Container, "DataItem.mittDest")) %>' ID="Label3">
											</asp:Label>
										</ItemTemplate>
										<EditItemTemplate>
