...
namespace DocsPAWA
{
    ...
    public class UserManager
    {
      ...
      /*  private string getCorrispondenteRuoloInferiore(DocsPaVO.trasmissione.OggettoTrasm objOggettoTrasmesso, DocsPaVO.utente.Ruolo objRuolo, bool cercaInf)
        ...
        public static bool IsUtenteVerticale(Page page, string idPeople)
        {
            bool resultValue = false;

            try
            {
                return docsPaWS.IsUtenteVerticale(idPeople);
            }
            catch (System.Exception e)
            {
                ErrorManager.redirectToErrorPage(page, e);
        ...
        public static bool SetUtenteVerticale(Page page, string userId, string idAmm, bool isVerticale)
        {
            bool resultValue = false;

            try
            {
                return docsPaWS.SetUtenteVerticale(userId, idAmm, isVerticale);
            }
            catch (System.Exception e)
            {
                ErrorManager.redirectToErrorPage(page, e);
