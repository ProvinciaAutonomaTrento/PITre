...
namespace DocsPAWA
{
    public class DiagrammiManager
    {
        ...
        public static bool IsModelloDiFirma(string idProcesso, Page page)
        {
            try
            {
        ...
        public static bool IsProcessoFirmaConCambioStato(string idProcesso, Page page)
        {
            try
            {
                return docsPaWS.IsProcessoFirmaConCambioStato(idProcesso);
            }
            catch (Exception ex)
            {
                ErrorManager.redirect(page, ex);
