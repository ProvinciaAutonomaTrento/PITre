<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisualizzaFrame.aspx.cs"
    Inherits="DocsPAWA.documento.Visualizzatore.VisualizzaFrame" %>
                    ...
                    <asp:DataGrid ID="grdButtons" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                        <asp:Label ID="lblDescrizione" runat="server" CssClass="lbl_indiceAllegato" 
                                        Text="<%# this.GetLabel((DocsPAWA.DocsPaWR.BaseInfoDoc) Container.DataItem) %>"
                                        ToolTip ="<%# this.GetNomeOriginale((DocsPAWA.DocsPaWR.BaseInfoDoc) Container.DataItem) %>"
                                        >
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
