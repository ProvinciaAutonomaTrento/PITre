...
{
    public partial class VisualizzaFrame : System.Web.UI.Page
    {
        /// <summary>
        ...
        {
            FileRequest fileRequest = new FileRequest { versionId = baseInfoDoc.VersionId, docNumber = baseInfoDoc.DocNumber , fileName = baseInfoDoc.FileName};
        ...
        private void LoadDocument()
        {
            ...
            // versione stampabile
            string versioneStampabile = "false";
            ...
            // Lettura del parametro su versione stampabile
            if (!String.IsNullOrEmpty(Request["versioneStampabile"]))
            ...
            if (!this.IsPostBack)
            {
                ...
                this.ShowDocument(docToShow.Description,
                    ...
                    docToShow.Path,
                    docToShow.FileName,
                    Convert.ToBoolean(versioneStampabile),
                    docToShow.IsProto);
