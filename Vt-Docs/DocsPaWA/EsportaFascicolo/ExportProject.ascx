<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExportProject.ascx.cs"
    Inherits="DocsPAWA.EsportaFascicolo.ExportProject" %>
    ...
    <tr style="background-color: Silver;">
        ...
        <td class="testo_grigio_scuro" valign="middle" align="right" height="10%">
            <asp:ImageButton ID="btn_stampa" Visible="true" runat="server" AlternateText="Esporta il log delle operazioni."
                ImageUrl="../images/proto/export.gif" OnClientClick="lanciaVisPdf();"></asp:ImageButton>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            ...
            <cc1:MessageBox Width="1" Height="1" CssClass="testo_grigio" ID="msg_result" runat="server">
            </cc1:MessageBox>
