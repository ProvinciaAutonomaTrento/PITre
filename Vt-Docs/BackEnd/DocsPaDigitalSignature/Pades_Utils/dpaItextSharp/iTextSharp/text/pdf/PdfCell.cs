...
namespace dpaItextSharp.text.pdf {
     ...
     *
     * @see     dpaItextSharp.text.Rectangle
     * @see     dpaItextSharp.text.Cell
     * @see     PdfLine
     * @see     PdfTable
     */
    ...
    public class PdfCell : Rectangle {
        ...
        */
        private float GetBorderWidthInside(int side) {
            ...
            if (useBorderPadding) {
                switch (side) {
                    case dpaItextSharp.text.Rectangle.LEFT_BORDER:
                        width = BorderWidthLeft;
                        break;

                    case dpaItextSharp.text.Rectangle.RIGHT_BORDER:
                        width = BorderWidthRight;
                        break;

                    case dpaItextSharp.text.Rectangle.TOP_BORDER:
