...
namespace dpaItextSharp.text.pdf {
    ...
    */
    public class PdfSignatureAppearance {
        ...
        */    
        public PdfTemplate GetAppearance() {
            ...
            if (app[2] == null) {
                ...
                if (Render == SignatureRender.NameAndDescription) {
                    string signedBy = dpaItextSharp.text.pdf.PdfPKCS7.GetSubjectFields(this.certChain[0]).GetField("CN");
        ...
        * @throws IOException on error
        */
        public void Close(PdfDictionary update, bool DoNotClose = false)
        {
            try {
                if (!preClosed)
