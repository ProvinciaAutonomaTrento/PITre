...
using dpaItextSharp.text.rtf.document.output;
using dpaItextSharp.text.rtf.list;
using ST = dpaItextSharp.text.rtf.style;
using dpaItextSharp.text.rtf.style;
using HF = dpaItextSharp.text.rtf.headerfooter;
using dpaItextSharp.text.rtf.headerfooter;
//using dpaItextSharp.text.rtf;
/*
...
namespace dpaItextSharp.text.rtf.document {
