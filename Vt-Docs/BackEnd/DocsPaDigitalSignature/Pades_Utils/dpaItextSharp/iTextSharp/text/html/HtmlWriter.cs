...
namespace dpaItextSharp.text.html {
    /**
    ...
    public class HtmlWriter : DocWriter {
        ...
        protected itextProperties markup = new itextProperties();
        ...
        protected void Write(IElement element, int indent) {
            itextProperties styleAttributes = null;
            switch (element.Type) {
                case Element.MARKED: {
                    try {
                        Add(element);
                ...
                case Element.PHRASE: {
                    ...
                    styleAttributes = new itextProperties();
        ...
        protected void Write(Font font, itextProperties styleAttributes) {
