...
{
   public partial class ARCHIVE_Disposal
    {
         #region Fields
        ...
        public ARCHIVE_Disposal(Int32 system_ID, Int32 id_Amministrazione, String description, String note)
        {
            System_ID = system_ID;
