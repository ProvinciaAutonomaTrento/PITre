...
namespace BusinessLogic.ServiceNotifications
{
    public class Notification
    {
        ...
        /// <returns></returns>
        public static bool RemoveNotifications(List<DocsPaVO.Notification.Notification> listNotifications, DocsPaVO.utente.InfoUtente infoUtente)
        {
            bool res = false;
            try
            {
                DocsPaDB.Query_DocsPAWS.NotificationDB notificationDB = new DocsPaDB.Query_DocsPAWS.NotificationDB();
                res = notificationDB.RemoveNotifications(listNotifications, infoUtente);
            }
            catch (Exception e)
            {
