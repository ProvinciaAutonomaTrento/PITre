    ...
    public class ExportDatiManager
    {
     ...
     this._objList.Count.ToString(), infoObjs);
        ...
        private DataTable DataTableVisibilitaProcessi(List<DocsPaVO.LibroFirma.ProcessoFirma> listaProssiFirma, DocsPaVO.utente.InfoUtente infoUtente)
        {
            ...
            const string NOTIFICA_CONCLUSIONE = "NOTIFICA CONCLUSIONE";
            const string NOTIFICA_INTERRUZIONE = "NOTIFICA INTERRUZIONE";
            const string NOTIFICA_ERRORE = "NOTIFICA ERRORE";
            ...
            processoFirma.Columns.Add(NOTIFICA_CONCLUSIONE);
            processoFirma.Columns.Add(NOTIFICA_INTERRUZIONE);
            processoFirma.Columns.Add(NOTIFICA_ERRORE);
            ...
            foreach (DocsPaVO.LibroFirma.ProcessoFirma processo in listaProssiFirma)
            {
                ...
                if (visibilita != null && visibilita.Count > 0)
                {
                    foreach(DocsPaVO.LibroFirma.VisibilitaProcessoRuolo vis in visibilita)
                    {
                        ...
                        else if (vis.TipoVisibilita.Equals(DocsPaVO.LibroFirma.TipoVisibilita.PROPONENTE))
                            processoFirmaItem[TIPO_VISIBILITA] = "Attivatore";
                        else if (vis.TipoVisibilita.Equals(DocsPaVO.LibroFirma.TipoVisibilita.PROPONENTE_MONITORATORE))
                            processoFirmaItem[TIPO_VISIBILITA] = "Attivatore/Monitoraggio";

                        processoFirmaItem[NOTIFICA_CONCLUSIONE] = vis.Notifica.Notifica_concluso ? "SI" : "NO";
                        processoFirmaItem[NOTIFICA_INTERRUZIONE] = vis.Notifica.Notifica_interrotto ? "SI" : "NO";
                        processoFirmaItem[NOTIFICA_ERRORE] = vis.Notifica.NotificaErrore ? "SI" : "NO";
                ...
                else
                {
                    ...
                    processoFirmaItem[NOTIFICA_CONCLUSIONE] = string.Empty;
                    processoFirmaItem[NOTIFICA_INTERRUZIONE] = string.Empty;
                    processoFirma.Rows.Add(processoFirmaItem);
                }
            ...
            foreach (DocsPaVO.ExportData.CampoSelezionato field in campiSelezionati)
            {
                switch (field.nomeCampo)
                {
                    ...
                    case "Tipo visibilità":
                        strXML += "<Column ss:StyleID=\"s63\" ss:Width=\"200\"/>";
                        break;
                    case "Notifica conclusione":
                        strXML += "<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>";
                        break;
                    case "Notifica interruzione":
                        strXML += "<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>";
                        break;
                    case "Notifica errore":
                        strXML += "<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>";
                        break;
                    default:
                        strXML += "<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>";
                        ...
                        foreach(DocsPaVO.LibroFirma.VisibilitaProcessoRuolo vis in visibilita)
                        {
                            ...
                            foreach (DocsPaVO.ExportData.CampoSelezionato field in campiSelezionati)
                            {
                                switch (field.nomeCampo)
                                {
                                    ...
                                    case "Tipo visibilità":
                                        if (vis.TipoVisibilita.Equals(DocsPaVO.LibroFirma.TipoVisibilita.MONITORATORE))
                                            tipoVisibilita = "Monitoraggio";
                                        else if (vis.TipoVisibilita.Equals(DocsPaVO.LibroFirma.TipoVisibilita.PROPONENTE))
                                            tipoVisibilita = "Attivatore";
                                        else if (vis.TipoVisibilita.Equals(DocsPaVO.LibroFirma.TipoVisibilita.PROPONENTE_MONITORATORE))
                                            tipoVisibilita = "Attivatore/Monitoraggio";

                                        riga += "<Cell>";
                                        riga += "<Data ss:Type=\"String\">" + tipoVisibilita;
                                        riga += "</Data>";
                                        riga += "</Cell>";
                                        break;
                                    case "Notifica conclusione":
                                        riga += "<Cell>";
                                        riga += "<Data ss:Type=\"String\">" + (vis.Notifica.Notifica_concluso ? "SI" : "NO");
                                        riga += "</Data>";
                                        riga += "</Cell>";
                                        break;
                                    case "Notifica interruzione":
                                        riga += "<Cell>";
                                        riga += "<Data ss:Type=\"String\">" + (vis.Notifica.Notifica_interrotto ? "SI" : "NO");
                                        riga += "</Data>";
                                        riga += "</Cell>";
                                        break;
                                    case "Notifica errore":
                                        riga += "<Cell>";
                                        riga += "<Data ss:Type=\"String\">" + (vis.Notifica.NotificaErrore ? "SI" : "NO");
                                        riga += "</Data>";
                                        riga += "</Cell>";
                                        break;
                                }
                        ...
                        foreach (CampoSelezionato selectedField in campiSelezionati)
                        {
                            switch (selectedField.nomeCampo)
                            {
                                ...
                                case "Tipo visibilità":
                                    ...
                                    break;
                                case "Notifica conclusione":
                                    value = vis.Notifica.Notifica_concluso ? "SI" : "NO";
                                    if (i == 0)
                                    {
                                        dt.Columns.Add(selectedField.nomeCampo);
                                        column.SetField(selectedField.nomeCampo, selectedField.nomeCampo);
                                    ...
                                    break;
                                case "Notifica interruzione":
                                    value = vis.Notifica.Notifica_interrotto ? "SI" : "NO";
                                    if (i == 0)
                                    {
                                        dt.Columns.Add(selectedField.nomeCampo);
                                        column.SetField(selectedField.nomeCampo, selectedField.nomeCampo);
                                    ...
                                    break;
                                case "Notifica errore":
                                    value = vis.Notifica.NotificaErrore ? "SI" : "NO";
                                    if (i == 0)
                                    {
                                        dt.Columns.Add(selectedField.nomeCampo);
                                        column.SetField(selectedField.nomeCampo, selectedField.nomeCampo);
