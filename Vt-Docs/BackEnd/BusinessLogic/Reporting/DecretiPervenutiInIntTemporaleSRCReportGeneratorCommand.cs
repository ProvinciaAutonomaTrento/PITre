...
{
    /// <summary>
    /// Classe per la generazione del report per i Decreti pervenuti in un dato intervallo temporale
    /// </summary>
    [ReportGeneratorAttribute(Name = "Report Decreti pervenuti in intervallo temporale", ContextName = "ProspettiRiepilogativi", Key = "DecretiInEsamePervenutiInIntTemporaleSRC")]
    class DecretiPervenutiInIntTemporaleSRCReportGeneratorCommand : ReportGeneratorCommand
    {
        /// <summary>
        ...
        protected override HeaderColumnCollection GenerateReportHeader(System.Data.DataSet dataSet, HeaderColumnCollection fieldsToExport)
        {
            ...
            // Revisore (68 px)
            header["Revisore"].ColumnSize = 51;
            header["Revisore"].ColumnName = "Revisore";
