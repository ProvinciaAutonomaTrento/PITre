...
namespace BusinessLogic.Import
{
    class ImportUtils
    {
        ...
        public static byte[] DounloadFileFromUserTempFolder(DocsPaVO.PrjDocImport.DocumentRowData rowData, InfoUtente userInfo, bool isAttachment = false)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Cartella temporanea utente non accesibile non accessibile");
                }
