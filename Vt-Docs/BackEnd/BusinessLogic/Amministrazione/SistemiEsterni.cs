...
namespace BusinessLogic.Amministrazione
{
    public class SistemiEsterni
    {
        ...
        {
            DocsPaDB.Query_DocsPAWS.Amministrazione dbAmm = new DocsPaDB.Query_DocsPAWS.Amministrazione();
            return dbAmm.Albo_InsFileDaPubblicare(idDocPrincipale, docNumber, daPubb);
        }

        public static List<string> Albo_GetStatiSelezioneFiles(string idDiagramma)
        {
            DocsPaDB.Query_DocsPAWS.Amministrazione dbAmm = new DocsPaDB.Query_DocsPAWS.Amministrazione();
            return dbAmm.Albo_GetStatiSelezioneFiles(idDiagramma);
        }
