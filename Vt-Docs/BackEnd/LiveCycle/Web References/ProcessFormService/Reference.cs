...
namespace LiveCycle.ProcessFormService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ProcessFormSoapBinding", Namespace="http://adobe.com/idp/services")]
    public partial class ProcessFormService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ProcessFormService() {
            this.Url = global::LiveCycle.Properties.Settings.Default.LiveCycle_ProcessFormService_ProcessFormService;
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("signatureResult")]
        public bool invoke(BLOB formPdf, out XML xmlOutput) {
            object[] results = this.Invoke("invoke", new object[] {
                        formPdf});
            xmlOutput = ((XML)(results[1]));
            return ((bool)(results[0]));
        }
        
        /// <remarks/>
        public void invokeAsync(BLOB formPdf) {
            this.invokeAsync(formPdf, null);
        }
        
        /// <remarks/>
        public void invokeAsync(BLOB formPdf, object userState) {
            ...
            this.InvokeAsync("invoke", new object[] {
                        formPdf}, this.invokeOperationCompleted, userState);
        }
    ...
    public partial class invokeCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public XML xmlOutput {
            get {
                this.RaiseExceptionIfNecessary();
                return ((XML)(this.results[1]));
            }
        }
    }
}
