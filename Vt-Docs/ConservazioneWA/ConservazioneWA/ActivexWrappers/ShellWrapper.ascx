<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShellWrapper.ascx.cs" Inherits="ConservazioneWA.ActivexWrappers.ShellWrapper" %>
<% if (this.UseActivexWrapper && !this.Page.ClientScript.IsClientScriptBlockRegistered(this.Page.GetType(), "ShellWrapperObject")) 
   { %> 
<OBJECT CLASSID="CLSID:C50FED4F-D464-4695-93E1-05C5B346C2D8" CODEBASE="../activex/DocsPa_ActivexWrappers.CAB#version=3,6,0,0" height="0" width="0"></OBJECT> 
<% 
