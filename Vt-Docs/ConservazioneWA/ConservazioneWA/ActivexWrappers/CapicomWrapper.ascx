<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CapicomWrapper.ascx.cs" Inherits="ConservazioneWA.ActivexWrappers.CapicomWrapper1" %>
...
function CapicomWrapper_GetCertificateList(storeLocation, storeName)
{
    try
    {
        ...
        if ("<%=UseActivexWrapper%>" == "True")
        {
            ...
            var list = capicomWrapper.GetCertificateList(storeLocation, storeName);
