...
{
    /// <summary>
    /// Summary description for DocsPaWSITokenAuth
    /// </summary>
    ...
    public class DocsPaWSITokenAuth : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public virtual bool protocollazioneCompleta(string token, 
                                DocsPaVO.OggettiLite.SchedaDocumentoLite schedaDocLite,
                                DocsPaVO.OggettiLite.ProtocolloEntrataLite protoELite,
                                DocsPaVO.OggettiLite.ProtocolloUscitaLite protoULite,
                                DocsPaVO.OggettiLite.ProtocolloInternoLite protoILite,
                       out int numProto, out int AnnoProto, out string segnatura, out string dataProtocollo)
        {
            bool result;
            //OGGETTI LITE: trasforma oggetti lite in oggetti completi
            //schedaDoc
            //protoE
            //protoU
            //protoI
            ...
            DocsPaVO.documento.ProtocolloEntrata protoE = new DocsPaVO.documento.ProtocolloEntrata();
            ...
            schedaDoc = ClassiLite.getSchedaDoc(schedaDocLite);
            protoE = (DocsPaVO.documento.ProtocolloEntrata) ClassiLite.getProtocolloCompleto(protoELite);
            protoU = (DocsPaVO.documento.ProtocolloUscita) ClassiLite.getProtocolloCompleto(protoULite);
            protoI = (DocsPaVO.documento.ProtocolloInterno) ClassiLite.getProtocolloCompleto(protoILite);
            ...
            result = this.protocollazioneEstesa(token, schedaDocLite, out numProto, out AnnoProto, out segnatura, out dataProtocollo);
            return result;
        }
        #endregion
        ...
        [WebMethod]
        public virtual bool protocollazioneEstesa(string token, 
            DocsPaVO.OggettiLite.SchedaDocumentoLite schedaDocLite, out int numProto, out int AnnoProto, out string segnatura, out string dataProtocollo)
        {
            bool result;
            numProto = 0;
            AnnoProto = 0;
            ...
            try
            {
                ...
                //inserisci i dettagli dei corrispondenti del protocollo
        ...
        [WebMethod]
        public DocsPaVO.OggettiLite.SchedaDocumentoLite ricercaSchedabySegnatura(string segnatura, string token)
        {
            ...
            try
            {
                ...
                //trasformo la scheda in LITE
                schLite = ClassiLite.getSchedaLite(sch);
                return schLite;
            }
            catch (Exception e)
            { throw e; }
        ...
        [WebMethod]
        public DocsPaVO.OggettiLite.SchedaDocumentoLite modificaProtocollo(DocsPaVO.OggettiLite.SchedaDocumentoLite schL, string token, out string ErrorMsg)
        {
            ...
            try
            {
                ...
                //trasformo l'oggetto Lite in oggetto classico
                DocsPaVO.documento.SchedaDocumento sch = ClassiLite.getSchedaDoc(schL);
                ...
                //trasformo la scheda in LITE
                schLite = ClassiLite.getSchedaLite(result);
        ...
        [WebMethod]
        public virtual bool creaDocumentoGrigio(string tokenDiAutenticazione, ref DocsPaVO.OggettiLite.SchedaDocumentoLite schedaDocL)
        {
            DocsPaVO.utente.InfoUtente infoUtente = null;

            //trasformo la scheda LITE in scheda Completa
            DocsPaVO.documento.SchedaDocumento schedaDocumento = null; 
            try
            {
                schedaDocumento = ClassiLite.getSchedaDoc(schedaDocL);
                if (schedaDocumento != null)
                {
                    ...
                    if (infoUtente != null)
                    {
                        ...
                        //trasforo da completa in lite
                        schedaDocL = ClassiLite.getSchedaLite(schedaDocumento);

                        if (schedaDocumento != null)
                        {
                            //BusinessLogic.UserLog.UserLog.getInstance().WriteLog(infoUtente, "CREADOCUMENTOGRIGIO", schedaDocumento.systemId, string.Format("{0} {1}", "N.ro Doc.: ", schedaDocumento.docNumber), DocsPaVO.Logger.CodAzione.Esito.OK);
        ...
        [WebMethod]
        public virtual bool protocollaDocumento(string tokenDiAutenticazione, ref DocsPaVO.OggettiLite.SchedaDocumentoLite schedaDocL)
        {
        ...
        [WebMethod]
        public virtual DocsPaVO.OggettiLite.SchedaDocumentoLite ricercaDocumentoById(string token, string idDocumento)
        {

            DocsPaVO.utente.InfoUtente infoUtente;
            DocsPaVO.documento.SchedaDocumento schedaDocumento = null;
            DocsPaVO.OggettiLite.SchedaDocumentoLite schedaDocLite = null;
            try
            {
                this.canaleWSAperto();
                this.UserID = this.getInfoFromToken("USER_ID", token);
                ...
                //trasforma da completo a lite
                schedaDocLite = ClassiLite.getSchedaLite(schedaDocumento);
        ...
        [WebMethod]
        public virtual bool aggiungiAllegato(string tokenDiAutenticazione, DocsPaVO.OggettiLite.SchedaDocumentoLite schedaL, string NumPagine, string Descrizione, DocsPaVO.documento.FileDocumento fd, ref DocsPaVO.documento.Allegato allegato)
        {
            bool esito = true;
            ...
            try
            {
                ...
                allegato.docNumber = schedaL.docNumber;
                allegato.version = "0";
