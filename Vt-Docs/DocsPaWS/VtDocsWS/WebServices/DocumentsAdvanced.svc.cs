...
namespace VtDocsWS.WebServices
{
    ...
    public class DocumentsAdvanced : IDocumentsAdvanced
    {
        ...
        public Services.DocumentsAdvanced.GetModifiedDocumentAdv.GetModifiedDocumentAdvResponse GetModifiedDocumentAdv(Services.DocumentsAdvanced.GetModifiedDocumentAdv.GetModifiedDocumentAdvRequest request)
        {
            logger.Info("BEGIN");

            Services.DocumentsAdvanced.GetModifiedDocumentAdv.GetModifiedDocumentAdvResponse response = VtDocsWS.Manager.DocumentsAdvancedManager.GetModifiedDocumentAdv(request);
