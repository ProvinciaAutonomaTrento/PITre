    ...
    public class Utils
    {
        ...
        public static Domain.Document GetDocumentFromSearchObject(DocsPaVO.Grids.SearchObject obj, bool estrazioneTemplate, DocsPaVO.Grid.Field[] visibilityFields, string codiceAmm)
        {
            ...
            if (obj != null)
            {
                ...
                {
                    result.MainDocument = new Domain.File();
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            if (oggettoCustom.TIPO.DESCRIZIONE_TIPO == "CampoDiTesto")
                            {
                                ...
                                {
                                    string mappLIQFun = "";
                                    //if (tipoLiquidazione == "LI")
                                    //{
                                    //    mappLIQFun = "//*[name()='ns0:Dati_DocLIQ']/*[name()='ns0:Funzionario']";
                                    //}
                                    //else
                                    //{
                                    //    mappLIQFun = "//*[name()='ns0:Dati_Doc']/*[name()='ns0:Funzionario']";
                                    //}
                                    if (tipoLiq2 == "LIQUIDAZIONE" || tipoLiq2 == "NOTA RETTIFICA")
                                    {
        ...
        public static DocsPaVO.utente.Corrispondente GetCorrespondentFromPisNewInsertOccasionale(Domain.Correspondent corr, DocsPaVO.utente.InfoUtente infoUtente)
        {
            DocsPaVO.utente.Corrispondente result = new DocsPaVO.utente.Corrispondente();
