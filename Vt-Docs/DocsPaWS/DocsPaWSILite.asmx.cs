...
{
    /// <summary>
    /// Summary description for DocsPaWSILite
    /// </summary>
    ...
    public class DocsPaWSILite : System.Web.Services.WebService
    {
        ...
        private string SessionIdWSLite = "WSILite";
        protected DocsPaVO.utente.UserLogin userLogin;




        public DocsPaWSILite()
        {
            InitializeComponent();
        }
        ...
        {
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSILite", "Protocollazione");
        ...
        {
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSILite", "InsertCorrispondenteEsterno");
        ...
        [WebMethod]
        [System.Xml.Serialization.XmlInclude(typeof(DocsPaVO.OggettiLite.UnitaOrganizzativaLite))]
        public DocsPaVO.OggettiLite.SchedaDocumentoLite ricercaSchedabyChiaveProto(string numproto, string anno, string tipodoc, string codreg, string userId, string password)
        {
            ...
            DocsPaVO.OggettiLite.SchedaDocumentoLite schLite = null;
            try
            {
                this.canaleWSAperto();
                ...
                //NUOVO IWS converti la scheda in schedaLite
                schLite = DocsPaUtils.ClassiLite.getSchedaLite(sch);
                return schLite;
            }
            catch (Exception e)
            { throw e; }
            ...
            string modelloTrasmissione, out int numProto, out int AnnoProto, out string segnatura, out string dataProtocollo)
        {
            ...
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSILite", "protocollazioneDocumentoProfilato");
            bool result = false;
            numProto = 0;
            AnnoProto = 0;
            segnatura = "";
        ...
        private DocsPaVO.utente.Corrispondente setInfoCorr(DocsPaVO.utente.Corrispondente corr, CorrLite corrWs)
        {
            ...
            //string codiceIpa = corrWs.codiceIpa != null ? corrWs.codiceIpa.Trim() : "";
            string codiceIpa = string.Empty;
...
infoUtente)
        ...
        [WebMethod]
        [System.Xml.Serialization.XmlInclude(typeof(DocsPaVO.OggettiLite.UnitaOrganizzativaLite))]
        public DocsPaVO.OggettiLite.SchedaDocumentoLite ricercaSchedabySegnatura(string segnatura, string userId, string password)
        {
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSILite", "ricercaSchedabySegnatura");
        ...
        {
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSILite", "putfile");
        ...
        /// <returns></returns>
        [WebMethod]
        public DocsPaVO.OggettiLite.SchedaDocumentoLite modificaProtocollo(DocsPaVO.OggettiLite.SchedaDocumentoLite sch, string userId, string password, out string ErrorMsg)
        {

            DocsPaVO.documento.SchedaDocumento schedaDocC;
            DocsPaVO.OggettiLite.SchedaDocumentoLite schedaDocLite;
            //TRASFORMA ILITE
            // sch --> schedaDocC
            schedaDocC = ClassiLite.getSchedaDoc(sch);
            ...
            try
            {
                ...
                bool uffref = false;
                result = this.WS.DocumentoSaveDocumento(null, infout, schedaDocC, false, out uffref);
            ...
            //TRASFORMO l'oggetto completo in ILITE
            // result --> schedaDocLite
            schedaDocLite = ClassiLite.getSchedaLite(result); 
            return schedaDocLite;
        ...
        #region Trasmissioni
        [WebMethod]
        public virtual bool executeTrasm(string serverPath, DocsPaVO.OggettiLite.SchedaDocumentoLite scheda, DocsPaVO.Modelli_Trasmissioni.ModelloTrasmissione modello, string userId, string password)
        {
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSLite", "executeTrasm");
            DocsPaVO.documento.SchedaDocumento schedaDocC;
            //DocsPaVO.OggettiLite.SchedaDocumentoLite schedaDocLite;
            //TRASFORMO LA SCHEDA LITE IN COMPLETA
            //scheda --> schedaDocC
            schedaDocC = ClassiLite.getSchedaDoc(scheda);
            ...
            try
            {
                ...
                trasmissione.infoDocumento = getInfoDocumento(schedaDocC);
        ...
        [WebMethod]
        public virtual bool ricercaCorrLiteIE(CorrLite corrispondente, string User_ID, string Pwd, string TipoIE, out DocsPaWSILite.CorrLite corrLiteOut)
        {
        ...
        [WebMethod]
        public virtual DocsPaVO.documento.Allegato aggiungiAllegato(string User_ID, string Pwd, DocsPaVO.OggettiLite.SchedaDocumentoLite scheda, string NumPagine, string Descrizione, DocsPaVO.documento.FileDocumento fd, DocsPaVO.documento.Allegato allegato)
        {
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSILite", "aggiungiAllegato");
            DocsPaVO.documento.SchedaDocumento schedaDocC;
            //TRASFORMO L'OGGETTO LITE in OGGETTO COMPLETO
            //  scheda --> schedaDocC
            schedaDocC = ClassiLite.getSchedaDoc(scheda);
        ...
        [WebMethod]
        public virtual DocsPaVO.documento.FileDocumento aggiungiEtichettaPDF(DocsPaVO.documento.FileRequest fr, DocsPaVO.OggettiLite.SchedaDocumentoLite scheda, string position, string userID, string password, DocsPaVO.documento.FileDocumento fd)
        {
            ServiceLoadController.LoadControllerManager.CheckInterval("DocsPaWSLite", "aggiungiEtichettaPDF");
            DocsPaVO.documento.SchedaDocumento schedaDoc;
            //TRASFORMO SCHEDA LITE IN SCHEDA COMPLETA
            schedaDoc =ClassiLite.getSchedaDoc(scheda);
            ...
            try
            {
                ...
                fd = BusinessLogic.Documenti.FileManager.setFileConSegnatura(fr, schedaDoc, infoUtente, xmlPath, position, ref fd);
        ...
        [WebMethod]
        public virtual bool ricercaCorrLiteIEbyDescrizione(string descRicerca, string User_ID, string Pwd, string tipoIE, out DocsPaWSILite.CorrLite[] corrLiteOut)
        {
