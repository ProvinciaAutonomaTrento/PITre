...
namespace DocsPaWS.Mobile.PdfToImage
{
    ...
    public class PDFConvert
    {
        ...
        public const string GhostScriptDLLName64 = "..\\gsdll\\gsdll64.dll";
        public const string GhostScriptDLLName32 = "..\\gsdll\\gsdll32.dll";
        ...
        /// <returns></returns>
        [DllImport(GhostScriptDLLName64, EntryPoint = "gsapi_new_instance")]
        private static extern int gsapi_new_instance64 (out IntPtr pinstance, IntPtr caller_handle);
        [DllImport(GhostScriptDLLName32, EntryPoint = "gsapi_new_instance")]
        ...
        /// <returns></returns>
        [DllImport(GhostScriptDLLName64, EntryPoint = "gsapi_init_with_args")]
        private static extern int gsapi_init_with_args64 (IntPtr instance, int argc, IntPtr argv);
        [DllImport(GhostScriptDLLName32, EntryPoint = "gsapi_init_with_args")]
        ...
        /// <param name="instance"></param>
        /// <returns></returns>
        [DllImport(GhostScriptDLLName64, EntryPoint = "gsapi_exit")]
        private static extern int gsapi_exit64 (IntPtr instance);
        [DllImport(GhostScriptDLLName32, EntryPoint = "gsapi_exit")]
        private static extern int gsapi_exit32(IntPtr instance);

        private static int gsapi_exit(IntPtr instance)
        {
            if (IntPtr.Size == 4)
                return gsapi_exit32(instance);
            else
                return gsapi_exit64(instance);
        ...
        /// </summary>
        /// <param name="instance"></param>
        [DllImport(GhostScriptDLLName64, EntryPoint = "gsapi_delete_instance")]
        private static extern void gsapi_delete_instance64 (IntPtr instance);
        [DllImport(GhostScriptDLLName32, EntryPoint = "gsapi_delete_instance")]
        ...
        /// <returns></returns>
        [DllImport(GhostScriptDLLName64, EntryPoint = "gsapi_revision")]
        private static extern int gsapi_revision64 (ref GS_Revision pGSRevisionInfo , int intLen );
        [DllImport(GhostScriptDLLName32, EntryPoint = "gsapi_revision")]
        ...
        /// <returns></returns>
        [DllImport(GhostScriptDLLName64, EntryPoint = "gsapi_set_stdio")]
        ...
        [DllImport(GhostScriptDLLName32, EntryPoint = "gsapi_set_stdio")]
        ...
        {
            if(IntPtr.Size == 4)
                return File.Exists(GhostScriptDLLName32);
            else
                return File.Exists(GhostScriptDLLName64);
        }
        #endregion
